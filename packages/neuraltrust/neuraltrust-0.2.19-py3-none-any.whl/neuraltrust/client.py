...
class NeuralTrust:
    ...
    def __init__(
        ...
        Args:
            ...
            sdk_version (str, optional): The SDK version to use.
    ...
    def send_event(
        ...
        Args:
            ...
            session_id (str, optional): The session ID.
            channel_id (str, optional): The channel ID.
            user (User, optional): The user associated with the event.
            metadata (Metadata, optional): Additional metadata for the event.
            custom (dict, optional): Custom data to include with the event.
            start_timestamp (int, optional): The start timestamp of the event in milliseconds.
            end_timestamp (int, optional): The end timestamp of the event in milliseconds.
        ...
        return self._trace(
            ...
            start_timestamp=start_timestamp,
            end_timestamp=end_timestamp,
            custom=json.dumps(custom) if custom else None
        )
...
class Trace:
    ...
    def system(self, input: str|object):
        ...
        Args:
            input (str|object): The input for the system trace.
        """
    ...
    def end(self, output: str|object):
        ...
        Args:
            output (str|object): The output of the trace.
        """
