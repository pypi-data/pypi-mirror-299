...
def getbyperiod(ws, exchange, InstrumentIdentifier, periodicity, period, fromtime, totime,Max, usertag, isShortIdentifiers):
    exg = exchange
    sym = InstrumentIdentifier
    ...
    return asyncio.get_event_loop().run_until_complete(
        mass_subscribe_n_streamft(ws, exg, sym, prc, prd, fromtime, totime,Max, iss, utg))
