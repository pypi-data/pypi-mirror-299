...
class TestTranslatableXBlockBase(TestCase):
    ...
    def test_should_translate_unallowed_language(self, translations_enabled):
        # Given translations are enabled
        translations_enabled.return_value = True

        # ... but the selected language is not allowed for Xpert translation
        self.xblock.source_lang = "zy"
        self.xblock.translate_lang = "zz"
