...
class Model(TypeModel, metaclass=AmsdalModelMetaclass):
    ...
    def _check_unique(self) -> None:
        ...
        obj = meta_model.objects.latest().filter(title=self.__class__.__name__).get().execute()
    ...
    def model_dump_refs(  # type: ignore[override]
        self,
        *,
    ...
    def model_dump_json_refs(  # type: ignore[override]
        self,
        *,
    ...
    def __eq__(self, other: Any) -> bool:
        ...
        return self.get_metadata().address == other.get_metadata().address
