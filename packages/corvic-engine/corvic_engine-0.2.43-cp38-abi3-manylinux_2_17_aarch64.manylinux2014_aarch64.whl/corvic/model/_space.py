...
class SemanticSpace(Space):
    ...
    def create(
        ...
        if len(feature_view.output_sources) == 0:
            return BadArgumentError("feature view must have at least one output source")
        sources = [
...
class TabularSpace(Space):
    ...
    def embeddings_tables(self) -> Ok[Mapping[str, Table]] | BadArgumentError:  # noqa: C901, PLR0911, PLR0912
