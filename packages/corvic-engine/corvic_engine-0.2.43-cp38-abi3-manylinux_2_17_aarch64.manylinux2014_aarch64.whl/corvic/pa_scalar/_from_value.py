...
def _visit_null(  # noqa: C901, PLR0911
...
def _visit_boolean(  # noqa: PLR0911
    value: struct_pb2.Value, dtype: pa.DataType, error_handler: _ErrorHandler
) -> object:
    match value.WhichOneof("kind"):
        case "null_value":
...
def _visit_any_binary(  # noqa: PLR0911
    value: struct_pb2.Value, error_handler: _ErrorHandler
) -> object:
    match value.WhichOneof("kind"):
        case "null_value":
            return None
        ...
        case "string_value":
            ...
            return base64.urlsafe_b64decode(value.string_value + missing_padding)
        case "struct_value":
...
def _visit_any_string(  # noqa: PLR0911
    value: struct_pb2.Value, error_handler: _ErrorHandler
) -> object:
    match value.WhichOneof("kind"):
        case "null_value":
...
def _make_from_iso8601(  # noqa: PLR0911
    value: struct_pb2.Value,
    error_handler: _ErrorHandler,
...
def _visit_duration(  # noqa: PLR0911, C901
    value: struct_pb2.Value, dtype: pa.DataType, error_handler: _ErrorHandler
) -> object:
...
def _visit_interval(  # noqa: PLR0911
    value: struct_pb2.Value, dtype: pa.DataType, error_handler: _ErrorHandler
) -> object:
    match value.WhichOneof("kind"):
        case "null_value":
...
def _visit_decimal(  # noqa: PLR0911
    value: struct_pb2.Value, error_handler: _ErrorHandler
) -> object:
    match value.WhichOneof("kind"):
        case "null_value":
...
def _visit_any_list(  # noqa: PLR0911
...
def _visit_map(  # noqa: PLR0911, C901
    value: struct_pb2.Value, dtype: pa.DataType, error_handler: _ErrorHandler
) -> object:
...
def _visit_struct(  # noqa: PLR0911
    value: struct_pb2.Value, dtype: pa.DataType, error_handler: _ErrorHandler
) -> object:
