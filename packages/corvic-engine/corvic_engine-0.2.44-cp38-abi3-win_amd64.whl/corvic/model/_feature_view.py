...
) -> Ok[Mapping[SourceID, str]] | BadArgumentError:
    if len(sources) < 1:
...
class RelationshipPath:
    ...
    def _end_table(
        ...
        return table.rename_columns({self.initial_end_column: self.final_end_column})
