...
setup(
    ...
    packages=find_packages(exclude=["tests", "tests.*","compilation.py"]),
    install_requires=['pandas>=1.0.0','numpy>=1.18.0','scikit-learn>=0.22.0','matplotlib>=3.1.0','seaborn>=0.10.0'],
    classifiers=[
