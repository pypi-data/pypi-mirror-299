...
class ColumnRuleFormulaCreatorInputV1(object):
    ...
    def __init__(self, column_index_data_id=None, column_indexes=None, description=None, formula=None, identity_id=None, name=None, parameters=None, permission_string=None, scoped_to=None):
        """
