...
class Seedax(MorphoPlugin):
    ...
    The longest axis of the segmentation shape is computed, and then split in N segments , N being the number of seeds in parameter.
    Seeds are generated at the contact points of the segments. It requires to select or label objects on MorphoNet.
