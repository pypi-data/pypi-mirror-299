...
asyncio.run(SdkMessageHelper().send_message_to_app_insights("SdkMessage", "Javonet SDK initialized"))
...
def activate(license_key):
    ...
    try:
        ...
        asyncio.run(SdkMessageHelper().send_message_to_app_insights("SdkException", "Activate exception: " + str(e)))
        raise e
