...
class SessionManagementBase(FeatureImplementationBase, ABC):
    ...
    @abstractmethod
    def RegisterPlate(self, Position: str, *, metadata: MetadataDict) -> RegisterPlate_Responses:
        """
    ...
    @abstractmethod
    def MovePlateToTest(self, Position: str, *, metadata: MetadataDict) -> MovePlateToTest_Responses:
        """
