...
class Rapid_dapper_validation:
    ...
    def get_dappervalidation_forecast(
        ...
        ----------
         ...
         rp_price_forecast_id: Optional[Union[list[str], Series[str], str]]
             rp price forecast id, be default None
        ...
        filter_params.append(list_to_filter("rp_price_forecast_id", rp_price_forecast_id))
        ...
        response = get_data(
            path=f"/rapid/v1/dappervalidation/dappervalidation-forecast",
            params=params,
    ...
    def get_dappervalidation_capacity(
        self, scenario_id: Optional[Union[list[str], Series[str], str]] = None, scenario_description: Optional[Union[list[str], Series[str], str]] = None, commodity: Optional[Union[list[str], Series[str], str]] = None, production_route: Optional[Union[list[str], Series[str], str]] = None, country: Optional[Union[list[str], Series[str], str]] = None, region: Optional[Union[list[str], Series[str], str]] = None, concept: Optional[Union[list[str], Series[str], str]] = None, date: Optional[Union[list[str], Series[str], str]] = None, value: Optional[Union[list[str], Series[str], str]] = None, uom: Optional[Union[list[str], Series[str], str]] = None, data_type: Optional[Union[list[str], Series[str], str]] = None, valid_to: Optional[Union[list[date], Series[date], date]] = None, valid_from: Optional[Union[list[date], Series[date], date]] = None, is_active: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
    ) -> Union[DataFrame, Response]:
        """
        Fetch the data based on the filter expression.
        ...
        ----------
         ...
         concept: Optional[Union[list[str], Series[str], str]]
             Concept that describes what the dataset is, be default None
         date: Optional[Union[list[str], Series[str], str]]
        ...
        response = get_data(
            path=f"/rapid/v1/dappervalidation/dappervalidation-capacity",
            params=params,
            df_fn=self._convert_to_df,
            raw=raw,
            paginate=paginate,
    ...
    def get_dappervalidation_price_forecast(
        self, scenario_id: Optional[Union[list[str], Series[str], str]] = None, scenario_description: Optional[Union[list[str], Series[str], str]] = None, series_description: Optional[Union[list[str], Series[str], str]] = None, commodity: Optional[Union[list[str], Series[str], str]] = None, commodity_grade: Optional[Union[list[str], Series[str], str]] = None, associated_platts_symbol: Optional[Union[list[str], Series[str], str]] = None, delivery_region: Optional[Union[list[str], Series[str], str]] = None, shipping_terms: Optional[Union[list[str], Series[str], str]] = None, currency: Optional[Union[list[str], Series[str], str]] = None, contract_type: Optional[Union[list[str], Series[str], str]] = None, concept: Optional[Union[list[str], Series[str], str]] = None, dataType: Optional[Union[list[str], Series[str], str]] = None, value: Optional[Union[list[str], Series[str], str]] = None, uom: Optional[Union[list[str], Series[str], str]] = None, publish_date: Optional[Union[list[str], Series[str], str]] = None, date: Optional[Union[list[date], Series[date], date]] = None, valid_to: Optional[Union[list[date], Series[date], date]] = None, valid_from: Optional[Union[list[date], Series[date], date]] = None, is_active: Optional[Union[list[str], Series[str], str]] = None, rp_price_forecast_id: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
    ) -> Union[DataFrame, Response]:
        """
        Fetch the data based on the filter expression.
        ...
        response = get_data(
            path=f"/rapid/v1/dappervalidation/dappervalidation-price-forecast",
            params=params,
            df_fn=self._convert_to_df,
            raw=raw,
            paginate=paginate,
