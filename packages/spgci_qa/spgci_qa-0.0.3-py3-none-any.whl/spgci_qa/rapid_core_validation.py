...
class Rapid_core_validation:
    ...
    def get_corevalidation_forecast(
        ...
        response = get_data(
            path=f"/rapid/v1/corevalidation/corevalidation-forecast",
            params=params,
    ...
    def get_corevalidation_capacity(
        self, scenario_id: Optional[Union[list[str], Series[str], str]] = None, scenario_description: Optional[Union[list[str], Series[str], str]] = None, commodity: Optional[Union[list[str], Series[str], str]] = None, production_route: Optional[Union[list[str], Series[str], str]] = None, country: Optional[Union[list[str], Series[str], str]] = None, region: Optional[Union[list[str], Series[str], str]] = None, concept: Optional[Union[list[str], Series[str], str]] = None, date: Optional[Union[list[str], Series[str], str]] = None, value: Optional[Union[list[str], Series[str], str]] = None, uom: Optional[Union[list[str], Series[str], str]] = None, data_type: Optional[Union[list[str], Series[str], str]] = None, valid_to: Optional[Union[list[str], Series[str], str]] = None, valid_from: Optional[Union[list[str], Series[str], str]] = None, is_active: Optional[Union[list[str], Series[str], str]] = None, filter_exp: Optional[str] = None, page: int = 1, page_size: int = 1000, raw: bool = False, paginate: bool = False
    ) -> Union[DataFrame, Response]:
        """
        Fetch the data based on the filter expression.
        ...
        response = get_data(
            path=f"/rapid/v1/corevalidation/corevalidation-capacity",
            params=params,
            df_fn=self._convert_to_df,
            raw=raw,
            paginate=paginate,
