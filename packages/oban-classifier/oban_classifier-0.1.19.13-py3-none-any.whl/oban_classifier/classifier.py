...
set_seed(42)  # Set the seed to ensure reproducibility
...
def oban_classifier(X, y, num_units=128, nonlin=nn.ReLU(), dropout_rate=0.5, 
    ...
    # Use iterator_train__shuffle=False to avoid random shuffling
    netv = NeuralNetClassifier(
        ...
        lr=lr,
        iterator_train__shuffle=False,  # No shuffling for reproducibility
        verbose=1,
