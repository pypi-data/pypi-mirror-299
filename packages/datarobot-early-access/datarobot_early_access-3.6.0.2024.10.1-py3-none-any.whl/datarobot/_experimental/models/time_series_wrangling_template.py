...
from datarobot._experimental.models.dataset import Dataset
from datarobot._experimental.models.enums import DataWranglingDataSourceTypes, DataWranglingDialect
from datarobot._experimental.models.recipe_operations import (
    DatetimeSamplingOperation,
    TimeSeriesOperation,
)
from datarobot._experimental.models.recipes import DataSourceInput, Recipe
...
def user_flow_template(client: RESTClientObject) -> None:
    ...
    # rolling median and rolling most frequent features generation. Ask DR support to provide the implementation.
