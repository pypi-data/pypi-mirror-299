...
class OWNxExplorer(OWDataProjectionWidget):
    ...
    UserAdviceMessages = [
        Message(__("msg.connect_component"),
                Message.Information),
    ]
    ...
    class Warning(OWDataProjectionWidget.Warning):
        distance_matrix_mismatch = Msg(__("msg.distance_matrix_mismatch"))
        no_graph_found = Msg(__('msg.no_graph_found'))
    ...
    def _add_mark_box(self):
        ...
        self.mark_criteria = [
            ...
            (__("gbox.mark_node_labelled_as"), text_line(), mark_label_equals),
