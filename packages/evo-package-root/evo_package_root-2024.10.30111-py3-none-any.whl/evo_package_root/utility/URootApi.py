...
#<        
            ...
            await UFirebaseApi.getInstance().doSet(collection=str(EApiConfig.VERSION), id=eApiConfig.id, data=data, isEncrypt=False)
...
#<        
            ...
            if id in self.mapEApiConfig.keys():
                ...
                data = await UFirebaseApi.getInstance().doGet(collection=str(EApiConfig.VERSION), id=id)
...
#<        
            ...
            eFirebaseMap = await UFirebaseApi.getInstance().doQuery(collection=str(EApiConfig.VERSION), query="")
