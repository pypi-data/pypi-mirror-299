...
class ReplayRecordsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["offset", b"offset", "timestamp", b"timestamp"]) -> None: ...
...
class BatchWriteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["client_id", b"client_id", "request_options", b"request_options", "write_requests", b"write_requests"]) -> None: ...
