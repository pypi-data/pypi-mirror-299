...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ceylon_checksum_constructor_adminagent_new() != 19623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_constructor_workeragent_new() != 59553:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class WorkerAgent:
    _pointer: ctypes.c_void_p
    def __init__(self, config: "WorkerAgentConfig",on_message: "MessageHandler",processor: "Processor",on_event: "EventHandler"):
...
class WorkerAgentConfig:
    name: "str"
    conf_file: "typing.Optional[str]"
    work_space_id: "str"
    admin_peer: "str"
    role: "str"
    admin_port: "int"
    admin_ip: "str"
    def __init__(self, *, name: "str", conf_file: "typing.Optional[str]" = _DEFAULT, work_space_id: "str", admin_peer: "str", role: "str", admin_port: "int", admin_ip: "str"):
        self.name = name
        if conf_file is _DEFAULT:
            self.conf_file = ".ceylon_network"
        else:
    ...
    def __str__(self):
        return "WorkerAgentConfig(name={}, conf_file={}, work_space_id={}, admin_peer={}, role={}, admin_port={}, admin_ip={})".format(self.name, self.conf_file, self.work_space_id, self.admin_peer, self.role, self.admin_port, self.admin_ip)

    def __eq__(self, other):
        if self.name != other.name:
            return False
        if self.conf_file != other.conf_file:
            return False
...
class _UniffiConverterTypeWorkerAgentConfig(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return WorkerAgentConfig(
            name=_UniffiConverterString.read(buf),
            conf_file=_UniffiConverterOptionalString.read(buf),
            ...
            admin_ip=_UniffiConverterString.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.name)
        _UniffiConverterOptionalString.check_lower(value.conf_file)
        ...
        _UniffiConverterString.check_lower(value.admin_ip)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.name, buf)
        _UniffiConverterOptionalString.write(value.conf_file, buf)
        ...
        _UniffiConverterString.write(value.admin_ip, buf)
