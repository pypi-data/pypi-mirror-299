...
class EntityType(sgqlc.types.Interface):
    __schema__ = api_schema
    __field_names__ = ('id', 'name', 'x_coordinate', 'y_coordinate', 'pretrained_nercmodels', 'list_white_dictionary', 'list_white_regexp', 'list_black_dictionary', 'pagination_concept_property_type', 'metric', 'pagination_concept_link_type', 'list_concept_property_type', 'list_concept_link_type', 'list_concept_header_property_type', 'image', 'full_dictionary', 'non_configurable_dictionary', 'list_black_regexp', 'list_names_dictionary', 'list_type_search_element', 'list_type_black_search_element')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
    x_coordinate = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name='xCoordinate')
    y_coordinate = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name='yCoordinate')
...
class ConceptType(sgqlc.types.Type, RecordInterface, EntityType):
    __schema__ = api_schema
...
class ConceptTypePresentation(sgqlc.types.Type, RecordInterface, EntityTypePresentation):
    __schema__ = api_schema
    __field_names__ = ('id', 'name', 'root_concept_type', 'is_default', 'layout', 'has_supporting_documents', 'has_header_information', 'hide_empty_rows', 'pagination_widget_type', 'list_widget_type', 'internal_url')
    id = sgqlc.types.Field(sgqlc.types.non_null(ID), graphql_name='id')
    name = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='name')
...
class DocumentType(sgqlc.types.Type, RecordInterface, EntityType):
    __schema__ = api_schema
