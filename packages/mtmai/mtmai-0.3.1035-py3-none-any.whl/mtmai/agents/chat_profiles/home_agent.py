...
from mtmai.agents.graphs.home_chat_graph import HomeChatGraph
...
class HomeAgent(ChatAgentBase):
    ...
    async def chat_start(self):
        ...
        graph = await HomeChatGraph().get_compiled_graph()
    ...
    async def on_message(self, message: cl.Message):
        ...
        await graph.astate_update(thread, {"user_input": message.content}, as_node="human_node")
        await self.run_graph(inputs, thread)
