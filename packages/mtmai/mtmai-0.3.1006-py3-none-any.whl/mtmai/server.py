...
# def setup_additional_openapi_Schema(app: FastAPI):
#     """
#     添加额外openapi schema 数据类型
#     原因： 有些数据类型没有直接在 fastapi router 中被引用，而是 在websocket 中使用。
#     所以需要在这里添加，让前端 typescript 类型定义正确
#     """
#     app.openapi_schema = app.openapi()
#     app.openapi_schema["components"]["schemas"]["DemoAdditionalModel"] = (
#         DemoAdditionalModel.model_json_schema()
#     )
#     # 添加 InputWidget 到 schema
#     app.openapi_schema["components"]["schemas"]["InputWidget"] = (
#         InputWidget.model_json_schema()
#     )

#     # 修改 ThreadForm 的 schema
#     thread_form_schema = ThreadForm.model_json_schema()
#     if "$defs" in thread_form_schema:
#         del thread_form_schema["$defs"]
#     thread_form_schema["properties"]["inputs"]["items"] = {
#         "$ref": "#/components/schemas/InputWidget"
#     }
#     app.openapi_schema["components"]["schemas"]["ThreadForm"] = thread_form_schema
