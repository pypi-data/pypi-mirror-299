...
http-request $verb if $expression"""
    ...
    # Specifically for per-ip concurrency enforcement
    fragment_log_excursion = """
http-request set-var(req.dummy_$safe_name) src,debug(silent-drop_for_300s_$safe_name) if $log_excursion_expression
