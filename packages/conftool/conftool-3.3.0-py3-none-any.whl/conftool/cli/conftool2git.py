...
class AuditLogHandler:
    ...
    def startup_sync(self) -> None:
        ...
        self._commit(None, "audit2git reconciliation on startup")
    ...
    async def process_audit_log_entry(self, msg: str) -> None:
        ...
        if entry.action == "delete":
            ...
            try:
                data = KVObject.backend.driver.read(entry.object)
        ...
        self._commit(author, message)
        logger.info("Committed changes for %s", entry.object)

    def _commit(self, author: Optional[Signature], message: str) -> None:
