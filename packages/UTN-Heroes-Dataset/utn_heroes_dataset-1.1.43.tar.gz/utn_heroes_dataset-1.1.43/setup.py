...
setup(
    ...
    requires=['setuptools', 'pygame', 'terminaltexteffects', 'tabulate'],
    install_requires=['setuptools', 'pygame', 'terminaltexteffects', 'tabulate'],
    include_package_data=True,
    package_data={
        'utn_assets': ['select.mp3', 'Desafio_01.md', 'Desafio_02.md'],
    },
    entry_points={
