...
async def launch(  # noqa
    ...
    # Optional params
    organization: Annotated[str, typer.Option()] | None = None,
    ...
    exclude_regex: Annotated[str, typer.Option()] | None = None,
    # Harware parameters
    ...
    compliance_soc2: Annotated[bool, typer.Option()] | None = None,
) -> None:
