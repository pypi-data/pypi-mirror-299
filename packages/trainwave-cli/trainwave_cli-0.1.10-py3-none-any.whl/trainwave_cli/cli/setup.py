...
@ensure_api_key
async def default(
    config: Annotated[Optional[str], typer.Option(help="Provide a config path")] = "trainwave.toml",
    accept: Annotated[bool, typer.Option(help="Accept overwrite of config without prompt")] = False,
) -> None:
    """
    Runs a configuration guide in the browser to create or update a config file.
