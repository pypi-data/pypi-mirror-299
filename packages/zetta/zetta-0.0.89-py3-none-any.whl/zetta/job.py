...
default_model_version_id = "model_version_dM7lhqeExwUg2A43RJZMg4qa"
default_dataset_version_id = "dataset_version_fGiFhCan7ws5Ji5CCiKU4L0O"
...
class ZettablockDataset:
    ...
    def to_json(self):
        return {
            "version_id": default_dataset_version_id,
...
class ZettablockModel:
    ...
    def to_json(self):
        return {"version_id": default_model_version_id}
...
def send_finetune_request(
    ...
    private_key = zetta_secret.get('default', 'wallet_private_key', fallback=None)
...
def process_base_datasets(base_datasets: list[dict]):
    return [ZettablockDataset(i) for i in base_datasets if i["source"] == "zettahub"]
