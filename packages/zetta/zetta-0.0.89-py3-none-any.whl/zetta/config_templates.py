...
base_model:
  # The name for the base model. Please specify a repository name on ZettaHub or HuggingFace
  name: chengcheng.pei/llava-1.5-7b-hf
  # Where the model is sourced from. Choose one from zettahub or huggingface
  source: zettahub
