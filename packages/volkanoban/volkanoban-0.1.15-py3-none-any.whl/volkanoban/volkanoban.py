...
def run_explainer_dashboard(model, X_test, y_test):
    """
    Set up and run the ExplainerDashboard for the given model and data.
    ...
    db = ExplainerDashboard(explainer, 
                            title="Breast Cancer Classifier Explainer",  # Dashboard title
                            shap_interaction=False)  # Disable SHAP interaction if not needed
    db.run(port=8050)  # Run the dashboard on port 8050
