...
class WebSapCommonFunctions:
    ...
    def initial_browser(self, has_save_folder: bool = False, save_folder_path: str = '', has_proxy: bool = True, proxy_area: str = 'hk',
                        ...
                        service_log_path='geckodriver.log', geckodriver_binary_location: str = 'geckodriver'):
        ...
        if has_proxy or has_save_folder:
            ...
            try:
                self.browser = webdriver.Firefox(options=opts, service_log_path=service_log_path, executable_path=geckodriver_binary_location)
            except:
                self.browser = webdriver.Firefox(options=opts, executable_path=geckodriver_binary_location)
        else:
            try:
                self.browser = webdriver.Firefox(options=opts, service_log_path=service_log_path, executable_path=geckodriver_binary_location)
            except:
    ...
    def input_download_excel_file_name(self, file_name: str):
        ...
        while True:
            try:
                ...
                # self.press_keyboard_shortcut([Keys.BACKSPACE])
                self.press_keyboard_shortcut([Keys.CONTROL, 'a', Keys.BACKSPACE])
    ...
    def input_multiple_selection_with_index(self,
        ...
        Args:
            ...
            name_format(str): This indicates whether user date or datetime to name screenshot
        """
        self.wait_element_presence_by_css_selector("div[title='Multiple selection']")
    ...
    def copy_paste_values(self, value_list: list, input_css_selector: str, wait_alert: bool = True, is_enter: bool = True):
        ...
        if wait_alert:
            ...
            sleep(1)
        action_chains.key_down(Keys.CONTROL, input_element).send_keys('v').key_up(
