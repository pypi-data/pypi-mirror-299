...
class DynamoFL:
    ...
    def create_guardrail_evaluation_test(  # pylint: disable=dangerous-default-value
        ...
        human_label_column: Optional[str] = "isCompliant_human_labels",
        topic_name_column: Optional[str] = "topic_name",
        topic_description_column: Optional[str] = "topic_description",
        trickiness_column: Optional[str] = "trickiness",
        gpu: Optional[GPUSpecification] = None,
        grid: List[Dict[str, List[Union[str, float, int]]]] = [{}],
        **kwargs
    ) -> TestEntity:
        ...
        Args:
            ...
            model_key (str): Key of the model to be tested
            dataset_id (str): Id of the dataset to be used
            prompt_column (Optional[str]): Column containing the
                prompts. Defaults to "prompt".
            human_label_column (Optional[str]): Column containing the
                human-predicted labels. Defaults to "isCompliant_human_label".
            topic_name_column (Optional[str]): Column containing the topic names.
                Defaults to "topic_name".
            topic_description_column (Optional[str]): Column containing the topic descriptions.
                Defaults to "topic_description".
            trickiness_column (Optional[str]): Column containing the
                trickiness scores. Defaults to "trickiness".
        ...
        common_attack_config = {
            "attack": Helpers.construct_dict_filtering_none_values(
                ...
                topic_name_column=topic_name_column,
                topic_description_column=topic_description_column,
                trickiness_column=trickiness_column,
                fast_mode=fast_mode,
            ),
        }
