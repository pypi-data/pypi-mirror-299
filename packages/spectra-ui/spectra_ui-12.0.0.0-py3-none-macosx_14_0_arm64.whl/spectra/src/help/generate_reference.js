...
function GetPlotlyDialog()
{
    ...
    let dlgconts = [
        [{rows: 3, label:PlotOptionsLabel.normalize[0]}, {rows: 3, label: "Select how to normalize the animation plot"}, BySpecifiedLabel+": y-/z-axis scale is defined by the former operation (probably by dragging a specific area)"],
        [null, null, ForEachLabel+": y-/z-axis scale is normalized by the maximum value for each slide"],
