...
public:
	...
	void GetSrcPoints(double srcpoints[]);
	void SetSrcPoints(double xy[]);
	...
	void SetTargetEnergy(int ne){m_netarget = ne;}
	void UpdateParticle(FluxDensity *fluxdens);
...
private:
	...
	double m_eptarget; // target photon energy
