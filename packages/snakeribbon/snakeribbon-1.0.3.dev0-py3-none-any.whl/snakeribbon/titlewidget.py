...
class RibbonTitleWidget(QtWidgets.QFrame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._application_button.set_icon(DataFile(RibbonIcon.Application))
        ...
        self._collapsable_ribbon_button.set_icon(DataFile(RibbonIcon.Up))
        ...
        self._help_button.set_icon(DataFile(RibbonIcon.Help))
