...
from ..models.thread_form_variants import ThreadFormVariants
...
class ThreadForm:
    ...
    Attributes:
        ...
        variants (Union[Unset, ThreadFormVariants]):  Default: ThreadFormVariants.DEFAULT.
    """
    ...
    variants: Union[Unset, ThreadFormVariants] = ThreadFormVariants.DEFAULT
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        variants: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        variants: Union[Unset, ThreadFormVariants]
        if isinstance(_variants, Unset):
            variants = UNSET
        else:
            variants = ThreadFormVariants(_variants)
