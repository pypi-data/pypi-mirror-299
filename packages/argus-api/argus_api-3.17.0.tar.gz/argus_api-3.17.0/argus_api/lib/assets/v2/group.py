...
def add_asset_group(
    ...
    filterIdOrShortName: str = None,
    dynamicGroupSchedule: str = None,
    ...
    :param str filterIdOrShortName: Dynamic group filter ID or short name\, if the group is dynamic this value is Required.
    :param str dynamicGroupSchedule: Dynamic group schedule for refresh of members\, counts and flags.
...
may not be immediately available. Depending on the group size some wait time will be necessary. \(default false\)
    ...
    # Only send filterIdOrShortName if the argument was provided, don't send null values
    if filterIdOrShortName is not None:
        body.update({"filterIdOrShortName": filterIdOrShortName})
    # Only send dynamicGroupSchedule if the argument was provided, don't send null values
    if dynamicGroupSchedule is not None:
        body.update({"dynamicGroupSchedule": dynamicGroupSchedule})
...
def convert_group_to_dynamic(
    ...
    :param str idOrShortName: AssetGroup ID or short name
    :param str customer: Customer ID or short name \(default is user\'s customer\)\, only used when group short name was provided
    :param str filterIdOrShortName: Dynamic group filter ID or short name.
    :param str dynamicGroupSchedule: Dynamic group schedule for refresh of members\, counts and flags.
    :param bool populateDynamicGroup: The group can be populated right away or it can wait for first refresh that is scheduled.
