...
def add_job_task(
    ...
    :param str worker: The name of the analyser \=\> \[a\-zA\-Z0\-9\_\:\\\-\\.\]\*
    ...
    body = body or {}
    # Only send worker if the argument was provided, don't send null values
    if worker is not None:
        body.update({"worker": worker})
...
def update_job_task(
    ...
    :param str analysisID: The ID of the analysis produced by this task. Deprecated\, use analyses instead
