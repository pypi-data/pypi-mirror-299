...
class CommandHeaderBuilder:
    def __init__(self) -> None:
        ...
    def add_inertial(self, arg0: str, arg1: numpy.ndarray[tuple[typing.Literal[6], typing.Literal[6]], numpy.dtype[numpy.float64]]) -> CommandHeaderBuilder:
        ...
    def set_control_hold_time(self, arg0: float) -> CommandHeaderBuilder:
        ...
    def set_gravity(self, arg0: numpy.ndarray[tuple[typing.Literal[3], typing.Literal[1]], numpy.dtype[numpy.float64]]) -> CommandHeaderBuilder:
        ...
...
class Robot_A:
    ...
    def start_log_stream(self, cb: typing.Callable[[list[Log]], None], rate: float) -> None:
        ...
    def start_state_update(self, cb: typing.Callable[[RobotState_A], None], rate: float) -> None:
        ...
