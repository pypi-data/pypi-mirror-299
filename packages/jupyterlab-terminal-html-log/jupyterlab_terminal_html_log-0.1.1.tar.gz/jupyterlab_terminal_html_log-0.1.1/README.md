...
```bash
pip install jupyterlab_terminal_html_log
```
...
```bash
pip uninstall jupyterlab_terminal_html_log
```
...
# Change directory to the jupyterlab_terminal_html_log directory
...
folder is located. Then you can remove the symlink named `jupyterlab_terminal_html_log` within that folder.
