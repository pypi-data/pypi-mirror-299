...
function Y(i) {
  ...
  return {
    c() {
      e = w("button"), s && s.c(), l = H(), a && a.c(), n = H(), c && c.c(), u(e, "class", t = "button-wrapper " + /*size*/
      i[4] + " " + /*variant*/
      i[3] + " " + /*elem_classes*/
      i[1].join(" ") + " svelte-eic142"), u(
        e,
        "id",
        /*elem_id*/
        i[0]
      ), e.disabled = /*disabled*/
      i[8], V(e, "hidden", !/*visible*/
      i[2]), h(
        e,
        "flex-grow",
        /*scale*/
    ...
    m(m, b) {
      k(m, e, b), s && s.m(e, null), v(e, l), a && a.m(e, null), v(e, n), c && c.m(e, null), f = !0, _ || (C = W(
        e,
        "click",
        /*click_handler*/
        i[14]
    ...
    p(m, b) {
      ...
      m[4] + " " + /*variant*/
      m[3] + " " + /*elem_classes*/
      m[1].join(" ") + " svelte-eic142")) && u(e, "class", t), (!f || b & /*elem_id*/
      1) && u(
        e,
        "id",
        /*elem_id*/
    ...
    d(m) {
      m && g(e), s && s.d(), a && a.d(m), c && c.d(), _ = !1, C();
    }
  };
}
function y(i) {
  ...
  return {
    c() {
      e = w("a"), _ && _.c(), l = H(), s && s.c(), n = H(), o && o.c(), u(
        e,
        "href",
        /*link*/
        i[6]
    ...
    m(a, c) {
      k(a, e, c), _ && _.m(e, null), v(e, l), s && s.m(e, null), v(e, n), o && o.m(e, null), f = !0;
    },
    p(a, c) {
      /*icon*/
      a[7] ? _ ? _.p(a, c) : (_ = N(a), _.c(), _.m(e, l)) : _ && (_.d(1), _ = null), s && s.p && (!f || c & /*$$scope*/
      4096) && K(
        s,
        C,
        a,
      ...
      a[11] ? o ? o.p(a, c) : (o = A(a), o.c(), o.m(e, null)) : o && (o.d(1), o = null), (!f || c & /*link*/
      64) && u(
        e,
        "href",
        /*link*/
      ...
      a[4] + " " + /*variant*/
      a[3] + " " + /*elem_classes*/
      a[1].join(" ") + " svelte-eic142")) && u(e, "class", t), (!f || c & /*elem_id*/
      1) && u(
        e,
        "id",
        /*elem_id*/
...
function L(i) {
  ...
  return {
    c() {
      e = w("img"), u(e, "class", "button-icon svelte-eic142"), M(e.src, l = /*icon*/
...
function p(i) {
  ...
  return e = C(i), l = _[e] = f[e](i), {
    c() {
      l.c(), n = R();
    },
    m(s, o) {
      _[e].m(s, o), k(s, n, o), t = !0;
    },
    p(s, [o]) {
      let a = e;
      e = C(s), e === a ? _[e].p(s, o) : (T(), S(_[a], 1, 1, () => {
        _[a] = null;
      }), Q(), l = _[e], l ? l.p(s, o) : (l = _[e] = f[e](s), l.c()), Z(l, 1), l.m(n.parentNode, n));
    },
    i(s) {
      t || (Z(l), t = !0);
    },
...
function x(i, e, l) {
  let { $$slots: n = {}, $$scope: t } = e, { elem_id: f = "" } = e, { elem_classes: _ = [] } = e, { visible: C = !0 } = e, { variant: s = "secondary" } = e, { size: o = "lg" } = e, { value: a = null } = e, { link: c = null } = e, { icon: m = null } = e, { disabled: b = !1 } = e, { scale: B = null } = e, { min_width: z = void 0 } = e, { tooltip: j = "" } = e;
  function r(d) {
    P.call(this, i, d);
  }
  return i.$$set = (d) => {
    "elem_id" in d && l(0, f = d.elem_id), "elem_classes" in d && l(1, _ = d.elem_classes), "visible" in d && l(2, C = d.visible), "variant" in d && l(3, s = d.variant), "size" in d && l(4, o = d.size), "value" in d && l(5, a = d.value), "link" in d && l(6, c = d.link), "icon" in d && l(7, m = d.icon), "disabled" in d && l(8, b = d.disabled), "scale" in d && l(9, B = d.scale), "min_width" in d && l(10, z = d.min_width), "tooltip" in d && l(11, j = d.tooltip), "$$scope" in d && l(12, t = d.$$scope);
  }, [
    f,
    _,
    C,
...
function de(i, e, l) {
  let { elem_id: n = "" } = e, { elem_classes: t = [] } = e, { visible: f = !0 } = e, { value: _ } = e, { variant: C = "secondary" } = e, { interactive: s } = e, { size: o = "lg" } = e, { scale: a = null } = e, { icon: c = null } = e, { link: m = null } = e, { min_width: b = void 0 } = e, { tooltip: B = "" } = e, { gradio: z } = e;
  const j = () => z.dispatch("click");
  return i.$$set = (r) => {
    "elem_id" in r && l(0, n = r.elem_id), "elem_classes" in r && l(1, t = r.elem_classes), "visible" in r && l(2, f = r.visible), "value" in r && l(3, _ = r.value), "variant" in r && l(4, C = r.variant), "interactive" in r && l(5, s = r.interactive), "size" in r && l(6, o = r.size), "scale" in r && l(7, a = r.scale), "icon" in r && l(8, c = r.icon), "link" in r && l(9, m = r.link), "min_width" in r && l(10, b = r.min_width), "tooltip" in r && l(11, B = r.tooltip), "gradio" in r && l(12, z = r.gradio);
  }, [
    n,
    t,
    f,
