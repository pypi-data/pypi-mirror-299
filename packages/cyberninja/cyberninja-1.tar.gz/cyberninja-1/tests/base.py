...
class cyberninjaBaseTest(unittest.TestCase):
    def setUp(self):
        """Cyber Ninja Base Test Setup.

        Does common setup tasks for base Cyber Ninja tests.
        ...
        excluded_sites_path = os.path.join(os.path.dirname(os.path.realpath(cyberninja.__file__)), "tests/.excluded_sites")
        try:
    ...
    def username_check(self, username_list, site_list, exist_check=True):
        ...
        for username in username_list:
            results = cyberninja.cyberninja(username,
                                           site_data,
                                           self.query_notify,
                                           tor=self.tor,
