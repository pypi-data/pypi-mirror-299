...
{
    Tango::Except::throw_exception("PyDs_WrongPythonDataTypeForDoubleStringArray",
                                   "Converter from python object to DevVarDoubleStringArray needs a python "
                                   "sequence<sequence<double>, sequence<str>>",
                                   "convert2array()");
}
...
void from_py_object(bopy::object &py_obj, Tango::MultiAttrProp<T> &multi_attr_prop)
{
    ...
    {
        multi_attr_prop.delta_t =
            bopy::extract<Tango::DevLong>(py_obj.attr("delta_t")); // Property type is Tango::DevLong!
    }
    ...
    {
        multi_attr_prop.event_period =
            bopy::extract<Tango::DevLong>(py_obj.attr("event_period")); // Property type is Tango::DevLong!
    }
    ...
    {
        multi_attr_prop.archive_period =
            bopy::extract<Tango::DevLong>(py_obj.attr("archive_period")); // Property type is Tango::DevLong!
    }
    ...
    else
    {
        ...
        {
            multi_attr_prop.rel_change =
                bopy::extract<Tango::DevDouble>(py_obj.attr("rel_change")); // Property type is Tango::DevDouble!
        }
    }
    ...
    else
    {
        ...
        {
            multi_attr_prop.abs_change =
                bopy::extract<Tango::DevDouble>(py_obj.attr("abs_change")); // Property type is Tango::DevDouble!
        }
    }
    ...
    else
    {
        ...
        {
            multi_attr_prop.archive_rel_change = bopy::extract<Tango::DevDouble>(
                py_obj.attr("archive_rel_change")); // Property type is Tango::DevDouble!
        }
    }
    ...
    else
    {
        ...
        {
            multi_attr_prop.archive_abs_change = bopy::extract<Tango::DevDouble>(
                py_obj.attr("archive_abs_change")); // Property type is Tango::DevDouble!
        }
    }
}
