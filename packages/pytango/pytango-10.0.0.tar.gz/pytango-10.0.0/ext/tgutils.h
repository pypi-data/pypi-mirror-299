...
#define TANGO_CALL_ON_ATTRIBUTE_DATA_TYPE_NAME(tid, fn, ...) \
  ...
  #define TANGO_DO_ON_DEVICE_DATA_TYPE_ID(tid, DOIT_SIMPLE, DOIT_ARRAY)                 \
      if(true)                                                                          \
      {                                                                                 \
          switch(tid)                                                                   \
          {                                                                             \
...
{
template <>
Tango::ApiUtil const volatile *get_pointer<class Tango::ApiUtil const volatile>(class Tango::ApiUtil const volatile *c)
{
    return c;
}

template <>
Tango::Pipe const volatile *get_pointer<class Tango::Pipe const volatile>(class Tango::Pipe const volatile *c)
{
    return c;
}

template <>
Tango::WPipe const volatile *get_pointer<class Tango::WPipe const volatile>(class Tango::WPipe const volatile *c)
{
    return c;
}

template <>
Tango::WAttribute const volatile *
    get_pointer<class Tango::WAttribute const volatile>(class Tango::WAttribute const volatile *c)
{
    return c;
}
} // namespace boost
