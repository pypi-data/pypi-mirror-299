...
void add_obj_polling(Tango::DServer &self, bopy::object &py_long_str_array, bool with_db_upd = true, int delta_ms = 0)
{
...
void upd_obj_polling_period(Tango::DServer &self, bopy::object &py_long_str_array, bool with_db_upd = true)
{
    Tango::DevVarLongStringArray long_str_array;
    convert2array(py_long_str_array, long_str_array);
...
void rem_obj_polling(Tango::DServer &self, bopy::object &py_str_array, bool with_db_upd = true)
{
...
void lock_device(Tango::DServer &self, bopy::object &py_long_str_array)
{
    Tango::DevVarLongStringArray long_str_array;
    convert2array(py_long_str_array, long_str_array);
...
Tango::DevLong un_lock_device(Tango::DServer &self, bopy::object &py_long_str_array)
{
    Tango::DevVarLongStringArray long_str_array;
    convert2array(py_long_str_array, long_str_array);
...
void re_lock_devices(Tango::DServer &self, bopy::object &py_str_array)
{
    Tango::DevVarStringArray str_array;
    convert2array(py_str_array, str_array);
...
PyObject *dev_lock_status(Tango::DServer &self, Tango::ConstDevString dev_name)
{
    ...
    PyObject *py_ret = CORBA_sequence_to_list<Tango::DevVarLongStringArray>::convert(*ret);
    delete ret;
    return py_ret;
}
} // namespace PyDServer
...
void export_dserver()
{
    bopy::class_<Tango::DServer, bopy::bases<Tango::Device_5Impl>, boost::noncopyable>("DServer", bopy::no_init)
        ...
        .def("restart", (void(Tango::DServer::*)(const std::string &)) & Tango::DServer::restart)
        ...
        .def("add_obj_polling", &PyDServer::add_obj_polling, add_obj_polling_overload())
        .def("upd_obj_polling_period", &PyDServer::upd_obj_polling_period, upd_obj_polling_period_overload())
        .def("rem_obj_polling", &PyDServer::rem_obj_polling, rem_obj_polling_overload())
        .def("stop_polling", &Tango::DServer::stop_polling)
        .def("start_polling", (void(Tango::DServer::*)()) & Tango::DServer::start_polling)
        ...
        .def("get_process_name",
             &Tango::DServer::get_process_name,
             bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("get_personal_name",
             &Tango::DServer::get_personal_name,
             bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("get_instance_name",
             &Tango::DServer::get_instance_name,
             bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("get_full_name",
             &Tango::DServer::get_full_name,
             bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("get_fqdn", &Tango::DServer::get_fqdn, bopy::return_value_policy<bopy::copy_non_const_reference>())
