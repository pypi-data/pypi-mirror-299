...
void _Pipe::read(Tango::DeviceImpl *dev, Tango::Pipe &pipe)
{
    if(!_is_method(dev, read_name))
    {
        ...
        o << read_name << " method "
          << " not found for " << pipe.get_name();
        Tango::Except::throw_exception("PyTango_ReadPipeMethodNotFound", o.str(), "PyTango::Pipe::read");
    }
...
void _Pipe::write(Tango::DeviceImpl *dev, Tango::WPipe &pipe)
{
    if(!_is_method(dev, write_name))
    {
        ...
        Tango::Except::throw_exception("PyTango_WritePipeMethodNotFound", o.str(), "PyTango::Pipe::write");
    }
    PyDeviceImplBase *__dev_ptr = dynamic_cast<PyDeviceImplBase *>(dev);
    AutoPythonGIL __py_lock;
    try
...
void append_scalar(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    __append_scalar<Tango::Pipe, tangoTypeConst>(pipe, name, py_value);
}

template <>
void append_scalar<Tango::DEV_VOID>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_scalar");
}

template <>
void append_scalar<Tango::DEV_PIPE_BLOB>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_scalar");
}

template <>
void append_scalar<Tango::DEV_ENCODED>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
...
void append_array(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    __append_array<Tango::Pipe, tangoArrayTypeConst>(pipe, name, py_value);
}

template <>
void append_array<Tango::DEV_VOID>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_array");
}

template <>
void append_array<Tango::DEV_PIPE_BLOB>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_array");
}

template <>
void append_array<Tango::DEVVAR_LONGSTRINGARRAY>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_array");
}

template <>
void append_array<Tango::DEVVAR_DOUBLESTRINGARRAY>(Tango::Pipe &pipe, const std::string &name, bopy::object &py_value)
{
    throw_wrong_python_data_type(pipe.get_name(), "append_array");
}
...
void export_pipe()
{
    bopy::class_<Tango::Pipe, boost::noncopyable>(
        "Pipe", bopy::init<const std::string &, const Tango::DispLevel, bopy::optional<Tango::PipeWriteType>>())

        .def("get_name", &Tango::Pipe::get_name, bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("set_name", &Tango::Pipe::set_name)
        .def("set_default_properties", &Tango::Pipe::set_default_properties)
        .def("get_root_blob_name",
        ...
        .def("get_desc", &Tango::Pipe::get_desc, bopy::return_value_policy<bopy::copy_non_const_reference>())
        .def("get_label", &Tango::Pipe::get_label, bopy::return_value_policy<bopy::copy_non_const_reference>())
        ...
        .def("_set_value", (void (*)(Tango::Pipe &, bopy::object &)) & PyTango::Pipe::set_value)

        .def("get_value", (bopy::object(*)(Tango::WPipe &)) & PyTango::Pipe::get_value);

    bopy::class_<Tango::WPipe, bopy::bases<Tango::Pipe>, boost::noncopyable>(
        "WPipe", bopy::init<const std::string &, const Tango::DispLevel>());
}
...
void __set_value(Tango::DevicePipeBlob &dpb, bopy::dict &dict)
{
    ...
    for(int i = 0; i < nitems; ++i)
    {
        ...
        bopy::dict pdict;
        if(__convert(item, ptuple) && __convert(ptuple[0], blob_name) && __convert(ptuple[1], pdict))
        {
