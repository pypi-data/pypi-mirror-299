...
.. _green_modes_no_sync_warning:
.. warning::  These green modes disable Tango's `device server serialisation <https://tango-controls.readthedocs.io/en/latest/development/advanced/threading.html#serialization-model-within-a-device-server>`_,
