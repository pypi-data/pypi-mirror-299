...
from src.GONGHAlphaAnomalyzer._cell_average_calculator import _calculate_cell_average
from src.GONGHAlphaAnomalyzer._anova_analysis import _anova_ftest
from src.GONGHAlphaAnomalyzer._cell_range_calculator import _calculate_cell_wise_ranges
...
class Anomalyzer:
    ...
    def compute_best_ranges(self,
        ...
        - The images should be H-alpha GONG solar observations in JPG, JPEG, 
        or PNG format.
    ...
    def plot_image_likelihoods(self, image_path: str = None, 
        ...
        - The image should be H-alpha GONG solar observation in JPG, JPEG, 
        or PNG format.
        """
