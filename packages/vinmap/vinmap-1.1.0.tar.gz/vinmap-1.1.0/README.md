...
![ViNmap Logo](https://raw.githubusercontent.com/VinnyVanGogh/ViNmap_custom_nmap_scanner/refs/heads/main/images/logo.webp)
...
![Basic Scan Output](https://github.com/VinnyVanGogh/ViNmap_custom_nmap_scanner/blob/main/images/basic_output_example.png?raw=true)

- **Aggressive Scan ran with --format html:**
![HTML Output](https://github.com/VinnyVanGogh/ViNmap_custom_nmap_scanner/blob/main/images/html_output_example.png?raw=true)

- **Basic Scan ran with --format json:**
![JSON Output](https://github.com/VinnyVanGogh/ViNmap_custom_nmap_scanner/blob/main/images/json_output_example.png?raw=true)

- **OS Detection Scan ran with default options:**
![OS Detection Output](https://github.com/VinnyVanGogh/ViNmap_custom_nmap_scanner/blob/main/images/os_output_example.png?raw=true)
