...
class Log:
    def __init__(self, webhook: dict = {"id": int, "token": str}, default_user: str = "Sem responsável definido", bot_name: str = "Robô sem nome definido", send_notification: bool = True) -> None:
        """
