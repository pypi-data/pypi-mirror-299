...
@pytest.fixture
def polcal_qaulity_beam_labels() -> list[str]:
    return ["Beam 1", "Beam 2"]


@pytest.fixture
def polcal_quality_skip_constants(polcal_qaulity_beam_labels) -> list[bool]:
    return ["1" not in label for label in polcal_qaulity_beam_labels]
