...
class LearnBlock(BaseModel):
    ...
    __properties = ["type", "title", "author", "description", "name", "recommended", "organizationModelId", "publicProjectTierAvailability", "isPublicEnterpriseOnly", "blockType", "displayCategory"]
