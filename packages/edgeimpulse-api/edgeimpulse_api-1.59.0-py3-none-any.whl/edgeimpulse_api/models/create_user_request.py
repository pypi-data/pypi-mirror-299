...
class CreateUserRequest(BaseModel):
    ...
    __properties = ["name", "username", "email", "password", "projectName", "privacyPolicy", "activationToken", "identityProvider", "jobTitle", "sessionId", "companyName", "utmParams", "ignoreEmailValidation"]
