...
class CalculateDataQualityMetricsRequest(BaseModel):
    representation: Optional[StrictStr] = Field(None, description="Type of representation to use for calculating metrics.")
    __properties = ["representation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CalculateDataQualityMetricsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CalculateDataQualityMetricsRequest:
        """Create an instance of CalculateDataQualityMetricsRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CalculateDataQualityMetricsRequest.construct(**obj)

        _obj = CalculateDataQualityMetricsRequest.construct(**{
