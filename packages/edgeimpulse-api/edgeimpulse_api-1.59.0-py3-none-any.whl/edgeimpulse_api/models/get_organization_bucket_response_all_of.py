...
class GetOrganizationBucketResponseAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOrganizationBucketResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrganizationBucketResponseAllOf:
        """Create an instance of GetOrganizationBucketResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetOrganizationBucketResponseAllOf.construct(**obj)

        _obj = GetOrganizationBucketResponseAllOf.construct(**{
