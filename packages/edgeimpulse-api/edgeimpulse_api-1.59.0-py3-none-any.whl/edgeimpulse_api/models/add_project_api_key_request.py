...
class AddProjectApiKeyRequest(BaseModel):
    ...
    role: StrictStr = ...
    __properties = ["name", "apiKey", "isDevelopmentKey", "role"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AddProjectApiKeyRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AddProjectApiKeyRequest:
        """Create an instance of AddProjectApiKeyRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AddProjectApiKeyRequest.construct(**obj)

        _obj = AddProjectApiKeyRequest.construct(**{
            "name": obj.get("name"),
