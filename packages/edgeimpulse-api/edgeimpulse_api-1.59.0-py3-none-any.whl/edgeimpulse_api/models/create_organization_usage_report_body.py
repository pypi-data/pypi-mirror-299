...
class CreateOrganizationUsageReportBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateOrganizationUsageReportBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateOrganizationUsageReportBody:
        """Create an instance of CreateOrganizationUsageReportBody from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateOrganizationUsageReportBody.construct(**obj)

        _obj = CreateOrganizationUsageReportBody.construct(**{
