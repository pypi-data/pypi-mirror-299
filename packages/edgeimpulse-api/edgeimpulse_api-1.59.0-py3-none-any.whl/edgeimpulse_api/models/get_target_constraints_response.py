...
class GetTargetConstraintsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetTargetConstraintsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetTargetConstraintsResponse:
        """Create an instance of GetTargetConstraintsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetTargetConstraintsResponse.construct(**obj)

        _obj = GetTargetConstraintsResponse.construct(**{
