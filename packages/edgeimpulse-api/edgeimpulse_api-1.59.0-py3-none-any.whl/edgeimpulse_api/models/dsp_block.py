...
class DSPBlock(BaseModel):
    ...
    __properties = ["type", "title", "author", "description", "name", "recommended", "experimental", "latestImplementationVersion", "organizationId", "organizationDspId", "blockType", "namedAxes"]
