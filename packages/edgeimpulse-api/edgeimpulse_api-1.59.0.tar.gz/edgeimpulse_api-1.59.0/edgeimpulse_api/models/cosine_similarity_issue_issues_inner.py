...
class CosineSimilarityIssueIssuesInner(BaseModel):
    ...
    windows: List[CosineSimilarityIssueIssuesInnerWindowsInner] = Field(..., description="The windows in this sample that are symptomatic of this issue.")
    __properties = ["id", "sample", "label", "windows"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CosineSimilarityIssueIssuesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CosineSimilarityIssueIssuesInner:
        """Create an instance of CosineSimilarityIssueIssuesInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CosineSimilarityIssueIssuesInner.construct(**obj)

        _obj = CosineSimilarityIssueIssuesInner.construct(**{
            "id": obj.get("id"),
            "sample": Sample.from_dict(obj.get("sample")) if obj.get("sample") is not None else None,
            "label": obj.get("label"),
            "windows": [CosineSimilarityIssueIssuesInnerWindowsInner.from_dict(_item) for _item in obj.get("windows")] if obj.get("windows") is not None else None
        })
        return _obj
