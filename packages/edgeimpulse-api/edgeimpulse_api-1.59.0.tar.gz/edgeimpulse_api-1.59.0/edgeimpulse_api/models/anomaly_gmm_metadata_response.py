...
class AnomalyGmmMetadataResponse(BaseModel):
    ...
    __properties = ["success", "error", "means", "covariances", "weights"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnomalyGmmMetadataResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnomalyGmmMetadataResponse:
        """Create an instance of AnomalyGmmMetadataResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AnomalyGmmMetadataResponse.construct(**obj)

        _obj = AnomalyGmmMetadataResponse.construct(**{
