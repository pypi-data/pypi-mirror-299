...
class GetUserResponseAllOf(BaseModel):
    ...
    __properties = ["email", "activated", "organizations", "projects", "experiments", "evaluation", "ambassador", "whitelabels", "suspended", "notifications", "subscriptionDowngradeDate", "subscriptionTerminationDate", "passwordConfigured", "projectsSortOrder", "activeEnterpriseTrial", "hasEnterpriseFeaturesAccess", "timezone"]
