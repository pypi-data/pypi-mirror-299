...
class ClassifySampleResponseVariantResults(BaseModel):
    variant: KerasModelVariantEnum = ...
    classifications: List[ClassifySampleResponseClassification] = ...
    __properties = ["variant", "classifications"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClassifySampleResponseVariantResults:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClassifySampleResponseVariantResults:
        """Create an instance of ClassifySampleResponseVariantResults from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ClassifySampleResponseVariantResults.construct(**obj)

        _obj = ClassifySampleResponseVariantResults.construct(**{
