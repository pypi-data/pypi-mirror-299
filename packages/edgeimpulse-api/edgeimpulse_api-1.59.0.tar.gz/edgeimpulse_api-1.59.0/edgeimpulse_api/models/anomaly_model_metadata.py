...
class AnomalyModelMetadata(BaseModel):
    ...
    __properties = ["created", "scale", "mean", "clusters", "axes", "defaultMinimumConfidenceRating", "availableModelTypes", "recommendedModelType", "modelValidationMetrics", "hasTrainedModel"]
