...
from utilities.forms.fields import CommentField, DynamicModelChoiceField, DynamicModelMultipleChoiceField, CSVModelMultipleChoiceField, CSVChoiceField, CSVModelChoiceField, TagFilterField
...
class LoginCredentialsForm(NetBoxModelForm):
    ...
    fieldsets = (
        (None, ('logon_name', 'contact',
         'system', 'login_credentials_status', 'tags')),
...
class LoginCredentialsBulkEditForm(NetBoxModelBulkEditForm):
    ...
    fieldsets = (
        (None, ('logon_name', 'contact', 'system',
         'ssh_keys', 'login_credentials_status')),
        ('Validity', ('valid_from', 'valid_to')),
    )
...
class LoginCredentialsFilterForm(ContactModelFilterForm,NetBoxModelFilterSetForm):
    ...
    fieldsets = (
        (None, ('q', 'index', 'tag')),
        ('Login Credentials', ('contact', 'system', 'login_credentials_status')),
    )
...
class LoginCredentialsCSVForm(NetBoxModelImportForm):
    ...
    class Meta:
        model = LoginCredentials
        fields = ['system', 'contact', 'ssh_keys',
                  'login_credentials_status', 'logon_name']
...
class LoginCredentialWithSelectedSshKeyForm(forms.Form):
    ...
    fieldsets = (
        (None, ('logon_name', 'contact', 'ssh_keys',
         'system', 'login_credentials_status', 'tags')),
        ('Validity', ('valid_from', 'valid_to')),
    )
    ...
    class Meta:
        fields = [
            'sshkeys', 'logon_name', 'system', 'contact', 'login_credentials_status', 'valid_from', 'valid_to', 'tags'
        ]
        help_texts = {
            'logon_name': "Logon name",
        }
