...
class LoginCredentialsSerializer(NetBoxModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'tags', 'custom_fields', 'display', 'url', 'system', 'ssh_keys', 'contact', 'created', 'last_updated',
                  'custom_field_data', 'logon_name', 'valid_from', 'valid_to', 'login_credentials_status', 'comments')
        brief_fields = ('id', 'tags', 'custom_fields', 'display', 'url', 'system', 'ssh_keys', 'contact', 'created', 'last_updated',
                        'custom_field_data', 'logon_name', 'valid_from', 'valid_to', 'login_credentials_status', 'comments')
