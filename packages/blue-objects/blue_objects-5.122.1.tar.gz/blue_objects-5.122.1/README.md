...
built by 🌀 [`blue_options-4.85.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on 🌀 [`blue_objects-5.122.1`](https://github.com/kamangir/blue-objects).
