...
built by 🌀 [`blue_options-4.83.1-abcli-current`](https://github.com/kamangir/awesome-bash-cli), based on 🌀 [`blue_objects-5.116.1`](https://github.com/kamangir/blue-objects).
