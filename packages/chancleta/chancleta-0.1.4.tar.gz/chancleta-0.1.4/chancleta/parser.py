...
class Chancleta:
    ...
    EMPTY_CONFIG_ERROR = "Empty configuration file"
    MISSING_CONFIG_ERROR = "Missing configuration file"
    ...
    def _handle_config(self):
        for config in self.CONFIG_FILES:
            ...
            if not os.path.getsize(config_path):
                raise ValueError(self.EMPTY_CONFIG_ERROR)
            return self._read_file(config_path)
        raise ValueError(self.MISSING_CONFIG_ERROR)
