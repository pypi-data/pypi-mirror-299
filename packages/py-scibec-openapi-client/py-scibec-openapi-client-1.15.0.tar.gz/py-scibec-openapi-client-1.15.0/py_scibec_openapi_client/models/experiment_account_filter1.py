...
class ExperimentAccountFilter1(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "where": obj.get("where"),
            "fields": ExperimentAccountFields.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
            "include": [ExperimentAccountIncludeFilterInner.from_dict(_item) for _item in obj["include"]] if obj.get("include") is not None else None
        })
        return _obj
