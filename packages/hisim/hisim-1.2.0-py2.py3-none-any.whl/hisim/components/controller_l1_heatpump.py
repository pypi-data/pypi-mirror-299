...
class L1HeatPumpController(cp.Component):
    ...
    def get_default_connections_from_energy_management_system(self):
        ...
        connections.append(
            cp.ComponentConnection(
                L1HeatPumpController.StorageTemperatureModifier,
                boiler_classname,
    ...
    @staticmethod
    def get_cost_capex(config: L1HeatPumpConfig, simulation_parameters: SimulationParameters) -> cp.CapexCostDataClass:  # pylint: disable=unused-argument
