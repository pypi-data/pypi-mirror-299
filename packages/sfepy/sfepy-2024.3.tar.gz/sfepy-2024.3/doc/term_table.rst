...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio <multi_physics-biot>`
   * - ev_biot_stress
   ...
   * - dw_dg_diffusion_flux
     ...
     - :ref:`bur.2D <dg-burgers_2D>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`lap.2D <dg-laplace_2D>`
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`bio <multi_physics-biot>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`
   * - dw_dot
     ...
     - :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`bor <quantum-boron>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`bal <large_deformation-balloon>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`wel <quantum-well>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`hyd <quantum-hydrogen>`, :ref:`aco <acoustics-acoustics>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`adv.2D <dg-advection_2D>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`aco <acoustics-acoustics>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`
   * - ev_integrate
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`bor <quantum-boron>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`sin <diffusion-sinbc>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`poi <diffusion-poisson>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`wel <quantum-well>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`hyd <quantum-hydrogen>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`aco <acoustics-acoustics>`, :ref:`cub <diffusion-cube>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`mul.poi.con <linear_elasticity-multi_point_constraints>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`mul.nod.lcb <linear_elasticity-multi_node_lcbcs>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`bio <multi_physics-biot>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`
   * - dw_lin_elastic_iso
   ...
   * - dw_lin_prestress
     ...
     - :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`non.hyp.mM <homogenization-nonlinear_hyperelastic_mM>`
   * - dw_lin_spring
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`tru.bri <linear_elasticity-truss_bridge>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`its.4 <linear_elasticity-its2D_4>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`
   * - ev_surface_moment
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`
   * - dw_volume_nvf
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_mooney_rivlin
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`bal <large_deformation-balloon>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`bal <large_deformation-balloon>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`hyp <large_deformation-hyperelastic>`, :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`act.fib <large_deformation-active_fibres>`
   * - dw_tl_he_neohook_ad
