...
def combine_pod_schemas(pod_names: Sequence[str], **kwargs: Any) -> BitfountSchema:
    ...
    Args:
        ...
        **kwargs: Additional arguments to pass to `get_pod_schema`.
    ...
    for pod_name in pod_names:
        pod_schema: BitfountSchema = get_pod_schema(pod_name, **kwargs)
