...
class PyTorchBitfountModel(
    ...
    def train_dataloader(self) -> _BasePyTorchBitfountDataLoader:  # type: ignore[override] # Reason: see below # noqa: E501
    ...
    def val_dataloader(self) -> _BasePyTorchBitfountDataLoader:  # type: ignore[override] # Reason: see below # noqa: E501
        """Returns validation dataloader."""
        # We override the dataloader return annotation as the LightningModule
        # expects a pytorch DataLoader, and we return out PyTorchBitfountDataLoader
        return cast(_BasePyTorchBitfountDataLoader, self.validation_dl)

    def test_dataloader(self) -> _BasePyTorchBitfountDataLoader:  # type: ignore[override] # Reason: see below # noqa: E501
    ...
    def test_epoch_end(
        self,
        outputs: list[dict[str, Union[torch.Tensor, list[str]]]],  # type: ignore[override] # Reason: see below # noqa: E501
    ) -> None:
