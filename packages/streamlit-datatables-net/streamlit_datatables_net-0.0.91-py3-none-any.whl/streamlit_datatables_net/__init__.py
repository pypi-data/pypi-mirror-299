    ...
    with content_column:
        with st.container(border=True):
            ...
            options["columns"] = [
                ...
                {"data": "category", "title": "category", "render": render_label},
                {"data": None, "defaultContent": "", "title": "Learn More", "name": "learn_more",
                    "render": render_learn_more_link},
            ...
            dt_click = st_datatable(None, options=options, context_menu=context_menu, css_files=[css_file], common_js_functions=common_js_functions, ajax_setup=ajax_setup, ajax_reload=ajax_reload, ajax_auto_refresh_period=60,
