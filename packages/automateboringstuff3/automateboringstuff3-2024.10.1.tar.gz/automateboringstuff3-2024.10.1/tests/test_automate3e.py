...
>>> doc.paragraphs[0].text
'Document Title'
>>> DUMMY = doc.paragraphs[0].style # The exact id may be different:
...
>>> import os;os.unlink('restyled.docx')
...
>>> import docx
>>> doc = docx.Document()
>>> DUMMY = doc.add_paragraph('Hello, world!')
>>> doc.save('helloworld.docx')

>>> import os;os.unlink('helloworld.docx')  # TEST CLEAN UP
...
>>> DUMMY = para_obj_1.add_run(' This text is being added to the second paragraph.')
>>> doc.save('multipleParagraphs.docx')

>>> import os;os.unlink('multipleParagraphs.docx')  # TEST CLEAN UP

>>> DUMMY = doc.add_paragraph('Hello, world!', 'Title')
...
>>> import docx
>>> doc = docx.Document()
>>> DUMMY = doc.add_heading('Header 0', 0)
>>> DUMMY = doc.add_heading('Header 1', 1)
>>> DUMMY = doc.add_heading('Header 2', 2)
>>> DUMMY = doc.add_heading('Header 3', 3)
>>> DUMMY = doc.add_heading('Header 4', 4)
>>> doc.save('headings.docx')

>>> import os;os.unlink('headings.docx')  # TEST CLEAN UP




>>> doc = docx.Document()
>>> DUMMY = doc.add_paragraph('This is on the first page!')
>>> doc.paragraphs[0].runs[0].add_break(docx.enum.text.WD_BREAK.PAGE)
>>> DUMMY = doc.add_paragraph('This is on the second page!')
>>> doc.save('twoPage.docx')

>>> import os;os.unlink('twoPage.docx')  # TEST CLEAN UP


>>> DUMMY = doc.add_picture('zophie.png', width=docx.shared.Inches(1), height=docx.shared.Cm(4))
...
def test_chapter23_pyautogui():
    """
>>> import pyautogui
>>> screen_size = pyautogui.size() # Obtain the screen resolution.
>>> DUMMY = screen_size
>>> DUMMY = screen_size[0], screen_size[1]
>>> DUMMY = screen_size.width, screen_size.height
>>> DUMMY = tuple(screen_size)

# TODO UNFINISHED
    """


def test_chpater24_tts():
    """
