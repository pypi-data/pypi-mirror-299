...
[boto3 1.35.32](https://boto3.amazonaws.com/v1/documentation/api/1.35.32/index.html)
...
- `boto3-stubs-lite[full]` - Type annotations for all 386 services in one
  package (recommended).
- `boto3-stubs-lite[all]` - Type annotations for all 386 services in separate
  packages.
