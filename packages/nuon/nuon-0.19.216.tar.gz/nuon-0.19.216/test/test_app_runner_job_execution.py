...
class TestAppRunnerJobExecution(unittest.TestCase):
    """AppRunnerJobExecution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppRunnerJobExecution:
        """Test AppRunnerJobExecution
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppRunnerJobExecution`
        """
        model = AppRunnerJobExecution()
        if include_optional:
            return AppRunnerJobExecution(
                created_at = '',
    ...
    def testAppRunnerJobExecution(self):
        """Test AppRunnerJobExecution"""
