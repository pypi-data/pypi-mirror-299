...
class TestAppDockerBuildComponentConfig(unittest.TestCase):
    """AppDockerBuildComponentConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppDockerBuildComponentConfig:
        """Test AppDockerBuildComponentConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppDockerBuildComponentConfig`
        """
        model = AppDockerBuildComponentConfig()
        if include_optional:
            return AppDockerBuildComponentConfig(
                build_args = [
                    ''
                    ],
    ...
    def testAppDockerBuildComponentConfig(self):
        """Test AppDockerBuildComponentConfig"""
