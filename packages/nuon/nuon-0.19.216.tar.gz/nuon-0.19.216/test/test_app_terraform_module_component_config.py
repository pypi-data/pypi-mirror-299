...
class TestAppTerraformModuleComponentConfig(unittest.TestCase):
    """AppTerraformModuleComponentConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppTerraformModuleComponentConfig:
        """Test AppTerraformModuleComponentConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppTerraformModuleComponentConfig`
        """
        model = AppTerraformModuleComponentConfig()
        if include_optional:
            return AppTerraformModuleComponentConfig(
    ...
    def testAppTerraformModuleComponentConfig(self):
        """Test AppTerraformModuleComponentConfig"""
