...
class TestAppAccount(unittest.TestCase):
    """AppAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppAccount:
        """Test AppAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppAccount`
        """
        model = AppAccount()
        if include_optional:
            return AppAccount(
