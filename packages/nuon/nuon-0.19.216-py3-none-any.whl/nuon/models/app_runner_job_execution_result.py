...
class AppRunnerJobExecutionResult(BaseModel):
    ...
    error_metadata: Optional[Dict[str, StrictStr]] = None
    id: Optional[StrictStr] = None
    org: Optional[AppOrg] = None
    org_id: Optional[StrictStr] = None
    runner_job_execution_id: Optional[StrictStr] = None
    success: Optional[StrictBool] = Field(default=None, description="TODO(jm): add richer information on the error or other tied to a job execution.")
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "created_by_id", "error_code", "error_metadata", "id", "org", "org_id", "runner_job_execution_id", "success", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error_metadata": obj.get("error_metadata"),
            "id": obj.get("id"),
