...
class AppRunnerJobExecution(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "created_by", "created_by_id", "id", "org", "org_id", "result", "runner_job_id", "status", "updated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "result": AppRunnerJobExecutionResult.from_dict(obj.get("result")) if obj.get("result") is not None else None,
