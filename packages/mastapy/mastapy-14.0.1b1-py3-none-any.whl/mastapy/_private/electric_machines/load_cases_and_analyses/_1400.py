...
class _Cast_ElectricMachineAnalysis:
    ...
    @property
    def dynamic_force_analysis(self: "CastSelf") -> "_1395.DynamicForceAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1395

        return self.__parent__._cast(_1395.DynamicForceAnalysis)

    @property
    def efficiency_map_analysis(self: "CastSelf") -> "_1398.EfficiencyMapAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1398

        return self.__parent__._cast(_1398.EfficiencyMapAnalysis)

    @property
    def electric_machine_fe_analysis(
        self: "CastSelf",
    ) -> "_1404.ElectricMachineFEAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1404

        return self.__parent__._cast(_1404.ElectricMachineFEAnalysis)

    @property
    def electric_machine_fe_mechanical_analysis(
        self: "CastSelf",
    ) -> "_1405.ElectricMachineFEMechanicalAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1405

        return self.__parent__._cast(_1405.ElectricMachineFEMechanicalAnalysis)

    @property
    def single_operating_point_analysis(
        self: "CastSelf",
    ) -> "_1418.SingleOperatingPointAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1418

        return self.__parent__._cast(_1418.SingleOperatingPointAnalysis)

    @property
    def speed_torque_curve_analysis(
        self: "CastSelf",
    ) -> "_1422.SpeedTorqueCurveAnalysis":
        from mastapy._private.electric_machines.load_cases_and_analyses import _1422

        return self.__parent__._cast(_1422.SpeedTorqueCurveAnalysis)
...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    @property
    def load_case(self: "Self") -> "_1407.ElectricMachineLoadCaseBase":
    ...
    def perform_analysis_with_progress(
        self: "Self", token: "_7730.TaskProgress"
    ) -> None:
        """Method does not return.
