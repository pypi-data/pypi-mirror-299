...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput]",
    ) -> "_5897.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        Returns:
            _5897.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
        """
        return _5897.HarmonicAnalysisFEExportOptions.ComplexNumberOutput
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5897.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5897.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":
