...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_DoeValueSpecificationOption]",
    ) -> "_4459.DoeValueSpecificationOption":
        ...
        Returns:
            _4459.DoeValueSpecificationOption
        """
        return _4459.DoeValueSpecificationOption
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _4459.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: "Self") -> "_4459.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: "Self") -> "List[_4459.DoeValueSpecificationOption]":
