...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_HarmonicAnalysisTorqueInputType]",
    ) -> "_5902.HarmonicAnalysisTorqueInputType":
        ...
        Returns:
            _5902.HarmonicAnalysisTorqueInputType
        """
        return _5902.HarmonicAnalysisTorqueInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5902.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: "Self") -> "_5902.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_5902.HarmonicAnalysisTorqueInputType]":
