...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    def wrapped_type(
        ...
        Returns:
            _7143.DestinationDesignState
        """
        return _7143.DestinationDesignState
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7143.DestinationDesignState.type_()

    @property
    def selected_value(self: "Self") -> "_7143.DestinationDesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_7143.DestinationDesignState]":
