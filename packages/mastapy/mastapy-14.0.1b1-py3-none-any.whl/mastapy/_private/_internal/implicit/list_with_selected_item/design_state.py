...
class ListWithSelectedItem_DesignState(
    _5796.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(cls: "Type[ListWithSelectedItem_DesignState]") -> "Any":
        ...
        Returns:
            Any
        """
        return _5796.DesignState.TYPE

    @property
    def selected_value(self: "Self") -> "_5796.DesignState":
    ...
    @property
    def available_values(self: "Self") -> "List[_5796.DesignState]":
