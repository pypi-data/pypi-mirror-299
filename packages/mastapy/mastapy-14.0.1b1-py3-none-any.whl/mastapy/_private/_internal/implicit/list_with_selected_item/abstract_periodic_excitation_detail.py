...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5812.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5812.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: "Self") -> "_5812.AbstractPeriodicExcitationDetail":
    ...
    def available_values(
        self: "Self",
    ) -> "List[_5812.AbstractPeriodicExcitationDetail]":
