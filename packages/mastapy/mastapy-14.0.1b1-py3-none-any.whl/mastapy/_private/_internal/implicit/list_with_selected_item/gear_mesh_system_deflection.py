...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2845.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _2845.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: "Self") -> "_2845.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: "Self") -> "List[_2845.GearMeshSystemDeflection]":
