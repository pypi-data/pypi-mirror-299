...
class _Cast_ParetoOptimisationVariableBase:
    ...
    @property
    def pareto_optimisation_input(self: "CastSelf") -> "_1595.ParetoOptimisationInput":
        from mastapy._private.math_utility.optimisation import _1595

        return self.__parent__._cast(_1595.ParetoOptimisationInput)

    @property
    def pareto_optimisation_output(
        self: "CastSelf",
    ) -> "_1596.ParetoOptimisationOutput":
        from mastapy._private.math_utility.optimisation import _1596

        return self.__parent__._cast(_1596.ParetoOptimisationOutput)

    @property
    def pareto_optimisation_variable(
        self: "CastSelf",
    ) -> "_1601.ParetoOptimisationVariable":
        from mastapy._private.math_utility.optimisation import _1601

        return self.__parent__._cast(_1601.ParetoOptimisationVariable)

    @property
    def parametric_study_doe_result_variable(
        self: "CastSelf",
    ) -> "_4496.ParametricStudyDOEResultVariable":
        from mastapy._private.system_model.analyses_and_results.parametric_study_tools import (
            _4496,
        )

        return self.__parent__._cast(_4496.ParametricStudyDOEResultVariable)
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def integer_range(self: "Self") -> "_1637.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: "Self", value: "_1637.IntegerRange") -> None:
    ...
    @property
    def range(self: "Self") -> "_1537.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: "Self", value: "_1537.Range") -> None:
        pythonnet_property_set(self.wrapped, "Range", value.wrapped)

    @property
    def specification_type(self: "Self") -> "_1606.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.math_utility.optimisation._1606", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: "Self", value: "_1606.TargetingPropertyTo") -> None:
    ...
    @property
    def specify_input_range_as(self: "Self") -> "_1605.SpecifyOptimisationInputAs":
    ...
    def specify_input_range_as(
        self: "Self", value: "_1605.SpecifyOptimisationInputAs"
    ) -> None:
        value = conversion.mp_to_pn_enum(
