...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2693, _2694, _2702
...
T = TypeVar("T", bound="_2702.ResultSurfaceOptions")
...
class _Cast_MeshedResultSurface:
    ...
    @property
    def meshed_result_surface_base(self: "CastSelf") -> "_2696.MeshedResultSurfaceBase":
        return self.__parent__._cast(_2696.MeshedResultSurfaceBase)

    @property
    def meshed_result_plane(self: "CastSelf") -> "_2693.MeshedResultPlane":
        from mastapy._private.system_model.part_model.acoustics import _2693

        return self.__parent__._cast(_2693.MeshedResultPlane)

    @property
    def meshed_result_sphere(self: "CastSelf") -> "_2694.MeshedResultSphere":
        from mastapy._private.system_model.part_model.acoustics import _2694

        return self.__parent__._cast(_2694.MeshedResultSphere)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeshedResultSurface(_2696.MeshedResultSurfaceBase, Generic[T]):
    """MeshedResultSurface
