...
class AcousticAnalysisSetupCacheReporting(_0.APIBase):
    ...
    @property
    def estimated_memory_at_the_maximum_frequency(self: "Self") -> "str":
        """str
        ...
        temp = pythonnet_property_get(
            self.wrapped, "EstimatedMemoryAtTheMaximumFrequency"
        )
    ...
    @property
    def estimated_memory_at_the_minimum_frequency(self: "Self") -> "str":
        """str
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "EstimatedMemoryAtTheMinimumFrequency"
        )
    ...
    @property
    def estimated_memory_for_near_field_integrals(self: "Self") -> "str":
        """str
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "EstimatedMemoryForNearFieldIntegrals"
        )
    ...
    @property
    def total_estimated_memory_for_near_field_integrals(self: "Self") -> "str":
        """str
        ...
        """
        temp = pythonnet_property_get(
            self.wrapped, "TotalEstimatedMemoryForNearFieldIntegrals"
        )
    ...
    def estimate_memory_for_m2l_coefficients(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "EstimateMemoryForM2LCoefficients")

    def estimate_memory_for_near_field_integrals(self: "Self") -> None:
        """Method does not return."""
        pythonnet_method_call(self.wrapped, "EstimateMemoryForNearFieldIntegrals")
