...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2693, _2694, _2695
...
class _Cast_MeshedResultSurfaceBase:
    ...
    @property
    def meshed_result_surface(self: "CastSelf") -> "_2695.MeshedResultSurface":
        from mastapy._private.system_model.part_model.acoustics import _2695

        return self.__parent__._cast(_2695.MeshedResultSurface)
