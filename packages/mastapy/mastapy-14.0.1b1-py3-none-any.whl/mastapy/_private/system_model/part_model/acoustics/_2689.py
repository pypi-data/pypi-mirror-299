...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2690, _2692
...
class AcousticInputSurfaceOptions(_0.APIBase):
    ...
    @property
    def fe_part_options(self: "Self") -> "List[_2690.FEPartInputSurfaceOptions]":
    ...
    @property
    def hole_meshes(self: "Self") -> "List[_2692.HoleInFaceGroup]":
