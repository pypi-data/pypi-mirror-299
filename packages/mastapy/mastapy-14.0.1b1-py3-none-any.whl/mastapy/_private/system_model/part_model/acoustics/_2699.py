...
class _Cast_ResultPlaneOptions:
    ...
    @property
    def result_surface_options(self: "CastSelf") -> "_2702.ResultSurfaceOptions":
        return self.__parent__._cast(_2702.ResultSurfaceOptions)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ResultPlaneOptions(_2702.ResultSurfaceOptions):
    """ResultPlaneOptions
    ...
    @property
    def axis_for_plane_normal(self: "Self") -> "_1540.Axis":
    ...
    def axis_for_plane_normal(self: "Self", value: "_1540.Axis") -> None:
