...
from mastapy._private.system_model.part_model.acoustics import _2695, _2700
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MeshedResultSphere(_2695.MeshedResultSurface[_2700.ResultSphereOptions]):
    """MeshedResultSphere
