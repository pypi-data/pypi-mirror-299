...
class AssemblyCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3080.AssemblySteadyStateSynchronousResponse]":
    ...
    def bearings(
        self: "Self",
    ) -> "List[_3216.BearingCompoundSteadyStateSynchronousResponse]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_3218.BeltDriveCompoundSteadyStateSynchronousResponse]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_3221.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_3228.BoltedJointCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def bolts(self: "Self") -> "List[_3227.BoltCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_3249.CVTCompoundSteadyStateSynchronousResponse]":
    ...
    def clutches(
        self: "Self",
    ) -> "List[_3229.ClutchCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3234.ConceptCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_3239.ConceptGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_3251.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_3253.CycloidalDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_3257.CylindricalGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_3264.FEPartCompoundSteadyStateSynchronousResponse]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_3263.FaceGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_3265.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3272.HypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3279.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3282.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_3283.MassDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3284.MeasurementComponentCompoundSteadyStateSynchronousResponse]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_3286.MicrophoneCompoundSteadyStateSynchronousResponse]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_3288.OilSealCompoundSteadyStateSynchronousResponse]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3290.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3295.PlanetCarrierCompoundSteadyStateSynchronousResponse]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_3296.PointLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_3297.PowerLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_3299.RingPinsCompoundSteadyStateSynchronousResponse]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3301.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3306.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_3305.ShaftCompoundSteadyStateSynchronousResponse]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3311.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3312.SpringDamperCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3317.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3320.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3323.SynchroniserCompoundSteadyStateSynchronousResponse]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3327.TorqueConverterCompoundSteadyStateSynchronousResponse]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3331.UnbalancedMassCompoundSteadyStateSynchronousResponse]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3335.WormGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3338.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]":
