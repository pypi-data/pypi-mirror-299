...
class _Cast_AbstractLoadCaseGroup:
    ...
    def abstract_static_load_case_group(
        self: "CastSelf",
    ) -> "_5793.AbstractStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5793,
        )

        return self.__parent__._cast(_5793.AbstractStaticLoadCaseGroup)
    ...
    def time_series_load_case_group(
        ...
        return self.__parent__._cast(_5804.TimeSeriesLoadCaseGroup)
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    @property
    def model(self: "Self") -> "_2255.Design":
    ...
    @property
    def parametric_analysis_options(self: "Self") -> "_4501.ParametricStudyToolOptions":
    ...
    @property
    def load_case_root_assemblies(self: "Self") -> "List[_7100.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: "Self", number_of_load_cases: "int", token: "_7730.TaskProgress"
    ) -> "List[_6953.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: "Self", progress: "_7730.TaskProgress") -> None:
        """Method does not return.
