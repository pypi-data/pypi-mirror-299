...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2589, _2591
...
TGearSet = TypeVar("TGearSet", bound="_2591.GearSet")
TGear = TypeVar("TGear", bound="_2589.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_7040.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2368.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_7042.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_7045.GearSetLoadCase")
...
class _Cast_GearSetStaticLoadCaseGroup:
    ...
    def part_static_load_case_group(
        self: "CastSelf",
    ) -> "_5810.PartStaticLoadCaseGroup":
        return self.__parent__._cast(_5810.PartStaticLoadCaseGroup)

    @property
    def design_entity_static_load_case_group(
        self: "CastSelf",
    ) -> "_5808.DesignEntityStaticLoadCaseGroup":
        from mastapy._private.system_model.analyses_and_results.load_case_groups.design_entity_static_load_case_groups import (
            _5808,
        )

        return self.__parent__._cast(_5808.DesignEntityStaticLoadCaseGroup)
...
class GearSetStaticLoadCaseGroup(
    ...
    def gears_load_cases(
        self: "Self",
    ) -> "List[_5806.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: "Self",
    ) -> "List[_5807.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
