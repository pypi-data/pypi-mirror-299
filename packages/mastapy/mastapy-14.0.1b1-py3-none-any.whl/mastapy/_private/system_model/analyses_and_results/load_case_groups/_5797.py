...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5793
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DutyCycle(_5793.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: "Self",
    ) -> "List[_5800.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: "Self") -> "_7153.TimeSeriesImporter":
    ...
    def add_static_load(self: "Self", static_load: "_6954.StaticLoadCase") -> None:
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: "Self", sub_group: "_5800.SubGroupInSingleDesignState"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: "Self", static_load: "_6954.StaticLoadCase") -> None:
        """Method does not return.
