...
class DynamicExternalInterfaceOptions(_0.APIBase):
    ...
    @property
    def input_signal_filter_level(self: "Self") -> "_5574.InputSignalFilterLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5574",
    ...
    def input_signal_filter_level(
        self: "Self", value: "_5574.InputSignalFilterLevel"
    ) -> None:
