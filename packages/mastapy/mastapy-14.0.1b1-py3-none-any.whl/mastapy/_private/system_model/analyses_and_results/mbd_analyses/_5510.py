...
class AssemblyMultibodyDynamicsAnalysis(
    ...
    @property
    def bearings(self: "Self") -> "List[_5512.BearingMultibodyDynamicsAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5515.BeltDriveMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5518.BevelDifferentialGearSetMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5524.BoltedJointMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5525.BoltMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5547.CVTMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5528.ClutchMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5534.ConceptCouplingMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5537.ConceptGearSetMultibodyDynamicsAnalysis]":
    ...
    def connections(
        self: "Self",
    ) -> "List[_5576.InterMountableComponentConnectionMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5549.CycloidalAssemblyMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5551.CycloidalDiscMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5555.CylindricalGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5562.FEPartMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5561.FaceGearSetMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5563.FlexiblePinAssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_5567.GearSetMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5571.HypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5582.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5585.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5586.MassDiscMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5590.MeasurementComponentMultibodyDynamicsAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5592.MicrophoneMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5595.OilSealMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5599.PartToPartShearCouplingMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5602.PlanetCarrierMultibodyDynamicsAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5603.PointLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5604.PowerLoadMultibodyDynamicsAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5606.RingPinsMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5608.RollingRingAssemblyMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5614.ShaftHubConnectionMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5615.ShaftMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5621.SpiralBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5625.SpringDamperMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5628.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5631.StraightBevelGearSetMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5635.SynchroniserMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5640.TorqueConverterMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5644.UnbalancedMassMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5649.WormGearSetMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5652.ZerolBevelGearSetMultibodyDynamicsAnalysis]":
