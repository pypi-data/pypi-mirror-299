...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConnectionMultibodyDynamicsAnalysis(_7713.ConnectionTimeSeriesLoadAnalysisCase):
    """ConnectionMultibodyDynamicsAnalysis
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_5594.MultibodyDynamicsAnalysis":
