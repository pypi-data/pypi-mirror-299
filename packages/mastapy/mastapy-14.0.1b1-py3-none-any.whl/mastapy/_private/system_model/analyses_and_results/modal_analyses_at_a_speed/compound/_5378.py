...
class AssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5246.AssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def bearings(self: "Self") -> "List[_5379.BearingCompoundModalAnalysisAtASpeed]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_5381.BeltDriveCompoundModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_5384.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_5391.BoltedJointCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5390.BoltCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5412.CVTCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5392.ClutchCompoundModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5397.ConceptCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5402.ConceptGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5414.CycloidalAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5416.CycloidalDiscCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5420.CylindricalGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5427.FEPartCompoundModalAnalysisAtASpeed]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5426.FaceGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5428.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5435.HypoidGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_5442.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5445.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5446.MassDiscCompoundModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5447.MeasurementComponentCompoundModalAnalysisAtASpeed]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_5449.MicrophoneCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5451.OilSealCompoundModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5453.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5458.PlanetCarrierCompoundModalAnalysisAtASpeed]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_5459.PointLoadCompoundModalAnalysisAtASpeed]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_5460.PowerLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5462.RingPinsCompoundModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5464.RollingRingAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5469.ShaftHubConnectionCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5468.ShaftCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5474.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5475.SpringDamperCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5480.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5483.StraightBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5486.SynchroniserCompoundModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5490.TorqueConverterCompoundModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5494.UnbalancedMassCompoundModalAnalysisAtASpeed]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5498.WormGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5501.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]":
