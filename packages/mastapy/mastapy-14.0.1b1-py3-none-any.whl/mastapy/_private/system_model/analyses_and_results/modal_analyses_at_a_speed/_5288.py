...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalGearSetModalAnalysisAtASpeed(_5299.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5287.CylindricalGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5286.CylindricalGearMeshModalAnalysisAtASpeed]":
