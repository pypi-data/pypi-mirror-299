...
class CylindricalGearSetCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5288.CylindricalGearSetModalAnalysisAtASpeed]":
    ...
    def cylindrical_gears_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5418.CylindricalGearCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_meshes_compound_modal_analysis_at_a_speed(
        self: "Self",
    ) -> "List[_5419.CylindricalGearMeshCompoundModalAnalysisAtASpeed]":
