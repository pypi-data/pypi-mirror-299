...
class AssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    def bearings(
        self: "Self",
    ) -> "List[_3347.BearingSteadyStateSynchronousResponseOnAShaft]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_3349.BeltDriveSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_3351.BevelDifferentialGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_3358.BoltedJointSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def bolts(self: "Self") -> "List[_3359.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_3381.CVTSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_3367.ConceptCouplingSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_3369.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_3382.CycloidalAssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_3385.CycloidalDiscSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_3387.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def fe_parts(
        self: "Self",
    ) -> "List[_3395.FEPartSteadyStateSynchronousResponseOnAShaft]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_3393.FaceGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_3396.FlexiblePinAssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3402.HypoidGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3409.KlingelnbergCycloPalloidHypoidGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3412.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def mass_discs(
        self: "Self",
    ) -> "List[_3414.MassDiscSteadyStateSynchronousResponseOnAShaft]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3415.MeasurementComponentSteadyStateSynchronousResponseOnAShaft]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_3417.MicrophoneSteadyStateSynchronousResponseOnAShaft]":
    ...
    def oil_seals(
        self: "Self",
    ) -> "List[_3419.OilSealSteadyStateSynchronousResponseOnAShaft]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3423.PartToPartShearCouplingSteadyStateSynchronousResponseOnAShaft]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3426.PlanetCarrierSteadyStateSynchronousResponseOnAShaft]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_3427.PointLoadSteadyStateSynchronousResponseOnAShaft]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_3428.PowerLoadSteadyStateSynchronousResponseOnAShaft]":
    ...
    def ring_pins(
        self: "Self",
    ) -> "List[_3430.RingPinsSteadyStateSynchronousResponseOnAShaft]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3432.RollingRingAssemblySteadyStateSynchronousResponseOnAShaft]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3436.ShaftHubConnectionSteadyStateSynchronousResponseOnAShaft]":
    ...
    def shafts(
        self: "Self",
    ) -> "List[_3437.ShaftSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3441.SpiralBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3445.SpringDamperSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3448.StraightBevelDiffGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3451.StraightBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3458.SynchroniserSteadyStateSynchronousResponseOnAShaft]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3461.TorqueConverterSteadyStateSynchronousResponseOnAShaft]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3463.UnbalancedMassSteadyStateSynchronousResponseOnAShaft]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3466.WormGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3469.ZerolBevelGearSetSteadyStateSynchronousResponseOnAShaft]":
