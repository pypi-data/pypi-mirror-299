...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3898
...
class KlingelnbergCycloPalloidConicalGearSetStabilityAnalysis(
    ...
    def conical_gears_stability_analysis(
        self: "Self",
    ) -> "List[_3935.KlingelnbergCycloPalloidConicalGearStabilityAnalysis]":
    ...
    def conical_meshes_stability_analysis(
        self: "Self",
    ) -> "List[_3933.KlingelnbergCycloPalloidConicalGearMeshStabilityAnalysis]":
