...
class _Cast_GearMeshExcitationDetail:
    ...
    def abstract_periodic_excitation_detail(
        self: "CastSelf",
    ) -> "_5812.AbstractPeriodicExcitationDetail":
        return self.__parent__._cast(_5812.AbstractPeriodicExcitationDetail)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearMeshExcitationDetail(_5812.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def uncoupled_modal_analysis(self: "Self") -> "_4770.ModalAnalysis":
    ...
    @property
    def gear_mesh(self: "Self") -> "_2845.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: "Self") -> "_5837.ComplianceAndForceData":
