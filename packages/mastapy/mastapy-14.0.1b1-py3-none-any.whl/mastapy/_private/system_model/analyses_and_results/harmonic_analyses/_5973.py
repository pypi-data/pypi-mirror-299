...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearHarmonicAnalysis(_5886.GearHarmonicAnalysis):
    """WormGearHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7134.WormGearLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2926.WormGearSystemDeflection":
