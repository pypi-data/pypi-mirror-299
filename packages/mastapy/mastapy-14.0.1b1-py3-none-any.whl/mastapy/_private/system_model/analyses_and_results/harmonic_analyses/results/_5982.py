...
class _Cast_ExcitationSourceSelectionGroup:
    ...
    def excitation_source_selection_base(
        self: "CastSelf",
    ) -> "_5981.ExcitationSourceSelectionBase":
        return self.__parent__._cast(_5981.ExcitationSourceSelectionBase)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ExcitationSourceSelectionGroup(_5981.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    @property
    def sub_items(self: "Self") -> "List[_5981.ExcitationSourceSelectionBase]":
    ...
    def include_only_harmonics_with_order(
        self: "Self", order: "_1577.RoundedOrder"
    ) -> None:
