...
class _Cast_PartToPartShearCouplingConnectionCompoundHarmonicAnalysis:
    ...
    def coupling_connection_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6052.CouplingConnectionCompoundHarmonicAnalysis":
        return self.__parent__._cast(_6052.CouplingConnectionCompoundHarmonicAnalysis)
...
class PartToPartShearCouplingConnectionCompoundHarmonicAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5924.PartToPartShearCouplingConnectionHarmonicAnalysis]":
