...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumHarmonicAnalysis(_5838.ComponentHarmonicAnalysis):
    """DatumHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7019.DatumLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2837.DatumSystemDeflection":
