...
from mastapy._private.system_model.analyses_and_results.harmonic_analyses import _5860
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class CylindricalPlanetGearHarmonicAnalysis(_5860.CylindricalGearHarmonicAnalysis):
    """CylindricalPlanetGearHarmonicAnalysis
