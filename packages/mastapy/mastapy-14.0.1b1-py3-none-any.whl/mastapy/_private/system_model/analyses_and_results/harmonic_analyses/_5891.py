...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetHarmonicAnalysis(_5945.SpecialisedAssemblyHarmonicAnalysis):
    """GearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self: "Self") -> "List[_5886.GearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: "Self",
    ) -> "List[_5888.GearMeshHarmonicAnalysis]":
