...
class ShaftHarmonicAnalysis(
    _5813.AbstractShaftHarmonicAnalysis, _2742.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4795.ShaftModalAnalysis":
    ...
    @property
    def export(self: "Self") -> "_5901.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2892.ShaftSystemDeflection":
