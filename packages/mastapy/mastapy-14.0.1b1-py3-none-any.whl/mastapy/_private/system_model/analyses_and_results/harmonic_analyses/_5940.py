...
class RootAssemblyHarmonicAnalysis(
    _5819.AssemblyHarmonicAnalysis, _2741.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: "Self") -> "_5900.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: "Self") -> "_5894.HarmonicAnalysis":
