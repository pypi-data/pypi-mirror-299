...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadAdvancedSystemDeflection(_7556.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7091.PowerLoadLoadCase":
    ...
    def component_system_deflection_results(
        self: "Self",
    ) -> "List[_2880.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: "Self",
    ) -> "List[_7554.TransmissionErrorToOtherPowerLoad]":
