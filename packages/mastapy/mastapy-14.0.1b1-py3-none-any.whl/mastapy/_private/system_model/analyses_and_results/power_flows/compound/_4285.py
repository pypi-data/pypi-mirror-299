...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BeltDriveCompoundPowerFlow(_4375.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2636.BeltDrive":
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4148.BeltDrivePowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4148.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]
