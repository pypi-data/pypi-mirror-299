...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetPowerFlow(_4201.GearSetPowerFlow):
    """ConceptGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: "Self") -> "List[_4168.ConceptGearPowerFlow]":
    ...
    @property
    def concept_gears_power_flow(self: "Self") -> "List[_4168.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: "Self") -> "List[_4167.ConceptGearMeshPowerFlow]":
    ...
    def concept_meshes_power_flow(
        self: "Self",
    ) -> "List[_4167.ConceptGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearMeshPowerFlow]
