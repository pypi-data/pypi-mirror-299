...
class KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4212.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_power_flow(
        self: "Self",
    ) -> "List[_4344.KlingelnbergCycloPalloidHypoidGearCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_power_flow(
        self: "Self",
    ) -> "List[_4345.KlingelnbergCycloPalloidHypoidGearMeshCompoundPowerFlow]":
