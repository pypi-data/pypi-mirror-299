...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class KlingelnbergCycloPalloidConicalGearSetPowerFlow(_4172.ConicalGearSetPowerFlow):
    """KlingelnbergCycloPalloidConicalGearSetPowerFlow
    ...
    def conical_gears_power_flow(
        self: "Self",
    ) -> "List[_4208.KlingelnbergCycloPalloidConicalGearPowerFlow]":
    ...
    def conical_meshes_power_flow(
        self: "Self",
    ) -> "List[_4207.KlingelnbergCycloPalloidConicalGearMeshPowerFlow]":
