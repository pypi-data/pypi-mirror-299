...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetPowerFlow(_4156.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def assembly_load_case(self: "Self") -> "_7139.ZerolBevelGearSetLoadCase":
    ...
    @property
    def bevel_gears_power_flow(self: "Self") -> "List[_4273.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: "Self",
    ) -> "List[_4273.ZerolBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    def bevel_meshes_power_flow(
        self: "Self",
    ) -> "List[_4272.ZerolBevelGearMeshPowerFlow]":
