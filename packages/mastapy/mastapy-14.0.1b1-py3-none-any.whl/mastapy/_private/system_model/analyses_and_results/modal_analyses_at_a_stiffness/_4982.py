...
class AssemblyModalAnalysisAtAStiffness(
    ...
    @property
    def bearings(self: "Self") -> "List[_4983.BearingModalAnalysisAtAStiffness]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4985.BeltDriveModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4988.BevelDifferentialGearSetModalAnalysisAtAStiffness]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_4994.BoltedJointModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4995.BoltModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5016.CVTModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4998.ClutchModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5003.ConceptCouplingModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_5006.ConceptGearSetModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5018.CycloidalAssemblyModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_5020.CycloidalDiscModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5024.CylindricalGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5032.FEPartModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_5031.FaceGearSetModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5033.FlexiblePinAssemblyModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5040.HypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5047.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5050.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5051.MassDiscModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5052.MeasurementComponentModalAnalysisAtAStiffness]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5054.MicrophoneModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5057.OilSealModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5061.PartToPartShearCouplingModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_5064.PlanetCarrierModalAnalysisAtAStiffness]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5065.PointLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5066.PowerLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5068.RingPinsModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5070.RollingRingAssemblyModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5074.ShaftHubConnectionModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5075.ShaftModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5080.SpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_5083.SpringDamperModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5086.StraightBevelDiffGearSetModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5089.StraightBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_5093.SynchroniserModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5097.TorqueConverterModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_5100.UnbalancedMassModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_5104.WormGearSetModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5107.ZerolBevelGearSetModalAnalysisAtAStiffness]":
