...
from mastapy._private.system_model.analyses_and_results.static_loads import _7052
...
class _Cast_HarmonicLoadDataCSVImport:
    ...
    def harmonic_load_data_import_from_motor_packages(
        self: "CastSelf",
    ) -> "_7052.HarmonicLoadDataImportFromMotorPackages":
        return self.__parent__._cast(_7052.HarmonicLoadDataImportFromMotorPackages)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class HarmonicLoadDataCSVImport(_7052.HarmonicLoadDataImportFromMotorPackages[T]):
    """HarmonicLoadDataCSVImport
    ...
    def electric_machine_data_per_speed(
        self: "Self",
    ) -> "List[_7018.DataFromMotorPackagePerSpeed]":
