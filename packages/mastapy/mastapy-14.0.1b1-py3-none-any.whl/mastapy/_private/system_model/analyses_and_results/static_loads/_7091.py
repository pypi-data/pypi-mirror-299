...
from mastapy._private.system_model.analyses_and_results.static_loads import _7129, _7133
...
if TYPE_CHECKING:
    ...
    from mastapy._private.math_utility.control import _1625
    ...
    from mastapy._private.system_model import _2271, _2273
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PowerLoadLoadCase(_7133.VirtualComponentLoadCase):
    """PowerLoadLoadCase
    ...
    @enforce_parameter_types
    def constant_resistance_coefficient_time_profile(
        self: "Self", value: "_1583.Vector2DListAccessor"
    ) -> None:
        pythonnet_property_set(
    ...
    def drag_torque_specification_method(
        self: "Self",
    ) -> "_2271.PowerLoadDragTorqueSpecificationMethod":
    ...
    @enforce_parameter_types
    def drag_torque_specification_method(
        self: "Self", value: "_2271.PowerLoadDragTorqueSpecificationMethod"
    ) -> None:
    ...
    @property
    def drag_torque_vs_speed_and_time(self: "Self") -> "_1613.GriddedSurfaceAccessor":
    ...
    def drag_torque_vs_speed_and_time(
        self: "Self", value: "_1613.GriddedSurfaceAccessor"
    ) -> None:
    ...
    @enforce_parameter_types
    def electric_machine_data_set_selector(
        self: "Self", value: "_2429.ElectricMachineDataSet"
    ) -> None:
    ...
    @property
    def engine_throttle_time_profile(self: "Self") -> "_1583.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @property
    def speed_vs_time(self: "Self") -> "_1583.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def speed_vs_time(self: "Self", value: "_1583.Vector2DListAccessor") -> None:
    ...
    @enforce_parameter_types
    def system_deflection_torque_method(
        self: "Self", value: "_7129.TorqueSpecificationForSystemDeflection"
    ) -> None:
    ...
    def target_speed_input_type(
        self: "Self",
    ) -> "_2273.PowerLoadPIDControlSpeedInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model._2273", "PowerLoadPIDControlSpeedInputType"
        )(value)

    @target_speed_input_type.setter
    @enforce_parameter_types
    def target_speed_input_type(
        self: "Self", value: "_2273.PowerLoadPIDControlSpeedInputType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def target_speed_vs_time(self: "Self") -> "_1583.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def target_speed_vs_time(self: "Self", value: "_1583.Vector2DListAccessor") -> None:
    ...
    @enforce_parameter_types
    def torque_input_method(
        self: "Self", value: "_2272.PowerLoadInputTorqueSpecificationMethod"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    @property
    def torque_vs_angle(self: "Self") -> "_1583.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_angle(self: "Self", value: "_1583.Vector2DListAccessor") -> None:
        pythonnet_property_set(self.wrapped, "TorqueVsAngle", value.wrapped)

    @property
    def torque_vs_angle_and_speed(self: "Self") -> "_1613.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def torque_vs_time(self: "Self") -> "_1583.Vector2DListAccessor":
        """mastapy.math_utility.Vector2DListAccessor"""
    ...
    @enforce_parameter_types
    def torque_vs_time(self: "Self", value: "_1583.Vector2DListAccessor") -> None:
    ...
    @property
    def wheel_slip_model(self: "Self") -> "_5646.WheelSlipType":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5646",
            "WheelSlipType",
        )(value)

    @wheel_slip_model.setter
    @enforce_parameter_types
    def wheel_slip_model(self: "Self", value: "_5646.WheelSlipType") -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.WheelSlipType",
        )
    ...
    @property
    def pid_control_settings(self: "Self") -> "_1625.PIDControlSettings":
        """mastapy.math_utility.control.PIDControlSettings
    ...
    def get_harmonic_load_data_for_import(
        self: "Self",
    ) -> "_7021.ElectricMachineHarmonicLoadData":
