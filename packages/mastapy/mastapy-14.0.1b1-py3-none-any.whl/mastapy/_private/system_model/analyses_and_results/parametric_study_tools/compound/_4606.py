...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DatumCompoundParametricStudyTool(_4580.ComponentCompoundParametricStudyTool):
    """DatumCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_7019.DatumLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4457.DatumParametricStudyTool]":
