...
class RingPinsToDiscConnectionSystemDeflection(
    ...
    @property
    def connection_load_case(self: "Self") -> "_7096.RingPinsToDiscConnectionLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4235.RingPinsToDiscConnectionPowerFlow":
    ...
    def ring_pin_to_disc_contacts(
        self: "Self",
    ) -> "List[_2884.RingPinToDiscContactReporting]":
