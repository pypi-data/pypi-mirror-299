...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblySystemDeflection(_2771.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4145.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: "Self") -> "List[_2784.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2786.BeltDriveSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_2788.BevelDifferentialGearSetSystemDeflection]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_2795.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2796.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2820.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2799.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: "Self") -> "List[_2801.ComponentSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2805.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_2807.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: "Self") -> "List[_2813.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_2824.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2828.CylindricalGearSetSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2843.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_2841.FaceGearSetSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2844.FlexiblePinAssemblySystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_2850.HypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_2858.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_2861.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_2865.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_2866.MeasurementComponentSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_2869.MicrophoneSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_2872.OilSealSystemDeflection]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_2878.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_2879.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_2880.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_2882.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2784.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_2885.RollingRingAssemblySystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_2892.ShaftSystemDeflection]":
    ...
    def sorted_converged_connection_details(
        self: "Self",
    ) -> "List[_2813.ConnectionSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.ConnectionSystemDeflection]
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_2896.SpiralBevelGearSetSystemDeflection]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_2900.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_2912.SynchroniserSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_2918.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_2922.UnbalancedMassSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2925.WormGearSetSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_2928.ZerolBevelGearSetSystemDeflection]":
