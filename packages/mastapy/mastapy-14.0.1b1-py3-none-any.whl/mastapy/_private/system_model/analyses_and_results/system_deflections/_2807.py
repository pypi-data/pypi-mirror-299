...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearSetSystemDeflection(_2846.GearSetSystemDeflection):
    """ConceptGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4169.ConceptGearSetPowerFlow":
    ...
    def gears_system_deflection(
        self: "Self",
    ) -> "List[_2808.ConceptGearSystemDeflection]":
    ...
    def meshes_system_deflection(
        self: "Self",
    ) -> "List[_2806.ConceptGearMeshSystemDeflection]":
