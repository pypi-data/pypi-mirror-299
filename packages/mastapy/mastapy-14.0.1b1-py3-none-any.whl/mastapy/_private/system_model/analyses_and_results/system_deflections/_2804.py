...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingHalfSystemDeflection(_2816.CouplingHalfSystemDeflection):
    """ConceptCouplingHalfSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_6989.ConceptCouplingHalfLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4165.ConceptCouplingHalfPowerFlow":
