...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ZerolBevelGearSetSystemDeflection(_2793.BevelGearSetSystemDeflection):
    """ZerolBevelGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4274.ZerolBevelGearSetPowerFlow":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2927.ZerolBevelGearMeshSystemDeflection]":
