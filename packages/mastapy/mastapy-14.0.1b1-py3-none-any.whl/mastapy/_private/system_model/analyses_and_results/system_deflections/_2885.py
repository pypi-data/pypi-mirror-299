...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingAssemblySystemDeflection(_2894.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4236.RollingRingAssemblyPowerFlow":
