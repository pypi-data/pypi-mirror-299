...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.drawing import _2302, _2312, _2313
...
class _Cast_RotorDynamicsViewable:
    ...
    def critical_speed_analysis_viewable(
        self: "CastSelf",
    ) -> "_2302.CriticalSpeedAnalysisViewable":
        from mastapy._private.system_model.drawing import _2302

        return self.__parent__._cast(_2302.CriticalSpeedAnalysisViewable)

    @property
    def stability_analysis_viewable(
        self: "CastSelf",
    ) -> "_2312.StabilityAnalysisViewable":
        from mastapy._private.system_model.drawing import _2312

        return self.__parent__._cast(_2312.StabilityAnalysisViewable)

    @property
    def steady_state_synchronous_response_viewable(
        self: "CastSelf",
    ) -> "_2313.SteadyStateSynchronousResponseViewable":
        from mastapy._private.system_model.drawing import _2313

        return self.__parent__._cast(_2313.SteadyStateSynchronousResponseViewable)
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    @property
    def rotor_dynamics(self: "Self") -> "_4132.RotorDynamicsDrawStyle":
