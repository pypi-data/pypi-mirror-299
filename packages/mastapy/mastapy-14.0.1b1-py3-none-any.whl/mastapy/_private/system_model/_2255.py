...
from mastapy._private.system_model.part_model import _2530, _2534
...
if TYPE_CHECKING:
    ...
    from mastapy._private import _7730
    ...
    from mastapy._private.system_model import _2260, _2266, _2267, _2277, _2278, _2279
    ...
    from mastapy._private.system_model.database_access import _2319
    ...
    from mastapy._private.system_model_gui import _1899
    from mastapy._private.utility import _1631, _1632, _1649
    from mastapy._private.utility.model_validation import _1844

    T_all_parts = TypeVar("T_all_parts", bound="_2526.Part")
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: "Self") -> "_1899.MASTAGUI":
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: "Self", value: "_2571.ActiveGearSetDesignSelectionGroup"
    ) -> None:
    ...
    @enforce_parameter_types
    def input_power_load(self: "Self", value: "_2530.PowerLoad") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: "Self", value: "_2530.PowerLoad") -> None:
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: "Self", value: "_2534.ShaftDiameterModificationDueToRollingBearingRing"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def thermal_expansion_for_grounded_nodes(
        self: "Self",
    ) -> "_2278.ThermalExpansionOptionForGroundedNodes":
    ...
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: "Self", value: "_2278.ThermalExpansionOptionForGroundedNodes"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
    ) -> "_2537.UnbalancedMassInclusionOption":
    ...
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: "Self", value: "_2537.UnbalancedMassInclusionOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    def acoustic_analysis_setups(
        self: "Self",
    ) -> "_2687.AcousticAnalysisSetupCollection":
    ...
    @property
    def default_system_temperatures(self: "Self") -> "_2279.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: "Self") -> "_1439.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: "Self") -> "_2266.MAAElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: "Self") -> "_2416.BatchOperations":
    ...
    @property
    def file_save_details_all(self: "Self") -> "_1631.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: "Self") -> "_1632.FileHistoryItem":
    ...
    @property
    def skf_loss_moment_multipliers(self: "Self") -> "_1649.SKFLossMomentMultipliers":
    ...
    def selected_gear_set_selection_group(
        self: "Self",
    ) -> "_2571.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def settings(self: "Self") -> "_2260.DesignSettings":
    ...
    @property
    def system(self: "Self") -> "_2277.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: "Self") -> "_2295.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: "Self",
    ) -> "List[_2680.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: "Self",
    ) -> "List[_2677.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: "Self",
    ) -> "List[_2571.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: "Self",
    ) -> "List[_2030.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: "Self",
    ) -> "List[_2679.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: "Self") -> "_2319.Databases":
    ...
    @property
    def design_states(self: "Self") -> "List[_5796.DesignState]":
    ...
    @property
    def duty_cycles(self: "Self") -> "List[_5797.DutyCycle]":
    ...
    @property
    def gear_set_config(self: "Self") -> "_2592.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: "Self", value: "_2592.GearSetConfiguration") -> None:
        pythonnet_property_set(self.wrapped, "GearSetConfig", value.wrapped)

    @property
    def masta_settings(self: "Self") -> "_2267.MASTASettings":
    ...
    @property
    def root_assembly(self: "Self") -> "_2533.RootAssembly":
    ...
    @property
    def static_loads(self: "Self") -> "List[_6954.StaticLoadCase]":
    ...
    @property
    def system_optimiser(self: "Self") -> "_2294.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: "Self",
    ) -> "List[_5804.TimeSeriesLoadCaseGroup]":
    ...
    def add_synchroniser_shift_empty(self: "Self") -> "_3072.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: "Self", name: "str") -> "_3072.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: "Self", name: "str") -> "_5796.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: "Self", name: "str") -> "_5797.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    ) -> "_2631.CycloidalAssemblyCreationOptions":
    ...
    ) -> "_2632.CylindricalGearLinearTrainCreationOptions":
    ...
    ) -> "_2634.PlanetCarrierCreationOptions":
    ...
    def remove_bearing_from_database(
        self: "Self", rolling_bearing: "_2219.RollingBearing"
    ) -> None:
        """Method does not return.
    ...
    def remove_synchroniser_shift(
        self: "Self", shift: "_3072.SynchroniserShift"
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: "Self", file_name: "str", save_results: "bool") -> "_1844.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: "Self", file_name: "str", load_cases: "List[_6953.LoadCase]"
    ) -> None:
        """Method does not return.
    ...
    def all_parts(self: "Self") -> "List[_2526.Part]":
    ...
    def all_parts_of_type_assembly(self: "Self") -> "List[_2489.Assembly]":
    ...
    def all_parts_of_type_abstract_shaft(self: "Self") -> "List[_2491.AbstractShaft]":
    ...
    def all_parts_of_type_abstract_shaft_or_housing(
        self: "Self",
    ) -> "List[_2492.AbstractShaftOrHousing]":
    ...
    def all_parts_of_type_bearing(self: "Self") -> "List[_2495.Bearing]":
    ...
    def all_parts_of_type_bolt(self: "Self") -> "List[_2498.Bolt]":
    ...
    def all_parts_of_type_bolted_joint(self: "Self") -> "List[_2499.BoltedJoint]":
    ...
    def all_parts_of_type_component(self: "Self") -> "List[_2500.Component]":
    ...
    def all_parts_of_type_connector(self: "Self") -> "List[_2503.Connector]":
    ...
    def all_parts_of_type_datum(self: "Self") -> "List[_2504.Datum]":
    ...
    def all_parts_of_type_fe_part(self: "Self") -> "List[_2509.FEPart]":
    ...
    def all_parts_of_type_flexible_pin_assembly(
        self: "Self",
    ) -> "List[_2510.FlexiblePinAssembly]":
    ...
    def all_parts_of_type_guide_dxf_model(self: "Self") -> "List[_2511.GuideDxfModel]":
    ...
    def all_parts_of_type_mass_disc(self: "Self") -> "List[_2518.MassDisc]":
    ...
    def all_parts_of_type_measurement_component(
        self: "Self",
    ) -> "List[_2519.MeasurementComponent]":
    ...
    def all_parts_of_type_microphone(self: "Self") -> "List[_2520.Microphone]":
    ...
    def all_parts_of_type_oil_seal(self: "Self") -> "List[_2524.OilSeal]":
    ...
    def all_parts_of_type_planet_carrier(self: "Self") -> "List[_2527.PlanetCarrier]":
    ...
    def all_parts_of_type_point_load(self: "Self") -> "List[_2529.PointLoad]":
    ...
    def all_parts_of_type_power_load(self: "Self") -> "List[_2530.PowerLoad]":
    ...
    def all_parts_of_type_root_assembly(self: "Self") -> "List[_2533.RootAssembly]":
    ...
    def all_parts_of_type_specialised_assembly(
        self: "Self",
    ) -> "List[_2535.SpecialisedAssembly]":
    ...
    def all_parts_of_type_unbalanced_mass(self: "Self") -> "List[_2536.UnbalancedMass]":
    ...
    def all_parts_of_type_shaft(self: "Self") -> "List[_2541.Shaft]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear(
        self: "Self",
    ) -> "List[_2572.AGMAGleasonConicalGear]":
    ...
    def all_parts_of_type_agma_gleason_conical_gear_set(
        self: "Self",
    ) -> "List[_2573.AGMAGleasonConicalGearSet]":
    ...
    def all_parts_of_type_bevel_differential_gear(
        self: "Self",
    ) -> "List[_2574.BevelDifferentialGear]":
    ...
    def all_parts_of_type_bevel_differential_gear_set(
        self: "Self",
    ) -> "List[_2575.BevelDifferentialGearSet]":
    ...
    def all_parts_of_type_bevel_differential_planet_gear(
        self: "Self",
    ) -> "List[_2576.BevelDifferentialPlanetGear]":
    ...
    def all_parts_of_type_bevel_differential_sun_gear(
        self: "Self",
    ) -> "List[_2577.BevelDifferentialSunGear]":
    ...
    def all_parts_of_type_bevel_gear(self: "Self") -> "List[_2578.BevelGear]":
    ...
    def all_parts_of_type_bevel_gear_set(self: "Self") -> "List[_2579.BevelGearSet]":
    ...
    def all_parts_of_type_concept_gear(self: "Self") -> "List[_2580.ConceptGear]":
    ...
    def all_parts_of_type_conical_gear(self: "Self") -> "List[_2582.ConicalGear]":
    ...
    def all_parts_of_type_cylindrical_planet_gear(
        self: "Self",
    ) -> "List[_2586.CylindricalPlanetGear]":
    ...
    def all_parts_of_type_face_gear(self: "Self") -> "List[_2587.FaceGear]":
    ...
    def all_parts_of_type_face_gear_set(self: "Self") -> "List[_2588.FaceGearSet]":
    ...
    def all_parts_of_type_gear(self: "Self") -> "List[_2589.Gear]":
    ...
    def all_parts_of_type_gear_set(self: "Self") -> "List[_2591.GearSet]":
    ...
    def all_parts_of_type_hypoid_gear(self: "Self") -> "List[_2593.HypoidGear]":
    ...
    def all_parts_of_type_hypoid_gear_set(self: "Self") -> "List[_2594.HypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear(
        self: "Self",
    ) -> "List[_2595.KlingelnbergCycloPalloidConicalGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_conical_gear_set(
        self: "Self",
    ) -> "List[_2596.KlingelnbergCycloPalloidConicalGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear(
        self: "Self",
    ) -> "List[_2597.KlingelnbergCycloPalloidHypoidGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set(
        self: "Self",
    ) -> "List[_2598.KlingelnbergCycloPalloidHypoidGearSet]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear(
        self: "Self",
    ) -> "List[_2599.KlingelnbergCycloPalloidSpiralBevelGear]":
    ...
    def all_parts_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set(
        self: "Self",
    ) -> "List[_2600.KlingelnbergCycloPalloidSpiralBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear(
        self: "Self",
    ) -> "List[_2604.StraightBevelDiffGear]":
    ...
    def all_parts_of_type_straight_bevel_diff_gear_set(
        self: "Self",
    ) -> "List[_2605.StraightBevelDiffGearSet]":
    ...
    def all_parts_of_type_straight_bevel_gear_set(
        self: "Self",
    ) -> "List[_2607.StraightBevelGearSet]":
    ...
    def all_parts_of_type_straight_bevel_planet_gear(
        self: "Self",
    ) -> "List[_2608.StraightBevelPlanetGear]":
    ...
    def all_parts_of_type_straight_bevel_sun_gear(
        self: "Self",
    ) -> "List[_2609.StraightBevelSunGear]":
    ...
    def all_parts_of_type_worm_gear(self: "Self") -> "List[_2610.WormGear]":
    ...
    def all_parts_of_type_worm_gear_set(self: "Self") -> "List[_2611.WormGearSet]":
    ...
    def all_parts_of_type_cycloidal_disc(self: "Self") -> "List[_2628.CycloidalDisc]":
    ...
    def all_parts_of_type_ring_pins(self: "Self") -> "List[_2629.RingPins]":
    ...
    def all_parts_of_type_belt_drive(self: "Self") -> "List[_2636.BeltDrive]":
    ...
    def all_parts_of_type_clutch(self: "Self") -> "List[_2638.Clutch]":
    ...
    def all_parts_of_type_clutch_half(self: "Self") -> "List[_2639.ClutchHalf]":
    ...
    def all_parts_of_type_concept_coupling_half(
        self: "Self",
    ) -> "List[_2642.ConceptCouplingHalf]":
    ...
    def all_parts_of_type_coupling(self: "Self") -> "List[_2644.Coupling]":
    ...
    def all_parts_of_type_coupling_half(self: "Self") -> "List[_2645.CouplingHalf]":
    ...
    def all_parts_of_type_cvt(self: "Self") -> "List[_2647.CVT]":
    ...
    def all_parts_of_type_cvt_pulley(self: "Self") -> "List[_2648.CVTPulley]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling(
        self: "Self",
    ) -> "List[_2649.PartToPartShearCoupling]":
    ...
    def all_parts_of_type_part_to_part_shear_coupling_half(
        self: "Self",
    ) -> "List[_2650.PartToPartShearCouplingHalf]":
    ...
    def all_parts_of_type_pulley(self: "Self") -> "List[_2652.Pulley]":
    ...
    def all_parts_of_type_rolling_ring(self: "Self") -> "List[_2658.RollingRing]":
    ...
    def all_parts_of_type_rolling_ring_assembly(
        self: "Self",
    ) -> "List[_2659.RollingRingAssembly]":
    ...
    def all_parts_of_type_spring_damper(self: "Self") -> "List[_2665.SpringDamper]":
    ...
    def all_parts_of_type_synchroniser(self: "Self") -> "List[_2667.Synchroniser]":
    ...
    def all_parts_of_type_torque_converter_pump(
        self: "Self",
    ) -> "List[_2673.TorqueConverterPump]":
    ...
    def all_parts_of_type_torque_converter_turbine(
        self: "Self",
    ) -> "List[_2675.TorqueConverterTurbine]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1630.ExternalFullFEFileOption" = _1630.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
