...
if TYPE_CHECKING:
    ...
    from mastapy._private.utility.report import _1807, _1814, _1822, _1824, _1831
...
TItem = TypeVar("TItem", bound="_1824.CustomReportPropertyItem")
...
class _Cast_CustomReportMultiPropertyItem:
    ...
    def shaft_system_deflection_sections_report(
        self: "CastSelf",
    ) -> "_2937.ShaftSystemDeflectionSectionsReport":
        from mastapy._private.system_model.analyses_and_results.system_deflections.reporting import (
            _2937,
        )

        return self.__parent__._cast(_2937.ShaftSystemDeflectionSectionsReport)

    @property
    def campbell_diagram_report(self: "CastSelf") -> "_4833.CampbellDiagramReport":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4833,
        )

        return self.__parent__._cast(_4833.CampbellDiagramReport)

    @property
    def per_mode_results_report(self: "CastSelf") -> "_4837.PerModeResultsReport":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.reporting import (
            _4837,
        )

        return self.__parent__._cast(_4837.PerModeResultsReport)
...
class CustomReportMultiPropertyItem(
    _1821.CustomReportMultiPropertyItemBase, Generic[TItem]
):
    """CustomReportMultiPropertyItem
