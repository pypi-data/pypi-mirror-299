...
class MicrophoneArrayDesign(_0.APIBase):
    ...
    @property
    def envelope_type(self: "Self") -> "_2688.AcousticEnvelopeType":
    ...
    @enforce_parameter_types
    def envelope_type(self: "Self", value: "_2688.AcousticEnvelopeType") -> None:
    ...
    def spherical_envelope_centre(
        self: "Self",
    ) -> "_2703.SphericalEnvelopeCentreDefinition":
    ...
    @enforce_parameter_types
    def spherical_envelope_centre(
        self: "Self", value: "_2703.SphericalEnvelopeCentreDefinition"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Acoustics.SphericalEnvelopeCentreDefinition",
    ...
    @property
    def spherical_envelope_type(self: "Self") -> "_2704.SphericalEnvelopeType":
    ...
    def spherical_envelope_type(
        self: "Self", value: "_2704.SphericalEnvelopeType"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def selected_part(self: "Self") -> "List[_2698.PartSelectionForAcousticEnvelope]":
