...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model import _2490, _2520, _2526
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneArray(_2535.SpecialisedAssembly):
    """MicrophoneArray
    ...
    @property
    def array_design(self: "Self") -> "_2697.MicrophoneArrayDesign":
    ...
    @property
    def microphones(self: "Self") -> "List[_2520.Microphone]":
