...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.acoustics import _2699, _2700
...
class _Cast_ResultSurfaceOptions:
    ...
    @property
    def result_plane_options(self: "CastSelf") -> "_2699.ResultPlaneOptions":
        from mastapy._private.system_model.part_model.acoustics import _2699

        return self.__parent__._cast(_2699.ResultPlaneOptions)

    @property
    def result_sphere_options(self: "CastSelf") -> "_2700.ResultSphereOptions":
        from mastapy._private.system_model.part_model.acoustics import _2700

        return self.__parent__._cast(_2700.ResultSphereOptions)
...
class ResultSurfaceOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def reference_component(self: "Self", value: "_2500.Component") -> None:
        wrapper_type = (
    ...
    @enforce_parameter_types
    def reference_component_type(self: "Self", value: "_2259.DesignEntityId") -> None:
