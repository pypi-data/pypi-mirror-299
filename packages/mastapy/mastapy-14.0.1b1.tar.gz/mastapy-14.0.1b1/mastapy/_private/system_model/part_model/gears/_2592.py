...
class GearSetConfiguration(_0.APIBase):
    ...
    @property
    def conical_gear_sets(self: "Self") -> "List[_2583.ConicalGearSet]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_2611.WormGearSet]":
    ...
    def implementation_detail_results_for_group(
        self: "Self",
        analysis_case: "_5793.AbstractStaticLoadCaseGroup",
    ...
    def implementation_detail_results_for(
        self: "Self",
        analysis_case: "_6954.StaticLoadCase",
        gear_set_mode: "_341.GearSetModes",
        run_all_planetary_meshes: "bool",
    ) -> "_1267.GearSetGroupDutyCycle":
        """mastapy.gears.analysis.GearSetGroupDutyCycle
    ...
    def perform_implementation_detail_analysis_group(
        self: "Self",
        static_load_case_group: "_5793.AbstractStaticLoadCaseGroup",
        gear_set_mode: "_341.GearSetModes",
    ...
    def perform_implementation_detail_analysis(
        self: "Self",
        static_load: "_6954.StaticLoadCase",
        gear_set_mode: "_341.GearSetModes",
        run_all_planetary_meshes: "bool" = True,
        perform_system_analysis_if_not_ready: "bool" = True,
    ) -> None:
