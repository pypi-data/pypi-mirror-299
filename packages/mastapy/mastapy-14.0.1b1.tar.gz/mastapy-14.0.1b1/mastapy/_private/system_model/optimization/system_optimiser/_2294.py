...
from mastapy._private.system_model.analyses_and_results.load_case_groups import _5797
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.part_model.gears import _2585, _2591
    from mastapy._private.utility.logging import _1861
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(
        self: "Self", value: "_5797.DutyCycle"
    ) -> None:
        wrapper_type = (
    ...
    @property
    def design(self: "Self") -> "_2255.Design":
    ...
    @property
    def details(self: "Self") -> "_2295.SystemOptimiserDetails":
    ...
    @property
    def log(self: "Self") -> "_1861.Logger":
    ...
    @property
    def tooth_number_finder(self: "Self") -> "_2296.ToothNumberFinder":
    ...
    @property
    def cylindrical_gear_sets(self: "Self") -> "List[_2585.CylindricalGearSet]":
    ...
    @property
    def gear_sets(self: "Self") -> "List[_2591.GearSet]":
    ...
    def system_optimisation_gear_sets(
        self: "Self",
    ) -> "List[_5801.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: "Self") -> "List[_2292.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: "Self") -> "_5797.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: "Self", value: "_5797.DutyCycle") -> None:
