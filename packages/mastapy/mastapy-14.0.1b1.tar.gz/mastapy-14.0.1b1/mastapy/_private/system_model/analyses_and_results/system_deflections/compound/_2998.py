...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearCompoundSystemDeflection(_3019.MountableComponentCompoundSystemDeflection):
    """GearCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_2847.GearSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_2847.GearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection]
