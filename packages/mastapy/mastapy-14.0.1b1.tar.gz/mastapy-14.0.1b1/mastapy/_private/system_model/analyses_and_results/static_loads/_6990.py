...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptCouplingLoadCase(_7003.CouplingLoadCase):
    """ConceptCouplingLoadCase
    ...
    @enforce_parameter_types
    def power_load_for_reference_speed(self: "Self", value: "_2530.PowerLoad") -> None:
        wrapper_type = (
    ...
    def speed_ratio_specification_method(
        self: "Self",
    ) -> "_2257.ConceptCouplingSpeedRatioSpecificationMethod":
    ...
    @enforce_parameter_types
    def speed_ratio_specification_method(
        self: "Self", value: "_2257.ConceptCouplingSpeedRatioSpecificationMethod"
    ) -> None:
    ...
    @property
    def speed_ratio_vs_time(self: "Self") -> "_1583.Vector2DListAccessor":
    ...
    @property
    def speed_ratio_pid_control(self: "Self") -> "_1625.PIDControlSettings":
