...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TorqueConverterTurbineSystemDeflection(_2816.CouplingHalfSystemDeflection):
    """TorqueConverterTurbineSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7127.TorqueConverterTurbineLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4266.TorqueConverterTurbinePowerFlow":
