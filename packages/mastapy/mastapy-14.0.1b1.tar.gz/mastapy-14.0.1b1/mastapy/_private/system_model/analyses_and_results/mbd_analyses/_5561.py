...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FaceGearSetMultibodyDynamicsAnalysis(_5567.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    def gears_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5560.FaceGearMultibodyDynamicsAnalysis]":
    ...
    def meshes_multibody_dynamics_analysis(
        self: "Self",
    ) -> "List[_5559.FaceGearMeshMultibodyDynamicsAnalysis]":
