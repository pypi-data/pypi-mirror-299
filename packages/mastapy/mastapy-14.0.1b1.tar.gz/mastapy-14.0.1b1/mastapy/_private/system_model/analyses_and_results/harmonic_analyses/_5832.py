...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BoltHarmonicAnalysis(_5838.ComponentHarmonicAnalysis):
    """BoltHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_6981.BoltLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2796.BoltSystemDeflection":
