...
class RootAssemblyAdvancedTimeSteppingAnalysisForModulation(
    _7168.AssemblyAdvancedTimeSteppingAnalysisForModulation,
    _2741.IHaveRootHarmonicAnalysisResults,
):
    """RootAssemblyAdvancedTimeSteppingAnalysisForModulation
    ...
    def results(
        self: "Self",
    ) -> "_6011.RootAssemblyHarmonicAnalysisResultsPropertyAccessor":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2888.RootAssemblySystemDeflection":
