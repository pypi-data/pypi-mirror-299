...
class _Cast_ShaftModalComplexShape:
    ...
    @property
    def shaft_complex_shape(self: "CastSelf") -> "_4133.ShaftComplexShape":
        return self.__parent__._cast(_4133.ShaftComplexShape)
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftModalComplexShape(_4133.ShaftComplexShape[_1738.Number, _1738.Number]):
    """ShaftModalComplexShape
