...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: "Self") -> "_5509.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5509",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: "Self", value: "_5509.AnalysisTypes") -> None:
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: "Self", value: "_5613.ShaftAndHousingFlexibilityOption"
    ) -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def method_to_define_period(
        self: "Self",
    ) -> "_5572.InertiaAdjustedLoadCasePeriodMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5572",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: "Self", value: "_5572.InertiaAdjustedLoadCasePeriodMethod"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(
        self: "Self", value: "_2530.PowerLoad"
    ) -> None:
        wrapper_type = (
    ...
    def static_load_cases_to_create(
        self: "Self",
    ) -> "_5573.InertiaAdjustedLoadCaseResultsToCreate":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.analyses_and_results.mbd_analyses._5573",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: "Self", value: "_5573.InertiaAdjustedLoadCaseResultsToCreate"
    ) -> None:
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    def external_interface_options(
        self: "Self",
    ) -> "_5659.DynamicExternalInterfaceOptions":
    ...
    def frequency_response_options(
        self: "Self",
    ) -> "_4748.FrequencyResponseAnalysisOptions":
    ...
    @property
    def run_up_analysis_options(self: "Self") -> "_5589.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: "Self") -> "_5622.SplineDampingOptions":
