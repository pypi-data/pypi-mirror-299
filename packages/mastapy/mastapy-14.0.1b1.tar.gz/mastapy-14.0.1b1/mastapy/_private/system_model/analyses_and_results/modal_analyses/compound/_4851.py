...
class AssemblyCompoundModalAnalysis(_4844.AbstractAssemblyCompoundModalAnalysis):
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4693.AssemblyModalAnalysis]":
    ...
    @property
    def bearings(self: "Self") -> "List[_4852.BearingCompoundModalAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4854.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4857.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4864.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4863.BoltCompoundModalAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4885.CVTCompoundModalAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4865.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4870.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4875.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4887.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_4889.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4893.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4900.FEPartCompoundModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4899.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4901.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4908.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4915.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4918.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4919.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4920.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4922.MicrophoneCompoundModalAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4924.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4926.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_4931.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4932.PointLoadCompoundModalAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4933.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4935.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4937.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4942.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4941.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4947.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4948.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4953.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4956.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4959.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4963.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4967.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4971.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4974.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4693.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
