...
T = TypeVar("T", bound="_2258.DesignEntity")
...
class _Cast_GenericClutchEngagementStatus:
    ...
    @property
    def clutch_engagement_status(self: "CastSelf") -> "_5794.ClutchEngagementStatus":
        from mastapy._private.system_model.analyses_and_results.load_case_groups import (
            _5794,
        )

        return self.__parent__._cast(_5794.ClutchEngagementStatus)
    ...
    def concept_synchro_gear_engagement_status(
        ...
        return self.__parent__._cast(_5795.ConceptSynchroGearEngagementStatus)
