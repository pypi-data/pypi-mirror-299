...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RootAssemblyLoadCase(_6968.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: "Self") -> "_1625.PIDControlSettings":
    ...
    def supercharger_rotor_sets(
        self: "Self",
    ) -> "List[_7015.CylindricalGearSetLoadCase]":
