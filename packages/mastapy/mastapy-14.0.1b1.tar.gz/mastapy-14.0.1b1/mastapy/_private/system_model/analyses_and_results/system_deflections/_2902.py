...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StraightBevelDiffGearSetSystemDeflection(_2793.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: "Self") -> "_4252.StraightBevelDiffGearSetPowerFlow":
    ...
    def bevel_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2901.StraightBevelDiffGearMeshSystemDeflection]":
