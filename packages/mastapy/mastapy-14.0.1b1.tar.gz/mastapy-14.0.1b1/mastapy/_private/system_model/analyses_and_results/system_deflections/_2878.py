...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class PlanetCarrierSystemDeflection(_2870.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def component_load_case(self: "Self") -> "_7087.PlanetCarrierLoadCase":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4228.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: "Self") -> "List[_2934.PlanetCarrierWindup]":
