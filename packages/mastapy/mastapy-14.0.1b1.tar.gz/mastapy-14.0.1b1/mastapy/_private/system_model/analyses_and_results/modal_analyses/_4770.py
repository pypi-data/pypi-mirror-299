...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ModalAnalysis(_7721.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    @property
    def analysis_settings(self: "Self") -> "_4773.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: "Self") -> "_4771.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: "Self") -> "_6470.DynamicAnalysis":
