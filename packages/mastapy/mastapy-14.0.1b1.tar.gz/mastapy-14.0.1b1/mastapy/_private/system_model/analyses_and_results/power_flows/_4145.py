...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyPowerFlow(_4138.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: "Self") -> "List[_4146.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4148.BeltDrivePowerFlow]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4157.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4158.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4179.CVTPowerFlow]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4161.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4166.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4169.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: "Self") -> "List[_4181.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4184.CycloidalDiscPowerFlow]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4197.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4194.FaceGearSetPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4205.HypoidGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_4201.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4216.MassDiscPowerFlow]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4219.MicrophonePowerFlow]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4221.OilSealPowerFlow]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4228.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4229.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4232.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4234.RingPinsPowerFlow]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4241.ShaftPowerFlow]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4249.SpringDamperPowerFlow]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4260.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4264.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4267.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4271.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: "Self") -> "List[_4274.ZerolBevelGearSetPowerFlow]":
