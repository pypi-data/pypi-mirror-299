...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyModalAnalysis(_4686.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self: "Self") -> "List[_4694.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4696.BeltDriveModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4699.BevelDifferentialGearSetModalAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4705.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4706.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4728.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: "Self",
    ) -> "List[_4832.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4709.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_4714.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_4717.ConceptGearSetModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4730.CycloidalAssemblyModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4732.CycloidalDiscModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4736.CylindricalGearSetModalAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4746.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4745.FaceGearSetModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4747.FlexiblePinAssemblyModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: "Self",
    ) -> "List[_4746.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4755.HypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4762.KlingelnbergCycloPalloidHypoidGearSetModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4765.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4766.MassDiscModalAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4767.MeasurementComponentModalAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4769.MicrophoneModalAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4776.OilSealModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4781.PartToPartShearCouplingModalAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4784.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4785.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4786.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4788.RingPinsModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4790.RollingRingAssemblyModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4794.ShaftHubConnectionModalAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4795.ShaftModalAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4804.SpringDamperModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4807.StraightBevelDiffGearSetModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4810.StraightBevelGearSetModalAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4814.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_4818.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_4821.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4828.WormGearSetModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4831.ZerolBevelGearSetModalAnalysis]":
