...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyCompoundPowerFlow(_4275.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: "Self") -> "List[_4145.AssemblyPowerFlow]":
    ...
    @property
    def bearings(self: "Self") -> "List[_4283.BearingCompoundPowerFlow]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4285.BeltDriveCompoundPowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4288.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_4295.BoltedJointCompoundPowerFlow]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4294.BoltCompoundPowerFlow]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4316.CVTCompoundPowerFlow]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4296.ClutchCompoundPowerFlow]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4301.ConceptCouplingCompoundPowerFlow]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4306.ConceptGearSetCompoundPowerFlow]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4318.CycloidalAssemblyCompoundPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_4320.CycloidalDiscCompoundPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4324.CylindricalGearSetCompoundPowerFlow]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4331.FEPartCompoundPowerFlow]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_4330.FaceGearSetCompoundPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4332.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_4339.HypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4346.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4349.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4350.MassDiscCompoundPowerFlow]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4351.MeasurementComponentCompoundPowerFlow]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4353.MicrophoneCompoundPowerFlow]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4355.OilSealCompoundPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4357.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_4362.PlanetCarrierCompoundPowerFlow]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4363.PointLoadCompoundPowerFlow]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4364.PowerLoadCompoundPowerFlow]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4366.RingPinsCompoundPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4368.RollingRingAssemblyCompoundPowerFlow]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4373.ShaftHubConnectionCompoundPowerFlow]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4372.ShaftCompoundPowerFlow]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4378.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_4379.SpringDamperCompoundPowerFlow]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4384.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4387.StraightBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_4390.SynchroniserCompoundPowerFlow]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4394.TorqueConverterCompoundPowerFlow]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4398.UnbalancedMassCompoundPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_4402.WormGearSetCompoundPowerFlow]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4405.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4145.AssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AssemblyPowerFlow]
