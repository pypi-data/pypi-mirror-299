...
class AssemblyCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_6695.AssemblyCriticalSpeedAnalysis]":
    ...
    @property
    def bearings(self: "Self") -> "List[_6830.BearingCompoundCriticalSpeedAnalysis]":
    ...
    def belt_drives(
        self: "Self",
    ) -> "List[_6832.BeltDriveCompoundCriticalSpeedAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6835.BevelDifferentialGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_6842.BoltedJointCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_6841.BoltCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_6863.CVTCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_6843.ClutchCompoundCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_6848.ConceptCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_6853.ConceptGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6865.CycloidalAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_6867.CycloidalDiscCompoundCriticalSpeedAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6871.CylindricalGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_6878.FEPartCompoundCriticalSpeedAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_6877.FaceGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6879.FlexiblePinAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6886.HypoidGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_6893.KlingelnbergCycloPalloidHypoidGearSetCompoundCriticalSpeedAnalysis]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6896.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_6897.MassDiscCompoundCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6898.MeasurementComponentCompoundCriticalSpeedAnalysis]":
    ...
    def microphones(
        self: "Self",
    ) -> "List[_6900.MicrophoneCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_6902.OilSealCompoundCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6904.PartToPartShearCouplingCompoundCriticalSpeedAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_6909.PlanetCarrierCompoundCriticalSpeedAnalysis]":
    ...
    def point_loads(
        self: "Self",
    ) -> "List[_6910.PointLoadCompoundCriticalSpeedAnalysis]":
    ...
    def power_loads(
        self: "Self",
    ) -> "List[_6911.PowerLoadCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_6913.RingPinsCompoundCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6915.RollingRingAssemblyCompoundCriticalSpeedAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_6920.ShaftHubConnectionCompoundCriticalSpeedAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_6919.ShaftCompoundCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6925.SpiralBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_6926.SpringDamperCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6931.StraightBevelDiffGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6934.StraightBevelGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_6937.SynchroniserCompoundCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_6941.TorqueConverterCompoundCriticalSpeedAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_6945.UnbalancedMassCompoundCriticalSpeedAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_6949.WormGearSetCompoundCriticalSpeedAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6952.ZerolBevelGearSetCompoundCriticalSpeedAnalysis]":
