...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class WormGearSetAdvancedSystemDeflection(_7490.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    def gears_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7557.WormGearAdvancedSystemDeflection]":
    ...
    def meshes_advanced_system_deflection(
        self: "Self",
    ) -> "List[_7558.WormGearMeshAdvancedSystemDeflection]":
