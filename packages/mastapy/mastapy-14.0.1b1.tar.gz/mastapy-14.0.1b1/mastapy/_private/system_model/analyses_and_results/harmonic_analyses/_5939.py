...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class RollingRingHarmonicAnalysis(_5851.CouplingHalfHarmonicAnalysis):
    """RollingRingHarmonicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7099.RollingRingLoadCase":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2887.RollingRingSystemDeflection":
