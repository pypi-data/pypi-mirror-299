...
class _Cast_CVTBeltConnectionCompoundHarmonicAnalysis:
    ...
    def belt_connection_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6023.BeltConnectionCompoundHarmonicAnalysis":
        return self.__parent__._cast(_6023.BeltConnectionCompoundHarmonicAnalysis)
...
class CVTBeltConnectionCompoundHarmonicAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_5853.CVTBeltConnectionHarmonicAnalysis]":
