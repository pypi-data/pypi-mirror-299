...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AGMAGleasonConicalGearSetSystemDeflection(_2811.ConicalGearSetSystemDeflection):
    """AGMAGleasonConicalGearSetSystemDeflection
    ...
    def conical_meshes_system_deflection(
        self: "Self",
    ) -> "List[_2775.AGMAGleasonConicalGearMeshSystemDeflection]":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4144.AGMAGleasonConicalGearSetPowerFlow":
