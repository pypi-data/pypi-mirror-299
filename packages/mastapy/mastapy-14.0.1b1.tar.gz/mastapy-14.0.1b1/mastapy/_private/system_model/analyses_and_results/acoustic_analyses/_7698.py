...
class HarmonicAcousticAnalysis(_0.APIBase):
    ...
    @property
    def analysis_run_type(self: "Self") -> "_7694.AcousticAnalysisRunType":
    ...
    def analysis_run_type(self: "Self", value: "_7694.AcousticAnalysisRunType") -> None:
    ...
    def excitation_details_to_run(
        self: "Self",
    ) -> "List[_7703.SingleExcitationDetails]":
