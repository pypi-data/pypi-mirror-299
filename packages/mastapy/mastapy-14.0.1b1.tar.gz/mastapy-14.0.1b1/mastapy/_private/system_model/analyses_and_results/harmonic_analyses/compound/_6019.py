...
class _Cast_AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis:
    ...
    def conical_gear_mesh_compound_harmonic_analysis(
        self: "CastSelf",
    ) -> "_6047.ConicalGearMeshCompoundHarmonicAnalysis":
        return self.__parent__._cast(_6047.ConicalGearMeshCompoundHarmonicAnalysis)
...
class AGMAGleasonConicalGearMeshCompoundHarmonicAnalysis(
    ...
    def connection_analysis_cases(
        self: "Self",
    ) -> "List[_5817.AGMAGleasonConicalGearMeshHarmonicAnalysis]":
