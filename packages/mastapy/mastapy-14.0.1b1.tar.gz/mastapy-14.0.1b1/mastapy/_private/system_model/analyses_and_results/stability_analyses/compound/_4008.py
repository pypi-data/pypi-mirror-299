...
class AssemblyCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3872.AssemblyStabilityAnalysis]":
    ...
    @property
    def bearings(self: "Self") -> "List[_4009.BearingCompoundStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_4011.BeltDriveCompoundStabilityAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_4014.BevelDifferentialGearSetCompoundStabilityAnalysis]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_4021.BoltedJointCompoundStabilityAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_4020.BoltCompoundStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_4042.CVTCompoundStabilityAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_4022.ClutchCompoundStabilityAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_4027.ConceptCouplingCompoundStabilityAnalysis]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_4032.ConceptGearSetCompoundStabilityAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_4044.CycloidalAssemblyCompoundStabilityAnalysis]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_4046.CycloidalDiscCompoundStabilityAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_4050.CylindricalGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_4057.FEPartCompoundStabilityAnalysis]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_4056.FaceGearSetCompoundStabilityAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_4058.FlexiblePinAssemblyCompoundStabilityAnalysis]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4065.HypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_4072.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4075.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_4076.MassDiscCompoundStabilityAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_4077.MeasurementComponentCompoundStabilityAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_4079.MicrophoneCompoundStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_4081.OilSealCompoundStabilityAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_4083.PartToPartShearCouplingCompoundStabilityAnalysis]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_4088.PlanetCarrierCompoundStabilityAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_4089.PointLoadCompoundStabilityAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_4090.PowerLoadCompoundStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_4092.RingPinsCompoundStabilityAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_4094.RollingRingAssemblyCompoundStabilityAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_4099.ShaftHubConnectionCompoundStabilityAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_4098.ShaftCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4104.SpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_4105.SpringDamperCompoundStabilityAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_4110.StraightBevelDiffGearSetCompoundStabilityAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4113.StraightBevelGearSetCompoundStabilityAnalysis]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_4116.SynchroniserCompoundStabilityAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_4120.TorqueConverterCompoundStabilityAnalysis]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_4124.UnbalancedMassCompoundStabilityAnalysis]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_4128.WormGearSetCompoundStabilityAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_4131.ZerolBevelGearSetCompoundStabilityAnalysis]":
