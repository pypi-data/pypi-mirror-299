...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class MicrophoneCompoundModalAnalysis(_4869.ComponentCompoundModalAnalysis):
    """MicrophoneCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4769.MicrophoneModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4769.MicrophoneModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.MicrophoneModalAnalysis]
