...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class GearSetDynamicAnalysis(_6520.SpecialisedAssemblyDynamicAnalysis):
    """GearSetDynamicAnalysis
    ...
    @property
    def gears_dynamic_analysis(self: "Self") -> "List[_6478.GearDynamicAnalysis]":
    ...
    @property
    def meshes_dynamic_analysis(self: "Self") -> "List[_6479.GearMeshDynamicAnalysis]":
