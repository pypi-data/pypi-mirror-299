...
class _Cast_CVTBeltConnectionCompoundStabilityAnalysis:
    ...
    def belt_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4010.BeltConnectionCompoundStabilityAnalysis":
        return self.__parent__._cast(_4010.BeltConnectionCompoundStabilityAnalysis)
...
class CVTBeltConnectionCompoundStabilityAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3906.CVTBeltConnectionStabilityAnalysis]":
