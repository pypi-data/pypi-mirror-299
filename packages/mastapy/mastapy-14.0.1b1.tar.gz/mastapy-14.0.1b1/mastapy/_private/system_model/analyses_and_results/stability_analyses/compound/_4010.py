...
class _Cast_BeltConnectionCompoundStabilityAnalysis:
    ...
    def cvt_belt_connection_compound_stability_analysis(
        self: "CastSelf",
    ) -> "_4041.CVTBeltConnectionCompoundStabilityAnalysis":
        from mastapy._private.system_model.analyses_and_results.stability_analyses.compound import (
            _4041,
        )

        return self.__parent__._cast(_4041.CVTBeltConnectionCompoundStabilityAnalysis)
...
class BeltConnectionCompoundStabilityAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_3874.BeltConnectionStabilityAnalysis]":
