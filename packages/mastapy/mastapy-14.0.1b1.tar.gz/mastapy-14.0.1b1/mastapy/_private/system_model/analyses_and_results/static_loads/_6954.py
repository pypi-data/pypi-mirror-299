...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class StaticLoadCase(_6953.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self: "Self") -> "_2732.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: "Self") -> "_2727.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: "Self") -> "_2718.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: "Self") -> "_2726.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: "Self") -> "_2721.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: "Self") -> "_2711.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: "Self") -> "_2728.StabilityAnalysis":
    ...
    def unbalanced_mass_inclusion(
        self: "Self",
        value: "Union[_2537.UnbalancedMassInclusionOption, Tuple[_2537.UnbalancedMassInclusionOption, bool]]",
    ) -> None:
        wrapper_type = (
    ...
    def advanced_system_deflection_options(
        self: "Self",
    ) -> "_7430.AdvancedSystemDeflectionOptions":
    ...
    def te_set_up_for_dynamic_analyses_options(
        self: "Self",
    ) -> "_2769.TESetUpForDynamicAnalysisOptions":
    ...
    @property
    def clutch_engagements(self: "Self") -> "List[_5794.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: "Self",
    ) -> "List[_5795.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: "Self") -> "_5796.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: "Self", new_design_state_group: "_5796.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
