...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyHarmonicAnalysis(_5811.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: "Self") -> "_4693.AssemblyModalAnalysis":
    ...
    @property
    def system_deflection_results(self: "Self") -> "_2778.AssemblySystemDeflection":
    ...
    @property
    def bearings(self: "Self") -> "List[_5820.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_5822.BeltDriveHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_5831.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_5832.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_5854.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_5835.ClutchHarmonicAnalysis]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_5841.ConceptCouplingHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_5844.ConceptGearSetHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_5856.CycloidalAssemblyHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_5858.CycloidalDiscHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_5862.CylindricalGearSetHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_5883.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_5882.FaceGearSetHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_5884.FlexiblePinAssemblyHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_5906.HypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_5913.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5916.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: "Self") -> "List[_5891.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_5917.MassDiscHarmonicAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_5918.MeasurementComponentHarmonicAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_5920.MicrophoneHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_5922.OilSealHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_5926.PartToPartShearCouplingHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_5930.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_5931.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_5932.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_5935.RingPinsHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_5937.RollingRingAssemblyHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_5942.ShaftHubConnectionHarmonicAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_5941.ShaftHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5949.SpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_5952.SpringDamperHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_5956.StraightBevelDiffGearSetHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_5959.StraightBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_5963.SynchroniserHarmonicAnalysis]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_5967.TorqueConverterHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_5971.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_5975.WormGearSetHarmonicAnalysis]":
