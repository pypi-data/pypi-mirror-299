...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearCompoundParametricStudyTool(_4613.GearCompoundParametricStudyTool):
    """ConceptGearCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: "Self") -> "_6991.ConceptGearLoadCase":
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4436.ConceptGearParametricStudyTool]":
