...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ShaftHubConnectionLoadCase(_7000.ConnectorLoadCase):
    """ShaftHubConnectionLoadCase
    ...
    @property
    def damping_options(self: "Self") -> "_5622.SplineDampingOptions":
    ...
    @property
    def left_flank_lead_relief(self: "Self") -> "_2662.SplineLeadRelief":
    ...
    @property
    def major_fit_options(self: "Self") -> "_2661.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: "Self") -> "_2661.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def right_flank_lead_relief(self: "Self") -> "_2662.SplineLeadRelief":
        """mastapy.system_model.part_model.couplings.SplineLeadRelief
    ...
    @property
    def spline_pitch_error_options(self: "Self") -> "_2664.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: "Self") -> "List[_2661.SplineFitOptions]":
    ...
    @property
    def lead_reliefs(self: "Self") -> "List[_2662.SplineLeadRelief]":
    ...
    def tooth_locations_external_spline_half(
        self: "Self",
    ) -> "List[_2655.RigidConnectorToothLocation]":
