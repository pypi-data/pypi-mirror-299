...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class FlexiblePinAssemblyCompoundPowerFlow(_4375.SpecialisedAssemblyCompoundPowerFlow):
    """FlexiblePinAssemblyCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2510.FlexiblePinAssembly":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4198.FlexiblePinAssemblyPowerFlow]":
