...
class _Cast_SingleExcitationResultsModalAnalysis:
    ...
    def design_entity_modal_analysis_group_results(
        self: "CastSelf",
    ) -> "_4835.DesignEntityModalAnalysisGroupResults":
        return self.__parent__._cast(_4835.DesignEntityModalAnalysisGroupResults)
...
class SingleExcitationResultsModalAnalysis(_4835.DesignEntityModalAnalysisGroupResults):
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4838.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
