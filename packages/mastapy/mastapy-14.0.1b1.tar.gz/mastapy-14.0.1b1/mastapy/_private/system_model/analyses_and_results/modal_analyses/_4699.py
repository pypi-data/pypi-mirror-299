...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class BevelDifferentialGearSetModalAnalysis(_4704.BevelGearSetModalAnalysis):
    """BevelDifferentialGearSetModalAnalysis
    ...
    def bevel_gears_modal_analysis(
        self: "Self",
    ) -> "List[_4698.BevelDifferentialGearModalAnalysis]":
    ...
    def bevel_meshes_modal_analysis(
        self: "Self",
    ) -> "List[_4697.BevelDifferentialGearMeshModalAnalysis]":
