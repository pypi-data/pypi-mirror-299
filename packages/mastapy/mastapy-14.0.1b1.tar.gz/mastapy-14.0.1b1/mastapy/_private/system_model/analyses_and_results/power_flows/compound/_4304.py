...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ConceptGearCompoundPowerFlow(_4333.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4168.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: "Self") -> "List[_4168.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
