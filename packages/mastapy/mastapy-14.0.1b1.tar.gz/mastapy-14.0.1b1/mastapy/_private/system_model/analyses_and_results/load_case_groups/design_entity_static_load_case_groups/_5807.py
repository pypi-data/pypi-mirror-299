...
TConnection = TypeVar("TConnection", bound="_2327.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_6999.ConnectionLoadCase"
)
...
class ConnectionStaticLoadCaseGroup(
    _5808.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
