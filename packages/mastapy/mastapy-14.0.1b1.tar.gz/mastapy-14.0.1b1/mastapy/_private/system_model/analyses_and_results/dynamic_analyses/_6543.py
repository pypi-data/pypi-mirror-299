...
from mastapy._private.system_model.analyses_and_results.dynamic_analyses import _6544
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class UnbalancedMassDynamicAnalysis(_6544.VirtualComponentDynamicAnalysis):
    """UnbalancedMassDynamicAnalysis
    ...
    @property
    def component_load_case(self: "Self") -> "_7132.UnbalancedMassLoadCase":
