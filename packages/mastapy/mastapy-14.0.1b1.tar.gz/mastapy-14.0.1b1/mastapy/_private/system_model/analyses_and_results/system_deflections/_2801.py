...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class ComponentSystemDeflection(_2873.PartSystemDeflection):
    """ComponentSystemDeflection
    ...
    def rigidly_connected_components(
        self: "Self",
    ) -> "_2936.RigidlyConnectedComponentGroupSystemDeflection":
    ...
    @property
    def power_flow_results(self: "Self") -> "_4163.ComponentPowerFlow":
