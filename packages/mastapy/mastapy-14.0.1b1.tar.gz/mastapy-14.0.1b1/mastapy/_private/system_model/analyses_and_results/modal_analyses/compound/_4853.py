...
class _Cast_BeltConnectionCompoundModalAnalysis:
    ...
    def cvt_belt_connection_compound_modal_analysis(
        self: "CastSelf",
    ) -> "_4884.CVTBeltConnectionCompoundModalAnalysis":
        from mastapy._private.system_model.analyses_and_results.modal_analyses.compound import (
            _4884,
        )

        return self.__parent__._cast(_4884.CVTBeltConnectionCompoundModalAnalysis)
...
class BeltConnectionCompoundModalAnalysis(
    ...
    def connection_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4695.BeltConnectionModalAnalysis]":
