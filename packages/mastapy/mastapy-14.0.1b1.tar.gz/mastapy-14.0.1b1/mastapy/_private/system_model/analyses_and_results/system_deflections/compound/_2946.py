...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyCompoundSystemDeflection(_2939.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    @property
    def bearings(self: "Self") -> "List[_2947.BearingCompoundSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_2949.BeltDriveCompoundSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_2952.BevelDifferentialGearSetCompoundSystemDeflection]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_2959.BoltedJointCompoundSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_2958.BoltCompoundSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_2980.CVTCompoundSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_2960.ClutchCompoundSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_2965.ConceptCouplingCompoundSystemDeflection]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_2970.ConceptGearSetCompoundSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_2982.CycloidalAssemblyCompoundSystemDeflection]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_2984.CycloidalDiscCompoundSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_2988.CylindricalGearSetCompoundSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_2996.FEPartCompoundSystemDeflection]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_2995.FaceGearSetCompoundSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_2997.FlexiblePinAssemblyCompoundSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3004.HypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_3011.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_3014.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: "Self") -> "List[_3015.MassDiscCompoundSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_3016.MeasurementComponentCompoundSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_3018.MicrophoneCompoundSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_3020.OilSealCompoundSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_3022.PartToPartShearCouplingCompoundSystemDeflection]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_3027.PlanetCarrierCompoundSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_3028.PointLoadCompoundSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_3029.PowerLoadCompoundSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_3031.RingPinsCompoundSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: "Self") -> "List[_2947.BearingCompoundSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.compound.BearingCompoundSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_3033.RollingRingAssemblyCompoundSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_3039.ShaftHubConnectionCompoundSystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_3037.ShaftCompoundSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3044.SpiralBevelGearSetCompoundSystemDeflection]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_3045.SpringDamperCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_3050.StraightBevelDiffGearSetCompoundSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3053.StraightBevelGearSetCompoundSystemDeflection]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_3056.SynchroniserCompoundSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_3060.TorqueConverterCompoundSystemDeflection]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_3064.UnbalancedMassCompoundSystemDeflection]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_3068.WormGearSetCompoundSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_3071.ZerolBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_2778.AssemblySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.AssemblySystemDeflection]
