...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2262
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class DesignStateOptions(_1900.ColumnInputOptions):
    """DesignStateOptions
    ...
    @design_state.setter
    @enforce_parameter_types
    def design_state(self: "Self", value: "_5796.DesignState") -> None:
        wrapper_type = (
    ...
    def design_state_destinations(
        self: "Self",
    ) -> "List[_2262.DutyCycleImporterDesignEntityMatch[_5796.DesignState]]":
