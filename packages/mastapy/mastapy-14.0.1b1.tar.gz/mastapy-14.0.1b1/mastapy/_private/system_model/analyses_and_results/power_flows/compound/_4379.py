...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpringDamperCompoundPowerFlow(_4312.CouplingCompoundPowerFlow):
    """SpringDamperCompoundPowerFlow
    ...
    @property
    def component_design(self: "Self") -> "_2665.SpringDamper":
    ...
    def assembly_analysis_cases_ready(
        self: "Self",
    ) -> "List[_4249.SpringDamperPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: "Self") -> "List[_4249.SpringDamperPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperPowerFlow]
