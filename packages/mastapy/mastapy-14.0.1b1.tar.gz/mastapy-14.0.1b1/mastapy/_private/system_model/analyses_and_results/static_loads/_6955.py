...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model.analyses_and_results import _2706, _2725, _2736
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class TimeSeriesLoadCase(_6953.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: "Self") -> "_2725.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: "Self") -> "_5588.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: "Self") -> "_5804.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: "Self",
        new_load_case_group: "_5804.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
