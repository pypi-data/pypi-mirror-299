...
from mastapy._private.system_model.analyses_and_results.stability_analyses import _3865
...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class SpecialisedAssemblyStabilityAnalysis(_3865.AbstractAssemblyStabilityAnalysis):
    """SpecialisedAssemblyStabilityAnalysis
