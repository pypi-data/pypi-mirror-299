...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyAdvancedSystemDeflection(_7425.AbstractAssemblyAdvancedSystemDeflection):
    """AssemblyAdvancedSystemDeflection
    ...
    @property
    def bearings(self: "Self") -> "List[_7436.BearingAdvancedSystemDeflection]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_7438.BeltDriveAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: "Self",
    ) -> "List[_7448.BoltedJointAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: "Self") -> "List[_7447.BoltAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_7469.CVTAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: "Self") -> "List[_7449.ClutchAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: "Self",
    ) -> "List[_7454.ConceptCouplingAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: "Self",
    ) -> "List[_7459.ConceptGearSetAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_7472.CycloidalAssemblyAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: "Self",
    ) -> "List[_7473.CycloidalDiscAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_7478.CylindricalGearSetAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_7486.FEPartAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: "Self",
    ) -> "List[_7485.FaceGearSetAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_7487.FlexiblePinAssemblyAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7494.HypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_7501.KlingelnbergCycloPalloidHypoidGearSetAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_7504.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: "Self") -> "List[_7506.MassDiscAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_7507.MeasurementComponentAdvancedSystemDeflection]":
    ...
    @property
    def microphones(self: "Self") -> "List[_7508.MicrophoneAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_7511.OilSealAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_7513.PartToPartShearCouplingAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: "Self",
    ) -> "List[_7518.PlanetCarrierAdvancedSystemDeflection]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_7519.PointLoadAdvancedSystemDeflection]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_7520.PowerLoadAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_7522.RingPinsAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_7525.RollingRingAssemblyAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: "Self",
    ) -> "List[_7529.ShaftHubConnectionAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: "Self") -> "List[_7528.ShaftAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: "Self",
    ) -> "List[_7535.SpringDamperAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_7540.StraightBevelDiffGearSetAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7543.StraightBevelGearSetAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: "Self",
    ) -> "List[_7546.SynchroniserAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: "Self",
    ) -> "List[_7550.TorqueConverterAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: "Self",
    ) -> "List[_7555.UnbalancedMassAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: "Self",
    ) -> "List[_7559.WormGearSetAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_7562.ZerolBevelGearSetAdvancedSystemDeflection]":
