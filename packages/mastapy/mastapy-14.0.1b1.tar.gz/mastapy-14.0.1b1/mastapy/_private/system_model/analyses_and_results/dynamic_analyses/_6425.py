...
@extended_dataclass(frozen=True, slots=True, weakref_slot=True)
class AssemblyDynamicAnalysis(_6418.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: "Self") -> "List[_6426.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: "Self") -> "List[_6428.BeltDriveDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: "Self",
    ) -> "List[_6431.BevelDifferentialGearSetDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: "Self") -> "List[_6438.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: "Self") -> "List[_6437.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: "Self") -> "List[_6459.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: "Self") -> "List[_6440.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: "Self") -> "List[_6445.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: "Self") -> "List[_6449.ConceptGearSetDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: "Self",
    ) -> "List[_6461.CycloidalAssemblyDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: "Self") -> "List[_6463.CycloidalDiscDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: "Self",
    ) -> "List[_6467.CylindricalGearSetDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: "Self") -> "List[_6476.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: "Self") -> "List[_6475.FaceGearSetDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: "Self",
    ) -> "List[_6477.FlexiblePinAssemblyDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: "Self") -> "List[_6484.HypoidGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: "Self",
    ) -> "List[_6491.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6494.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: "Self") -> "List[_6495.MassDiscDynamicAnalysis]":
    ...
    def measurement_components(
        self: "Self",
    ) -> "List[_6496.MeasurementComponentDynamicAnalysis]":
    ...
    @property
    def microphones(self: "Self") -> "List[_6498.MicrophoneDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: "Self") -> "List[_6500.OilSealDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: "Self",
    ) -> "List[_6503.PartToPartShearCouplingDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: "Self") -> "List[_6507.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: "Self") -> "List[_6508.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: "Self") -> "List[_6509.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: "Self") -> "List[_6511.RingPinsDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: "Self",
    ) -> "List[_6513.RollingRingAssemblyDynamicAnalysis]":
    ...
    @property
    def shafts(self: "Self") -> "List[_6517.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: "Self") -> "List[_6525.SpringDamperDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: "Self",
    ) -> "List[_6529.StraightBevelDiffGearSetDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6532.StraightBevelGearSetDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: "Self") -> "List[_6535.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: "Self") -> "List[_6540.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: "Self") -> "List[_6543.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: "Self") -> "List[_6547.WormGearSetDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: "Self",
    ) -> "List[_6550.ZerolBevelGearSetDynamicAnalysis]":
