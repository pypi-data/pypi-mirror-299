...
from mastapy._private.system_model.fe import _2444, _2467
from mastapy._private.system_model.part_model import _2500, _2504
...
if TYPE_CHECKING:
    ...
    from mastapy._private.system_model import _2275
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self: "Self") -> "_2411.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2411", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: "Self", value: "_2411.AlignmentMethod") -> None:
    ...
    @property
    def bearing_node_alignment(self: "Self") -> "_2417.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy._private.system_model.fe._2417", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(
        self: "Self", value: "_2417.BearingNodeAlignmentOption"
    ) -> None:
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: "Self", value: "_2500.Component") -> None:
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: "Self", value: "_2504.Datum") -> None:
    ...
    @enforce_parameter_types
    def distance_display_unit(self: "Self", value: "_1660.Unit") -> None:
    ...
    @enforce_parameter_types
    def force_display_unit(self: "Self", value: "_1660.Unit") -> None:
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @enforce_parameter_types
    def thermal_expansion_option(
        self: "Self", value: "_2467.ThermalExpansionOption"
    ) -> None:
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: "Self", value: "_2444.FESubstructureType") -> None:
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
    ...
    def alignment_using_axial_node_positions(
        self: "Self",
    ) -> "_2413.AlignmentUsingAxialNodePositions":
    ...
    def alignment_to_component(
        self: "Self",
    ) -> "_2275.RelativeComponentAlignment[_2500.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2500.Component](temp)
    ...
    @property
    def coordinate_system(self: "Self") -> "_1547.CoordinateSystem3D":
    ...
    @property
    def export(self: "Self") -> "_2440.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: "Self") -> "_2509.FEPart":
    ...
    @property
    def gear_meshing_options(self: "Self") -> "List[_2451.GearMeshingOptions]":
    ...
    @property
    def geometries(self: "Self") -> "List[_2437.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: "Self",
    ) -> "List[_2452.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: "Self") -> "List[_2474.FELink]":
    ...
    @property
    def nodes(self: "Self") -> "List[_2441.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: "Self") -> "List[_2541.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: "Self",
    ) -> "List[_2465.ReplacedShaftSelectionHelper]":
    ...
    def create_fe_substructure_with_selection_components(
        self: "Self",
    ) -> "_2447.FESubstructureWithSelectionComponents":
    ...
    def create_fe_substructure_with_selection_for_harmonic_analysis(
        self: "Self",
    ) -> "_2448.FESubstructureWithSelectionForHarmonicAnalysis":
    ...
    def create_fe_substructure_with_selection_for_modal_analysis(
        self: "Self",
    ) -> "_2449.FESubstructureWithSelectionForModalAnalysis":
    ...
    def create_fe_substructure_with_selection_for_static_analysis(
        self: "Self",
    ) -> "_2450.FESubstructureWithSelectionForStaticAnalysis":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7730.TaskProgress"] = None,
    ) -> None:
        """Method does not return.
    ...
    def import_node_positions(
        self: "Self", file_name: "str", distance_unit: "_1660.Unit"
    ) -> None:
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: "Self",
        file_name: "str",
        distance_unit: "_1660.Unit",
        force_unit: "_1660.Unit",
    ) -> None:
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(
        self: "Self", node: "_2441.FESubstructureNode"
    ) -> "List[_2474.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: "Self", file_name: "str", progress: "_7730.TaskProgress"
    ) -> None:
        """Method does not return.
    ...
    def load_stl_geometry(
        self: "Self", length_unit: "_1660.Unit", file_path: "str"
    ) -> None:
        """Method does not return.
