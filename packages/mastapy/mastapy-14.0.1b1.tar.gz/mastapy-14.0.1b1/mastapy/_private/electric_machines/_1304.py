...
if TYPE_CHECKING:
    ...
    from mastapy._private.electric_machines.results import _1390, _1391
...
class _Cast_ElectricMachineDetail:
    ...
    def wound_field_synchronous_machine(
        self: "CastSelf",
    ) -> "_1367.WoundFieldSynchronousMachine":
        from mastapy._private.electric_machines import _1367

        return self.__parent__._cast(_1367.WoundFieldSynchronousMachine)
...
class ElectricMachineDetail(_0.APIBase):
    ...
    @property
    def non_linear_dq_model(self: "Self") -> "_1390.NonLinearDQModel":
    ...
    def non_linear_dq_model_generator_settings(
        self: "Self",
    ) -> "_1391.NonLinearDQModelGeneratorSettings":
    ...
    @property
    def results_locations(self: "Self") -> "List[_1570.Named2DLocation]":
    ...
    def generate_design_without_non_linear_dq_model(
        self: "Self",
    ) -> "_1640.MethodOutcomeWithResult[ElectricMachineDetail]":
