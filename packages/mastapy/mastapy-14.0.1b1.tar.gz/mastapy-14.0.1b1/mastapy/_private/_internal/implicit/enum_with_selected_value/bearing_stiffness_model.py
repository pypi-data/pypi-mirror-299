...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5513.BearingStiffnessModel
        """
        return _5513.BearingStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5513.BearingStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5513.BearingStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5513.BearingStiffnessModel]":
