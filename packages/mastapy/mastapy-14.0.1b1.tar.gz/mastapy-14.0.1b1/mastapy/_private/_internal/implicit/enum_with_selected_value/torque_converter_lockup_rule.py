...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    def wrapped_type(
        cls: "Type[EnumWithSelectedValue_TorqueConverterLockupRule]",
    ) -> "_5639.TorqueConverterLockupRule":
        ...
        Returns:
            _5639.TorqueConverterLockupRule
        """
        return _5639.TorqueConverterLockupRule
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5639.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: "Self") -> "_5639.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: "Self") -> "List[_5639.TorqueConverterLockupRule]":
