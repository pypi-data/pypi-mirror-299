...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7128.TorqueRippleInputType
        """
        return _7128.TorqueRippleInputType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7128.TorqueRippleInputType.type_()

    @property
    def selected_value(self: "Self") -> "_7128.TorqueRippleInputType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7128.TorqueRippleInputType]":
