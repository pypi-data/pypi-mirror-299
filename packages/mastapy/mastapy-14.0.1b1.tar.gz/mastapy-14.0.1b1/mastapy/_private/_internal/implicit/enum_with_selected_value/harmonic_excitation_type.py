...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    def wrapped_type(
        ...
        Returns:
            _7047.HarmonicExcitationType
        """
        return _7047.HarmonicExcitationType
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _7047.HarmonicExcitationType.type_()

    @property
    def selected_value(self: "Self") -> "_7047.HarmonicExcitationType":
    ...
    @property
    def available_values(self: "Self") -> "List[_7047.HarmonicExcitationType]":
