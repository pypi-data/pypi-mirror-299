...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    def wrapped_type(
        ...
        Returns:
            _5565.GearMeshStiffnessModel
        """
        return _5565.GearMeshStiffnessModel
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5565.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: "Self") -> "_5565.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: "Self") -> "List[_5565.GearMeshStiffnessModel]":
