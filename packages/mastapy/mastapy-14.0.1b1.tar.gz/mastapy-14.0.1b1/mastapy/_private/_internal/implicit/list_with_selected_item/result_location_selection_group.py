...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5986.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def implicit_type(
        ...
        Returns:
            Any
        """
        return _5986.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: "Self") -> "_5986.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: "Self") -> "List[_5986.ResultLocationSelectionGroup]":
