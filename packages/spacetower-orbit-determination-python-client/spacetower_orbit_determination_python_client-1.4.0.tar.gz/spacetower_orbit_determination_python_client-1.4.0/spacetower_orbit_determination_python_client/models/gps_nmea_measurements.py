...
class GpsNmeaMeasurements(Measurements):
    ...
    standard_deviations: Optional[List[Union[Annotated[float, Field(strict=True, gt=0)], Annotated[int, Field(strict=True, gt=0)]]]] = Field(default=None, description="Standard deviations for the entire set of measurements. The data contains a standard deviation for each of the following ordered content: geodetic latitude, longitude, geodetic altitude and earth fixed speed ", alias="standardDeviations")
