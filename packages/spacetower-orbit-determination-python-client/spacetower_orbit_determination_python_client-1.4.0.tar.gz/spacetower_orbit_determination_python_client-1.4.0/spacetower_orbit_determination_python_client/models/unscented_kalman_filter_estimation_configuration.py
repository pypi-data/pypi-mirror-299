...
class UnscentedKalmanFilterEstimationConfiguration(EstimationConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["orbitEstimationRequest", "dragCoefficientEstimationRequest", "reflectivityCoefficientEstimationRequest", "satelliteClockOffsetEstimationRequest", "thrustScaleFactorsEstimationRequest", "estimatorType", "unscentedKalmanFilterConfiguration"]
