...
class KalmanResult(BaseModel):
    ...
    output_residuals: Optional[DatedEstimatedResiduals] = Field(default=None, alias="outputResiduals")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputResiduals": DatedEstimatedResiduals.from_dict(obj["outputResiduals"]) if obj.get("outputResiduals") is not None else None,
