...
class KalmanResiduals(DatedEstimatedResiduals):
    """
    ...
    __properties: ClassVar[List[str]] = ["estimatorType", "dates", "normalizationFlag", "rejectionStatus", "description", "preFitResiduals", "postFitResiduals"]
