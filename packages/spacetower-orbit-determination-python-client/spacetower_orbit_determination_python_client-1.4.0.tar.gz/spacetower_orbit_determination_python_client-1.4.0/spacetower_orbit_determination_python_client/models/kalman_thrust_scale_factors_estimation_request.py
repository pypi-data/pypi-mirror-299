...
class KalmanThrustScaleFactorsEstimationRequest(BaseModel):
    """
    If activated, three scale factors (one per direction component) are added to the estimated parameters. If one of the direction component is set to zero by the user, then it is replaced by a very small value and the scale factor weights on it
    """ # noqa: E501
