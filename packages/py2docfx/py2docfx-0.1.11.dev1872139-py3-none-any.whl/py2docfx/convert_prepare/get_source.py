...
def update_package_info(pkg: PackageInfo, source_folder: str, executable):
    cur_path = os.getcwd()
...
def get_source(pkg: PackageInfo, cnt: int, executable: str, vststoken=None, githubtoken=None, ):
    path_cnt = str(cnt)
