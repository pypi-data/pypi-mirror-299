...
class CloudServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.dbusage_info = channel.unary_unary(
                '/spaceone.api.inventory.v1.CloudService/dbusage_info',
                request_serializer=spaceone_dot_api_dot_inventory_dot_v1_dot_cloud__service__pb2.CloudServiceDBStatQuery.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_struct__pb2.Struct.FromString,
                )
...
class CloudServiceServicer(object):
    ...
    def dbusage_info(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CloudServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'dbusage_info': grpc.unary_unary_rpc_method_handler(
                    servicer.dbusage_info,
                    request_deserializer=spaceone_dot_api_dot_inventory_dot_v1_dot_cloud__service__pb2.CloudServiceDBStatQuery.FromString,
                    response_serializer=google_dot_protobuf_dot_struct__pb2.Struct.SerializeToString,
            ),
    }
...
class CloudService(object):
    ...
    def dbusage_info(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/spaceone.api.inventory.v1.CloudService/dbusage_info',
            spaceone_dot_api_dot_inventory_dot_v1_dot_cloud__service__pb2.CloudServiceDBStatQuery.SerializeToString,
            google_dot_protobuf_dot_struct__pb2.Struct.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
