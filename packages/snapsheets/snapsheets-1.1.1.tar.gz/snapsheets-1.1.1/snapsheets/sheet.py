...
from .downloader import via_wget, via_httpx
...
class Sheet:
    ...
    def download_via_httpx(self):
        """Download spreadsheet via httpx"""
        return via_httpx(self.filename, self.export_url)
    ...
    def download(self) -> None:
        ...
        # result = self.download_via_httpx()
