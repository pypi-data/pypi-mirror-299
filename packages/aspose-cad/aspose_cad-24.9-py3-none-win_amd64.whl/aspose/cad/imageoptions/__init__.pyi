...
class ApsGroupOptions(ImageOptionsBase):
    ...
    @property
    def watermark_guard_options(self) -> aspose.cad.WatermarkGuardOptions:
        ...
    
    @watermark_guard_options.setter
    def watermark_guard_options(self, value : aspose.cad.WatermarkGuardOptions):
        ...
...
class GlbOptions(ImageOptionsBase):
    '''The GLB options.'''
...
class GltfOptions(ImageOptionsBase):
    '''The GLTF options.'''
