...
class DeletedParameterData(ParameterType, ABC):
    """
    Store and analyze DELETED parameter data.
    ...
    def load_from_modified(self, data: dict, parameter_type: str, path: str, http_method: str, name: str):
        ...
        Specifically:
            paths.modified.{path}.operations.modified.{method}.parameters.deleted.{param_type}.{param_name}

        Example:
            paths.modified.["/hello/{name}"].operations.modified.["GET"].parameters.deleted.["query"].name
        """
