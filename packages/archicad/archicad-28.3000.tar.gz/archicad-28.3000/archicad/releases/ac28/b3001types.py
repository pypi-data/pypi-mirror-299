...
class AttributeFolderIdWrapperItem(_ACBaseType):
    """ EMPTY STRING

    Attributes:
        attributeFolderId (:obj:`AttributeFolderId`): The identifier of an attribute folder.

    """
    __slots__ = ("attributeFolderId", )

    def __init__(self, attributeFolderId: AttributeFolderId):
        self.attributeFolderId: AttributeFolderId = attributeFolderId

AttributeFolderIdWrapperItem.get_classinfo().add_field('attributeFolderId', AttributeFolderId)
...
class AttributeIndexAndGuid(_ACBaseType):
    """ The complete identifier of an attribute.

    Attributes:
        guid (:obj:`UUID`): A Globally Unique Identifier (or Universally Unique Identifier) in its string representation as defined in RFC 4122.
        index (:obj:`float`): The index of an attribute.

    """
    __slots__ = ("guid", "index", )

    def __init__(self, guid: UUID, index: float):
        self.guid: UUID = guid
        self.index: float = index

AttributeIndexAndGuid.get_classinfo().add_field('guid', UUID)
AttributeIndexAndGuid.get_classinfo().add_field('index', float)


class AttributeIndexAndGuidWrapperItem(_ACBaseType):
    """ EMPTY STRING

    Attributes:
        attributeIndexAndGuid (:obj:`AttributeIndexAndGuid`): The complete identifier of an attribute.

    """
    __slots__ = ("attributeIndexAndGuid", )

    def __init__(self, attributeIndexAndGuid: AttributeIndexAndGuid):
        self.attributeIndexAndGuid: AttributeIndexAndGuid = attributeIndexAndGuid

AttributeIndexAndGuidWrapperItem.get_classinfo().add_field('attributeIndexAndGuid', AttributeIndexAndGuid)
...
class AttributeFolder(_ACBaseType):
    ...
    Attributes:
        ...
        path (:obj:`list` of :obj:`str`): A list of attribute folder names. May be empty.
        attributeFolderId (:obj:`AttributeFolderId`): The identifier of an attribute folder.
        attributeIds (:obj:`list` of :obj:`AttributeIdWrapperItem`): A list of attribute identifiers.
        attributeFolderIds (:obj:`list` of :obj:`AttributeFolderIdWrapperItem`): A list of attribute folder identifiers.

    """
    __slots__ = ("attributeType", "path", "attributeFolderId", "attributeIds", "attributeFolderIds", )

    def __init__(self, attributeType: str, path: List[str], attributeFolderId: AttributeFolderId, attributeIds: List[AttributeIdWrapperItem], attributeFolderIds: List[AttributeFolderIdWrapperItem]):
        self.attributeType: str = attributeType
        self.path: List[str] = path
        self.attributeFolderId: AttributeFolderId = attributeFolderId
        self.attributeIds: List[AttributeIdWrapperItem] = attributeIds
        self.attributeFolderIds: List[AttributeFolderIdWrapperItem] = attributeFolderIds
...
AttributeFolder.get_classinfo().add_field('path', List[str], listitem_validator(min_length(1)))
AttributeFolder.get_classinfo().add_field('attributeFolderId', AttributeFolderId)
AttributeFolder.get_classinfo().add_field('attributeIds', List[AttributeIdWrapperItem])
AttributeFolder.get_classinfo().add_field('attributeFolderIds', List[AttributeFolderIdWrapperItem])


class AttributeFolderCreationParameters(_ACBaseType):
    ...
    def __init__(self, attributeType: str, path: List[str]):
        self.attributeType: str = attributeType
        self.path: List[str] = path

AttributeFolderCreationParameters.get_classinfo().add_field('attributeType', str, value_set(['BuildingMaterial', 'Composite', 'Fill', 'Layer', 'LayerCombination', 'Line', 'PenTable', 'Profile', 'Surface', 'ZoneCategory']))
AttributeFolderCreationParameters.get_classinfo().add_field('path', List[str], listitem_validator(min_length(1)))


class AttributeFolderRenameParameters(_ACBaseType):
    """ Used to rename an attribute folder. The folder is identified by it's Id.

    Attributes:
        attributeFolderId (:obj:`AttributeFolderId`): The identifier of an attribute folder.
        newName (:obj:`str`): The name of an attribute folder. Legal names are not empty, and do not begin or end with whitespace.

    """
    __slots__ = ("attributeFolderId", "newName", )

    def __init__(self, attributeFolderId: AttributeFolderId, newName: str):
        self.attributeFolderId: AttributeFolderId = attributeFolderId
        self.newName: str = newName

AttributeFolderRenameParameters.get_classinfo().add_field('attributeFolderId', AttributeFolderId)
AttributeFolderRenameParameters.get_classinfo().add_field('newName', str, min_length(1))
...
AttributeHeader.get_classinfo().add_field('name', str, min_length(1))


class AttributeHeaderArrayItem(_ACBaseType):
    """ EMPTY STRING

    Attributes:
        attribute (:obj:`AttributeHeader`): The header object of an attribute.

    """
    __slots__ = ("attribute", )

    def __init__(self, attribute: AttributeHeader):
        self.attribute: AttributeHeader = attribute

AttributeHeaderArrayItem.get_classinfo().add_field('attribute', AttributeHeader)
...
LayerAttribute.get_classinfo().add_field('name', str, min_length(1))
...
FillAttribute.get_classinfo().add_field('name', str, min_length(1))
...
ProfileAttribute.get_classinfo().add_field('name', str, min_length(1))
...
LayerCombinationAttribute.get_classinfo().add_field('name', str, min_length(1))
...
class AttributeFolderWrapper(_ACBaseType):
    """ 
...
AttributeFolderWrapper.get_classinfo().add_field('attributeFolder', AttributeFolder)
...
class AttributeIndexAndGuidOrError(_ACUnionType):
    """ The attribute's identifier or an error.

    Attributes:
        attributeIndexAndGuid (:obj:`AttributeIndexAndGuid`, optional): The complete identifier of an attribute.
        error (:obj:`Error`, optional): The details of an error.

    """
    __slots__ = ("attributeIndexAndGuid", "error", )

    constructor  = _ConstructUnion(Union[AttributeIndexAndGuidWrapperItem, ErrorItem])

    def __new__(cls, attributeIndexAndGuid: Optional[AttributeIndexAndGuid] = None, error: Optional[Error] = None):
        return cls.constructor(attributeIndexAndGuid=attributeIndexAndGuid, error=error)

    def __init__(self, attributeIndexAndGuid: Optional[AttributeIndexAndGuid] = None, error: Optional[Error] = None):
        self.attributeIndexAndGuid: Optional[AttributeIndexAndGuid] = attributeIndexAndGuid
        self.error: Optional[Error] = error


class AttributeFolderOrError(_ACUnionType):
    """ An attribute folder or an error.

    Attributes:
        attributeFolder (:obj:`AttributeFolder`, optional): Identifies an attribute folder. The path of the root folder is repesented by empty array.
        error (:obj:`Error`, optional): The details of an error.

    """
    __slots__ = ("attributeFolder", "error", )

    constructor  = _ConstructUnion(Union[AttributeFolderWrapper, ErrorItem])

    def __new__(cls, attributeFolder: Optional[AttributeFolder] = None, error: Optional[Error] = None):
        return cls.constructor(attributeFolder=attributeFolder, error=error)

    def __init__(self, attributeFolder: Optional[AttributeFolder] = None, error: Optional[Error] = None):
        self.attributeFolder: Optional[AttributeFolder] = attributeFolder
        self.error: Optional[Error] = error
...
SurfaceAttribute.get_classinfo().add_field('name', str, min_length(1))
...
CompositeAttribute.get_classinfo().add_field('name', str, min_length(1))
...
class Pen(_ACBaseType):
    ...
    """
    __slots__ = ("index", "color", "weight", "description", )

    def __init__(self, index: int, color: RGBColor, weight: float, description: str):
...
ZoneCategoryAttribute.get_classinfo().add_field('name', str, min_length(1))
...
BuildingMaterialAttribute.get_classinfo().add_field('name', str, min_length(1))
...
PenTableAttribute.get_classinfo().add_field('name', str, min_length(1))
...
LineAttribute.get_classinfo().add_field('name', str, min_length(1))
...
class AttributeFolderStructure_: pass
class AttributeFolderStructureArrayItem(_ACBaseType):
    """ EMPTY STRING

    Attributes:
        attributeFolder (:obj:`AttributeFolderStructure_`): The details of an attribute folder structure.

    """
    __slots__ = ("attributeFolder", )

    def __init__(self, attributeFolder: AttributeFolderStructure_):
        self.attributeFolder: AttributeFolderStructure_ = attributeFolder


class AttributeFolderStructure(_ACBaseType):
    """ The details of an attribute folder structure.

    Attributes:
        attributeFolderId (:obj:`AttributeFolderId`): The identifier of an attribute folder.
        name (:obj:`str`): The name of an attribute folder. Legal names are not empty, and do not begin or end with whitespace.
        attributes (:obj:`list` of :obj:`AttributeHeaderArrayItem`, optional): A list of attribute headers.
        subfolders (:obj:`list` of :obj:`AttributeFolderStructureArrayItem`, optional): A list of attribute folder structures.

    """
    __slots__ = ("attributeFolderId", "name", "attributes", "subfolders", )

    def __init__(self, attributeFolderId: AttributeFolderId, name: str, attributes: Optional[List[AttributeHeaderArrayItem]] = None, subfolders: Optional[List[AttributeFolderStructureArrayItem]] = None):
        self.attributeFolderId: AttributeFolderId = attributeFolderId
        self.name: str = name
        self.attributes: Optional[List[AttributeHeaderArrayItem]] = attributes
        self.subfolders: Optional[List[AttributeFolderStructureArrayItem]] = subfolders

AttributeFolderStructure.get_classinfo().add_field('attributeFolderId', AttributeFolderId)
AttributeFolderStructure.get_classinfo().add_field('name', str, min_length(1))
AttributeFolderStructure.get_classinfo().add_field('attributes', Optional[List[AttributeHeaderArrayItem]])
AttributeFolderStructure.get_classinfo().add_field('subfolders', Optional[List[AttributeFolderStructureArrayItem]])

AttributeFolderStructure_ = AttributeFolderStructure
AttributeFolderStructureArrayItem.get_classinfo().add_field('attributeFolder', AttributeFolderStructure)


class AttributeFolderStructureOrError(_ACUnionType):
    ...
    Attributes:
        ...
        name (:obj:`str`, optional): The name of an attribute folder. Legal names are not empty, and do not begin or end with whitespace.
        attributes (:obj:`list` of :obj:`AttributeHeaderArrayItem`, optional): A list of attribute headers.
        subfolders (:obj:`list` of :obj:`AttributeFolderStructureArrayItem`, optional): A list of attribute folder structures.
        error (:obj:`Error`, optional): The details of an error.

    """
    __slots__ = ("attributeFolderId", "name", "attributes", "subfolders", "error", )

    constructor  = _ConstructUnion(Union[AttributeFolderStructure, ErrorItem])

    def __new__(cls, attributeFolderId: Optional[AttributeFolderId] = None, name: Optional[str] = None, attributes: Optional[List[AttributeHeaderArrayItem]] = None, subfolders: Optional[List[AttributeFolderStructureArrayItem]] = None, error: Optional[Error] = None):
        return cls.constructor(attributeFolderId=attributeFolderId, name=name, attributes=attributes, subfolders=subfolders, error=error)

    def __init__(self, attributeFolderId: Optional[AttributeFolderId] = None, name: Optional[str] = None, attributes: Optional[List[AttributeHeaderArrayItem]] = None, subfolders: Optional[List[AttributeFolderStructureArrayItem]] = None, error: Optional[Error] = None):
...
class Types:
    ...
    AttributeFolderIdWrapperItem=AttributeFolderIdWrapperItem
    AttributeId=AttributeId
    AttributeIdWrapperItem=AttributeIdWrapperItem
    AttributeIndexAndGuid=AttributeIndexAndGuid
    AttributeIndexAndGuidWrapperItem=AttributeIndexAndGuidWrapperItem
    AttributeFolder=AttributeFolder
    AttributeFolderCreationParameters=AttributeFolderCreationParameters
    AttributeFolderRenameParameters=AttributeFolderRenameParameters
    AttributeHeader=AttributeHeader
    AttributeHeaderArrayItem=AttributeHeaderArrayItem
    ...
    AttributeFolderWrapper=AttributeFolderWrapper
    ...
    AttributeIndexAndGuidOrError=AttributeIndexAndGuidOrError
    AttributeFolderOrError=AttributeFolderOrError
    ...
    AttributeFolderStructureArrayItem=AttributeFolderStructureArrayItem
    AttributeFolderStructure=AttributeFolderStructure
    AttributeFolderStructureOrError=AttributeFolderStructureOrError
