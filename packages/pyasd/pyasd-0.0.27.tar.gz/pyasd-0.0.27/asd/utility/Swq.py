...
def test_spin_wave(lat_type,J1=1,J2=0,SIA=0.1,nx=1,ny=1,nq=100,plot_en_axis=True,show=False,freq_unit='THz'):
    ...
    analytic_spectra = analytic_spin_wave_FM(lat_type,qpt_cart,J1,J2,SIA,freq_unit=freq_unit)
