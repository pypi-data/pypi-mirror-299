...
if "site-packages/Orange/widgets" in os.path.dirname(os.path.abspath(__file__)).replace("\\","/"):
    ...
    from Orange.widgets.orangecontrib.AAIT.utils import thread_management, concat_gpt4all
    from Orange.widgets.orangecontrib.AAIT.utils.import_uic import uic
else:
    from orangecontrib.AAIT.llm import GPT4ALL
    from orangecontrib.AAIT.utils import thread_management, concat_gpt4all
    from orangecontrib.AAIT.utils.import_uic import uic

# To be removed
concat_gpt4all.unzip_gpt4all_if_needed()
