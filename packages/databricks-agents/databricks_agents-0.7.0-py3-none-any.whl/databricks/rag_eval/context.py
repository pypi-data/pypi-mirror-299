...
from databricks.rag_eval.clients import managedrag
...
class RealContext(Context):
    ...
    def build_managed_rag_client(self) -> managed_rag_client.ManagedRagClient:
        ...
        return managed_rag_client.ManagedRagClient(api_url=api_url, api_token=api_token)
...
def eval_api(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if "run_id" not in kwargs:
            raise ValueError("Internal error: run_id is required")
