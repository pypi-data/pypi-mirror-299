...
def default_config_dict() -> Mapping[str, Any]:
    """Returns the default config as a dictionary"""
    return yaml.safe_load(default_config())


def default_metrics_with_expected_response() -> Set[str]:
    """Returns a default list of metrics to run when expected response is provided"""
    return {
...
def default_metrics_with_grading_notes() -> Set[str]:
    """Returns a default list of metrics to run when grading notes are provided"""
    return {
        builtin_judge.CORRECTNESS.assessment_name,
...
def default_metrics_without_ground_truth() -> Set[str]:
    """Returns a default list of metrics to run when ground truth is not provided"""
    return {
