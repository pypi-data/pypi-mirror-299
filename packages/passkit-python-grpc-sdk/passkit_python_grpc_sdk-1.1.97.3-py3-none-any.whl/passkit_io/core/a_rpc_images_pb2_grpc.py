...
class Images(object):
    ...
    def getStampImageConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/io.Images/getStampImageConfig',
            io_dot_common_dot_common__objects__pb2.Id.SerializeToString,
    ...
    def updateStampImageConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/io.Images/updateStampImageConfig',
    ...
    def getStampImagePreview(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/io.Images/getStampImagePreview',
