...
from worker_automate_hub.utils.util import (
    ...
    selecionar_nota_externa,
    digitar_datas_emissao,
    digitar_numero_nota,
    worker_sleep,
)
...
async def entrada_de_notas_39(task):
    """
    ...
    try:
        ...
        importar_notas_outras_empresas(nota["dataEmissao"], nota["numeroNota"])

        #Tela importa nota de outra empresa
        #Seleciona Empresa externa

        cnpj_fornecedor = str(int(nota['cnpjFornecedor'][8:12]))
        selecionar_nota_externa(cnpj_fornecedor)
