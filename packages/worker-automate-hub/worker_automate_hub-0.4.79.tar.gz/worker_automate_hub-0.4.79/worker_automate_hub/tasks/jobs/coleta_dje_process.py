            ...
            try:
                ...
                if items:
                    ...
                    with sync_playwright() as playwright:
                        ...
                        page.wait_for_selector("text=Comunicação Processual Acompanhe as citações, intimações e ofícios direcionados", timeout=15000)
                        page.get_by_text("Comunicação Processual Acompanhe as citações, intimações e ofícios direcionados").click()

                        page.wait_for_load_state("networkidle")
                        page.wait_for_selector("button.buscar", timeout=15000)
                        await asyncio.sleep(3)
                        ...
                        page.get_by_label("Usuário Autenticado").click()
                        page.locator("a").filter(has_text="Sair").click()
