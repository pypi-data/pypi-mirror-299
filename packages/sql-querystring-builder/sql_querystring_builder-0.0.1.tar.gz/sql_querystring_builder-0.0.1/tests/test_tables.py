...
class TestTables(TestCase):
    ...
    def test_valid_name(self):
        try:
            Table("a"*128)
        except InvalidNameException as _:
            self.fail("Table() with name length 128 unexpectedly raised an InvalidNameException.")
        try:
            TempTable("a"*115)
        except InvalidNameException as _:
            self.fail("TempTable() with name length 115 (+1 for #) unexpectedly raised an InvalidNameException.")
