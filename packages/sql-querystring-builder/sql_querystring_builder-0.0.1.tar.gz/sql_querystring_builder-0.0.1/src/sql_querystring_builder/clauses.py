...
# TODO  Implement a mechanism to know if we can have several statement with same value of 'place'.
# Ex: for place 0: NO because ce can't have both updte and select.
#     for place 3: YES because several inner joins are possible.
