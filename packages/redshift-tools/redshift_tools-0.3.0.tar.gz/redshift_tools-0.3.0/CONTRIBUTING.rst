...
To fix bugs please fork the repository and create a merge request.

Write Documentation
~~~~~~~~~~~~~~~~~~~

``redshift_tools`` could always use more documentation, whether as part of the 
official ``redshift_tools`` docs, in docstrings, or even on
