...
async def get_api_key_money(api_key):
    ...
    async with httpx.AsyncClient(base_url=BASE_URL, headers=headers, timeout=30) as client:
        response1 = await client.get("/v1/dashboard/billing/usage")
        response2 = await client.get("/v1/dashboard/billing/subscription")  # 查令牌
...
if __name__ == '__main__':
    ...
    arun(get_api_key_money("sk-kBc2cacPZNcPIjwE4c461b796aAd4702A9B2C34cAfBe64Af"))
