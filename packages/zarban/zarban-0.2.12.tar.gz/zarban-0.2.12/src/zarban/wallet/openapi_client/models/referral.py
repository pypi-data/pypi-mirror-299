...
class Referral(object):
    ...
    def __init__(self, id=None, referrer_id=None, name=None, usage_limit=None, usage_count=None, created_at=None, link=None, local_vars_configuration=None):  # noqa: E501
