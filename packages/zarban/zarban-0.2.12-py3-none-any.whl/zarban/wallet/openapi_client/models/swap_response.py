...
class SwapResponse(object):
    ...
    def __init__(self, id=None, trade_type=None, _in=None, out=None, amount=None, quote=None, rate=None, input_balance_after_swap=None, output_balance_after_swap=None, created_at=None, expires_at=None, executed_at=None, local_vars_configuration=None):  # noqa: E501
