...
class StreamHandle(str):
    ...
    where ``<uuid>`` is an UUID of a Blob.
    """
...
def close(handle: StreamHandle) -> typing.Generator[T_JSON_DICT, T_JSON_DICT, None]:  # NOQA
    """
...
def read(
    ...
    :param size: *(Optional)*
     ...
     (left upon the agent discretion if not specified).
