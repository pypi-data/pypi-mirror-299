...
class BackgroundServiceEvent:
    ...
    def from_json(cls, json: T_JSON_DICT) -> BackgroundServiceEvent:
        return cls(
            ...
            service_worker_registration_id=service_worker.RegistrationID.from_json(  # NOQA
                json["serviceWorkerRegistrationId"]
            ),
            ...
            event_metadata=[
                EventMetadata.from_json(i) for i in json["eventMetadata"]
            ],
...
class BackgroundServiceEventReceived:
    """
    Called with all existing backgroundServiceEvents when enabled,
    and all new events afterwards if enabled and recording.
    """
