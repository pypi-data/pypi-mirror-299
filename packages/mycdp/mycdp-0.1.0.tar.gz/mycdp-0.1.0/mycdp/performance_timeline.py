...
class LayoutShift:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LayoutShift:
        return cls(
            ...
            last_input_time=network.TimeSinceEpoch.from_json(
                json["lastInputTime"]
            ),
            sources=[
                LayoutShiftAttribution.from_json(i) for i in json["sources"]
            ],
        )
...
def enable(
    ...
    The specified filter overrides any previous filters,
    passing empty filter disables recording.
