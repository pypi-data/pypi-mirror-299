...
class TextExampleDoc(BaseDoc):
    ...
    label: Union[bool, str] = Field(description='The label of the text')
...
class ImageExampleDoc(BaseDoc):
    ...
    label: Union[bool, str] = Field(description='The label of the image')
...
class TrainingInput(BaseDocWithoutId):
    ...
    visibility: Literal['public', 'private'] = Field(
        description='The visibility of the classifier when created. '
...
class ClassifierParameters(BaseModel):
    ...
    class_statistics: Optional[dict] = Field(
        description='The class statistics', default=None
    )
    classification_type: Optional[str] = Field(
        description='The classification type', default=None
    )
    ...
    class Config:
        ...
        schema_extra = {
            "example": {
                ...
                "bias": [1, 2],
                "iteration_count": 100,
                "class_statistics": {"label1": 10, "label2": 20, "label3": 30},
...
class ExecutorTrainingInputDoc(BaseDoc):
    ...
    label_boolean: Optional[bool] = Field(
        description='The label of the input. This is a workaround to bypass docarray Union type issue',  # noqa
        default=None,
    )
