...
SLEPC_EXTERN void  epspowersetsignnormalization_(EPS eps,PetscBool *sign_normalization, int *__ierr)
{
*__ierr = EPSPowerSetSignNormalization(
	(EPS)PetscToPointer((eps) ),*sign_normalization);
}
SLEPC_EXTERN void  epspowergetsignnormalization_(EPS eps,PetscBool *sign_normalization, int *__ierr)
{
*__ierr = EPSPowerGetSignNormalization(
	(EPS)PetscToPointer((eps) ),sign_normalization);
}
