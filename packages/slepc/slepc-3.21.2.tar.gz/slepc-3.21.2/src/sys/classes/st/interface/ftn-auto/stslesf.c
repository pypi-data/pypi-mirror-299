...
SLEPC_EXTERN void  stmatmulthermitiantranspose_(ST st,PetscInt *k,Vec x,Vec y, int *__ierr)
{
*__ierr = STMatMultHermitianTranspose(
	(ST)PetscToPointer((st) ),*k,
	(Vec)PetscToPointer((x) ),
	(Vec)PetscToPointer((y) ));
}
...
SLEPC_EXTERN void  stmatmatsolve_(ST st,Mat B,Mat X, int *__ierr)
{
*__ierr = STMatMatSolve(
	(ST)PetscToPointer((st) ),
...
SLEPC_EXTERN void  stmatsolvehermitiantranspose_(ST st,Vec b,Vec x, int *__ierr)
{
*__ierr = STMatSolveHermitianTranspose(
	(ST)PetscToPointer((st) ),
	(Vec)PetscToPointer((b) ),
	(Vec)PetscToPointer((x) ));
}
