...
class PresentationFileWriter(object):
    ...
    def WriteFile(self, fileName: "std::string const &", author: "std::string const &", description: "std::string const &", buildNumber: "uint32_t const", narrationProjects: "NarrationProjectList", supplementaryFiles: "SupplementaryFileList", presentationOrder: "PresentationItemTypeList", narrations: "NarrationList", learningModules: "LearningModuleList") -> "void":
        return _pyglass.PresentationFileWriter_WriteFile(self, fileName, author, description, buildNumber, narrationProjects, supplementaryFiles, presentationOrder, narrations, learningModules)
