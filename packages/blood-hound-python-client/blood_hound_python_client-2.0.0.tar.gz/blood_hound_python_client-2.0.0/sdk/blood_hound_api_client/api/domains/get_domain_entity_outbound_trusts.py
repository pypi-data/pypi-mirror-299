...
from ...models.get_domain_entity_outbound_trusts_type import GetDomainEntityOutboundTrustsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityOutboundTrustsType] = GetDomainEntityOutboundTrustsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/outbound-trusts",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityOutboundTrustsType]):  Default:
            GetDomainEntityOutboundTrustsType.LIST.
