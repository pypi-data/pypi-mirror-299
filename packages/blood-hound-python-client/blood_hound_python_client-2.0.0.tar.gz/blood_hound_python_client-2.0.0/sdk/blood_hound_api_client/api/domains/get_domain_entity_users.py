...
from ...models.get_domain_entity_users_type import GetDomainEntityUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityUsersType] = GetDomainEntityUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityUsersType]):  Default: GetDomainEntityUsersType.LIST.
