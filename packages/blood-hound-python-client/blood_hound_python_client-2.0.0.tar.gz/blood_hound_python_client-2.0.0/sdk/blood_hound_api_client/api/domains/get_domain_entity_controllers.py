...
from ...models.get_domain_entity_controllers_type import GetDomainEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityControllersType] = GetDomainEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityControllersType]):  Default:
            GetDomainEntityControllersType.LIST.
