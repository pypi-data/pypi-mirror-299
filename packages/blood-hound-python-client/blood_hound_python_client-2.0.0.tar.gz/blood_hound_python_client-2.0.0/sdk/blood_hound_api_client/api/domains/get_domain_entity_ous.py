...
from ...models.get_domain_entity_ous_type import GetDomainEntityOusType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityOusType] = GetDomainEntityOusType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/ous",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityOusType]):  Default: GetDomainEntityOusType.LIST.
