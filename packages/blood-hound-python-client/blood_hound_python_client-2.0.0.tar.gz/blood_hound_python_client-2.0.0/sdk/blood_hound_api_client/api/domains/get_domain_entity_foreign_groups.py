...
from ...models.get_domain_entity_foreign_groups_type import GetDomainEntityForeignGroupsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityForeignGroupsType] = GetDomainEntityForeignGroupsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/foreign-groups",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityForeignGroupsType]):  Default:
            GetDomainEntityForeignGroupsType.LIST.
