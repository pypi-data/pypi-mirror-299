...
from ...models.get_computer_entity_controllables_type import GetComputerEntityControllablesType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityControllablesType] = GetComputerEntityControllablesType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/controllables",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityControllablesType]):  Default:
            GetComputerEntityControllablesType.LIST.
