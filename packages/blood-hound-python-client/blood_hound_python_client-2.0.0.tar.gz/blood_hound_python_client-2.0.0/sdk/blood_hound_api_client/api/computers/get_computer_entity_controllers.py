...
from ...models.get_computer_entity_controllers_type import GetComputerEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityControllersType] = GetComputerEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityControllersType]):  Default:
            GetComputerEntityControllersType.LIST.
