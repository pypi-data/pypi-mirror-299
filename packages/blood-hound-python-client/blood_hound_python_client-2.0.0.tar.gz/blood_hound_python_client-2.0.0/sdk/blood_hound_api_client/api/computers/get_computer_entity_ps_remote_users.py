...
from ...models.get_computer_entity_ps_remote_users_type import GetComputerEntityPsRemoteUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityPsRemoteUsersType] = GetComputerEntityPsRemoteUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/ps-remote-users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityPsRemoteUsersType]):  Default:
            GetComputerEntityPsRemoteUsersType.LIST.
