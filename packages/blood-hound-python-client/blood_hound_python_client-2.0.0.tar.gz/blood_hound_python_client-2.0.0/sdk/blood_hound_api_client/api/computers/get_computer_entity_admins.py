...
from ...models.get_computer_entity_admins_type import GetComputerEntityAdminsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityAdminsType] = GetComputerEntityAdminsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/admin-users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityAdminsType]):  Default:
            GetComputerEntityAdminsType.LIST.
