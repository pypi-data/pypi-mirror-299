...
from ...models.get_computer_entity_ps_remote_rights_type import GetComputerEntityPsRemoteRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityPsRemoteRightsType] = GetComputerEntityPsRemoteRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/ps-remote-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityPsRemoteRightsType]):  Default:
            GetComputerEntityPsRemoteRightsType.LIST.
