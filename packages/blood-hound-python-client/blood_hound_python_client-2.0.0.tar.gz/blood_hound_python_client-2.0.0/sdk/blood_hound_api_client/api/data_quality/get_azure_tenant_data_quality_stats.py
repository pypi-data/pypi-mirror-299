...
from ...models.get_azure_tenant_data_quality_stats_response_200 import GetAzureTenantDataQualityStatsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/azure-tenants/{tenant_id}/data-quality-stats",
        "params": params,
    }
...
) -> Optional[Union[Any, GetAzureTenantDataQualityStatsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetAzureTenantDataQualityStatsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetAzureTenantDataQualityStatsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, GetAzureTenantDataQualityStatsResponse200]
    """
