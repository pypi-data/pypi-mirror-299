...
from ...models.get_entity_controllers_type import GetEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetEntityControllersType] = GetEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/base/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetEntityControllersType]):  Default: GetEntityControllersType.LIST.
