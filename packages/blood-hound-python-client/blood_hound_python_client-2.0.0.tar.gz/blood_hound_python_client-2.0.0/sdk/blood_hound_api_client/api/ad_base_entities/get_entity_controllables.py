...
from ...models.get_entity_controllables_type import GetEntityControllablesType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetEntityControllablesType] = GetEntityControllablesType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/base/{object_id}/controllables",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetEntityControllablesType]):  Default:
            GetEntityControllablesType.LIST.
