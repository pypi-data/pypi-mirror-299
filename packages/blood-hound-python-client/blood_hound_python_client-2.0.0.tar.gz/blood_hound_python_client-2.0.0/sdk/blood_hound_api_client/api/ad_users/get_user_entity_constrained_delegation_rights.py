...
from ...models.get_user_entity_constrained_delegation_rights_type import GetUserEntityConstrainedDelegationRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[
        Unset, GetUserEntityConstrainedDelegationRightsType
    ] = GetUserEntityConstrainedDelegationRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/constrained-delegation-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityConstrainedDelegationRightsType]):  Default:
            GetUserEntityConstrainedDelegationRightsType.LIST.
