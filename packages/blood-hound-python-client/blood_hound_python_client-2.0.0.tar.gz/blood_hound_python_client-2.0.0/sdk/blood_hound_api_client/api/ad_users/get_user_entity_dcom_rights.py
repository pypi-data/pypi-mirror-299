...
from ...models.get_user_entity_dcom_rights_type import GetUserEntityDcomRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityDcomRightsType] = GetUserEntityDcomRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/dcom-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityDcomRightsType]):  Default:
            GetUserEntityDcomRightsType.LIST.
