...
from ...models.get_user_entity_sessions_type import GetUserEntitySessionsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntitySessionsType] = GetUserEntitySessionsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/sessions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntitySessionsType]):  Default: GetUserEntitySessionsType.LIST.
