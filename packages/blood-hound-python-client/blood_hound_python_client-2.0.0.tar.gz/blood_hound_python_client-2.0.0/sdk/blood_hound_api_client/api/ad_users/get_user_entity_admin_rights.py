...
from ...models.get_user_entity_admin_rights_type import GetUserEntityAdminRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityAdminRightsType] = GetUserEntityAdminRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/admin-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityAdminRightsType]):  Default:
            GetUserEntityAdminRightsType.LIST.
