...
from ...models.get_user_entity_controllables_type import GetUserEntityControllablesType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityControllablesType] = GetUserEntityControllablesType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/controllables",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityControllablesType]):  Default:
            GetUserEntityControllablesType.LIST.
