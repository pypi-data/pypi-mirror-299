...
from ...models.get_user_entity_sql_admin_rights_type import GetUserEntitySqlAdminRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntitySqlAdminRightsType] = GetUserEntitySqlAdminRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/sql-admin-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntitySqlAdminRightsType]):  Default:
            GetUserEntitySqlAdminRightsType.LIST.
