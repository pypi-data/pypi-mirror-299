...
from ...models.get_ou_entity_gpos_type import GetOuEntityGposType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetOuEntityGposType] = GetOuEntityGposType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/ous/{object_id}/gpos",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetOuEntityGposType]):  Default: GetOuEntityGposType.LIST.
