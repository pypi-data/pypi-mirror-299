...
from ...models.get_ou_entity_groups_type import GetOuEntityGroupsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetOuEntityGroupsType] = GetOuEntityGroupsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/ous/{object_id}/groups",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetOuEntityGroupsType]):  Default: GetOuEntityGroupsType.LIST.
