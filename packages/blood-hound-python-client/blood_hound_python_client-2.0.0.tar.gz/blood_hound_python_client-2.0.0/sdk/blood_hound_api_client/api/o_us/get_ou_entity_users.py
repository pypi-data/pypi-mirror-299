...
from ...models.get_ou_entity_users_type import GetOuEntityUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetOuEntityUsersType] = GetOuEntityUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/ous/{object_id}/users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetOuEntityUsersType]):  Default: GetOuEntityUsersType.LIST.
