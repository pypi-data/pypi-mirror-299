...
from ...models.get_aia_ca_entity_controllers_type import GetAiaCaEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetAiaCaEntityControllersType] = GetAiaCaEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/aiacas/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetAiaCaEntityControllersType]):  Default:
            GetAiaCaEntityControllersType.LIST.
