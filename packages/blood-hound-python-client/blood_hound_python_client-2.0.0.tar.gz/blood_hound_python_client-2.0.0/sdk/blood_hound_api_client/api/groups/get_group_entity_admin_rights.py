...
from ...models.get_group_entity_admin_rights_type import GetGroupEntityAdminRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityAdminRightsType] = GetGroupEntityAdminRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/admin-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityAdminRightsType]):  Default:
            GetGroupEntityAdminRightsType.LIST.
