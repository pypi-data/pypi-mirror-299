...
from ...models.get_group_entity_members_type import GetGroupEntityMembersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityMembersType] = GetGroupEntityMembersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/members",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityMembersType]):  Default: GetGroupEntityMembersType.LIST.
