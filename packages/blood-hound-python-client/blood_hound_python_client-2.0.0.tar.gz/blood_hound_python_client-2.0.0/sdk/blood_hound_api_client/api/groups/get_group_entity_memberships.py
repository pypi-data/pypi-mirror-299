...
from ...models.get_group_entity_memberships_type import GetGroupEntityMembershipsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityMembershipsType] = GetGroupEntityMembershipsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/memberships",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityMembershipsType]):  Default:
            GetGroupEntityMembershipsType.LIST.
