...
from ...models.get_group_entity_rdp_rights_type import GetGroupEntityRdpRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityRdpRightsType] = GetGroupEntityRdpRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/rdp-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityRdpRightsType]):  Default:
            GetGroupEntityRdpRightsType.LIST.
