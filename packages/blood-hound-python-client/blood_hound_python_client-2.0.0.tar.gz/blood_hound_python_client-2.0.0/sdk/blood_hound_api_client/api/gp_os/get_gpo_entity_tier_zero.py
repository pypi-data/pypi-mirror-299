...
from ...models.get_gpo_entity_tier_zero_type import GetGpoEntityTierZeroType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGpoEntityTierZeroType] = GetGpoEntityTierZeroType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/gpos/{object_id}/tier-zero",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGpoEntityTierZeroType]):  Default: GetGpoEntityTierZeroType.LIST.
