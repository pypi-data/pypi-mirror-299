...
from ...models.get_gpo_entity_computers_type import GetGpoEntityComputersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGpoEntityComputersType] = GetGpoEntityComputersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/gpos/{object_id}/computers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGpoEntityComputersType]):  Default: GetGpoEntityComputersType.LIST.
