...
T = TypeVar("T", bound="GetSearchResultResponse200Data")


@_attrs_define
class GetSearchResultResponse200Data:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        get_search_result_response_200_data = cls()
        ...
        get_search_result_response_200_data.additional_properties = additional_properties
        return get_search_result_response_200_data
