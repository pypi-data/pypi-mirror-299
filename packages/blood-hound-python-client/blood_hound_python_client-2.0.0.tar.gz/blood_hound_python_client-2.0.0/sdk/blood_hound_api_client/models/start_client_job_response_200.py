...
T = TypeVar("T", bound="StartClientJobResponse200")


@_attrs_define
class StartClientJobResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        start_client_job_response_200 = cls(
            data=data,
        )

        start_client_job_response_200.additional_properties = d
        return start_client_job_response_200
