...
T = TypeVar("T", bound="ModelComponentsTimestamps")


@_attrs_define
class ModelComponentsTimestamps:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model_components_timestamps = cls(
            created_at=created_at,
            updated_at=updated_at,
            deleted_at=deleted_at,
        )

        model_components_timestamps.additional_properties = d
        return model_components_timestamps
