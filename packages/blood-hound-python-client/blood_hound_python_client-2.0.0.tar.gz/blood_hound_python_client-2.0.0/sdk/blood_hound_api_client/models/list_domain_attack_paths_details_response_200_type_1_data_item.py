...
T = TypeVar("T", bound="ListDomainAttackPathsDetailsResponse200Type1DataItem")


@_attrs_define
class ListDomainAttackPathsDetailsResponse200Type1DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_domain_attack_paths_details_response_200_type_1_data_item = cls(
            id=id,
        ...
        list_domain_attack_paths_details_response_200_type_1_data_item.additional_properties = d
        return list_domain_attack_paths_details_response_200_type_1_data_item
