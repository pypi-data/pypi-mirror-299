...
T = TypeVar("T", bound="GetMfaActivationStatusResponse200Data")


@_attrs_define
class GetMfaActivationStatusResponse200Data:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_mfa_activation_status_response_200_data = cls(
            status=status,
        )

        get_mfa_activation_status_response_200_data.additional_properties = d
        return get_mfa_activation_status_response_200_data
