...
T = TypeVar("T", bound="ModelAzureDataQualityAggregation")


@_attrs_define
class ModelAzureDataQualityAggregation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model_azure_data_quality_aggregation = cls(
            id=id,
        ...
        model_azure_data_quality_aggregation.additional_properties = d
        return model_azure_data_quality_aggregation
