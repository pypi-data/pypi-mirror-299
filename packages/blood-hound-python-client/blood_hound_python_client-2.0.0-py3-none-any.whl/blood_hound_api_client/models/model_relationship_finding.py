...
T = TypeVar("T", bound="ModelRelationshipFinding")


@_attrs_define
class ModelRelationshipFinding:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model_relationship_finding = cls(
            id=id,
        ...
        model_relationship_finding.additional_properties = d
        return model_relationship_finding
