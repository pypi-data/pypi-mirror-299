...
T = TypeVar("T", bound="UpdateAssetGroupSelectorsDeprecatedResponse201Data")


@_attrs_define
class UpdateAssetGroupSelectorsDeprecatedResponse201Data:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_asset_group_selectors_deprecated_response_201_data = cls(
            added_selectors=added_selectors,
            removed_selectors=removed_selectors,
        )

        update_asset_group_selectors_deprecated_response_201_data.additional_properties = d
        return update_asset_group_selectors_deprecated_response_201_data
