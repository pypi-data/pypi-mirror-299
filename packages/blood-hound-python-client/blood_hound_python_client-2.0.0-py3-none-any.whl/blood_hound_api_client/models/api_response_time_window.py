...
T = TypeVar("T", bound="ApiResponseTimeWindow")


@_attrs_define
class ApiResponseTimeWindow:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_response_time_window = cls(
            start=start,
            end=end,
        )

        api_response_time_window.additional_properties = d
        return api_response_time_window
