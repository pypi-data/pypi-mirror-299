...
T = TypeVar("T", bound="ModelAdDataQualityAggregation")


@_attrs_define
class ModelAdDataQualityAggregation:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        model_ad_data_quality_aggregation = cls(
            id=id,
        ...
        model_ad_data_quality_aggregation.additional_properties = d
        return model_ad_data_quality_aggregation
