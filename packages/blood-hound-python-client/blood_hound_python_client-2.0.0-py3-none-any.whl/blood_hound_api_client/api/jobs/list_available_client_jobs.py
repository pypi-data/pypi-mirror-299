...
from ...models.list_available_client_jobs_response_200 import ListAvailableClientJobsResponse200
...
) -> Optional[Union[Any, ListAvailableClientJobsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListAvailableClientJobsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ListAvailableClientJobsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ListAvailableClientJobsResponse200]
    """
