...
from ...models.get_client_jobs_response_200 import GetClientJobsResponse200
...
) -> Optional[Union[Any, GetClientJobsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetClientJobsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetClientJobsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetClientJobsResponse200]
    """
