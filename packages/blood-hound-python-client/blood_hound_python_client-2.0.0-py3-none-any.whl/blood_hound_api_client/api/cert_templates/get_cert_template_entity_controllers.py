...
from ...models.get_cert_template_entity_controllers_type import GetCertTemplateEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetCertTemplateEntityControllersType] = GetCertTemplateEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/certtemplates/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetCertTemplateEntityControllersType]):  Default:
            GetCertTemplateEntityControllersType.LIST.
