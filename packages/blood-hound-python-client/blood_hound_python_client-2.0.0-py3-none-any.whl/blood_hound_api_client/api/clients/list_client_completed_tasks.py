...
from ...models.list_client_completed_tasks_response_200 import ListClientCompletedTasksResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/clients/{client_id_path}/completed-tasks",
        "params": params,
    }
...
) -> Optional[Union[Any, ListClientCompletedTasksResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListClientCompletedTasksResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ListClientCompletedTasksResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ListClientCompletedTasksResponse200]
    """
