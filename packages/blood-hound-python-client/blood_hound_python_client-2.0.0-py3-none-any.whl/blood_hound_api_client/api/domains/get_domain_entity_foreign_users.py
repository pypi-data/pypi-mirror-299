...
from ...models.get_domain_entity_foreign_users_type import GetDomainEntityForeignUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityForeignUsersType] = GetDomainEntityForeignUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/foreign-users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityForeignUsersType]):  Default:
            GetDomainEntityForeignUsersType.LIST.
