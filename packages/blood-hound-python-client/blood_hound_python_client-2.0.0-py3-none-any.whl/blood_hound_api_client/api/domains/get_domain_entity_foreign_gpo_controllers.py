...
from ...models.get_domain_entity_foreign_gpo_controllers_type import GetDomainEntityForeignGpoControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityForeignGpoControllersType] = GetDomainEntityForeignGpoControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/foreign-gpo-controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityForeignGpoControllersType]):  Default:
            GetDomainEntityForeignGpoControllersType.LIST.
