...
from ...models.get_domain_entity_inbound_trusts_type import GetDomainEntityInboundTrustsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityInboundTrustsType] = GetDomainEntityInboundTrustsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/inbound-trusts",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityInboundTrustsType]):  Default:
            GetDomainEntityInboundTrustsType.LIST.
