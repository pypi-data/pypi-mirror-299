...
from ...models.get_domain_entity_linked_gpos_type import GetDomainEntityLinkedGposType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityLinkedGposType] = GetDomainEntityLinkedGposType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/linked-gpos",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityLinkedGposType]):  Default:
            GetDomainEntityLinkedGposType.LIST.
