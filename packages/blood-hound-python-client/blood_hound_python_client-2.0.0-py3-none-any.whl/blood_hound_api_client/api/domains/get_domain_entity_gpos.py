...
from ...models.get_domain_entity_gpos_type import GetDomainEntityGposType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityGposType] = GetDomainEntityGposType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/gpos",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityGposType]):  Default: GetDomainEntityGposType.LIST.
