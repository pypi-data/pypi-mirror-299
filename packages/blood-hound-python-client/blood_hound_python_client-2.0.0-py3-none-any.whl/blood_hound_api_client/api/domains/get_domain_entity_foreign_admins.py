...
from ...models.get_domain_entity_foreign_admins_type import GetDomainEntityForeignAdminsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityForeignAdminsType] = GetDomainEntityForeignAdminsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/foreign-admins",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityForeignAdminsType]):  Default:
            GetDomainEntityForeignAdminsType.LIST.
