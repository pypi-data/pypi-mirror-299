...
from ...models.get_domain_entity_dc_syncers_type import GetDomainEntityDcSyncersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityDcSyncersType] = GetDomainEntityDcSyncersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/dc-syncers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityDcSyncersType]):  Default:
            GetDomainEntityDcSyncersType.LIST.
