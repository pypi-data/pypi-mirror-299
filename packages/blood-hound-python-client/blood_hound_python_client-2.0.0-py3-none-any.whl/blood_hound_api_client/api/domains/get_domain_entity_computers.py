...
from ...models.get_domain_entity_computers_type import GetDomainEntityComputersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityComputersType] = GetDomainEntityComputersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/computers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityComputersType]):  Default:
            GetDomainEntityComputersType.LIST.
