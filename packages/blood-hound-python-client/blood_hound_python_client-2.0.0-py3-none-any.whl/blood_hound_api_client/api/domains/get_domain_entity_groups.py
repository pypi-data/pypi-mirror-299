...
from ...models.get_domain_entity_groups_type import GetDomainEntityGroupsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetDomainEntityGroupsType] = GetDomainEntityGroupsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/domains/{object_id}/groups",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetDomainEntityGroupsType]):  Default: GetDomainEntityGroupsType.LIST.
