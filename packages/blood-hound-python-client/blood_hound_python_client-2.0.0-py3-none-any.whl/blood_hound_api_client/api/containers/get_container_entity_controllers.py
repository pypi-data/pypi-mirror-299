...
from ...models.get_container_entity_controllers_type import GetContainerEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetContainerEntityControllersType] = GetContainerEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/containers/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetContainerEntityControllersType]):  Default:
            GetContainerEntityControllersType.LIST.
