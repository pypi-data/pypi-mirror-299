...
from ...models.get_computer_entity_sessions_type import GetComputerEntitySessionsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntitySessionsType] = GetComputerEntitySessionsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/sessions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntitySessionsType]):  Default:
            GetComputerEntitySessionsType.LIST.
