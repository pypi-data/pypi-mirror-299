...
from ...models.get_computer_entity_dcom_rights_type import GetComputerEntityDcomRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityDcomRightsType] = GetComputerEntityDcomRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/dcom-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityDcomRightsType]):  Default:
            GetComputerEntityDcomRightsType.LIST.
