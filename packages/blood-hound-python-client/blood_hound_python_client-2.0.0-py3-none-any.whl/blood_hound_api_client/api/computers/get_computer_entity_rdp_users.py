...
from ...models.get_computer_entity_rdp_users_type import GetComputerEntityRdpUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityRdpUsersType] = GetComputerEntityRdpUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/rdp-users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityRdpUsersType]):  Default:
            GetComputerEntityRdpUsersType.LIST.
