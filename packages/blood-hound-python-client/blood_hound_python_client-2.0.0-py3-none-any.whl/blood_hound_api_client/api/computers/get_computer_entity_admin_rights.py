...
from ...models.get_computer_entity_admin_rights_type import GetComputerEntityAdminRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityAdminRightsType] = GetComputerEntityAdminRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/admin-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityAdminRightsType]):  Default:
            GetComputerEntityAdminRightsType.LIST.
