...
from ...models.get_computer_entity_dcom_users_type import GetComputerEntityDcomUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityDcomUsersType] = GetComputerEntityDcomUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/dcom-users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityDcomUsersType]):  Default:
            GetComputerEntityDcomUsersType.LIST.
