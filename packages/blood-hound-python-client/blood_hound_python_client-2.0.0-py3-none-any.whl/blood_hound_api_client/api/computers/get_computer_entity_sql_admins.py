...
from ...models.get_computer_entity_sql_admins_type import GetComputerEntitySqlAdminsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntitySqlAdminsType] = GetComputerEntitySqlAdminsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/sql-admins",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntitySqlAdminsType]):  Default:
            GetComputerEntitySqlAdminsType.LIST.
