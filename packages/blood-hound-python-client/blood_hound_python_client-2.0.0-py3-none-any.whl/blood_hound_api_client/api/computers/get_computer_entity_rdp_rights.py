...
from ...models.get_computer_entity_rdp_rights_type import GetComputerEntityRdpRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityRdpRightsType] = GetComputerEntityRdpRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/rdp-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityRdpRightsType]):  Default:
            GetComputerEntityRdpRightsType.LIST.
