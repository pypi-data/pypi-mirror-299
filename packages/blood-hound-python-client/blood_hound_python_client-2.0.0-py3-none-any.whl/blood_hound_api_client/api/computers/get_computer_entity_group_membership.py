...
from ...models.get_computer_entity_group_membership_type import GetComputerEntityGroupMembershipType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetComputerEntityGroupMembershipType] = GetComputerEntityGroupMembershipType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/computers/{object_id}/group-membership",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetComputerEntityGroupMembershipType]):  Default:
            GetComputerEntityGroupMembershipType.LIST.
