...
from ...models.get_group_entity_ps_remote_rights_type import GetGroupEntityPsRemoteRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityPsRemoteRightsType] = GetGroupEntityPsRemoteRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/ps-remote-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityPsRemoteRightsType]):  Default:
            GetGroupEntityPsRemoteRightsType.LIST.
