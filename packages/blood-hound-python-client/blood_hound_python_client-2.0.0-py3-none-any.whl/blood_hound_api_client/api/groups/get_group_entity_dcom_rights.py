...
from ...models.get_group_entity_dcom_rights_type import GetGroupEntityDcomRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityDcomRightsType] = GetGroupEntityDcomRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/dcom-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityDcomRightsType]):  Default:
            GetGroupEntityDcomRightsType.LIST.
