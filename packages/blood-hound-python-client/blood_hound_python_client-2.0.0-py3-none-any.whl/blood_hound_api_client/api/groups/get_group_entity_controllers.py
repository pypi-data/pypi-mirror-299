...
from ...models.get_group_entity_controllers_type import GetGroupEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityControllersType] = GetGroupEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityControllersType]):  Default:
            GetGroupEntityControllersType.LIST.
