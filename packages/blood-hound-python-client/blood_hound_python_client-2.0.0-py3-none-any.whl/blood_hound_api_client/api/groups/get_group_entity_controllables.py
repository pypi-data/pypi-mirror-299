...
from ...models.get_group_entity_controllables_type import GetGroupEntityControllablesType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntityControllablesType] = GetGroupEntityControllablesType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/controllables",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntityControllablesType]):  Default:
            GetGroupEntityControllablesType.LIST.
