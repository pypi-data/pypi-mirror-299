...
from ...models.get_group_entity_sessions_type import GetGroupEntitySessionsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGroupEntitySessionsType] = GetGroupEntitySessionsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/groups/{object_id}/sessions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGroupEntitySessionsType]):  Default:
            GetGroupEntitySessionsType.LIST.
