...
from ...models.get_user_entity_membership_type import GetUserEntityMembershipType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityMembershipType] = GetUserEntityMembershipType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/memberships",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityMembershipType]):  Default:
            GetUserEntityMembershipType.LIST.
