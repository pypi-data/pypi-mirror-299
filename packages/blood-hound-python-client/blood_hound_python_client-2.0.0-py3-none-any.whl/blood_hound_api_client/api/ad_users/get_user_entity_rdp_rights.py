...
from ...models.get_user_entity_rdp_rights_type import GetUserEntityRdpRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityRdpRightsType] = GetUserEntityRdpRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/rdp-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityRdpRightsType]):  Default:
            GetUserEntityRdpRightsType.LIST.
