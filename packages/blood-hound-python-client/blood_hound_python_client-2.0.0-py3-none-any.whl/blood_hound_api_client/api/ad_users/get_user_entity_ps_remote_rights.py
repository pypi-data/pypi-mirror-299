...
from ...models.get_user_entity_ps_remote_rights_type import GetUserEntityPsRemoteRightsType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityPsRemoteRightsType] = GetUserEntityPsRemoteRightsType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/ps-remote-rights",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityPsRemoteRightsType]):  Default:
            GetUserEntityPsRemoteRightsType.LIST.
