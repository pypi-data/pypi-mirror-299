...
from ...models.get_user_entity_controllers_type import GetUserEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetUserEntityControllersType] = GetUserEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/users/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetUserEntityControllersType]):  Default:
            GetUserEntityControllersType.LIST.
