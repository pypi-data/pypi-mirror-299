...
from ...models.get_root_ca_entity_controllers_type import GetRootCaEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetRootCaEntityControllersType] = GetRootCaEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/rootcas/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetRootCaEntityControllersType]):  Default:
            GetRootCaEntityControllersType.LIST.
