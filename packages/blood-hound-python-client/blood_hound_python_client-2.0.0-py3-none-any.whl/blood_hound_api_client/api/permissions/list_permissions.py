...
from ...models.list_permissions_response_200 import ListPermissionsResponse200
...
) -> Optional[Union[Any, ListPermissionsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ListPermissionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ListPermissionsResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        authority (Union[Unset, str]): Filter results by column string value. Valid filter
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ListPermissionsResponse200]
    """
