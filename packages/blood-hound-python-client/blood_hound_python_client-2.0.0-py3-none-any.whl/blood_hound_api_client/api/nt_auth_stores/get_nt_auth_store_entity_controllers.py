...
from ...models.get_nt_auth_store_entity_controllers_type import GetNtAuthStoreEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetNtAuthStoreEntityControllersType] = GetNtAuthStoreEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/ntauthstores/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetNtAuthStoreEntityControllersType]):  Default:
            GetNtAuthStoreEntityControllersType.LIST.
