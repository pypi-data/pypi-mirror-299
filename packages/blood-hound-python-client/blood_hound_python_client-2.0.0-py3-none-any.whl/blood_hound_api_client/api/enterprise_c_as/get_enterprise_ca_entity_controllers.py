...
from ...models.get_enterprise_ca_entity_controllers_type import GetEnterpriseCaEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetEnterpriseCaEntityControllersType] = GetEnterpriseCaEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/enterprisecas/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetEnterpriseCaEntityControllersType]):  Default:
            GetEnterpriseCaEntityControllersType.LIST.
