...
from ...models.get_gpo_entity_controllers_type import GetGpoEntityControllersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGpoEntityControllersType] = GetGpoEntityControllersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/gpos/{object_id}/controllers",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGpoEntityControllersType]):  Default:
            GetGpoEntityControllersType.LIST.
