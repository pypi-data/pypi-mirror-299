...
from ...models.get_gpo_entity_users_type import GetGpoEntityUsersType
...
def _get_kwargs(
    ...
    *,
    ...
    type: Union[Unset, GetGpoEntityUsersType] = GetGpoEntityUsersType.LIST,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/api/v2/gpos/{object_id}/users",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type (Union[Unset, GetGpoEntityUsersType]):  Default: GetGpoEntityUsersType.LIST.
