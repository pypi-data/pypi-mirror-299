...
setup(
    ...
    url='https://github.com/cedricmoorejr/quantsumore/tree/v1.3.2b1',
    project_urls={
        'Source Code': 'https://github.com/cedricmoorejr/quantsumore/releases/tag/v1.3.2-beta.1',
    },
    # packages=find_packages(include=['quantsumore.configuration', 'quantsumore.gui.assets']),
    # packages=find_packages(include=['quantsumore', 'quantsumore.*']),
