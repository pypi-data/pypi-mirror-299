...
def fps_conversion_test_case(test_obj, filename, fps, expected_frames, red_shift, green_shift):
    ...
    while True:
        ...
        print(f'idx: {frame_idx} got', frame_color, f'expected: [.., {expected_green}, {expected_red}]')
        test_obj.assertTrue(
...
class TestPyAvReader(unittest.TestCase):
    ...
    def test_video_reader_VFR(self):
        ...
        for fps, expected_frames in test_cases:
            with self.subTest((fps, expected_frames)):
                fps_conversion_test_case(self, filename, fps, expected_frames, red_shift, green_shift)
