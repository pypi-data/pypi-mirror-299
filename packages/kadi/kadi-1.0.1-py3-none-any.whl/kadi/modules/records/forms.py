...
class NewRecordForm(BaseRecordForm):
    ...
    :param import_data: (optional) See :class:`BaseRecordForm`.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            *args, import_data=import_data, record=record, template=template, **kwargs
        )
...
class UploadChunkForm(BaseForm):
