...
def validate_iri(value):
    """Validate an IRI reference according to RFC3987.

    :param value: The IRI reference string.
    :raises KadiValidationError: If the validation fails.
    """

    # IRI references are technically a bit more lax than actual (absolute) IRIs, but we
    # mostly care about avoiding invalid characters.
