...
class InventoryResource(RestAdaptor):
    ...
    def _get_endpoint(self,df:pd.DataFrame) -> pd.DataFrame:
        ...
        events_endpoint = ('CCTV','acms','vms','ai-camera','pms','smart_box','Robot')
    ...
    def get_devices_list(self, with_fragment:bool=False, query:str="has(c8y_Availability)" ) -> pd.DataFrame:
        """
