...
def organizations_tube_in_the_cube (responses: text, study: str, output_dir : str):
    ################################
    ...
    tube_in_the_tube_query = """select distinct ?answerset ?person ?domain ?zone ?layer where {{
        ...
        ?answerset prov:wasQuotedFrom/prov:actedOnBehalfOf/ema:areaOfOperation/ema:inDomain ?domain .
        ?answerset prov:wasQuotedFrom/prov:actedOnBehalfOf/ema:areaOfOperation/ema:inZone ?zone .
        ?answerset prov:wasQuotedFrom/prov:actedOnBehalfOf/ema:areaOfOperation/ema:onLayer ?layer .
