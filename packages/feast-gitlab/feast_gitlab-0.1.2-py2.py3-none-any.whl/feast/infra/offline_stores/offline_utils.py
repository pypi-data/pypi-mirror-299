...
class FeatureViewQueryContext:
    ...
    is_template_table: bool = False # GITLAB CHANGES
...
def get_feature_view_query_context(
    ...
    for feature_view, features in feature_views_to_feature_map.items():
        ...
        if 'USE_TEMPLATE_WORKFLOW' in table_subquery:
            is_template_table = True
            print('Using template table workflow')
        else:
            is_template_table = False
        ...
        context = FeatureViewQueryContext(
            ...
            table_subquery=feature_view.batch_source.get_table_query_string(),
            is_template_table=is_template_table, # GITLAB CHANGES
...
def build_point_in_time_query(
    ...
    final_output_feature_names = list() # Gitlab changes
    entity_df_columns = list(entity_df_columns) # Gitlab changes
    ...
    template_context = {
        ...
        "entity_df_columns": entity_df_columns # Gitlab changes
    }
