...
setup(
    ...
    install_requires=['pandas==2.1.1', 'uvicorn', 'numpy==1.26.0', 'requests', 'pip_audit==2.7.3', 'stdlib-list', 'pyyaml', 'click==8.1.7', 'packaging', 'nbconvert==7.16.4', 'fastapi', 'attrs>=22.2.0', 'nbformat', 'mkdocs==1.6.0'],
