...
setup(
    ...
    install_requires=['attrs>=22.2.0', 'stdlib-list', 'mkdocs==1.6.0', 'nbconvert==7.16.4', 'requests', 'pip_audit==2.7.3', 'pyyaml', 'packaging', 'click==8.1.7', 'nbformat', 'fastapi', 'uvicorn', 'pandas==2.1.1', 'numpy==1.26.0'],
