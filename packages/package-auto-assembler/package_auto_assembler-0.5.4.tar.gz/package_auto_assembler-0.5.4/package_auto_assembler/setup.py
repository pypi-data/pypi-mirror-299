...
setup(
    ...
    install_requires=['pandas==2.1.1', 'attrs>=22.2.0', 'nbformat', 'mkdocs==1.6.0', 'nbconvert==7.16.4', 'pip_audit==2.7.3', 'click==8.1.7', 'fastapi', 'stdlib-list', 'uvicorn', 'pyyaml', 'numpy==1.26.0', 'requests', 'packaging'],
