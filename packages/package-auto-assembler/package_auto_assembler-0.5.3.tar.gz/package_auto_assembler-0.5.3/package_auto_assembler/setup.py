...
setup(
    ...
    install_requires=['pandas==2.1.1', 'pip_audit==2.7.3', 'mkdocs==1.6.0', 'click==8.1.7', 'numpy==1.26.0', 'attrs>=22.2.0', 'fastapi', 'pyyaml', 'requests', 'packaging', 'uvicorn', 'nbconvert==7.16.4', 'stdlib-list', 'nbformat'],
