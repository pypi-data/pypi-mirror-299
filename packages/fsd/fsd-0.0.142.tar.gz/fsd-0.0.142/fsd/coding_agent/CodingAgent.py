...
class CodingAgent:
    ...
    async def get_coding_request(self, is_first, file, techStack, crawl_logs, prompt):
        ...
        user_prompt = (
            ...
            "Provide complete, production-ready code with full logic and integration.\n"
            "Implement an elegant, professional UI with modern design principles.\n"
            "Ensure responsive layouts, intuitive user interactions, and consistent styling.\n"
            "Incorporate accessibility features and optimize for performance.\n"
