...
class FormattingAgent:
    ...
    def read_file_content(self, file_path):
        ...
        if not os.path.exists(file_path):
            logger.info(f"FormattingAgent: File does not exist: {file_path}")
            return ""
        ...
        for encoding in encodings:
            try:
                ...
                logger.info(f"FormattingAgent: Failed to read file {file_path} with {encoding} encoding: {e}")
        ...
        try:
            ...
            logger.info(f"FormattingAgent: Failed to read file {file_path} in binary mode: {e}")
    ...
    async def get_format(self, file):
        ...
        if file_content:
            ...
            try:
                ...
                logger.info(f"FormattingAgent: Failed: {e}")
                return {
                    "reason": str(e)
                }
    ...
    async def replace_all_code_in_file(self, file_path, result):
        ...
        if file_path:
            ...
            logger.warning(f"FormattingAgent: File not found: {file_path}")
    ...
    async def get_formats(self, files, prompt, role):
        ...
        for file in file_paths:
            ...
            if result:
                ...
                logger.info(f"FormattingAgent: Completed formatting for: {file}")
