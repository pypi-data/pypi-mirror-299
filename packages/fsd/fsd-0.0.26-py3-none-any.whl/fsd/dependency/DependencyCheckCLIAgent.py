...
class DependencyCheckCLIAgent:
    ...
    def read_file_content(self, file_path):
        ...
        if not os.path.exists(file_path):
            logger.info(f"DependencyCheckCLIAgent: File does not exist: {file_path}")
            return ""
        ...
        for encoding in encodings:
            try:
                ...
                logger.info(f"DependencyCheckCLIAgent: Failed to read file {file_path} with {encoding} encoding: {e}")
        ...
        try:
            ...
            logger.info(f"DependencyCheckCLIAgent: Failed to read file {file_path} in binary mode: {e}")
