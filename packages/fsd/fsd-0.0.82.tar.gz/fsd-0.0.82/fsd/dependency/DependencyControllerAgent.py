...
class DependencyControllerAgent:
    ...
    async def start_dependency_installation_process(self, instruction):
        logger.info("\n #### It looks like you need to install those dependencies")
        ...
        if user_prompt != "a":
            ...
            while True:
                logger.info("\n #### The `Dependency Agent` is requesting feedback ")
                logger.info("Are you satisfied with this plan? Enter \"yes\" if satisfied, or provide feedback for modifications: ")
                ...
                if user_prompt == "" or user_prompt == "yes" or user_prompt == "y":
                    ...
                    logger.info("\n #### The `Dependency Agent` is updating the plan based on feedback")
            ...
            logger.info("\n #### The `Dependency Agent` is preparing to execute the finalized plan")
