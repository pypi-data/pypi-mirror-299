...
class DependencyProjectAnalysForCodingAgent:
    ...
    def initial_setup(self, dependency_files, OS_architecture):
        ...
        system_prompt = (
            ...
            "If you need to generate a new configuration file like package.json, in the very last step, make sure you configure it to make it able to run the project as easily as possible after the coding step."
        )
