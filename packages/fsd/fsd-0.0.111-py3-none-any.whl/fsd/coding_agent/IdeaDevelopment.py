...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"Use clear headings to organize your response. For all markdown, never use heading levels larger than h4 (####). "
            f"If you provide a tree structure, use a code block markdown for it. "
