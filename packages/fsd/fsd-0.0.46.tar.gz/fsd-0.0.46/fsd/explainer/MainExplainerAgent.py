        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Return a nicely formatted response. Spacing between each section clearly, ensure the text is clear and easy to read, not crowded together.\n"
                    "- No weird symbols, uncessary text, or other distractions or patterns\n"
