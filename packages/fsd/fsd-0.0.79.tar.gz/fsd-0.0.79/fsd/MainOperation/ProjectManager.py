...
class ProjectManager:
    ...
    async def create_and_add_file_to_xcodeproj(self, full_path: str) -> Optional[str]:
        ...
        logger.info(f"\n The `File Manager Agent` added file '{file_name}' to Xcode project.")
        return full_path
    ...
    async def create_file_or_folder(self, full_path: str) -> Optional[str]:
        ...
        logger.info(f"\n The `File Manager Agent` successfully created file '{os.path.basename(full_path)}'.")
        return full_path
    ...
    async def move_file_within_xcodeproj(self, old_full_path: str, new_full_path: str) -> Optional[str]:
        ...
        logger.info(f"\n The `File Manager Agent` moved file '{os.path.basename(old_full_path)}' in Xcode project.")
    ...
    async def move_file(self, old_full_path: str, new_full_path: str) -> Optional[str]:
        ...
        self._move_file(old_full_path, new_full_path)
        logger.info(f"\n The `File Manager Agent` moved file '{os.path.basename(old_full_path)}'.")
        return new_full_path
