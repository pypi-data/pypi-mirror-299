...
class CodingAgent:
    ...
    async def get_coding_request(self, is_first, file, techStack, crawl_logs, prompt):
        ...
        lazy_prompt = """You are diligent and tireless!
            ...
            """
        user_prompt = (
            f"{'Use the provided data above to complete the task' if crawl_logs else ''}:\n"
            ...
            "For UI tasks, ensure elegant, well-designed layouts with appropriate spacing like an EXPERT.\n"
