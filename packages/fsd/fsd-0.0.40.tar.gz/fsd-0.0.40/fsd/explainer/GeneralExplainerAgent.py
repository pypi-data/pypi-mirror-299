    ...
    async def get_normal_answer_plan(self, user_prompt, language):
        ...
        messages = [
            ...
            },
            {
                ...
                "content": (
                    f"User prompt:\n{user_prompt}\n\n"
                    f"Return a nicely formatted response. Separate each section clearly, ensure the text is clear and easy to read, not crowded together. Use a proper markdown format if needed only, be careful of spacing as well.\n"
