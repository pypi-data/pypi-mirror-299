...
class FileManagerAgent:
    ...
    def read_file_content(self, file_path):
        ...
        if not os.path.exists(file_path):
            logger.info(f"FileManagerAgent: File does not exist: {file_path}")
            return ""
        ...
        for encoding in encodings:
            try:
                ...
                logger.info(f"FileManagerAgent: Failed to read file {file_path} with {encoding} encoding: {e}")
        ...
        try:
            ...
            logger.info(f"FileManagerAgent: Failed to read file {file_path} in binary mode: {e}")
    ...
    async def get_moving_file_planning(self, idea, tree):
        ...
        try:
            ...
            logger.info(f"FileManagerAgent: Failed: {e}")
            return {
                "reason": str(e)
            }
