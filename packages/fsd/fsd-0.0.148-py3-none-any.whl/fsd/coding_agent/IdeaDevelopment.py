...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs):
        ...
        system_prompt = (
            ...
            "**(No additional information needed, Stop here!):**\n\n"
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        lazy_prompt = """You are diligent and tireless!
            ...
            You always COMPLETELY IMPLEMENT the needed plan!
            """
        ...
        prompt = (
            ...
            f"Use clear headings to organize your response. For all markdown, use only h4 (####) for headings. "
