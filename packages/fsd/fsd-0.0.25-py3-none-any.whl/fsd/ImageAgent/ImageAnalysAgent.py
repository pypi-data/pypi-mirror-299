...
class ImageAnalysAgent:
    ...
    def read_file_content(self, file_path):
        ...
        if not os.path.exists(file_path):
            logger.info(f"ImageAnalysAgent: File does not exist: {file_path}")
            return ""
        ...
        for encoding in encodings:
            try:
                ...
                logger.info(f"ImageAnalysAgent: Failed to read file {file_path} with {encoding} encoding: {e}")
        ...
        try:
            ...
            logger.info(f"ImageAnalysAgent: Failed to read file {file_path} in binary mode: {e}")
    ...
    async def get_idea_plan(self, user_prompt):
        ...
        try:
            ...
            logger.info(f"ImageAnalysAgent: Failed: {e}")
            return {
                "reason": str(e)
            }
