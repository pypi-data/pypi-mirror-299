...
class FirstPromptAgent:
    ...
    async def get_prePrompt_plans(self, user_prompt):
        ...
        """
        try:
            logger.info("\n ### The `FirstPromptAgent` is initiating the pre-prompt planning process")
    ...
    def _parse_response(self, response):
        ...
        try:
            ...
            logger.warning("\n ### The `FirstPromptAgent` encountered a JSON decoding error and is attempting to repair the JSON")
