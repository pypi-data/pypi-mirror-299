...
class CodingAgent:
    ...
    def initial_setup(self, context_files, instructions, context, role):
        ...
        additional_guideline = """
            **Code Guidelines:**
            ...
            9. Use design patterns appropriately to solve common software design problems.
            10. Implement proper authentication and authorization mechanisms.
            11. Follow SOLID principles to create more maintainable and scalable code.
            12. Use asynchronous programming techniques where appropriate to improve performance.
            13. Implement proper security measures, including input validation and sanitization.
            14. Optimize code for performance, considering time and space complexity.
            15. Write self-documenting code with meaningful variable and function names.
        """
    ...
    async def get_coding_request(self, is_first, file, techStack, crawl_logs, prompt):
        ...
        user_prompt = (
            ...
            "Follow instructions strictly to achieve the ultimate goal.\n"
