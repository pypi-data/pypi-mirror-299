...
class CompileProjectAnalysAgent:
    ...
    def initial_setup(self, dependency_files, OS_architecture):
        ...
        system_prompt = (
            "You are a senior DevOps engineer. Analyze the project structure and develop a concise plan for setting up and compiling the project for local development using CLI commands. Follow these guidelines:\n\n"
