        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    f"Return a nicely formatted markdown for necessary explanation only, don't make it too big or overkill. Separate each section clearly, ensure the text is clear and easy to read, not crowded together. Use a proper markdown format for tree views if needed, be careful of spacing as well.\n"
