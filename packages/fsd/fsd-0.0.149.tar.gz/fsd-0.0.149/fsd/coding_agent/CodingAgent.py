...
class CodingAgent:
    ...
    async def get_coding_request(self, is_first, file, techStack, crawl_logs, prompt):
        ...
        user_prompt = (
            ...
            f"{'Commence' if is_first else 'Proceed with'} implementing the following task on {file_info} with expert-level proficiency:\n"
            ...
            "Your responses MUST ONLY contain SEARCH/REPLACE blocks for code changes. Absolutely no other content is permitted.\n"
