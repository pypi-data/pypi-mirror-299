...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt):
        ...
        prompt = (
            ...
            f"Return a nicely formatted response. Separate each section clearly, ensure the text is clear and easy to read, not crowded together. Use clear headings (no larger than h4)."
