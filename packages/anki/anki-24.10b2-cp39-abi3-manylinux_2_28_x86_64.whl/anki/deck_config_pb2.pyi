...
class DeckConfigId(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dcid", b"dcid"]) -> None: ...
...
class DeckConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["config", b"config", "id", b"id", "mtime_secs", b"mtime_secs", "name", b"name", "usn", b"usn"]) -> None: ...
...
class DeckConfigsForUpdate(google.protobuf.message.Message):
    ...
    class ConfigWithExtra(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["config", b"config"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["config", b"config", "use_count", b"use_count"]) -> None: ...
    ...
    class CurrentDeck(google.protobuf.message.Message):
        ...
        class Limits(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["_new", b"_new", "_new_today", b"_new_today", "_review", b"_review", "_review_today", b"_review_today", "new", b"new", "new_today", b"new_today", "review", b"review", "review_today", b"review_today"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["_new", b"_new", "_new_today", b"_new_today", "_review", b"_review", "_review_today", b"_review_today", "new", b"new", "new_today", b"new_today", "new_today_active", b"new_today_active", "review", b"review", "review_today", b"review_today", "review_today_active", b"review_today_active"]) -> None: ...
            @typing.overload
            def WhichOneof(self, oneof_group: typing.Literal["_new", b"_new"]) -> typing.Literal["new"] | None: ...
            @typing.overload
            def WhichOneof(self, oneof_group: typing.Literal["_new_today", b"_new_today"]) -> typing.Literal["new_today"] | None: ...
            @typing.overload
            def WhichOneof(self, oneof_group: typing.Literal["_review", b"_review"]) -> typing.Literal["review"] | None: ...
            @typing.overload
            def WhichOneof(self, oneof_group: typing.Literal["_review_today", b"_review_today"]) -> typing.Literal["review_today"] | None: ...
        ...
        def ClearField(self, field_name: typing.Literal["config_id", b"config_id", "limits", b"limits", "name", b"name", "parent_config_ids", b"parent_config_ids"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["current_deck", b"current_deck", "defaults", b"defaults"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["all_config", b"all_config", "apply_all_parent_limits", b"apply_all_parent_limits", "card_state_customizer", b"card_state_customizer", "current_deck", b"current_deck", "days_since_last_fsrs_optimize", b"days_since_last_fsrs_optimize", "defaults", b"defaults", "fsrs", b"fsrs", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "schema_modified", b"schema_modified"]) -> None: ...
...
class UpdateDeckConfigsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["limits", b"limits"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["apply_all_parent_limits", b"apply_all_parent_limits", "card_state_customizer", b"card_state_customizer", "configs", b"configs", "fsrs", b"fsrs", "fsrs_reschedule", b"fsrs_reschedule", "limits", b"limits", "mode", b"mode", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "removed_config_ids", b"removed_config_ids", "target_deck_id", b"target_deck_id"]) -> None: ...
