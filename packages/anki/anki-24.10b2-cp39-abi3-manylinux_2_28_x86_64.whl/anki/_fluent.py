...
class GeneratedTranslations:
    ...
    def actions_options_for(self, val: FluentVariable) -> str:
        r''' Options for {$val} '''
        return self._translate(1, 45, {"val": val})
    ...
    def actions_shortcut_key(self, val: FluentVariable) -> str:
        r''' Shortcut key: {$val} '''
        return self._translate(1, 62, {"val": val})
    ...
    def actions_with_ellipsis(self, action: str) -> str:
        r''' {$action}... '''
        return self._translate(1, 71, {"action": action})
...
message from appearing. '''
    ...
    def card_stats_previous_card(self, context: str) -> str:
        ...
        return self._translate(5, 25, {"context": context})
...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_complete(self, num: FluentVariable) -> str:
        r''' {$num}% complete. '''
        return self._translate(11, 28, {"num": num})
...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 39, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 42, {"cards": cards})
...
Markdown will appear as text on Anki 2.1.40 and below. '''
    ...
    def deck_config_desired_retention_tooltip(self, ) -> str:
        r''' The default value of 0.9 schedules cards so that you have a 90% chance of remembering them when
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 91, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 117, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        ...
        return self._translate(11, 119, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 121, {"num": num})


    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Minimum recommended retention: {$num} '''
        return self._translate(11, 122, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 142, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 181, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 182, {"decks": decks})
...
you proceed. '''
    ...
    def editing_mathjax_placeholder(self, accept: str, newline: str) -> str:
        ...
        return self._translate(13, 71, {"accept": accept, "newline": newline})
...
{$link} '''
    ...
    def qt_misc_second(self, count: int) -> str:
        r''' {$count} seconds '''
        return self._translate(29, 47, {"count": count})
    ...
    def qt_misc_the_following_character_can_not_be(self, val: FluentVariable) -> str:
        ...
        return self._translate(29, 56, {"val": val})
...
Please select  before proceeding. '''
    ...
    def statistics_in_days_range(self, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 65, {"daysStart": days_start, "daysEnd": days_end})


    def statistics_in_days_single(self, days: int) -> str:
        r''' In {$days} days '''
        return self._translate(32, 66, {"days": days})
    ...
    def statistics_intervals_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 73, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_intervals_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day interval '''
        return self._translate(32, 74, {"cards": cards, "day": day})
    ...
    def statistics_retrievability_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 86, {"cards": cards, "percent": percent})


    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(32, 87, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(32, 89, {"count": count})
    ...
    def statistics_stability_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 96, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_stability_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day stability '''
        return self._translate(32, 97, {"cards": cards, "day": day})
...
({$secs-per-card}s/card) '''
        return self._translate(32, 99, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 102, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 106, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})


    def statistics_total(self, ) -> str:
        r''' Total '''
        return self._translate(32, 107, {})
...
class LegacyTranslationEnum:
    ...
    ACTIONS_HELP = (1, 35)
    ACTIONS_IMPORT = (1, 36)
    ACTIONS_INCREMENT_VALUE = (1, 37)
    ACTIONS_MANAGE = (1, 38)
    ACTIONS_NAME = (1, 39)
    ACTIONS_NEW = (1, 40)
    ACTIONS_NEW_NAME = (1, 41)
    ACTIONS_NOTHING_TO_REDO = (1, 42)
    ACTIONS_NOTHING_TO_UNDO = (1, 43)
    ACTIONS_OPTIONS = (1, 44)
    ACTIONS_OPTIONS_FOR = (1, 45)
    ACTIONS_PREVIEW = (1, 46)
    ACTIONS_PREVIOUS_CARD_INFO = (1, 47)
    ACTIONS_REBUILD = (1, 48)
    ACTIONS_REMOVE_NOTETYPE = (1, 49)
    ACTIONS_REMOVE_TAG = (1, 50)
    ACTIONS_RENAME = (1, 51)
    ACTIONS_RENAME_DECK = (1, 52)
    ACTIONS_RENAME_TAG = (1, 53)
    ACTIONS_RENAME_WITH_PARENTS = (1, 54)
    ACTIONS_REPLAY_AUDIO = (1, 55)
    ACTIONS_REPOSITION = (1, 56)
    ACTIONS_SAVE = (1, 57)
    ACTIONS_SEARCH = (1, 58)
    ACTIONS_SELECT = (1, 59)
    ACTIONS_SET_DUE_DATE = (1, 60)
    ACTIONS_SET_FLAG = (1, 61)
    ACTIONS_SHORTCUT_KEY = (1, 62)
    ACTIONS_SUSPEND_CARD = (1, 63)
    ACTIONS_UNBURY_UNSUSPEND = (1, 64)
    ACTIONS_UPDATE_CARD = (1, 65)
    ACTIONS_UPDATE_CONFIG = (1, 66)
    ACTIONS_UPDATE_DECK = (1, 67)
    ACTIONS_UPDATE_NOTE = (1, 68)
    ACTIONS_UPDATE_NOTETYPE = (1, 69)
    ACTIONS_UPDATE_TAG = (1, 70)
    ACTIONS_WITH_ELLIPSIS = (1, 71)
    ...
    CARD_STATS_FSRS_FORGETTING_CURVE_FIRST_MONTH = (5, 11)
    CARD_STATS_FSRS_FORGETTING_CURVE_FIRST_WEEK = (5, 12)
    CARD_STATS_FSRS_FORGETTING_CURVE_FIRST_YEAR = (5, 13)
    CARD_STATS_FSRS_FORGETTING_CURVE_TITLE = (5, 14)
    CARD_STATS_FSRS_RETRIEVABILITY = (5, 15)
    CARD_STATS_FSRS_STABILITY = (5, 16)
    CARD_STATS_INTERVAL = (5, 17)
    CARD_STATS_LAPSE_COUNT = (5, 18)
    CARD_STATS_LATEST_REVIEW = (5, 19)
    CARD_STATS_NEW_CARD_POSITION = (5, 20)
    CARD_STATS_NO_CARD = (5, 21)
    CARD_STATS_NOTE_ID = (5, 22)
    CARD_STATS_NOTE_TYPE = (5, 23)
    CARD_STATS_PRESET = (5, 24)
    CARD_STATS_PREVIOUS_CARD = (5, 25)
    CARD_STATS_REVIEW_COUNT = (5, 26)
    CARD_STATS_REVIEW_LOG_DATE = (5, 27)
    CARD_STATS_REVIEW_LOG_ELAPSED_TIME = (5, 28)
    CARD_STATS_REVIEW_LOG_RATING = (5, 29)
    CARD_STATS_REVIEW_LOG_TIME_TAKEN = (5, 30)
    CARD_STATS_REVIEW_LOG_TYPE = (5, 31)
    CARD_STATS_REVIEW_LOG_TYPE_FILTERED = (5, 32)
    CARD_STATS_REVIEW_LOG_TYPE_LEARN = (5, 33)
    CARD_STATS_REVIEW_LOG_TYPE_MANUAL = (5, 34)
    CARD_STATS_REVIEW_LOG_TYPE_RELEARN = (5, 35)
    CARD_STATS_REVIEW_LOG_TYPE_REVIEW = (5, 36)
    CARD_STATS_TOTAL_TIME = (5, 37)
    ...
    DECK_CONFIG_ANSWER_ACTION_TOOLTIP_2 = (11, 7)
    DECK_CONFIG_ANSWER_AGAIN = (11, 8)
    DECK_CONFIG_ANSWER_GOOD = (11, 9)
    DECK_CONFIG_ANSWER_HARD = (11, 10)
    DECK_CONFIG_APPLY_ALL_PARENT_LIMITS = (11, 11)
    DECK_CONFIG_APPLY_ALL_PARENT_LIMITS_TOOLTIP = (11, 12)
    DECK_CONFIG_AUDIO_TITLE = (11, 13)
    DECK_CONFIG_BURY_IF_NEW = (11, 14)
    DECK_CONFIG_BURY_IF_NEW_OR_REVIEW = (11, 15)
    DECK_CONFIG_BURY_IF_NEW_REVIEW_OR_INTERDAY = (11, 16)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 17)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_TOOLTIP = (11, 18)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 19)
    DECK_CONFIG_BURY_NEW_TOOLTIP = (11, 20)
    DECK_CONFIG_BURY_PRIORITY_TOOLTIP = (11, 21)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 22)
    DECK_CONFIG_BURY_REVIEW_TOOLTIP = (11, 23)
    DECK_CONFIG_BURY_SIBLINGS = (11, 24)
    DECK_CONFIG_BURY_TITLE = (11, 25)
    DECK_CONFIG_BURY_TOOLTIP = (11, 26)
    DECK_CONFIG_CLONE_GROUP = (11, 27)
    DECK_CONFIG_COMPLETE = (11, 28)
    DECK_CONFIG_COMPUTE_BUTTON = (11, 29)
    DECK_CONFIG_COMPUTE_MINIMUM_RECOMMENDED_RETENTION = (11, 30)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION = (11, 31)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP = (11, 32)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP2 = (11, 33)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP3 = (11, 34)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP4 = (11, 35)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 36)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 37)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP2 = (11, 38)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 39)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 40)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 41)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 42)
    DECK_CONFIG_DAILY_LIMITS = (11, 43)
    DECK_CONFIG_DAYS_TO_SIMULATE = (11, 44)
    DECK_CONFIG_DECK_ONLY = (11, 45)
    DECK_CONFIG_DEFAULT_NAME = (11, 46)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 47)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 48)
    DECK_CONFIG_DESIRED_RETENTION = (11, 49)
    DECK_CONFIG_DESIRED_RETENTION_BELOW_OPTIMAL = (11, 50)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 51)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 52)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 53)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 54)
    DECK_CONFIG_DO_NOT_BURY = (11, 55)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 56)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 57)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 58)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 59)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 60)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 61)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 62)
    DECK_CONFIG_GET_PARAMS = (11, 63)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 64)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 65)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 66)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 67)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 68)
    DECK_CONFIG_IGNORE_BEFORE = (11, 69)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 70)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP_2 = (11, 71)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 72)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 73)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 74)
    DECK_CONFIG_INVALID_PARAMETERS = (11, 75)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 76)
    DECK_CONFIG_ITERATIONS = (11, 77)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 78)
    DECK_CONFIG_LEARNING_STEPS = (11, 79)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 80)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 81)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 82)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 83)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 84)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 85)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 86)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 87)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 88)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 89)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 90)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 91)
    DECK_CONFIG_NAME_PROMPT = (11, 92)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 93)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 94)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 95)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 96)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 97)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 98)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 99)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 100)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 101)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 102)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 103)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 104)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 105)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 106)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 107)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 108)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 109)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 110)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 111)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 112)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 113)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 114)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 115)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 116)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 117)
    DECK_CONFIG_ORDERING_TITLE = (11, 118)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 119)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 120)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 121)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 122)
    DECK_CONFIG_QUESTION_ACTION = (11, 123)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 124)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 125)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 126)
    DECK_CONFIG_RELEARNING_STEPS = (11, 127)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 128)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 129)
    DECK_CONFIG_REMOVE_GROUP = (11, 130)
    DECK_CONFIG_RENAME_GROUP = (11, 131)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 132)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 133)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 134)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 135)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 136)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 137)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 138)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 139)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 140)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 141)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 142)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 143)
    DECK_CONFIG_SAVE_BUTTON = (11, 144)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 145)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 146)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 147)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 148)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 149)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 150)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 151)
    DECK_CONFIG_SHARED_PRESET = (11, 152)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 153)
    DECK_CONFIG_SHOW_REMINDER = (11, 154)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 155)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 156)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 157)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 158)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 159)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 160)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 161)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 162)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 163)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 164)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 165)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 166)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 167)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 168)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 169)
    DECK_CONFIG_SORT_ORDER_RELATIVE_OVERDUENESS = (11, 170)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 171)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 172)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 173)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 174)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 175)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 176)
    DECK_CONFIG_TIMER_TITLE = (11, 177)
    DECK_CONFIG_TITLE = (11, 178)
    DECK_CONFIG_TODAY_ONLY = (11, 179)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 180)
    DECK_CONFIG_UPDATING_CARDS = (11, 181)
    DECK_CONFIG_USED_BY_DECKS = (11, 182)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 183)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 184)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 185)
    DECK_CONFIG_WEIGHTS = (11, 186)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 187)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 188)
    DECK_CONFIG_WHICH_DECK = (11, 189)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 190)
    ...
    EDITING_IMAGE_OCCLUSION_GROUP = (13, 46)
    EDITING_IMAGE_OCCLUSION_MODE = (13, 47)
    EDITING_IMAGE_OCCLUSION_POLYGON_TOOL = (13, 48)
    EDITING_IMAGE_OCCLUSION_RECTANGLE_TOOL = (13, 49)
    EDITING_IMAGE_OCCLUSION_RESET = (13, 50)
    EDITING_IMAGE_OCCLUSION_SELECT_ALL = (13, 51)
    EDITING_IMAGE_OCCLUSION_SELECT_TOOL = (13, 52)
    EDITING_IMAGE_OCCLUSION_TEXT_TOOL = (13, 53)
    EDITING_IMAGE_OCCLUSION_TOGGLE_MASK_EDITOR = (13, 54)
    EDITING_IMAGE_OCCLUSION_TOGGLE_TRANSLUCENT = (13, 55)
    EDITING_IMAGE_OCCLUSION_UNGROUP = (13, 56)
    EDITING_IMAGE_OCCLUSION_ZOOM_IN = (13, 57)
    EDITING_IMAGE_OCCLUSION_ZOOM_OUT = (13, 58)
    EDITING_IMAGE_OCCLUSION_ZOOM_RESET = (13, 59)
    EDITING_IMAGE_OCCLUSION_ZOOM_TOOL = (13, 60)
    EDITING_INDENT = (13, 61)
    EDITING_ITALIC_TEXT = (13, 62)
    EDITING_JUMP_TO_TAGS_WITH_CTRLANDSHIFTANDT = (13, 63)
    EDITING_JUSTIFY = (13, 64)
    EDITING_LATEX = (13, 65)
    EDITING_LATEX_EQUATION = (13, 66)
    EDITING_LATEX_MATH_ENV = (13, 67)
    EDITING_MATHJAX_BLOCK = (13, 68)
    EDITING_MATHJAX_CHEMISTRY = (13, 69)
    EDITING_MATHJAX_INLINE = (13, 70)
    EDITING_MATHJAX_PLACEHOLDER = (13, 71)
    EDITING_MATHJAX_PREVIEW = (13, 72)
    EDITING_MEDIA = (13, 73)
    EDITING_NO_IMAGE_FOUND_ON_CLIPBOARD = (13, 74)
    EDITING_ORDERED_LIST = (13, 75)
    EDITING_OUTDENT = (13, 76)
    EDITING_PASTE = (13, 77)
    EDITING_RECORD_AUDIO = (13, 78)
    EDITING_REMOVE_FORMATTING = (13, 79)
    EDITING_RESTORE_ORIGINAL_SIZE = (13, 80)
    EDITING_SELECT_REMOVE_FORMATTING = (13, 81)
    EDITING_SHOW_DUPLICATES = (13, 82)
    EDITING_SHOW_IN_FOLDER = (13, 83)
    EDITING_SHRINK_IMAGES = (13, 84)
    EDITING_SUBSCRIPT = (13, 85)
    EDITING_SUPERSCRIPT = (13, 86)
    EDITING_TAGS = (13, 87)
    EDITING_TAGS_ADD = (13, 88)
    EDITING_TAGS_COPY = (13, 89)
    EDITING_TAGS_REMOVE = (13, 90)
    EDITING_TAGS_SELECT_ALL = (13, 91)
    EDITING_TEXT_COLOR = (13, 92)
    EDITING_TEXT_HIGHLIGHT_COLOR = (13, 93)
    EDITING_TO_MAKE_A_CLOZE_DELETION_ON = (13, 94)
    EDITING_TOGGLE_HTML_EDITOR = (13, 95)
    EDITING_TOGGLE_STICKY = (13, 96)
    EDITING_TOGGLE_VISUAL_EDITOR = (13, 97)
    EDITING_UNDERLINE_TEXT = (13, 98)
    EDITING_UNORDERED_LIST = (13, 99)
    EDITING_WARNING_CLOZE_DELETIONS_WILL_NOT_WORK = (13, 100)
    ...
    PREFERENCES_USER_INTERFACE = (26, 80)
    PREFERENCES_USER_INTERFACE_SIZE = (26, 81)
    PREFERENCES_V3_SCHEDULER = (26, 82)
    PREFERENCES_VIDEO_DRIVER = (26, 83)
    PREFERENCES_VIDEO_DRIVER_ANGLE = (26, 84)
    PREFERENCES_VIDEO_DRIVER_DEFAULT = (26, 85)
    PREFERENCES_VIDEO_DRIVER_OPENGL_MAC = (26, 86)
    PREFERENCES_VIDEO_DRIVER_OPENGL_OTHER = (26, 87)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_MAC = (26, 88)
    PREFERENCES_VIDEO_DRIVER_SOFTWARE_OTHER = (26, 89)
    PREFERENCES_WEEKLY_BACKUPS = (26, 90)
    PREFERENCES_WHEN_ADDING_DEFAULT_TO_CURRENT_DECK = (26, 91)
    PREFERENCES_YOU_CAN_RESTORE_BACKUPS_VIA_FILESWITCH = (26, 92)
    ...
    QT_ACCEL_TOOLS = (28, 39)
    QT_ACCEL_UNDO = (28, 40)
    QT_ACCEL_VIEW = (28, 41)
    QT_ACCEL_ZOOM_EDITOR_IN = (28, 42)
    QT_ACCEL_ZOOM_EDITOR_OUT = (28, 43)
    QT_ACCEL_ZOOM_IN = (28, 44)
    QT_ACCEL_ZOOM_OUT = (28, 45)
    ...
    QT_MISC_REPLACE_YOUR_COLLECTION_WITH_AN_EARLIER2 = (29, 45)
    QT_MISC_REVERT_TO_BACKUP = (29, 46)
    QT_MISC_SECOND = (29, 47)
    QT_MISC_SEGOE_UI = (29, 48)
    QT_MISC_SHIFT_KEY_WAS_HELD_DOWN_SKIPPING = (29, 49)
    QT_MISC_SHORTCUT_KEY_LEFT_ARROW = (29, 50)
    QT_MISC_SHORTCUT_KEY_RIGHT_ARROW_OR_ENTER = (29, 51)
    QT_MISC_STATS = (29, 52)
    QT_MISC_STUDY_DECK = (29, 53)
    QT_MISC_SYNC = (29, 54)
    QT_MISC_TARGET_DECK_CTRLANDD = (29, 55)
    QT_MISC_THE_FOLLOWING_CHARACTER_CAN_NOT_BE = (29, 56)
    QT_MISC_THE_REQUESTED_CHANGE_WILL_REQUIRE_A = (29, 57)
    QT_MISC_THERE_MUST_BE_AT_LEAST_ONE = (29, 58)
    QT_MISC_THIS_FILE_EXISTS_ARE_YOU_SURE = (29, 59)
    QT_MISC_UNABLE_TO_ACCESS_ANKI_MEDIA_FOLDER = (29, 60)
    QT_MISC_UNABLE_TO_RECORD = (29, 61)
    QT_MISC_UNEXPECTED_RESPONSE_CODE = (29, 62)
    QT_MISC_WOULD_YOU_LIKE_TO_DOWNLOAD_IT = (29, 63)
    QT_MISC_YOUR_COLLECTION_FILE_APPEARS_TO_BE = (29, 64)
    QT_MISC_YOUR_COMPUTERS_STORAGE_MAY_BE_FULL = (29, 65)
    QT_MISC_YOUR_FIREWALL_OR_ANTIVIRUS_PROGRAM_IS = (29, 66)
    ...
    STATISTICS_ESTIMATED_TOTAL_KNOWLEDGE = (32, 56)
    STATISTICS_FUTURE_DUE_SUBTITLE = (32, 57)
    STATISTICS_FUTURE_DUE_TITLE = (32, 58)
    STATISTICS_HOURS_CORRECT = (32, 59)
    STATISTICS_HOURS_CORRECT_REVIEWS = (32, 60)
    STATISTICS_HOURS_RANGE = (32, 61)
    STATISTICS_HOURS_REVIEWS = (32, 62)
    STATISTICS_HOURS_SUBTITLE = (32, 63)
    STATISTICS_HOURS_TITLE = (32, 64)
    STATISTICS_IN_DAYS_RANGE = (32, 65)
    STATISTICS_IN_DAYS_SINGLE = (32, 66)
    STATISTICS_IN_TIME_SPAN_DAYS = (32, 67)
    STATISTICS_IN_TIME_SPAN_HOURS = (32, 68)
    STATISTICS_IN_TIME_SPAN_MINUTES = (32, 69)
    STATISTICS_IN_TIME_SPAN_MONTHS = (32, 70)
    STATISTICS_IN_TIME_SPAN_SECONDS = (32, 71)
    STATISTICS_IN_TIME_SPAN_YEARS = (32, 72)
    STATISTICS_INTERVALS_DAY_RANGE = (32, 73)
    STATISTICS_INTERVALS_DAY_SINGLE = (32, 74)
    STATISTICS_INTERVALS_SUBTITLE = (32, 75)
    STATISTICS_INTERVALS_TITLE = (32, 76)
    STATISTICS_MINUTES_PER_DAY = (32, 77)
    STATISTICS_NO_DATA = (32, 78)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 79)
    STATISTICS_RANGE_ALL_HISTORY = (32, 80)
    STATISTICS_RANGE_ALL_TIME = (32, 81)
    STATISTICS_RANGE_COLLECTION = (32, 82)
    STATISTICS_RANGE_DECK = (32, 83)
    STATISTICS_RANGE_SEARCH = (32, 84)
    STATISTICS_RETRIEVABILITY_SUBTITLE = (32, 85)
    STATISTICS_RETRIEVABILITY_TOOLTIP = (32, 86)
    STATISTICS_REVIEWS = (32, 87)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 88)
    STATISTICS_REVIEWS_PER_DAY = (32, 89)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 90)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 91)
    STATISTICS_REVIEWS_TITLE = (32, 92)
    STATISTICS_RUNNING_TOTAL = (32, 93)
    STATISTICS_SAVE_PDF = (32, 94)
    STATISTICS_SAVED = (32, 95)
    STATISTICS_STABILITY_DAY_RANGE = (32, 96)
    STATISTICS_STABILITY_DAY_SINGLE = (32, 97)
    STATISTICS_STATS = (32, 98)
    STATISTICS_STUDIED_TODAY = (32, 99)
    STATISTICS_TITLE = (32, 100)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 101)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 102)
    STATISTICS_TODAY_NO_CARDS = (32, 103)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 104)
    STATISTICS_TODAY_TITLE = (32, 105)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 106)
    STATISTICS_TOTAL = (32, 107)
    STATISTICS_TRUE_RETENTION_ALL_TIME = (32, 108)
    STATISTICS_TRUE_RETENTION_FAIL = (32, 109)
    STATISTICS_TRUE_RETENTION_MONTH = (32, 110)
    STATISTICS_TRUE_RETENTION_PASS = (32, 111)
    STATISTICS_TRUE_RETENTION_RANGE = (32, 112)
    STATISTICS_TRUE_RETENTION_RETENTION = (32, 113)
    STATISTICS_TRUE_RETENTION_SUBTITLE = (32, 114)
    STATISTICS_TRUE_RETENTION_TITLE = (32, 115)
    STATISTICS_TRUE_RETENTION_TODAY = (32, 116)
    STATISTICS_TRUE_RETENTION_WEEK = (32, 117)
    STATISTICS_TRUE_RETENTION_YEAR = (32, 118)
    STATISTICS_TRUE_RETENTION_YESTERDAY = (32, 119)
    STUDYING_AGAIN = (33, 0)
