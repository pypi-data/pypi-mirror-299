...
Welcome to `digatron-utility` contributor's guide.
...
If you experience bugs or general issues with `digatron-utility`, please have a look
...
You can help improve `digatron-utility` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`digatron-utility` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `digatron-utility`'s files. While this mechanism can
...
```
conda create -n digatron-utility python=3 six virtualenv pytest pytest-cov
conda activate digatron-utility
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/digatron-utility.git
   cd digatron-utility
   ```
...
5. Install [pre-commit]:
   ...
   `digatron-utility` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/digatron-utility
[issue tracker]: https://github.com/<USERNAME>/digatron-utility/issues
