...
class NodeWithRegistries(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "resource_type", "description", "org_id", "user_id", "role", "live", "architecture", "interfaces", "tags", "last_seen", "error", "status", "cluster_id", "docker_swarm_info", "registry_associations", "registries"]
