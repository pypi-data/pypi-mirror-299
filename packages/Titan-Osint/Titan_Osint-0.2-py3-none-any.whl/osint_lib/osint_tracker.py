...
def search_username(username):
    sites = {
        ...
        "BitPatron": "https://www.bitpatron.co/{}",
        ...
        "Voat": "https://voat.co/u/{}",
        "Pleroma": "https://pleroma.site/users/{}",
        "Diaspora": "https://diasp.org/people/{}",
        "Friendica": "https://{}/friendica",
        "Yubo": "https://www.yubo.live/u/{}",
        "Vingle": "https://www.vingle.net/{}/",
    ...
    print(f"{Fore.BLUE}[>] Searching for username {username} on sites..\n")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if username_lower in page_text:
                    number_found += 1
                    print(f"{Fore.BLUE}[{Fore.WHITE}{current_time_hour()}{Fore.BLUE}] Found on {Fore.WHITE}{site}{Fore.BLUE} -> {Fore.WHITE}{url}{Fore.BLUE}{Fore.WHITE}")
        except Exception:
            pass
    
    print(f"\n{Fore.BLUE}[{Fore.WHITE}{current_time_hour()}{Fore.BLUE}] Total sites scanned: {Fore.WHITE}{number_site}{Fore.BLUE}, Found: {Fore.WHITE}{number_found}{Fore.WHITE}")
