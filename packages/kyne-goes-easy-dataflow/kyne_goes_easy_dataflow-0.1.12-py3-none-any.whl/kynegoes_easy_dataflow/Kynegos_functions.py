...
def download_file_from_gcs(bucket_name, file_path):
    """
    Descarga un archivo desde un bucket de Google Cloud Storage sin procesarlo.
    ...
    Returns:
        BytesIO: El archivo descargado como un objeto en memoria.
    """
    ...
    file_data = blob.download_as_bytes()  # Descargar cualquier archivo como binario
    return BytesIO(file_data)  # Devolver como BytesIO para todos los tipos de archivos
