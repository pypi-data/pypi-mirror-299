...
from OTCFinUtils.data_structs import APIParams, HTTPMethod, HTTPStatus, ResponseIds
from OTCFinUtils.utils import extract_segment_response_id, extract_segment_status_code, extract_segment_table_name
...
def get_dataverse_token(dataverse_url: str) -> str:
    ...
    app = msal.ConfidentialClientApplication(
        client_id=getenv("TOKEN_CLIENT_ID"),
        client_credential=getenv("TOKEN_CLIENT_CREDENTIAL"),
        authority=getenv("TOKEN_AUTHORITY"),
    )
