...
def process_timeseries(data_path: pathlib.Path, labels: list[str], times: np.ndarray):
    ...
    # process timeseries
    fid_timeseries = ResultTimeSeries("decane_fid", INTERNAL_STANDARD, internal_standard_mmol=0.00547)
    ms_timeseries = ResultTimeSeries("decane_ms", INTERNAL_STANDARD, internal_standard_mmol=0.00547)
...
def main():
    ...
    labels = [f"DJW-19-{i}h_TMS" for i in times]
