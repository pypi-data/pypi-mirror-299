...
class OptionUniverse(QuantConnect.Data.UniverseSelection.BaseDataCollection, QuantConnect.Securities.ISymbol):
    ...
    @property
    def greeks(self) -> QuantConnect.Data.Market.BaseGreeks:
    ...
    @staticmethod
    def to_csv(symbol: typing.Union[QuantConnect.Symbol, str], open: float, high: float, low: float, close: float, volume: float, open_interest: typing.Optional[float], implied_volatility: typing.Optional[float], greeks: QuantConnect.Data.Market.BaseGreeks) -> str:
