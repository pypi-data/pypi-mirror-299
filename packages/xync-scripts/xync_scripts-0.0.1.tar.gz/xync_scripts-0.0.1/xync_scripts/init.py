...
from xync_scripts.utils import pt_db
from xync_scripts.loader import BKEY, BSEC, dsn
...
async def main():
    ...
    exs = {
        "Beribit": (ExType.p2p, 'https://sun9-41.userapi.com/impg/cZCGFTXH5-11_HjiWw9aWr3__SlbmMIiXSc-ig/YtOHJpjuVW0.jpg?size=604x604&quality=95&sign=def93bbe4283c563eb2d75a5968350f2', 'beribit.app', 'https://beribit.app/login'),
        "Binance": (ExType.main, 'https://assets.coingecko.com/markets/images/52/large/binance.jpg', 'binance.com', 'https://accounts.binance.com/login'),
        "BingX": (ExType.p2p, 'https://assets.coingecko.com/markets/images/812/large/YtFwQwJr_400x400.jpg', 'bingx.com', 'https://bingx.com/login'),
        "Bisq": (ExType.p2p, '', '', ''),
        "BitcoinGlobal": (ExType.p2p, '', '', ''),
        "BitGet": (ExType.p2p, 'https://assets.coingecko.com/markets/images/591/large/2023-07-25_21.47.43.jpg', 'www.bitget.com', 'https://www.bitget.com/login'),
        "BitPapa": (ExType.p2p, 'https://avatars.mds.yandex.net/i?id=130c32d9900d514d738ef89b9c61bcd3_l-4767909-images-thumbs&n=13', 'bitpapa.com', 'https://bitpapa.com/log-in'),
        "Bitvalve ": (ExType.p2p, '', '', ''),
        "Bybit": (ExType.main, 'https://assets.coingecko.com/markets/images/698/large/bybit_spot.png', 'bybit.com', 'https://bybit.com/login'),
        "CoinCola": (ExType.main, '', '', ''),
        "CRYPTED": (ExType.p2p, '', '', ''),
        "Garantex": (ExType.p2p, '', '', ''),
        "Gate": (ExType.p2p, 'https://assets.coingecko.com/markets/images/403/large/gate_io_logo.jpg', 'gate.io', 'https://www.gate.io/login'),
        "HodlHodl": (ExType.p2p, '', '', ''),
        "Htx": (ExType.main, 'https://assets.coingecko.com/markets/images/25/large/logo_V_colour_black.png', 'htx.com', 'https://htx.com/login'),
        "Koshelek": (ExType.p2p, '', '', ''),
        "KuCoin": (ExType.main, 'https://assets.coingecko.com/markets/images/61/large/kucoin.png', 'kucoin.com', 'https://www.kucoin.com/ucenter/signin'),
        "LocalCoinSwap": (ExType.p2p, '', '', ''),
        "LocalMonero": (ExType.p2p, '', '', ''),
        "Mexc": (ExType.main, 'https://assets.coingecko.com/markets/images/409/large/MEXC_logo_square.jpeg', 'www.mexc.com', 'https://www.mexc.com/login'),
        "Noones ": (ExType.p2p, '', '', ''),
        "Okx": (ExType.main, 'https://assets.coingecko.com/markets/images/379/large/WeChat_Image_20220117220452.png', 'www.okx.cab', 'https://www.okx.cab/account/login'),
        "Paxful": (ExType.p2p, '', '', ''),
        ...
        "RiseX": (ExType.p2p, '', '', ''),
        "RoboSats": (ExType.p2p, '', '', ''),
        "Sigen": (ExType.p2p, 'https://yastatic.net/naydex/yandex-search/neZ1W6346/a21f02dA/2SvJ6dTLJwRiz_lTFP-fhywHqi1fxPNRcIxuKzcpwJ0DGlJzbzdT8ARet86SrINoGNj87R9U-t8HLZcrrBASQf0_6OkAL7cgl6uc0gCrHxI9Y369emE2MJF5yotCyODdZ5iXljtkQJMXTMV9VXsEL68seaiqQF578wnB3V', 'sigen.pro', 'https://sigen.pro/p2p'),
        "SkyCrypto": (ExType.p2p, '', '', ''),
        "SmartSwap": (ExType.p2p, '', '', ''),
        "Solid": (ExType.main, '', '', ''),
        "TgWallet": (ExType.p2p, 'https://telerock.ru/uploads/posts/2024-03/f658443d9e_c9d505bbf856e2360ba6812079ba02d0.webp', 'walletbot.me', ''),
        "TotalCoin": (ExType.p2p, '', '', ''),
        "WazirX": (ExType.p2p, '', '', ''),
        "WebMoney": (ExType.p2p, 'https://vectorseek.com/wp-content/uploads/2023/08/Webmoney-Icon-Logo-Vector.svg-.png', 'exchanger.money', 'https://exchanger.money/'),
        "WhiteBIT": (ExType.p2p, '', '', ''),
    ...
    await Ex.bulk_create((Ex(name=n, type=val[0], logo=val[1], host=val[2], url=val[3]) for n, val in exs.items()), update_fields=['host','type','logo','url'], on_conflict=['name', 'type'])
