...
class TestFireberryClient(TestCase):
    ...
    def test_create_lead(self):
        data = {'pcfAccount': '9b48a43f-1597-430e-a61d-f5a5921b376e',
                'pcfCourse': '86dcd466-3f92-40be-9417-0b224653e5ff',
                'pcfDidLeaveDetails': '', 'pcfGoldLead': '',
                'pcfLeadSource': 2, 'pcfLeftDetailsFor': '', 'pcfMainMarketingChannel': 3,
                'pcfStatusCode': 1}

        record = self.client.create_record(1002, data)
        self.assertTrue(record)
