...
class ModelConfiguration:
    def __init__(self, model_name: str, geom_export: str, mesh_export: str):
        """
        Initializes a ModelConfiguration object.

        :param model_name: Name of the model, used for the central model file export.
        :param geom_export: Path for exporting geometry visualization assets.
        :param mesh_export: Path for exporting mesh visualization assets.
        """
        ... 
