            ...
            try:
                ...
                if self.tracking_log:
                    driver.save_screenshot(
                        f"./{self._dir_model}/{stamp_url}_2_after_click_specification_{stamp_today}.png")
                ...
                try:
                    ...
                    if self.tracking_log:
                        driver.save_screenshot(f"./{self._dir_model}/{stamp_url}_3_after_click_see_more_{stamp_today}.png")
                    ...
                    try:
                        ...
                        if self.tracking_log:
                            driver.save_screenshot(
                                f"./{self._dir_model}/{stamp_url}_3_after_click_see_more_{stamp_today}.png")
                        element_see_more.click()
                    except:
                        if self.tracking_log:
                ...
                for _ in range(15):
                    ...
                    for element in elements:
                        ...
                        dict_spec.update(self._convert_soup_to_dict(soup))
                ...
                if self.tracking_log:
                    if cnt_try + 1 == try_total:
                        print(f"An error occurred on _extract_global_specs : {self._dir_model.split('/')[-1]}")
            finally:
                driver.quit()
