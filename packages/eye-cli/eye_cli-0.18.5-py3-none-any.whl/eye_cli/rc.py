...
from eye_cli.data import find_bucket, quoted
from eye_cli.util import message, color, cmd

app = typer.Typer()

RC = quoted("C:\Program Files\Capturing Reality\RealityCapture\RealityCapture.exe")
...
def simplify(project: str, component: str, relative_percent: int = 50, times: int = 1):
    ...
    #      CalledProcessError: Command '['C:\\Program Files\\Capturing Reality\\RealityCapture\\RealityCapture.exe', '-delegateTo', 'RC1', '-load', 'D:\\bucket\\rc\\2024.09.11_c130_painted\\2024.09.11_c130_painted.rcproj']' returned non-zero exit status 5.
