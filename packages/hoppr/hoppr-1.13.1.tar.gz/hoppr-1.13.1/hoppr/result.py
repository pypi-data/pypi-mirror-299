...
class Result:
    ...
    @classmethod
    def success(cls, message="", return_obj: Any = None) -> Self:
        """
    ...
    @classmethod
    def retry(cls, message="", return_obj: Any = None) -> Self:
        """
    ...
    @classmethod
    def fail(cls, message="", return_obj: Any = None) -> Self:
        """
    ...
    @classmethod
    def warn(cls, message="", return_obj: Any = None) -> Self:
        """
    ...
    @classmethod
    def excluded(cls, message="", return_obj: Any = None) -> Self:
        """
    ...
    @classmethod
    def skip(cls, message="", return_obj: Any = None) -> Self:
        """
