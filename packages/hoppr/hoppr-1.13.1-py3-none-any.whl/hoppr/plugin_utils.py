...
def get_missing_commands(cmd_list: list[str | list[str]]) -> list[str]:
    """
...
def check_for_missing_commands(cmd_list: list[str | list[str]]) -> Result:
    """
    Raise an exception if any of a list of required commands are unavailable
    """
    return (
        Result.fail(
            f"The following required commands are unavailable: {', '.join(missing_cmds)}. "
