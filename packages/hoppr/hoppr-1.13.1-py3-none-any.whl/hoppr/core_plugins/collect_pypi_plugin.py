...
class CollectPypiPlugin(SerialCollectorPlugin):
    ...
    def _map_download_urls(self, component: Component, links: list[dict[str, str]]) -> dict[str, str]:
        ...
        return {link["#text"]: link["@href"] for link in [*binary_links, *source_links]}
    ...
    def _get_success_message(self, success_count: int, result_codes: list[int]) -> str:
        message = ""
        match self.collector_config.type, self.collector_config._type_order, result_codes:  # pylint: disable=protected-access
    ...
    def _get_retry_exception_message(self, success_count: int) -> str:
        message = ""
        match self.collector_config.type, *self.collector_config._type_order:  # pylint: disable=protected-access
