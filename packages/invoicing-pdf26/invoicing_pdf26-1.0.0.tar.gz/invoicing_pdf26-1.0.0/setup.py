...
setup(
  name = 'invoicing-pdf26',         #* Your package will have this name
  ...
  author = 'Mykola Korbut',                   # Your name
  author_email = 'mykolakorbut@example.com',  # Your email
  ...
  install_requires=['pandas', 'fpdf', 'openpyxl'], # Other 3rd-party libs
  # that pip needs to install
  classifiers=[
