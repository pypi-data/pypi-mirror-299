...
class Camera(BaseCamera):
    ...
    def frames( ):
        ...
        STARTUP_PORT = int(config.CONFIG['startupport']) # original CONFG value is stored here
        joffset = 0
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"durrent  {CURRENT_PORT} != {STARTUP_PORT} startup")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        print(f"  {CURRENT_PORT} != {STARTUP_PORT} ")
        if CURRENT_PORT != STARTUP_PORT:    joffset = 10
