...
The function that will act as middleware will receive as a single mandatory parameter [`data: Datasy`](/0.2.0/how-to-use/#datasy-data) and its structure or content may vary depending on the context and specific requirements of the middleware.

## **Method and attribute to use** [[`See more`](/0.2.0/how-to-use/#datasy-data)]
