    ...
    <div class="pricing-step bg-white w-full border border-transparent rounded-md">
      ...
      <div class="pricing-step-content w-full flex flex-col"
        ...
        <div class="pricing-step-content-data-wrap w-full flex items-center"
          :class="{ 'selected-supplier': selectedSupplier === index }" :style="{'background-color': supplier.color ?? 'rgba(246, 248, 252, 0.5)'}" v-for="(supplier, index) in supplyFuel?.results"
          :key="index">
          <div class="pricing-step-content-col w-1/12">
          ...
          <div class="pricing-step-content-col w-2/12">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ supplier.ipa?.full_repr ? supplier.ipa?.full_repr : selectedSupplier !== null ? '-' : 'TBC' }}</div>
          </div>
          <div class="pricing-step-content-col w-1/12">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ supplier.delivery_method?.name ?? 'All' }}</div>
          </div>
          <div class="pricing-step-content-col w-1/12">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ supplier.apron?.name ?? 'All' }}</div>
          </div>
          <div class="pricing-step-content-col w-1/12">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ supplier.terminal?.name ?? 'All' }}</div>
          </div>
          <div class="pricing-step-content-col w-2/12">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem]">{{ formatNumber(supplier.total_uplift_cost) }} {{
              supplier.currency.code }}</div>
          </div>
          <div class="pricing-step-content-col w-1/12 relative">
            <div class="pricing-step-content-col-data px-[0.75rem] py-[0.5rem] flex gap-2" v-if="supplier.issues.length > 0">
      ...
      <div class="pricing-step-content roi flex flex-col" v-if="orderPricing && order && orderPricing.supplier_id">
        ...
        <div class="roi-results flex py-[0.75rem]">
          ...
          <div class="roi-results-wrap w-6/12 flex items-center px-[0.75rem]">
            ...
            <div class="roi-results-value-green">{{ formatNumber(orderRoi?.calculated_roi) }} %</div>
          </div>
        </div>
      </div>
      <div class="pricing-step-content-missing flex items-center justify-center py-[1.25rem]" v-else>
