      ...
      <div class="supply-modal-container" ref="target">
        ...
        <ScrollBar v-else class="my-0">
          <div class="modal-body">
            <div class="modal-body-header flex gap-4">
              <div class="modal-body-header-col w-6/12 flex flex-col gap-2">
                <div class="modal-body-header-el flex gap-2">
                  ...
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.airport?.full_repr ?? '--' }}
                  </div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                  <div class="modal-body-header-el-name w-6/12">Into-Plane Agent</div>
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.ipa?.full_repr ??
                    '--' }}
                  </div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                ...
                <div class="modal-body-header-el flex gap-2">
                  ...
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.handler_specific_pricing ?
                    supplyFuelDetails?.handler_specific_pricing?.name :
                    'No' }}</div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                  <div class="modal-body-header-el-name w-6/12">Apron-Specific Pricing</div>
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.apron_specific_pricing ?
              ...
              <div class="modal-body-header-col w-6/12 flex flex-col gap-2">
                <div class="modal-body-header-el flex gap-2">
                  ...
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.supplier?.full_repr
                    ?? '--' }}</div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                  <div class="modal-body-header-el-name w-6/12">Intermediate Supplier</div>
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.intermediate_supplier ?
                    supplyFuelDetails?.intermediate_supplier?.full_repr :
                    'No' }}</div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                  <div class="modal-body-header-el-name w-6/12">Delivery Method</div>
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.delivery_method ?
                    supplyFuelDetails?.delivery_method.name :
                    'TBC' }}</div>
                </div>
                <div class="modal-body-header-el flex gap-2">
                  <div class="modal-body-header-el-name w-6/12">Client-Specific Pricing</div>
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.client_specific_pricing ?
                ...
                <div class="modal-body-header-el flex gap-2">
                  ...
                  <div class="modal-body-header-el-data w-6/12">{{ supplyFuelDetails?.terminal_specific_pricing ?
            ...
            <div class="modal-body-content-wrap flex">
              <div class="modal-body-content w-full flex flex-col gap-2">
                <div class="modal-body-content-block" v-if="supplyFuelDetails?.issues.length > 0">
                  <div class="modal-body-content-block-header issues p-[0.75rem]">
                    <img width="20" height="20" src="../../assets/icons/alert.svg" alt="warn" class="warn">
                    {{ supplyFuelDetails?.issues.length }} Issues Detected
                  </div>
                  <div class="modal-body-content-block-body px-[0.75rem] py-[1rem] pl-[1.5rem] gap-3 flex flex-col">
                    <div class="issue-html" v-for="issue in supplyFuelDetails?.issues" v-html="issue">
                    </div>
                  </div>
                </div>
                <div class="modal-body-content-block">
                  <div class="modal-body-content-block-header p-[0.75rem]">
                    Fuel Pricing
                  </div>
                  <div class="modal-body-content-block-body flex px-[0.75rem] py-[1rem]">
                    <div class="modal-body-content-block-body-name w-4/12">{{
                      supplyFuelDetails?.fuel_price?.fuel?.name
                      }}
                    </div>
                    <div class="modal-body-content-block-body-desc w-6/12 relative">
                      ...
                      <div class="modal-body-content-block-body-note hover-wrap contents flex items-center">
                    ...
                    <div class="modal-body-content-block-body-value w-2/12">{{
                ...
                <div class="modal-body-content-block">
                  ...
                  <div
                    class="results modal-body-content-block-body flex px-[0.75rem] py-6 flex justify-center border border-transparent rounded"
                  ...
                  <div class="modal-body-content-block-body flex px-[0.75rem] py-[1rem]" v-else
                    ...
                    <div class="modal-body-content-block-body-value w-2/12">{{ formatNumber(fee?.amount) }} {{
                      supplyFuelDetails?.currency?.code }}</div>
                  </div>
                </div>
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex flex-col" v-else>
                    <div class="flex w-full">
                      <div class="modal-body-content-block-body-header w-6/12 text-center">
                        <div class="el-border modal-body-content-block-body-header-el my-[0.5rem]">
                          Official Taxes
                        </div>
                      </div>
                      <div class="modal-body-content-block-body-header w-6/12 text-center">
                        <div class="modal-body-content-block-body-header-el my-[0.5rem]">Supplier-Defined Taxes </div>
                      </div>
                    </div>
                    <div class="flex w-full" v-for="(tax, key, index) in supplyFuelDetails?.taxes?.list" :key="key">
                      <div class="el-border w-6/12 issues flex px-[0.75rem] py-[1rem] items-center relative">
                        ...
                        <div class="modal-body-content-block-body-value w-4/12">{{ formatNumber(tax?.official?.amount)
                          }}
                          {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                      <div class="w-6/12 issues flex px-[0.75rem] py-[1rem] items-center relative">
                        ...
                        <div class="modal-body-content-block-body-value w-4/12">{{ formatNumber(tax?.supplier?.amount)
                          }}
                          {{ supplyFuelDetails?.currency?.code }}</div>
                      </div>
                    </div>
                ...
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex flex-col">
                    <div class="flex w-full">
                      ...
                      <div class="modal-body-content-block-body-header w-6/12 pl-3 ">
                        <div class="modal-body-content-block-body-header-el my-[0.5rem]">With Supplier-Defined Taxes</div>
                      </div>
                    </div>
                    <div class="flex w-full">
                ...
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex flex-col px-[0.75rem] py-[0.75rem]"
                    v-if="supplyFuelDetails?.notams?.length > 0">
                    <div class="modal-body-content-block-body-name flex flex-col"
                  ...
                  <div class="results modal-body-content-block-body flex flex-col items-center justify-center px-[0.75rem] py-6"
                    v-else>
