          ...
          <OrderForm add-default-classes>
            <template #header>
              <div class="header w-full flex justify-between">
                <div class="text-[1.25rem] font-medium text-grey-1000">Send Supplier Order Request</div>
            ...
            <template #content>
              <div class="form-body-wrapper">
                ...
                <div class="flex items-start justify-start pb-3">
                  <CheckboxField class="mb-0 mt-[2px] mr-1" />
                  <div class="checkbox-text flex flex-col">
                    <p class="text-base whitespace-nowrap font-semibold text-main">Proof of Tax Reg</p>
