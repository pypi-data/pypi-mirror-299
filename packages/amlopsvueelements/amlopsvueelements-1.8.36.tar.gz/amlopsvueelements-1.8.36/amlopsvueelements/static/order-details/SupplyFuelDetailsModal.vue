  ...
  <div v-if="isOpen" class="modal-mask">
    <div class="modal-wrapper">
      <div class="modal-container" ref="target">
        ...
        <div class="py-6 px-3 min-h-[70vh] flex items-center" v-if="isLoadingSupplierFuelDetails">
          <Loading></Loading>
        </div>
        <ScrollBar v-else class="my-0">
          <div class="modal-body">
            ...
            <div class="modal-body-content-wrap flex">
              <div class="modal-body-content w-full flex flex-col p-3 gap-2">
                ...
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex flex-col" v-else>
                    ...
                    <div class="flex w-full" v-for="(tax, key, index) in supplyFuelDetails?.taxes?.list" :key="key">
                      <div class="el-border w-6/12 issues flex px-3 py-4 items-center relative">
                      ...
                      <div class="w-6/12 issues flex px-3 py-4 items-center relative">
                        <div class="modal-body-content-block-body-name w-8/12">{{ key }} <div
                            class="modal-body-content-block-body-note hover-wrap contents flex items-center">
                            <img width="12" height="12" src="../../assets/icons/info-circle.svg" alt="warn"
                              class="warn">
                ...
                <div class="modal-body-content-block">
                  ...
                  <div class="modal-body-content-block-body flex flex-col px-3 py-3"
                  ...
                  <div class="results modal-body-content-block-body flex flex-col items-center justify-center px-3 py-6"
                    v-else>
        ...
        <div class="modal-footer px-6 py-5 flex justify-end">
          <div class="modal-footer-el flex justify-between w-6/12">
            <div class="modal-footer-el-name" v-if="!isLoadingSupplierFuelDetails">
              Total Uplift Cost
            </div>
            <div class="modal-footer-el-value" v-if="!isLoadingSupplierFuelDetails">
