...
class TestEncode(unittest.TestCase):
    ...
    def test06_huffman_encoding_of_input_wav_file(self):
        ...
        node_mapping_dict, bit_string, end_zero_padding = (
            brainwire.encode.huffman_encoding(input_data=input_wav)
        )

        byte_string = brainwire.encode.create_byte_string(
            node_mapping_dict, bit_string, end_zero_padding
        )
    ...
    def test07_huffman_encoding_of_decoded_encoded_data(self):
        ...
        node_mapping_dict, bit_string, end_zero_padding = (
            brainwire.encode.huffman_encoding(input_data=amplitude_array)
        )
    ...
    def test09_writing_encoded_data_byte_string_using_huffman_encoding_main(self):
        ...
        start_time = time.time_ns()
        node_mapping_dict, bit_string, end_zero_padding = (
            brainwire.encode.huffman_encoding(
        ...
        process_signal.print_time_each_function_takes_to_complete_processing(
            start_time=start_time,
            stop_time=stop_time,
            executed_line="brainwire.encode.huffman_encoding(",
        )
    ...
    def test15_test_of_arg_parser(self):
        parser = brainwire.encode.initialize_argument_parser()
