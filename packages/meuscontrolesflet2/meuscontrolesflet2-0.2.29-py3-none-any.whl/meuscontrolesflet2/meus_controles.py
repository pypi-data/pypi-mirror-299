...
class TemaSelectSysten(ft.IconButton):
    ...
    def Edit(self, e):
        self.page.controls = [ft.Column([self.EditarTema,self.sair])]
        self.page.update()
    ...
    def JanelaEditarTema(self):
        ...
        self.nome_tema = ft.TextField(hint_text='Digite o nome do tema')
        self.conf = False
        ...
        self.linha_salve = ft.Row([self.nome_tema, self.confirmar, self.cancelar], visible = False, col = 48)
        self.btn_save = ft.FilledButton('Salvar Tema', on_click=self.TornarVizivel)
        ...
        self.cts = [self.ferramentas, self.tema_escolhido]
                ...
                controls = [
                    ft.PopupMenuButton(
                        content = ft.Container(
                            ft.Text(self.funcoes[i], no_wrap=False, width=150), 
        ...
        self.cts += [ft.ResponsiveRow([self.btn_save, self.linha_salve], columns=48, spacing=0, run_spacing=0)]
    
        return ft.ResponsiveRow(self.cts,columns=3)
    ...
    def Salvar(self, e):
        ...
        if nome_tema not in ['', ' ', None]+list(self.arquiv.keys()):
            ...
            self.escrever_json(self.arquiv, 'Tema')
    ...
    def definirCor(self, e):
        ...
        # for i in  self.atributos_ColorScheme:
        #     if self.icones[i].data[1]:
        #         print(i, self.dic_atributos[i])
        # print(self.dic_atributos)
        # print('\n')
        self.page.theme = ft.Theme(
            color_scheme=ft.ColorScheme(
                primary = self.dic_atributos["primary"],
