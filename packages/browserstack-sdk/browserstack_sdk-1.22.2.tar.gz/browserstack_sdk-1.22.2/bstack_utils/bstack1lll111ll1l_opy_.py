...
bstack1lll111l1l1_opy_ = 5
bstack1lll111l11l_opy_ = 30
bstack1lll11111ll_opy_ = 2
class bstack1lll11111l1_opy_:
    def __init__(self, handler, bstack1lll1111l1l_opy_=bstack1lll1111lll_opy_, bstack1lll1111l11_opy_=bstack1lll111l1l1_opy_):
        self.queue = []
    ...
    def bstack1lll111ll11_opy_(self):
        self.timer = threading.Timer(self.bstack1lll1111l11_opy_, self.bstack1lll1111ll1_opy_)
        self.timer.start()
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack1lll1111l1l_opy_:
    ...
    def bstack1lll1111ll1_opy_(self):
        if len(self.queue) <= 0:
            return
        data = self.queue[:self.bstack1lll1111l1l_opy_]
        del self.queue[:self.bstack1lll1111l1l_opy_]
        self.handler(data)
    def shutdown(self):
        self.bstack1lll111l1ll_opy_()
