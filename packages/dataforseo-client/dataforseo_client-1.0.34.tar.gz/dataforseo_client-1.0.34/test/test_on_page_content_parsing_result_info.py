...
class TestOnPageContentParsingResultInfo(unittest.TestCase):
    """OnPageContentParsingResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnPageContentParsingResultInfo:
        """Test OnPageContentParsingResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnPageContentParsingResultInfo`
        """
        model = OnPageContentParsingResultInfo()
        if include_optional:
            return OnPageContentParsingResultInfo(
                crawl_progress = '',
    ...
    def testOnPageContentParsingResultInfo(self):
        """Test OnPageContentParsingResultInfo"""
