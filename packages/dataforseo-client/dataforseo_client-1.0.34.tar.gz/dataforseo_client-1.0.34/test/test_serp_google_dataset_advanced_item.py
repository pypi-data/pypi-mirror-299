...
class TestSerpGoogleDatasetAdvancedItem(unittest.TestCase):
    """SerpGoogleDatasetAdvancedItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SerpGoogleDatasetAdvancedItem:
        """Test SerpGoogleDatasetAdvancedItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SerpGoogleDatasetAdvancedItem`
        """
        model = SerpGoogleDatasetAdvancedItem()
        if include_optional:
            return SerpGoogleDatasetAdvancedItem(
                type = '',
                rank_group = 56,
                rank_absolute = 56,
                position = '',
    ...
    def testSerpGoogleDatasetAdvancedItem(self):
        """Test SerpGoogleDatasetAdvancedItem"""
