...
class TestOnPageRedirectChainsResultInfo(unittest.TestCase):
    """OnPageRedirectChainsResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnPageRedirectChainsResultInfo:
        """Test OnPageRedirectChainsResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnPageRedirectChainsResultInfo`
        """
        model = OnPageRedirectChainsResultInfo()
        if include_optional:
            return OnPageRedirectChainsResultInfo(
                crawl_progress = '',
    ...
    def testOnPageRedirectChainsResultInfo(self):
        """Test OnPageRedirectChainsResultInfo"""
