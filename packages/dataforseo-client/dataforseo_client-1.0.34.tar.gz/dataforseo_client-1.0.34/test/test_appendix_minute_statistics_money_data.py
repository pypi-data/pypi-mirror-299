...
class TestAppendixMinuteStatisticsMoneyData(unittest.TestCase):
    """AppendixMinuteStatisticsMoneyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixMinuteStatisticsMoneyData:
        """Test AppendixMinuteStatisticsMoneyData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixMinuteStatisticsMoneyData`
        """
        model = AppendixMinuteStatisticsMoneyData()
        if include_optional:
            return AppendixMinuteStatisticsMoneyData(
    ...
    def testAppendixMinuteStatisticsMoneyData(self):
        """Test AppendixMinuteStatisticsMoneyData"""
