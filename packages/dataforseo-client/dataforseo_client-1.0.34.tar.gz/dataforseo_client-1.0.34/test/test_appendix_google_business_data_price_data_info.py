...
class TestAppendixGoogleBusinessDataPriceDataInfo(unittest.TestCase):
    """AppendixGoogleBusinessDataPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixGoogleBusinessDataPriceDataInfo:
        """Test AppendixGoogleBusinessDataPriceDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixGoogleBusinessDataPriceDataInfo`
        """
        model = AppendixGoogleBusinessDataPriceDataInfo()
        if include_optional:
            return AppendixGoogleBusinessDataPriceDataInfo(
    ...
    def testAppendixGoogleBusinessDataPriceDataInfo(self):
        """Test AppendixGoogleBusinessDataPriceDataInfo"""
