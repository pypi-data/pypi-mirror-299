...
class TestAppendixBusinessDataDayStatisticsMoneyData(unittest.TestCase):
    """AppendixBusinessDataDayStatisticsMoneyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixBusinessDataDayStatisticsMoneyData:
        """Test AppendixBusinessDataDayStatisticsMoneyData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixBusinessDataDayStatisticsMoneyData`
        """
        model = AppendixBusinessDataDayStatisticsMoneyData()
        if include_optional:
            return AppendixBusinessDataDayStatisticsMoneyData(
    ...
    def testAppendixBusinessDataDayStatisticsMoneyData(self):
        """Test AppendixBusinessDataDayStatisticsMoneyData"""
