...
class TestBusinessDataBusinessListingsSearchLiveTaskInfo(unittest.TestCase):
    """BusinessDataBusinessListingsSearchLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessDataBusinessListingsSearchLiveTaskInfo:
        """Test BusinessDataBusinessListingsSearchLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessDataBusinessListingsSearchLiveTaskInfo`
        """
        model = BusinessDataBusinessListingsSearchLiveTaskInfo()
        if include_optional:
            return BusinessDataBusinessListingsSearchLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.business_data_business_listings_search_live_result_info.BusinessDataBusinessListingsSearchLiveResultInfo(
                        total_count = 56, 
                        count = 56, 
                        offset = 56, 
                        offset_token = '', 
    ...
    def testBusinessDataBusinessListingsSearchLiveTaskInfo(self):
        """Test BusinessDataBusinessListingsSearchLiveTaskInfo"""
