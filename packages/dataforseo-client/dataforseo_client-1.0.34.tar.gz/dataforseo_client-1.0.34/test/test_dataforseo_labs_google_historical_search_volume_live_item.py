    ...
    def make_instance(self, include_optional) -> DataforseoLabsGoogleHistoricalSearchVolumeLiveItem:
        ...
        if include_optional:
            return DataforseoLabsGoogleHistoricalSearchVolumeLiveItem(
                ...
                keyword_info_normalized_with_bing = dataforseo_client.models.keyword_info_normalized_with_info.KeywordInfoNormalizedWithInfo(
                    last_updated_time = '', 
                    search_volume = 56, 
                    monthly_searches = [
                        dataforseo_client.models.monthly_searches.MonthlySearches(
                ...
                keyword_info_normalized_with_clickstream = dataforseo_client.models.keyword_info_normalized_with_info.KeywordInfoNormalizedWithInfo(
                    last_updated_time = '', 
                    search_volume = 56, 
                    monthly_searches = [
                        dataforseo_client.models.monthly_searches.MonthlySearches(
