    ...
    def make_instance(self, include_optional) -> AppendixDayStatisticsMoneyData:
        ...
        if include_optional:
            return AppendixDayStatisticsMoneyData(
                serp = dataforseo_client.models.appendix_serp_day_statistics_money_data.AppendixSerpDayStatisticsMoneyData(
                    task_post = 1.337, 
                ...
                on_page = dataforseo_client.models.appendix_on_page_day_statistics_money_data.AppendixOnPageDayStatisticsMoneyData(
                    task_post = 1.337, 
                    tasks_ready = 1.337, 
                    summary = 1.337, 
                    resources = 1.337, 
                    ...
                    refund_money = 1.337, ),
                total_on_page = 1.337,
                business_data = dataforseo_client.models.appendix_business_data_day_statistics_money_data.AppendixBusinessDataDayStatisticsMoneyData(
                ...
                app_data = dataforseo_client.models.appendix_app_data_day_statistics_money_data.AppendixAppDataDayStatisticsMoneyData(
                    ...
                    categories = 1.337, 
                    tasks_ready = 1.337, 
                    app_listings = dataforseo_client.models.appendix_business_data_day_limits_rates_data_info.AppendixBusinessDataDayLimitsRatesDataInfo(
