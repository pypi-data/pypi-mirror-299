...
class TestSerpGoogleDatasetInfoAdvancedItem(unittest.TestCase):
    """SerpGoogleDatasetInfoAdvancedItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SerpGoogleDatasetInfoAdvancedItem:
        """Test SerpGoogleDatasetInfoAdvancedItem
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SerpGoogleDatasetInfoAdvancedItem`
        """
        model = SerpGoogleDatasetInfoAdvancedItem()
        if include_optional:
            return SerpGoogleDatasetInfoAdvancedItem(
                type = '',
                rank_group = 56,
                rank_absolute = 56,
                position = '',
    ...
    def testSerpGoogleDatasetInfoAdvancedItem(self):
        """Test SerpGoogleDatasetInfoAdvancedItem"""
