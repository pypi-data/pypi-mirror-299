...
class TestAppendixKeywordsDataPriceDataInfo(unittest.TestCase):
    """AppendixKeywordsDataPriceDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixKeywordsDataPriceDataInfo:
        """Test AppendixKeywordsDataPriceDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixKeywordsDataPriceDataInfo`
        """
        model = AppendixKeywordsDataPriceDataInfo()
        if include_optional:
            return AppendixKeywordsDataPriceDataInfo(
    ...
    def testAppendixKeywordsDataPriceDataInfo(self):
        """Test AppendixKeywordsDataPriceDataInfo"""
