...
class TestOnPageContentParsingTaskInfo(unittest.TestCase):
    """OnPageContentParsingTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnPageContentParsingTaskInfo:
        """Test OnPageContentParsingTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnPageContentParsingTaskInfo`
        """
        model = OnPageContentParsingTaskInfo()
        if include_optional:
            return OnPageContentParsingTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.on_page_content_parsing_result_info.OnPageContentParsingResultInfo(
                        crawl_progress = '', 
    ...
    def testOnPageContentParsingTaskInfo(self):
        """Test OnPageContentParsingTaskInfo"""
