...
class Wrapper(L.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.idx.append(indices.flatten().cpu())
        self.gt.append(targets.flatten().cpu())
        self.pred.append(preds.flatten().cpu())
        self.loss.append(losses.flatten().cpu())
        self.conf.append(signed_confs.flatten().cpu())
        self.gt_conf.append(signed_target_confs.flatten().cpu())
