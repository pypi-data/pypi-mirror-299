...
class OfflineSQLProvider(OfflineProvider):
    ...
    def sql_transformation(
        ...
        **Examples**:
        ...
        if (
            snowflake_dynamic_table_config is not None
        ...
        return self.__registrar.sql_transformation(
            ...
            tags=tags,
            properties=properties,
            snowflake_dynamic_table_config=snowflake_dynamic_table_config,
        )
    ...
    def to_source(self) -> SourceVariant:
        return SourceVariant(
            ...
            definition=SQLTransformation(
                ...
                snowflake_dynamic_table_config=self.snowflake_dynamic_table_config,
            ),
            owner=self.owner,
...
class ColumnResource(ABC):
    ...
    def __init__(
        ...
        self.snowflake_dynamic_table_config = snowflake_dynamic_table_config
...
class Registrar:
    ...
    def sql_transformation(
        ...
        is_streaming: bool = False,
        streaming_inputs: Union[List[NameVariant], List[str], List[ColumnSourceRegistrar]] = None,
        description: str = "",
        args: K8sArgs = None,
        tags: List[str] = [],
        properties: dict = {},
