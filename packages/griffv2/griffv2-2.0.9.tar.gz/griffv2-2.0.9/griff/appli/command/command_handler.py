...
from griff.appli.policies.policy import PolicyResult, verify_policies, Policy
...
class CommandHandler(
    ...
    async def verify_policies(self, command: CM) -> PolicyResult:
        return await verify_policies(command, self.policies)
