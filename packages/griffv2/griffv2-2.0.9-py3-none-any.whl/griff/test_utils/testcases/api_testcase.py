...
from griff.infra.persistence.domain_persistence import QueryRowResults
...
class ApiTestCase(RuntimeTestMixin, TestCase, ABC):
    ...
    async def prepare_success_resultset(
        ...
        results: QueryRowResults = await repository._persistence.run_query("list_all")  # type: ignore # noqa: E501
        persistence = (
