...
class SessionManager:
    ...
    def request(
        ...
        headers={},
        can_retry=True,
        use_backoff=True,  # New parameter to control backoff behavior
        ...
        **kwargs,
        ...
        if use_backoff:
            ...
            return self._request_without_backoff(method, url, headers, can_retry, **kwargs)
    ...
    def _request_with_backoff(
        ...
        **kwargs,
        ...
        return self._execute_request(method, url, headers, can_retry, **kwargs)

    def _request_without_backoff(
        self,
        method,
        url,
        headers,
        ...
        **kwargs,
        ...
        try:
            ...
            try:
                ...
                e.args = (f"{e.args[0]}: {response.text}",) + e.args[1:]
                raise
            return response
        except SSLError as ssl_error:
            with no_ssl_verification():
                return self.request(
                    method=method, url=url, headers=headers, can_retry=can_retry, **kwargs
                )
        except HTTPError as e:
