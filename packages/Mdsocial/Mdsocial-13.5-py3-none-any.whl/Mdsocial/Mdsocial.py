...
class Instagram:
    ...
    def info(user):
        ...
        'fbm_124024574287414': 'base_domain=k.instagram.com',
        'ps_l': '1',
        'ps_n': '1',
        'fbsr_124024574287414': 'VwV0fKvhTOBgp2hbwu5qU5MmGpJ95vN-VbqPhXJImvo.',
        'csrftoken': 'DrjO4V9F8KTFfcs4nNy047kcRmoRP3xn',
        'ds_user_id': '64540361093',
        'sessionid': '64540361093%3AnGgy46TtVRbsXP%3A26%3AAYcvqSHkCsv7-sj9JWlwhczMyk9VHb1J-9adZjTbFQ',
        'shbid': f'"{uuid.uuid4().hex}"',
        'shbts': f'"{uuid.uuid4().hex}"',
        'fbsr_124024574287414': 'VwV0fKvhTOBgp2hbwu5qU5MmGpJ95vN-VbqPhXJImvo.',
        'wd': '958x945',
        'rur': f'"{uuid.uuid4().hex}"',
    }
                    ...
                    headers = {
                        ...
                        'origin': 'https://www.instagram.com',
                        'priority': 'u=1, i',
                        'referer': 'https://www.instagram.com/zw.zh4810/',
                    ...
                    params = {
                        ...
                        'type': 'app',
                        '__bkv': '09fff58deeb88769a507e6a0c5ca827764e30d356854bd9db4b62367e4060664',
                    }
                    ...
                    data = {
                        ...
                        '__ccg': 'UNKNOWN',
                        '__rev': '1017025230',
                        '__s': '0kbubm:cs0tx9:huy92b',
                        '__hsi': '7421543101816974423',
                        ...
                        '__csr': 'gD1fdb2YjM_4Ygx4jZHNad4G-JN298YyZLFVXIzilFBQjhyBAqaBhbjAjhcOGhJGlvhRzqz4GhqmGnQQq9JCLgGGK-VKipUR4XAOK8mQcVUF4igOdABz66eeGRF2VoymuQmSuQaVm9K-HDWWm_x2awAyonxp004QJU5G44axSqWLx22h0DzU2uwXw5eDwDho1uE18x68wAwMwTwOJzHoaU3lw1Zkw2Ww2982uBwhogxrwpcWx519k310r8cUhClwlxhlEq6odkrgi80FUcCym0LpkmoE2vChE5q1zCy888mg26yo5a0AU4i182A81f81qwgoK17w0Khw0j7o0m_w',
                        '__comet_req': '7',
                        'fb_dtsg': 'NAcOt0pQ-qLX8lfESwj4T4xItITzBy0Nsvk6IMYmuI_4ImT2j-3HBwg:17854231342124680:1727962655',
                        'jazoest': '26212',
                        'lsd': 'XMByonPbPPYOUsHY4EadXG',
                        '__spin_r': '1017025230',
                        '__spin_b': 'trunk',
                        '__spin_t': '1727962657',
                        'params': '{"referer_type":"ProfileUsername","target_user_id":"{id}"}'.replace("{id}",id),
                    }
                    ...
                    # البحث عن نص يشبه "June 2012" (الشهر والسنة)
                    match = re.search(r'"\w+\s\d{4}"', response_text)

                    if match:
                        # طباعة التاريخ المستخرج
