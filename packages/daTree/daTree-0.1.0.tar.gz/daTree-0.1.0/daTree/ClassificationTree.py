...
class DecisionTree:
    ...
    def grow_tree(self, data = pd.DataFrame(), target = None, crit = None, max_depth = float('inf'), act_depth = 0, min_gain = 0, min_leaf_cases=0):
            ...
            if len(list_of_splits) > 0:
                ...
                if best_gain >= min_gain:
                	...
                	for i in range(len(list_of_subsets)):
                		...
                		self.grow_tree(new_input_subset, target, self.criterion, max_depth, act_depth+1, min_gain, min_leaf_cases)
