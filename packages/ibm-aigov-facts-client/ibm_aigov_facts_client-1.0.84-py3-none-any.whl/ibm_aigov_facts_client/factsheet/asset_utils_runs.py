...
class NotebookExperimentRunsUtilities:
    ...
    def _get_cpd_image_val(self):
        ...
        if "hotfix483" in cpd_image_val or (self._is_cp4d and self._cp4d_version >= "5.1.0") or (not self._is_cp4d): #conditions cpd hotfix 483, 485, 510 and above, sas supported
            return True
        return False
    ...
    def set_custom_run_facts(self, metrics: Dict[str, Any] = None, params: Dict[str, Any] = None,
        ...
        if cams_response and self._get_cpd_image_val():
            # op sync code
