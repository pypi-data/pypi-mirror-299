...
class ModelUsecaseUtilities:
    ...
    def remove_approach(self, approach: ApproachUtilities = None):
        ...
        if (approach_id == "00000000-0000-0000-0000-000000000000"):
            ...
            if response.status_code == 204:
                ...
                raise ClientError(
                    "Failed in removing an approache. ERROR {}. {}".format(response.status_code, response.text))
    ...
    def get_approaches(self) -> list:
        ...
        if response.status_code == 200:
            ...
            raise ClientError(
                "Failed in retrieving an approache. ERROR {}. {}".format(response.status_code, response.text))
