...
class CableInventoryItemTable(BaseTable):
    ...
    name = tables.LinkColumn(
        'plugins:nautobot_cable_utils:cableinventoryitem_edit', args=[tables.A('pk')],
    ...
    class Meta(BaseTable.Meta):
        ...
        fields = (
            'pk', 'name', 'label', 'owner', 'type', 'plug', 'supplier', 'storage_rack', 'procurement_ident', 'length', 'color', 'in_use'
        )
        default_columns = (
            'pk', 'name', 'label', 'owner', 'type', 'plug', 'supplier', 'storage_rack', 'procurement_ident', 'length', 'color', 'in_use'
        )
