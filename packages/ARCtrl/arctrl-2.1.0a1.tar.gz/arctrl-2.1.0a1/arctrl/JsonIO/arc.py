...
def encoder(isa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow3058(value: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow3060(value_2: str, isa: Any=isa) -> IEncodable:
    ...
    def _arrow3061(oa: ArcInvestigation, isa: Any=isa) -> IEncodable:
        return ROCrate_encoder(oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow3058, "CreativeWork"), try_include("@id", _arrow3060, "ro-crate-metadata.json"), try_include("about", _arrow3061, isa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue)]))
...
def _arrow3063(get: IGetters) -> ArcInvestigation | None:
    object_arg: IOptionalGetter = get.Optional
    return object_arg.Field("about", ROCrate_decoder)


decoder: Decoder_1[ArcInvestigation | None] = object(_arrow3063)
