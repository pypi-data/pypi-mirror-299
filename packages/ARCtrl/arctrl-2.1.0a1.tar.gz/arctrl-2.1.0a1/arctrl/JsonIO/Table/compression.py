...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3021())
    class ObjectExpr3022:
        @property
    ...
    cell_table: Any = Dictionary([], ObjectExpr3022())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3026(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3025(__unit: None=None) -> Array[CompositeCell]:
