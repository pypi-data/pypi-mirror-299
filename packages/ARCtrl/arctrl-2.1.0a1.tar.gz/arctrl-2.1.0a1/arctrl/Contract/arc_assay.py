...
def ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(this: ArcAssay, WithFolder: bool | None=None) -> Array[Contract]:
    ...
    def _arrow2954(__unit: None=None, this: Any=this, WithFolder: Any=WithFolder) -> IEnumerable_1[Contract]:
        ...
        return append(_arrow2952() if with_folder else empty(), delay(_arrow2953))

    return to_array(delay(_arrow2954))
