...
class ObjectExpr55(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr55()

class ObjectExpr58(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow56(__unit: None=None) -> str:
                return out_arg

            def _arrow57(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow56, _arrow57)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr58()

class ObjectExpr59(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr59()

class ObjectExpr62(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow60(__unit: None=None) -> int8:
                return out_arg

            def _arrow61(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow60, _arrow61)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr62()

class ObjectExpr65(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow63(__unit: None=None) -> uint8:
                return out_arg

            def _arrow64(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow63, _arrow64)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr65()

class ObjectExpr68(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow66(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow67(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow66, _arrow67)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr68()
