...
def _arrow2230(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2231(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2232(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2233(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2230, ROCrate_decoder_1), map(_arrow2231, ROCrate_decoder_2), map(_arrow2232, ROCrate_decoder_3), map(_arrow2233, ROCrate_decoder_4)]))
...
def _arrow2236(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2237(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2238(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2239(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2236, ISAJson_decoder_1), map(_arrow2237, ISAJson_decoder_2), map(_arrow2238, ISAJson_decoder_3), map(_arrow2239, ISAJson_decoder_4)]))
