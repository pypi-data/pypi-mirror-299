...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2222(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2225(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2226(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2222()), ("@type", list_1_2(singleton(ObjectExpr2223()))), try_include("name", _arrow2225, oa.Name), try_include_list("additionalProperties", _arrow2226, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2234(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2229(__unit: None=None) -> str:
        ...
        if (_arrow2229() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2234()
