...
def _arrow2388(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2388
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2394(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2398(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2401(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2406(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2394()), ("table", encoder(template.Table)), ("name", _arrow2398()), ("description", _arrow2401()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2406()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2446(get: IGetters) -> Template:
    ...
    def _arrow2442(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2444(__unit: None=None) -> Any:
        object_arg_9: IRequiredGetter = get.Required
        return object_arg_9.Field("last_updated", Decode_datetime)

    return Template.create(_arrow2430(), _arrow2431(), _arrow2432(), _arrow2433(), _arrow2434(), _arrow2435(), _arrow2436(), _arrow2438(), _arrow2442(), _arrow2444())


Template_decoder: Decoder_1[Template] = object(_arrow2446)
...
def Template_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, template: Template) -> IEncodable:
    ...
    def _arrow2457(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_3: str = template.Name
    ...
    def _arrow2460(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_4: str = template.Description
    ...
    def _arrow2463(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_5: str = template.Version
    ...
    def _arrow2471(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2454()), ("table", encoder_compressed(string_table, oa_table, cell_table, template.Table)), ("name", _arrow2457()), ("description", _arrow2460()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2463()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", _arrow2471())])
...
def Template_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[Template]:
    def _arrow2490(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> Template:
        ...
        def _arrow2478(__unit: None=None) -> ArcTable:
        ...
        return Template.create(_arrow2475(), _arrow2478(), _arrow2479(), _arrow2481(), _arrow2483(), _arrow2485(), _arrow2486(), _arrow2487(), _arrow2488(), _arrow2489())
