...
def _arrow1556(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1549()), ("arc", ObjectExpr1550()), ("CreativeWork", ObjectExpr1551()), ("about", ObjectExpr1552()), ("conformsTo", ObjectExpr1553())])
