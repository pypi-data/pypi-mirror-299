...
def _arrow2866(get: IGetters) -> ArcInvestigation:
    identifier: str
    ...
    def _arrow2855(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
    ...
    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow2855(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr2857:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow2856(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr2857()))
    ...
    def _arrow2861(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("publicReleaseDate", string)

    def _arrow2862(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    def _arrow2863(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow2864(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow2865(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifier, _arrow2858(), _arrow2859(), _arrow2860(), _arrow2861(), _arrow2862(), _arrow2863(), _arrow2864(), assays, studies, study_identifiers, _arrow2865())


ROCrate_decoder: Decoder_1[ArcInvestigation] = object(_arrow2866)
...
def ROCrate_encodeRoCrate(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2870(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2872(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2873(oa_1: ArcInvestigation, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow2870, "CreativeWork"), try_include("@id", _arrow2872, "ro-crate-metadata.json"), try_include("about", _arrow2873, oa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue_1)]))
...
def ISAJson_encoder(id_map: Any | None, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2878(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2880(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2894(value_3: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2896(value_5: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2898(value_7: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2900(value_9: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2901(osr: OntologySourceReference, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_1(id_map, osr)

    def _arrow2902(oa: Publication, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_2(id_map, oa)

    def _arrow2903(person: Person, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_3(id_map, person)

    def _arrow2904(s: ArcStudy, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_4(id_map, None, s)

    def _arrow2905(comment: Comment, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_5(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2878()), ("filename", _arrow2880()), ("identifier", _arrow2882()), try_include("title", _arrow2894, inv.Title), try_include("description", _arrow2896, inv.Description), try_include("submissionDate", _arrow2898, inv.SubmissionDate), try_include("publicReleaseDate", _arrow2900, inv.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow2901, inv.OntologySourceReferences), try_include_seq("publications", _arrow2902, inv.Publications), try_include_seq("people", _arrow2903, inv.Contacts), try_include_seq("studies", _arrow2904, inv.Studies), try_include_seq("comments", _arrow2905, inv.Comments)]))
...
def _arrow2918(get: IGetters) -> ArcInvestigation:
    identifer: str
    match_value: str | None
    object_arg: IOptionalGetter = get.Optional
    match_value = object_arg.Field("identifier", string)
    identifer = create_missing_identifier() if (match_value is None) else match_value
    def _arrow2907(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
        arg_3: Decoder_1[FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]]] = list_1_1(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("studies", arg_3)

    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow2907(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr2909:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow2908(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr2909()))
    studies: Array[ArcStudy] = list(studies_raw)
    def mapping(a_1: ArcStudy) -> str:
        return a_1.Identifier

    study_identifiers: Array[str] = list(map_1(mapping, studies_raw))
    def _arrow2910(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("title", string)

    def _arrow2911(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("description", string)
    ...
    def _arrow2914(__unit: None=None) -> Array[OntologySourceReference] | None:
        arg_13: Decoder_1[Array[OntologySourceReference]] = resize_array(ISAJson_decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("ontologySourceReferences", arg_13)

    def _arrow2915(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow2916(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ISAJson_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow2917(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifer, _arrow2910(), _arrow2911(), _arrow2912(), _arrow2913(), _arrow2914(), _arrow2915(), _arrow2916(), assays, studies, study_identifiers, _arrow2917())


ISAJson_decoder: Decoder_1[ArcInvestigation] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2918)
