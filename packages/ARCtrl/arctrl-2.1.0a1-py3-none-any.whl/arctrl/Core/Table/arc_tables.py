...
class ArcTables:
    def __init__(self, init_tables: Array[ArcTable]) -> None:
        ...
        self.tables: Array[ArcTable] = _expr684()
    ...
    def RemoveRowAt(self, table_index: int, row_index: int) -> None:
        this: ArcTables = self
        def _arrow667(table: ArcTable) -> None:
            table.RemoveRow(row_index)

        this.MapTableAt(table_index, _arrow667)
    ...
    def update_reference_tables_by_sheets(reference_tables: ArcTables, sheet_tables: ArcTables, keep_unused_ref_tables: bool | None=None) -> ArcTables:
        ...
        reference_table_map: Any = of_seq_1(choose(chooser, reference_tables.Tables), ObjectExpr672())
        def _arrow681(__unit: None=None) -> IEnumerable_1[ArcTable]:
            ...
            def _arrow677(__unit: None=None) -> Array[ArcTable]:
            ...
            class ObjectExpr679:
                @property
                def Equals(self) -> Callable[[str, str], bool]:
                    def _arrow678(x_2: str, y_1: str) -> bool:
                        return x_2 == y_1
            ...
            s: Array[ArcTable] = map_3(mapping_4, map_3(mapping_3, Array_groupBy(projection, map_3(mapping_2, _arrow677(), None), ObjectExpr679()), None), None)
        ...
        return ArcTables(list(_arrow681()))
