...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        def _arrow3072(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow3069(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow3070(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow3071(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow3069, _arrow3070, _arrow3071))

        return list_1(to_list(delay(_arrow3072)))
...
def encoder(obj: ROCrateObject) -> IEncodable:
    ...
    class ObjectExpr3073(IEncodable):
        def Encode(self, helpers: IEncoderHelpers_1[Any], obj: Any=obj) -> Any:
    ...
    return ObjectExpr3073()


def _arrow3086(__unit: None=None) -> Decoder_1[Any]:
    def decode(__unit: None=None) -> Decoder_1[Any]:
        class ObjectExpr3077(Decoder_1[ROCrateObject]):
            def Decode(self, helpers: IDecoderHelpers_1[Any], value: Any) -> FSharpResult_2[ROCrateObject, tuple[str, ErrorReason_1[__A_]]]:
                if helpers.is_object(value):
                    ...
                    def _arrow3074(__unit: None=None) -> str:
                        object_arg: IRequiredGetter = get.Required
                        return object_arg.Field("@id", string)

                    def _arrow3075(__unit: None=None) -> str:
                        object_arg_1: IRequiredGetter = get.Required
                        return object_arg_1.Field("@type", string)

                    o: ROCrateObject = ROCrateObject__ctor_Z2FC25A28(_arrow3074(), _arrow3075())
        ...
        decode_object: Decoder_1[ROCrateObject] = ObjectExpr3077()
        class ObjectExpr3079(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow3078(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow3078())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr3079()
        def _arrow3081(value_4: ROCrateObject) -> Any:
            return value_4

        def _arrow3082(value_5: Array[Any]) -> Any:
            return value_5

        def _arrow3083(value_6: str) -> Any:
            return value_6

        def _arrow3084(value_7: int) -> Any:
            return value_7

        def _arrow3085(value_8: Decimal) -> Any:
            return value_8

        return one_of(of_array([map_1(_arrow3081, decode_object), map_1(_arrow3082, resize_array), map_1(_arrow3083, string), map_1(_arrow3084, int_1), map_1(_arrow3085, decimal)]))

    return decode(None)


decoder: Decoder_1[Any] = _arrow3086()
