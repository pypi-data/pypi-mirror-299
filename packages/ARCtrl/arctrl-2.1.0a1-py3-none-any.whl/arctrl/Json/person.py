...
def encoder(person: Person) -> IEncodable:
    ...
    def _arrow1909(value: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1911(value_2: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1915(value_4: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1919(value_6: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1921(value_8: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1926(value_10: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1929(value_12: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1931(value_14: str, person: Any=person) -> IEncodable:
    ...
    def _arrow1933(value_16: str, person: Any=person) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("firstName", _arrow1909, person.FirstName), try_include("lastName", _arrow1911, person.LastName), try_include("midInitials", _arrow1915, person.MidInitials), try_include("orcid", _arrow1919, person.ORCID), try_include("email", _arrow1921, person.EMail), try_include("phone", _arrow1926, person.Phone), try_include("fax", _arrow1929, person.Fax), try_include("address", _arrow1931, person.Address), try_include("affiliation", _arrow1933, person.Affiliation), try_include_seq("roles", _arrow1935, person.Roles), try_include_seq("comments", _arrow1936, person.Comments)]))
...
def _arrow1949(get: IGetters) -> Person:
    ...
    def _arrow1947(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    return Person(_arrow1938(), _arrow1939(), _arrow1940(), _arrow1941(), _arrow1942(), _arrow1943(), _arrow1944(), _arrow1945(), _arrow1946(), _arrow1947(), _arrow1948())


decoder: Decoder_1[Person] = object(_arrow1949)
...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow1953(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr1951()), ("@id", _arrow1953()), ("name", ObjectExpr1954()), ("@context", context_jsonvalue)])
...
def _arrow1956(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow1956)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow1966(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = ROCrate_genID(oa)
        class ObjectExpr1965(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr1965()

    class ObjectExpr1968(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_1.encode_string("Person")

    def _arrow1970(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1974(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1977(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1981(value_8: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1966()), ("@type", ObjectExpr1968()), try_include("orcid", _arrow1970, oa.ORCID), try_include("firstName", _arrow1974, oa.FirstName), try_include("lastName", _arrow1977, oa.LastName), try_include("midInitials", _arrow1981, oa.MidInitials), try_include("email", _arrow1985, oa.EMail), try_include("phone", _arrow1987, oa.Phone), try_include("fax", _arrow1989, oa.Fax), try_include("address", _arrow1991, oa.Address), try_include("affiliation", _arrow1992, oa.Affiliation), try_include_seq("roles", _arrow1993, oa.Roles), try_include_seq("comments", _arrow1994, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow2007(get: IGetters) -> Person:
    def _arrow1996(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("orcid", string)

    def _arrow1997(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("lastName", string)

    def _arrow1998(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("firstName", string)

    def _arrow1999(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("midInitials", string)
    ...
    def _arrow2005(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow2006(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow1996(), _arrow1997(), _arrow1998(), _arrow1999(), _arrow2000(), _arrow2001(), _arrow2002(), _arrow2003(), _arrow2004(), _arrow2005(), _arrow2006())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2007)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2016(value_1: str, name: Any=name) -> IEncodable:
            class ObjectExpr2015(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_1)

            return ObjectExpr2015()

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2014()), try_include("name", _arrow2016, name), ("@context", context_minimal_json_value)]))
