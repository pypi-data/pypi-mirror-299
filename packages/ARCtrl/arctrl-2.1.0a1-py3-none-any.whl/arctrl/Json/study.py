...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow2689(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow2688(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow2688

        encoded_protocols = try_include_list("protocols", _arrow2689(), value_5)
        ...
        def _arrow2693(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2696(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2698(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2700(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2702(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2704(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2705(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow2706(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow2707(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2709(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow2708(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow2708

        def _arrow2711(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow2710(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow2710

        def _arrow2712(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2693()), ("filename", ObjectExpr2694()), ("identifier", _arrow2696()), try_include("title", _arrow2698, study.Title), try_include("description", _arrow2700, study.Description), try_include("submissionDate", _arrow2702, study.SubmissionDate), try_include("publicReleaseDate", _arrow2704, study.PublicReleaseDate), try_include_seq("publications", _arrow2705, study.Publications), try_include_seq("people", _arrow2706, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow2707, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow2709(), processes), try_include_seq("assays", _arrow2711(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow2712, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow2716(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow2716, f, s, id_map)
...
def _arrow2734(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2722(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    def def_thunk(__unit: None=None) -> str:
        def _arrow2723(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("filename", string)

        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow2723()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow2722(), def_thunk)
