...
def _arrow2302(get: IGetters) -> Process:
    ...
    def _arrow2295(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2296(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
    ...
    def _arrow2299(__unit: None=None) -> FSharpList[ProcessInput] | None:
        arg_13: Decoder_1[FSharpList[ProcessInput]] = list_1_2(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("inputs", arg_13)

    def _arrow2300(__unit: None=None) -> FSharpList[ProcessOutput] | None:
        arg_15: Decoder_1[FSharpList[ProcessOutput]] = list_1_2(ROCrate_decoder_4)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("outputs", arg_15)

    def _arrow2301(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_5)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Process(_arrow2293(), _arrow2294(), _arrow2295(), _arrow2296(), _arrow2297(), _arrow2298(), None, None, _arrow2299(), _arrow2300(), _arrow2301())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2302)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2306(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2308(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2309(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2310(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2312(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2314(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2315(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2316(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2317(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2318(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2319(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2306, ROCrate_genID(oa_1)), try_include("name", _arrow2308, oa_1.Name), try_include("executesProtocol", _arrow2309, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2310, oa_1.ParameterValues), try_include("performer", _arrow2312, oa_1.Performer), try_include("date", _arrow2314, oa_1.Date), try_include("previousProcess", _arrow2315, oa_1.PreviousProcess), try_include("nextProcess", _arrow2316, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2317, oa_1.Inputs), try_include_list_opt("outputs", _arrow2318, oa_1.Outputs), try_include_list_opt("comments", _arrow2319, oa_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2321(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2321, f, oa, id_map)
...
def _arrow2337(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2336(get: IGetters) -> Process:
            def _arrow2322(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2323(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2324(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2326(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
