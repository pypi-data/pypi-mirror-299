...
def encoder(table: ArcTable) -> IEncodable:
    def _arrow2381(__unit: None=None, table: Any=table) -> IEnumerable_1[tuple[str, IEncodable]]:
        ...
        def _arrow2380(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            ...
            def _arrow2379(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                ...
                def _arrow2377(__unit: None=None) -> IEnumerable_1[tuple[tuple[int, int], CompositeCell]]:
                    def _arrow2376(match_value: Any) -> IEnumerable_1[tuple[tuple[int, int], CompositeCell]]:
                    ...
                    return collect(_arrow2376, table.Values)

                class ObjectExpr2378:
                    @property
                    def Compare(self) -> Callable[[tuple[int, int], tuple[int, int]], int]:
                        return compare_arrays

                return singleton(("values", map_1(key_encoder, encoder_2, of_seq(to_list(delay(_arrow2377)), ObjectExpr2378())))) if (len(table.Values) != 0) else empty()

            return append(singleton(("header", list_1(to_list(delay(_arrow2371))))) if (len(table.Headers) != 0) else empty(), delay(_arrow2379))

        return append(singleton(("name", _arrow2370())), delay(_arrow2380))

    values: IEnumerable_1[tuple[str, IEncodable]] = to_list(delay(_arrow2381))
...
def _arrow2390(get: IGetters) -> ArcTable:
    def _arrow2383(__unit: None=None) -> FSharpList[CompositeHeader] | None:
        arg_1: Decoder_1[FSharpList[CompositeHeader]] = list_1_1(decoder_1)
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("header", arg_1)

    decoded_header: Array[CompositeHeader] = list(default_arg(_arrow2383(), empty_1()))
    def _arrow2384(__unit: None=None) -> Any | None:
        arg_3: Decoder_1[Any] = map_0027(tuple2_1(int_1, int_1), decoder_2)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("values", arg_3)

    class ObjectExpr2385:
        @property
        def Compare(self) -> Callable[[tuple[int, int], tuple[int, int]], int]:
            return compare_arrays

    class ObjectExpr2386:
        @property
    ...
    decoded_values: Any = Dictionary(default_arg(_arrow2384(), empty_2(ObjectExpr2385())), ObjectExpr2386())
    def _arrow2389(__unit: None=None) -> str:
        object_arg_2: IRequiredGetter = get.Required
        return object_arg_2.Field("name", string)

    return ArcTable.create(_arrow2389(), decoded_header, decoded_values)


decoder: Decoder_1[ArcTable] = object(_arrow2390)
...
def encoder_compressed_column(column_index: int, row_count: int, cell_table: Any, table: ArcTable) -> IEncodable:
    if True if table.Headers[column_index].IsIOType else (row_count < 100):
        def _arrow2392(__unit: None=None, column_index: Any=column_index, row_count: Any=row_count, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[IEncodable]:
            def _arrow2391(r: int) -> IEncodable:
                return encode_cell(cell_table, get_item_from_dict(table.Values, (column_index, r)))

            return map(_arrow2391, range_big_int(0, 1, row_count - 1))

        values: Array[IEncodable] = to_array(delay(_arrow2392))
        ...
        from_: int = 0
        def _arrow2427(__unit: None=None, column_index: Any=column_index, row_count: Any=row_count, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[IEncodable]:
            def _arrow2415(i: int) -> IEnumerable_1[IEncodable]:
                next_1: CompositeCell = get_item_from_dict(table.Values, (column_index, i))
                def _arrow2412(__unit: None=None) -> IEncodable:
                    def _arrow2404(__unit: None=None) -> IEncodable:
                    ...
                    def _arrow2408(__unit: None=None) -> IEncodable:
                    ...
                    values_1: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("f", _arrow2404()), ("t", _arrow2408()), ("v", encode_cell(cell_table, current))])
                ...
                def _arrow2413(__unit: None=None) -> IEnumerable_1[IEncodable]:
                    nonlocal current, from_
                    current = next_1
                    from_ = i or 0
                    return empty()

                return append(singleton(_arrow2412()), delay(_arrow2413)) if (not equals(next_1, current)) else empty()

            def _arrow2426(__unit: None=None) -> IEnumerable_1[IEncodable]:
                def _arrow2425(__unit: None=None) -> IEncodable:
                    def _arrow2418(__unit: None=None) -> IEncodable:
                    ...
                    def _arrow2422(__unit: None=None) -> IEncodable:
                    ...
                    values_2: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("f", _arrow2418()), ("t", _arrow2422()), ("v", encode_cell(cell_table, current))])
                ...
                return singleton(_arrow2425())

            return append(collect(_arrow2415, range_big_int(1, 1, row_count - 1)), delay(_arrow2426))

        values_3: Array[IEncodable] = to_array(delay(_arrow2427))
...
def decoder_compressed_column(cell_table: Array[CompositeCell], table: ArcTable, column_index: int) -> Decoder_1[None]:
    class ObjectExpr2450(Decoder_1[None]):
        def Decode(self, helper: IDecoderHelpers_1[Any], column: Any, cell_table: Any=cell_table, table: Any=table, column_index: Any=column_index) -> FSharpResult_2[None, tuple[str, ErrorReason_1[__A_]]]:
            ...
            if match_value.tag == 1:
                def _arrow2440(get: IGetters) -> None:
                    from_: int
                ...
                range_decoder: Decoder_1[None] = object(_arrow2440)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, table: ArcTable) -> IEncodable:
    def _arrow2469(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, table: Any=table) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow2468(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow2462(__unit: None=None) -> IEnumerable_1[IEncodable]:
                return map(encoder_1, table.Headers)

            def _arrow2467(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                if len(table.Values) != 0:
                    row_count: int = table.RowCount or 0
                    def _arrow2465(__unit: None=None) -> IEnumerable_1[IEncodable]:
                        def _arrow2464(c: int) -> IEncodable:
                            return encoder_compressed_column(c, row_count, cell_table, table)

                        return map(_arrow2464, range_big_int(0, 1, table.ColumnCount - 1))

                    columns: Array[IEncodable] = to_array(delay(_arrow2465))
            ...
            return append(singleton(("h", list_1(to_list(delay(_arrow2462))))) if (len(table.Headers) != 0) else empty(), delay(_arrow2467))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcTable]:
    def _arrow2484(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcTable:
        def _arrow2474(__unit: None=None) -> FSharpList[CompositeHeader] | None:
            arg_1: Decoder_1[FSharpList[CompositeHeader]] = list_1_1(decoder_1)
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("h", arg_1)

        decoded_header: Array[CompositeHeader] = list(default_arg(_arrow2474(), empty_1()))
        def _arrow2476(__unit: None=None) -> str:
            arg_3: Decoder_1[str] = decode_string(string_table)
            object_arg_1: IRequiredGetter = get.Required
            return object_arg_1.Field("n", arg_3)

        class ObjectExpr2477:
            @property
            def Equals(self) -> Callable[[tuple[int, int], tuple[int, int]], bool]:
                return equal_arrays
        ...
        table: ArcTable = ArcTable.create(_arrow2476(), decoded_header, Dictionary([], ObjectExpr2477()))
        def _arrow2482(__unit: None=None) -> Array[None] | None:
            def _arrow2480(column_index: int) -> Decoder_1[None]:
                return decoder_compressed_column(cell_table, table, column_index)

            arg_5: Decoder_1[Array[None]] = arrayi(_arrow2480)
