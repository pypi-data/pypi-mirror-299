...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3110(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3109:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3108(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr3109())
        ...
        def _arrow3113(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3112(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3111(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow3111))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3112))

        return list(to_list(delay(_arrow3113)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3116(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3115:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3114(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr3115())
        ...
        def _arrow3118(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3117(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3117))

        return list(to_list(delay(_arrow3118)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3121(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3120:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3119(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr3120())
        ...
        def _arrow3123(__unit: None=None) -> IEnumerable_1[Contract]:
            ...
            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3122))
    ...
    def GetUpdateContracts(self, __unit: None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow3124(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow3125(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow3139(__unit: None=None) -> Array[Contract]:
            ...
            def _arrow3138(__unit: None=None) -> IEnumerable_1[Contract]:
                ...
                def _arrow3137(__unit: None=None) -> IEnumerable_1[Contract]:
                    inv_2.StaticHash = hash_1 or 0
                    def _arrow3130(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow3129(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow3128(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                def _arrow3126(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_2, safe_hash(dm_2))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3126))
                                ...
                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3127))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3129))

                    def _arrow3136(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3135(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow3134(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow3133(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow3131(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3131))
                                    ...
                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3132))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3134))

                        return collect(_arrow3135, inv_2.Assays)

                    return append(collect(_arrow3130, inv_2.Studies), delay(_arrow3136))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow3137))

            return to_array(delay(_arrow3138))

        return (_arrow3125() if _arrow3124() else _arrow3139()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow3143(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3142(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3141(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3140))

                return append(singleton(gitattributes_contract), delay(_arrow3141))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow3142))

        return to_array(delay(_arrow3143))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow3151(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3150(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3149(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3148(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3147(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3146(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3145(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3145))

                                return append(singleton(text_value), delay(_arrow3146))

                            return collect(_arrow3147, table.Values)

                        return collect(_arrow3148, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3149))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3150))

            class ObjectExpr3152:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3151)), ObjectExpr3152())

        class ObjectExpr3153:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow3160(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3159(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3158(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3157(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3156(kv_1: Any) -> IEnumerable_1[str]:
                                text_value_1: str = kv_1[1].ToFreeTextCell().AsFreeText
                                def _arrow3155(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3154(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + assay_foldername) + "/") + "protocols") + "/") + text_value_1) + "")

                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3154))

                                return append(singleton(text_value_1), delay(_arrow3155))

                            return collect(_arrow3156, table_1.Values)

                        return collect(_arrow3157, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3158))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3159))

            class ObjectExpr3161:
                @property
                def Compare(self) -> Callable[[str, str], int]:
                    return compare_primitives

            return of_seq(to_list(delay(_arrow3160)), ObjectExpr3161())

        class ObjectExpr3162:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        class ObjectExpr3163:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3144()), union_many(map(mapping_3, registered_studies, None), ObjectExpr3153()), union_many(map(mapping_4, registered_assays, None), ObjectExpr3162())]), ObjectExpr3163())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3164(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3164)(tree_1)

            else: 
                return tree_1


        def _arrow3166(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3165(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3165)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3166()), FileSystemTree.from_file_paths([]))
    ...
    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3167())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
    ...
    def DefaultContracts() -> Any:
        ...
        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3171())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow3172(__unit: None=None) -> ArcInvestigation | None:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        ...
        class ObjectExpr3175:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3174(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3175()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3177:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3176(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3177()):
            def predicate(p: str) -> bool:
