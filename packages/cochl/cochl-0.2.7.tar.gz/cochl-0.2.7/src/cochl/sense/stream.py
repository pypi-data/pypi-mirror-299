...
class AudioDataType(Enum):
    ...
    U24 = ("u24", 3)  # unsigned 3-byte
    U32 = ("u32", 4)  # unsigned 4-byte
...
class StreamBuffer:
    ...
    based on the given audio type and API configuration.
    """
    ...
    def __init__(self, audio_type: StreamAudioType, api_config: config.APIConfig):
        ...
        self.window_byte_size = audio_type.get_window_byte_size(api_config.window_size)
        self.window_hop_byte_size = int(self.window_byte_size / api_config.window_size * api_config.window_hop.second)
