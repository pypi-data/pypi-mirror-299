...
scaler_path = base_dir / 'scaler_custom.pkl'
...
# Custom scaling function (matches how you scaled the data earlier)
...
# Load the scaler min and max values
scaler_data = joblib.load('scaler_custom.pkl')
...
def predict_one_hour():
    ...
    # Fetch current and historical close data
    ...
    # Scale the data for the model using the custom scaler
