...
class WellTestInput(BaseModel):
    ...
    gauge_pressure: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Downhole gauge pressure, psig (downhole gauge must be available in downhole equipment table)", alias="gaugePressure")
    gauge_temperature: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Downhole gauge temperature, degF (downhole gauge must be available in downhole equipment table)", alias="gaugeTemperature")
    ...
    __properties: ClassVar[List[str]] = ["uwi", "date", "oilRate", "gasRate", "waterRate", "tubingPressure", "tubingTemperature", "casingPressure", "casingTemperature", "gaugePressure", "gaugeTemperature", "choke", "upstreamChokePressure", "downstreamChokePressure", "basicSedimentAndWater", "duration", "separatorPressure", "separatorTemperature"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WellTestInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WellTestInput from a dict"""
        if obj is None:
            return None
