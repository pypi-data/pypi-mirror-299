...
def add_feature_frames_v2(current_running_index, temp_text_file, directory, feature_images_urls, feature_desciption, feature_speech_objs): 
    ...
    current_total_audio_duration = 0.0
    ...
    for feature_images_url in feature_images_urls:  
        ...
        if show_first_feature_anim == True:
            ...
            #current_step_duration = current_step_duration + 5.96
            residual_time = 0
            if is_last_audio_in_step and ( current_total_duration + 5.96  ) > current_total_audio_duration:
                residual_time = ( current_total_duration + 5.96  ) - current_total_audio_duration
                print("found residual for build_first_feature_animation", residual_time, ' total_audio_duration_in_step ', current_total_audio_duration , ' current_step_duration ', current_total_duration)
            ...
            current_step_duration = current_step_duration + 5.44
            residual_time = 0
            if is_last_audio_in_step and ( current_total_duration + 5.44  ) > current_total_audio_duration:
                residual_time = ( current_total_duration + 5.44  ) - current_total_audio_duration
                print("found residual for build_feature_switch_anim", residual_time, ' total_audio_duration_in_step ', current_total_audio_duration, ' current_step_duration ', current_total_duration)
            ...
            if is_last_audio_in_step and ( current_total_duration + 2.12  ) > current_total_audio_duration:
                residual_time = ( current_total_duration + 2.12  ) - current_total_audio_duration
                print("found residual for build_third_animation", residual_time, ' total_audio_duration_in_step ', current_total_audio_duration, ' current_step_duration ', current_total_duration)
