    ...
    for feature_images_url in feature_images_urls:  
        ...
        if show_first_feature_anim == True:
            ...
            if is_last_audio_in_step:
                ...
                print("the total_audio_duration_in_step in this step was :", total_audio_duration_in_step, " after adding video the total time will be ", temp_current_total_duration + first_anim_default_duration, ' the audio index is : ', audio_index, ' 1st anim ' ) 
            ...
            if is_last_audio_in_step:
                ...
                print("the total_audio_duration_in_step in this step was :", total_audio_duration_in_step, " after adding video the total time will be ", temp_current_total_duration + switch_feature_default_duraion, ' the audio index is : ', audio_index , ' switch anim ' ) 
            ...
            if is_last_audio_in_step: 
                ...
                print("the total_audio_duration_in_step in this step was :", total_audio_duration_in_step, " after adding video the total time will be ", temp_current_total_duration + third_anim_default_duration, ' the audio index is : ', audio_index , ' 3rd anim ') 
...
def build_with_new_design(build_card_name, feature_descriptions, intro_text, preview_screen_text, process_mode, feature_images_urls, feature_ids, existing_audios, device, preview_feature_image_urls, feature_names, subscription_key, service_region):
    ...
    total_intitial_video_duration = video_duration + 7.16
