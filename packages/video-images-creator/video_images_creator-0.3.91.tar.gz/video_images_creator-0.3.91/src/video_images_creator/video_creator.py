    ...
    for feature_images_url in feature_images_urls:  
        ...
        if show_first_feature_anim == True:
            ...
            if is_last_audio_in_step and ( current_total_duration + 2.12  ) > current_total_audio_duration:
                ...
                print("found residual for build_third_animation", residual_time, ' total_audio_duration_in_step ', current_total_audio_duration, ' current_step_duration ', ( current_total_duration + 2.12 ) )
