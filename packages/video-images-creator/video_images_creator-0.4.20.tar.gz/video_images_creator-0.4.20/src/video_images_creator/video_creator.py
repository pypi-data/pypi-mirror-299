    ...
    for index in range(1,50):
        ...
        if continuation_mode == False:
            if index == 1 or index % 2 == 0:
                ...
                text_index = ( ( initial_running_index + running_index ) % initial_running_index ) 

        else: 
            if index == 1 or index % 2 == 0:
                text_index = ( ( initial_running_index + running_index ) ) + 1 
            else:
                text_index = ( ( initial_running_index + running_index ) )
...
def add_feature_frames_v2(current_running_index, temp_text_file, directory, feature_images_urls, feature_desciption, feature_speech_objs):
    ...
    animation_no = 1 
    current_total_duration = 16.19
    current_total_audio_duration = 16.5
    added_previous_residual_time = False
    first_anim_default_duration = 5.96
    switch_feature_default_duraion = 5.44
    third_anim_default_duration = 2.116
