        ...
        if self.FFMPEG_URL is None or self.FFMPEG_BINARY is None:
            if os.name == 'nt':
                ...
                if arch in ['x86_64', 'amd64']:
                    ...
                    self.FFMPEG_URL = (
                        'https://github.com/PauloCesar-dev404/binarios/blob/main/linux/ffmpeg-7.0.2-amd64.zip')
                    self.FFMPEG_BINARY = 'ffmpeg'
                elif arch in ['i686', 'x86']:
                    # Arquitetura de 32 bits
                    self.FFMPEG_URL = (
                        'https://github.com/PauloCesar-dev404/binarios/blob/main/linux/ffmpeg-7.0.2-i686.zip')
                    self.FFMPEG_BINARY = 'ffmpeg'
                elif arch in ['arm64', 'aarch64']:
                    # Arquitetura ARM de 64 bits
                    self.FFMPEG_URL = (
                        'https://github.com/PauloCesar-dev404/binarios/blob/main/linux/ffmpeg-7.0.2-arm64.zip')
                    self.FFMPEG_BINARY = 'ffmpeg'
                elif arch in ['arm', 'armhf', 'armel']:
                    # Arquitetura ARM de 32 bits
                    self.FFMPEG_URL = (
                        'https://github.com/PauloCesar-dev404/binarios/blob/main/linux/ffmpeg-7.0.2-armel.zip')
                    self.FFMPEG_BINARY = 'ffmpeg'
                else:
