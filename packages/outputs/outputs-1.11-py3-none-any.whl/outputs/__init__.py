            ...
            **参数用途**：
            ...
            if pinkshell is False:
                ...
                for i in list(char):
                    ...
                    time.sleep(verbatim)
                print() if not _screened.fatal else None
                window.error(text, title = '致命错误') if popup_window and not _screened.fatal else None
...
{color.green}{style.bold}版本：{style.rst}1.10（2024年9月19日更新）
