...
class FcoSearchResult(_message.Message):
    ...
    FEATURE_DESCRIPTIONS_FIELD_NUMBER: ClassVar[int]
    FEATURE_TAGS_FIELD_NUMBER: ClassVar[int]
...
class ListApiKeysResponse(_message.Message):
    ...
    def __init__(self, api_keys: Optional[Iterable[Union[_tecton_api_key_dto__client_pb2.TectonApiKeyDto, Mapping]]] = ...) -> None: ...
...
class QueryStateUpdateResponse(_message.Message):
    ...
    PLAN_INTEGRATION_VALIDATION_RESULT_FIELD_NUMBER: ClassVar[int]
    ...
    def __init__(self, ready: bool = ..., success: bool = ..., error: Optional[str] = ..., recreates_suppressed: bool = ..., validation_result: Optional[Union[_state_update__client_pb2.ValidationResult, Mapping]] = ..., diff_items: Optional[Iterable[Union[_state_update__client_pb2.FcoDiff, Mapping]]] = ..., latest_status_message: Optional[str] = ..., plan_integration_validation_result: Optional[Union[_state_update__client_pb2.ValidationResult, Mapping]] = ...) -> None: ...
