...
class RealtimeFeatureView(_RealtimeOrPromptBase):
    ...
    def __init__(
        ...
        *,
        ...
        _validate_rtfv_transformation_mode(mode, feature_view_function)
        ...
        if feature_view_function:
            ...
            pipeline_root = _build_join_inputs_pipeline(sources=sources)
...
def _validate_rtfv_transformation_mode(mode: Optional[str], feature_view_function: Optional[Callable]) -> None:
