...
from tecton.framework.utils import _convert_secret_to_sanitized_reference
...
class EMRJsonClusterConfig(StrictModel):
    ...
    .. _User Guide: https://docs.tecton.ai/docs/materializing-features/configure-spark-materialization/configuring-job-clusters-via-json#configuring-emr-job-clusters
    """
...
class KafkaConfig(BaseStreamConfig):
    ...
    def __init__(
        ...
        :param watermark_delay_threshold: (Default: 24h) Watermark time interval, e.g: timedelta(hours=36), used by Spark Structured Streaming to account for late-arriving data. See: [Productionizing a Stream](https://docs.tecton.ai/docs/defining-features/feature-views/stream-feature-view#productionizing-a-stream).
