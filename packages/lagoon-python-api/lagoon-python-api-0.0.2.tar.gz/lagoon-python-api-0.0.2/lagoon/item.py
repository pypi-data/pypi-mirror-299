...
class Item(Entity):
    """
    This class describes an Item object child of Lagoon class.
    """
    ...
    def create(self, type='', data={}, path=None):
        ...
        .. warning::
            We advice you to use :func:`~lagoon.item.Item.append` instead of :func:`~lagoon.item.Item.create`.
            This function will create an item, without inserting it to an existing hiearchy.
            Once the item is created, you should use Edge :func:`~lagoon.edge.Edge.create` function to connect it to an other existing item.
        .. tip::
        ...
        :returns:   Item object
        :rtype:     :class:`~lagoon.item.Item` or subclass
        """
    ...
    def append(self, type='', data={}, edge_type='Child', edge_data={}, apply_template=None, template_key=None, path=None):
        ...
        :param      template_key:    The template key to apply. If no template key, automatic context's template will be used.
        :type       template_key:    string, optional
        :param      path:            File path you want to upload on the appended item
        :type       path:            string, optional

        :returns:   Dictionary composed by an item and its edge.
        :rtype:     dict {item: :class:`~lagoon.item.Item`
        """
    ...
    def copy(self, parent_key=''):
        ...
        :rtype:     List of :class:`~lagoon.item.Item` or subclass : :class:`~lagoon.items.asset.Asset` | :class:`~lagoon.items.project.Project` | :class:`~lagoon.items.shot.Shot` | :class:`~lagoon.items.task.Task` | :class:`~lagoon.items.template.Template` | :class:`~lagoon.items.user.User` | :class:`~lagoon.items.usergroup.Usergroup`
        """
    ...
    def convert_to_template(self, parent_key=''):
        ...
        :rtype:     :class:`~lagoon.items.template.Template`
        """
    ...
    def apply_template(self, template_key=''):
        ...
        :returns:   Item object
        :rtype:     :class:`~lagoon.item.Item` or subclass : :class:`~lagoon.items.asset.Asset` | :class:`~lagoon.items.project.Project` | :class:`~lagoon.items.shot.Shot` | :class:`~lagoon.items.task.Task` | :class:`~lagoon.items.template.Template` | :class:`~lagoon.items.user.User` | :class:`~lagoon.items.usergroup.Usergroup`
        """
    ...
    def get_versions(self, populate=False):
        """
        Alias of :func:`~lagoon.items.item.get_history`
        """
    ...
    def update_permission(self, participant_key, permissions, propagate=True):
        ...
        .. tip::
            Available permissions are the same than :func:`~lagoon.item.Item.create_permission`
    ...
    def get_parents(self, limit = 50, offset = 0):
        ...
        :rtype:     list of {item: :class:`~lagoon.item.Item`, edge: :class:`~lagoon.edge.Edge`}
        """
    ...
    def move(self, old_parent_key=None, new_parent_key=None):
        ...
        :rtype:     dictionary {item: :class:`~lagoon.item.Item`,edge: :class:`~lagoon.edge.Edge`}
        """
    ...
    def delete(self):
        ...
        .. danger::
            The item will be completely deleted. You can use :func:`~lagoon.item.Item.trash` instead
    ...
    def upload_file(self, path='', data = {}, message = None):
        ...
        .. warning::
            ...
            We advice you to use :func:`~lagoon.item.Item.append` if you want to upload the file as a new item.
