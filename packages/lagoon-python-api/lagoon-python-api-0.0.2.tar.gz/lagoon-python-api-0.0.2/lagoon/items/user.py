...
class User(Item):
    ...
    def set_data_variables(self, data={}):
        ...
        :param      data:  The object item from Lagoon API
    ...
    def signin(self, email='', password=''):
        ...
        :rtype: Dict {user: :class:`~lagoon.items.user.User`}
        """
    ...
    def connect(self, email='', password=''):
        """
        Alias of :func:`~lagoon.items.user.User.signin`
        """
    ...
    def signout(self):
        ...
        .. note::
            After a :func:`~lagoon.items.user.User.signout`, you need to use a :func:`~lagoon.items.user.User.signin` before sending authenticated requests
    ...
    def get_tasks(self, project_key='', task_status='', task_name='', task_completed=False):
        ...
        :rtype:     List of dict {item: :class:`~lagoon.items.task.Task`, edge: :class:`~lagoon.edge.Edge`}
        """
        task = list()
        query = list()
    ...
    def forgot_password(self, lagoon_url=None):
        """
        ...
        if (email is not None):
            ...
            headers = {
                'origin': lagoon_url or self.parent.api_url
            }
            self.do_request(
