...
def update_all_metadata_command(
    ...
    try:
        response = update_all_metadata(target_id, ip, port, metadata_dict, username, client_id, password, token)
    except AuthenticationException as error:
        print(str(error))
        raise typer.Exit() from error
    except UnauthorizedException as error:
...
def update_bitsq_command(
    ...
    try:
        response = update_bitsq(target_id, ip, port, bitsq, username, client_id, password, token)
    except AuthenticationException as error:
        print(str(error))
        raise typer.Exit() from error
    except KeyError as error:
...
def delete_bitsq_command(
    ...
    try:
        response = delete_bitsq(target_id, ip, port, username, client_id, password, token)
    except AuthenticationException as error:
        print(str(error))
        raise typer.Exit() from error
    except KeyError as error:
...
def add_bitsq_command(
    ...
    try:
        response = add_bitsq(target_id, ip, port, bitsq, username, client_id, password, token)
    except AuthenticationException as error:
        print(str(error))
        raise typer.Exit() from error
    except KeyError as error:
