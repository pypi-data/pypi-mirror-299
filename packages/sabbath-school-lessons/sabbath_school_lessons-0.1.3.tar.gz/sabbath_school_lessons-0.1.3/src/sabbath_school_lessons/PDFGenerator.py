...
class markdown_to_pdf:
    def __init__(self, input_file, output_file, lesson_header_color=colors.red, lang="en", start_date=None, lesson_title="Provide a title", copyrightowner="Gospel Sounders", quarter="Quarter 4, 2024", lesson_book=None):
    ...
    def create_first_page_content(self):
        ...
        self.intro_content = [
            ...
            FirstPageRender(title, subtitle, copyright_info, width, height, title_color=colors.red, copyright_color=colors.gray,lesson_book=lesson_book),
            PageBreak()
        ] + self.intro_content
    ...
    def parse_sections(self):
        ...
        for section in sections:
            lesson_title = translations.lesson_title[self.lang]
