...
from typing import IO, TYPE_CHECKING, Any, Dict, List, Optional, Sequence, Union, cast

from google.protobuf import json_format

from buildgrid._protos.buildgrid.v2.monitoring_pb2 import BusMessage, LogRecord, MetricRecord
...
class MonitoringBus:
    def __init__(
        ...
        self._streaming_process: Optional[Process] = None
        self._stop_streaming_worker = Event()
        self._streaming_process_ppid: Optional[int] = None
    ...
    def send_record_nowait(self, record: Union[MetricRecord, LogRecord]) -> None:
