...
from typing import Any, Dict, Protocol, Tuple, Type, TypeVar, Union

GrpcTrailingMetadata = Tuple[Tuple[str, Union[str, bytes]], ...]
LogStreamConnectionConfig = Dict[str, Union[str, Dict[str, str]]]
