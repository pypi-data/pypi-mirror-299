...
class InstrumentClass():
    ...
    def InstrumentConnection(self):
        ...
        try:
            ...
            print('Attempt to connecto to ' + self.ConnectionType + '::' + self.port + '::INSTR')
...
class PowerMeterClass(InstrumentClass):
    ...
    def __init__(self, port, CalFile = None, AvgSamples = 0, ConnectionType = 'GPIB1'):
        InstrumentClass.__init__(self,port, ConnectionType = 'GPIB1')
