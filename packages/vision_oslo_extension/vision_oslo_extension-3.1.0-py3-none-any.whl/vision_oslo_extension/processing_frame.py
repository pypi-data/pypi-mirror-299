...
class P14(BasePage):
    ...
    def __init__(self, parent, controller):
        ...
        # add widgets here
        head = tk.Label(master=self.headframe, text = 'Page 13: DC Falling Voltage Protection Processing and Assessment',font = controller.sub_title_font)
        head.pack()
        ...
        option1 = tk.StringVar(value = "0") # Initialize with a value not used by the radio buttons
        choice1 = tk.Radiobutton(master=self.optionframe, text = 'Option 1: Falling Voltage Protection assessment with OSOP extraction, without scatter plots and step results', value="1", variable=option1)
        choice1.grid(row = 0, column = 0, sticky = "w", padx=5, pady=5)

        choice2 = tk.Radiobutton(master=self.optionframe, text = 'Option 2: Falling Voltage Protection assessment with OSOP extraction, with scatter plots and step results',value="2", variable=option1)
        choice2.grid(row = 1, column = 0, sticky = "w", padx=5, pady=5)

        choice3 = tk.Radiobutton(master=self.optionframe, text = 'Option 3: Falling Voltage Protection assessment without OSOP extraction, without scatter plots and step results', value="3", variable=option1)
        choice3.grid(row = 2, column = 0, sticky = "w", padx=5, pady=5)

        choice4 = tk.Radiobutton(master=self.optionframe, text = 'Option 4: Falling Voltage Protection assessment without OSOP extraction, with scatter plots and step results', value="4", variable=option1)
        choice4.grid(row = 3, column = 0, sticky = "w", padx=5, pady=5)
