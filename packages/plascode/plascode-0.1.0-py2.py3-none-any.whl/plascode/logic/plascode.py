...
# models / mappers
# ---------------------------------------------------------
# from ..models.plascode import PlascodeApp
# from .. import mappers
...
class PlascodeCrawler(iAsyncCrawler):
    "Example class for Plascode crawler"
    # MODEL = PlascodeApp
    ...
    async def get_data(self, kind, path, **kwargs):
        """
        Example a crawling function for Plascode crawler.
