...
from plascode.models.script import PlascodeScript as Item
from plascode.models.script import PlascodeScriptRequest as Request
from plascode.models.script import PlascodeScriptResponse as Response
...
@click.pass_obj
def script(env):
    """subcommands for managing scripts for plascode"""
...
@click.pass_obj
def create(env, path):
    """Create a new script for plascode"""
...
@click.pass_obj
def read(env):
    """Find and list existing scripts for plascode"""
    # force config loading
    config.callback()
...
@click.pass_obj
def update(env):
    """Update and existing scripts for plascode"""
    # force config loading
    config.callback()
...
@click.pass_obj
def delete(env):
    """Delete an existing scripts for plascode"""
    # force config loading
    config.callback()
