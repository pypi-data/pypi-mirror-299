...
for port in ACTIVE_PORTS:
    prefix= "/".join(["", "plascode", port.__name__.split('.')[-1]])
...
if __name__ == "__main__":
    """
    $ uvicorn plascode.plascode:app --reload --reload-delay 1 --reload-dir ~/your/code/plascode --reload-exclude 'venv' --loop uvloop
    """
