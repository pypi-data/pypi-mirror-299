...
class APIPath:
    def __init__(self, host):
        self.host = host
        self.findAchievementBelongerDetail = f"https://{self.host}/api/cs-pc-report/cs-report/reports/findAchievementBelongerDetail"
        self.arrange = f"https://{self.host}/api/cs-pc-edu/arrange/page"
        self.classInfo = f"https://{self.host}/api/cs-pc-edu/classInfo/page"
        self.queryClassStudentList = f"https://{self.host}/api/cs-pc-edu/classStudent/queryClassStudentList"
        self.findCourseSignCharge = f"https://{self.host}/api/cs-pc-report/cs-report/reports/findCourseSignCharge"
        self.findCourseSignChargeDetail = f"https://{self.host}/api/cs-pc-report/cs-report/reports/findCourseSignChargeDetail"
        self.curriculum = f"https://{self.host}/api/cs-pc-edu/curriculum/page"
        self.findOrderItemAll = f"https://{self.host}/api/cs-pc-report/cs-report/reports/findOrderItemAll/page"
        self.orderInfo = f"https://{self.host}/api/cs-edu/orderInfo/get"
        self.findDataReportList = f"https://{self.host}/api/cs-report/report/findDataReportList"
        self.student = f"https://{self.host}/api/cs-pc-crm/student/extendList"
        self.studentCourseCard = f"https://{self.host}/api/cs-pc-report/cs-report/reports/studentCourseCard/report"
        self.findStudentAttendCourse = f"https://{self.host}/api/cs-pc-edu/courseStudent/findStudentAttendCourse"
        self.becomeStudy = f"https://{self.host}/api/cs-pc-edu/student/becomeStudy"
        self.becomeHistory = f"https://{self.host}/api/cs-pc-edu/student/becomeHistory"
        self.listTeacher = f"https://{self.host}/api/cs-pc-crm/teacher/pageList"
        self.editTeacher = f"https://{self.host}/api/cs-pc-crm/teacher/editTeacher"
        self.createTeacher = f"https://{self.host}/api/cs-pc-crm/teacher/create"
        self.leaveTeacher = f"https://{self.host}/api/cs-pc-crm/teacher/leaveOffice"
        self.backTeacher = f"https://{self.host}/api/cs-pc-crm/teacher/backOffice"
