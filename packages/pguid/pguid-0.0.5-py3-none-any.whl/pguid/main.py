...
class pgUId:
  ...
  class elements:
    ...
    class Button:
      def __init__(self, function, texture=None, clicked_texture=None, background_color=None, x=0, y=0, tag=None, text=None, font="Arial", font_size=24, color="black", width=None, height=None) -> None:
      ...
      def config(self, texture=None, clicked_texture=None, background_color=None, tag=None, x=None, y=None, text=None, font=None, font_size=None, color=None, width=None, height=None):
          if texture is not None:
              self.texture = pygame.image.load(texture)
