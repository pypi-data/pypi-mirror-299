...
class BrickToAgxMapper(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(BrickToAgxMapper self, Simulation simulation, std::string const & source_id, std::shared_ptr< BrickAgx::AgxCache > agx_cache=0, std::shared_ptr< Brick::ErrorReporter > error_reporter=std::make_shared< Brick::ErrorReporter >()) -> BrickToAgxMapper
...
def load_brick_string(*args):
    r"""
    load_brick_string(Simulation simulation, std::string const & source, std::string const & bundle_paths, std::string const & modelname="") -> Result
...
def serialize_brick_file(*args):
    r"""
    serialize_brick_file(std::string const & path, std::string const & bundle_paths, std::string const & modelname="") -> std::string
