...
@define
class WrappingStrategyArrayDerivedTypeDeferredSize:
    """
    Wrapping strategy for arrays of derived types of a deferred size
    """
    ...
    """Suffix to use for variables that represent the shape of the array"""

    shape_callable_suffix: str = "_shape"
    """Suffix to use for callables that return the shape of the array"""
    ...
    def get_receiving_from_python_steps(  # noqa: D102, PLR0913
        ...
        return ReceivingFromPythonSteps(
            ...
            fortran_wrapper_callable_parameters=(
                (variable_instance_indexes, "integer, dimension(:)", value),
            ),
    ...
    def get_python_return_type_annotation(  # noqa: D102
        ...
        return_type = fdt.python_equivalent_type_annotation.replace(
            derived_type, derived_type_no_setters
        )
        # TODO: check if tuple or list is better.
        # This currently returns tuple
        return return_type
