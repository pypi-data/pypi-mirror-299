...
if __name__ == '__main__':
    ...
    win = Collapsible("Animation")
    butn = QPushButton("Click me!")
    butn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
    win.add_widget(butn)
    butn1 = QPushButton("Click me!")
    butn1.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
    win.add_widget(butn1)
    win.show()
    sys.exit(app.exec_())
