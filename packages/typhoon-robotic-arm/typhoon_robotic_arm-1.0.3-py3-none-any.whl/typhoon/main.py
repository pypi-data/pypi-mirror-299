...
class Typhoon():
    ...
    def __init__(self, port: str, start_x: int, start_y: int, start_z: int,
        ...
        self.START_JOINT1_ANGLE, self.START_JOINT2_ANGLE, self.START_JOINT3_ANGLE = calculations.angles_from_coords(start_x, start_y, start_z, tool_offset_x, tool_offset_y, tool_offset_z)
    ...
    def move_to(self, x: int, y: int, z: int) -> None:
        ...
        self.joint1_angle, self.joint2_angle, self.joint3_angle = calculations.angles_from_coords(self.x, self.y, self.z, self.TOOL_OFFSET_X, self.TOOL_OFFSET_Y, self.TOOL_OFFSET_Z)
    ...
    def move_home(self) -> None:
        ...
        communication.send(self.serial, "coords", f"0,0,0", output=self.OUTPUT)
