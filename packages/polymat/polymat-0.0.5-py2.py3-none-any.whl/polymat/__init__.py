...
# @do()
# def accumulate(expr: MatrixExpression):
#     def gen_sos_polynomial():
...
#     rows = tuple(gen_sos_polynomial())

#     if 1 < len(rows):
#         sos_polynomial = polymat.v_stack(rows)
#     else:
#         sos_polynomial = rows[0]