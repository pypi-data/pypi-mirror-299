...
class TrainingScoringClient:
    ...
    def create_training_set(
        ...
        return TrainingSet(
            ...
            kwargs.get(
                _USE_SPARK_NATIVE_JOIN,
                training_scoring_utils.get_default_use_spark_native_join(feature_spec),
            ),
        )
        ...
        **kwargs,
        ...
        with TempDir() as tmp_location:
            ...
            predict_udf = self._spark_client.get_predict_udf(
                raw_model_path, result_type=result_type, env_manager=env_manager
            )
        ...
        augmented_df = TrainingSet(
            ...
            use_spark_native_join=kwargs.get(
                _USE_SPARK_NATIVE_JOIN,
                training_scoring_utils.get_default_use_spark_native_join(feature_spec),
            ),
        )._augment_df()
