...
class NFCE:
    ...
    def __init__(self):
        ...
        self.__nNFFin = None
        self.cfop = ""
        self.icms_desonerado_desconto = False
    ...
    def retornarListaIdCFOP(self) -> List[str]:
        ...
        return [str(item.id_cfop) for item in self.lista_itens if item.id_cfop is not None]
    ...
    def calcular_cfop(self) -> str:
        ...
        return utilidades.elemento_mais_comum(self.retornarListaCFOP())

    def retornarIdCFOP(self) -> str:
        """Retorna o CFOP da Nota (o mais comum nos itens)"""
        return utilidades.elemento_mais_comum(self.retornarListaIdCFOP())
    ...
    def retornarDescontoTotal(self) -> float:
        """Retorna o valor total de descontos da NF"""
        desoneracao = self.vICMSDeson if self.icms_desonerado_desconto else 0
