...
from importador_docfis_lib.handler.destinatario_handler import DestinatarioHandler
from importador_docfis_lib.handler.evento_handler import EventoHandler
...
from importador_docfis_lib.handler.produto_handler import ProdutoHandler
