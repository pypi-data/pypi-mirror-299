...
class ProdutoDAO:
    ...
    def obterSQLInsertItem() -> str:
        ...
        """
        return f"insert into estoque.itens (id, item, id_grupo, reduzido, \
                ...
                tipomedicamento, tipocalctrib, unidadetrib, cest, produto) values ({','.join(['%s']*23)})"
    ...
    def obterSQLInsertProduto() -> str:
        ...
        """
        return f"insert into estoque.produtos(produto, codigo, especificacao,\
                TipoProduto, Bloqueado, OrigemMercadoria, codigodebarras, \
                tipodemedicamento, TIPI, unidadedemedida, cest) values ({','.join(['%s']*11)})"
    ...
    def obterSQLInsertConjuntos() -> str:
        ...
        """
        return f"insert into ns.conjuntosprodutos \
