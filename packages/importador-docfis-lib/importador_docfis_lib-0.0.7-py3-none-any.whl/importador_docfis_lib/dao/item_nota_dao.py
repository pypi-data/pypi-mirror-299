...
class ItemNotaDAO:
    ...
    def obterSQLInsertDf_Itens() -> str:
        ...
        return f"""WITH valor(id_ano, especificacao, cfop, unidade, tiposoma, classe, tiporec, ignorasoma, vinculoreceita, semmov, 
    ...
    def obterSQLInsertDf_Linhas() -> str:
        ...
        return f""" WITH valor(df_linha, id_item, id_cfop, id_docfis, tipolinha, quantidadecomercial, valorunitariocomercial, 
