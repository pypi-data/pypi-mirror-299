...
class ControllerEstabelecimento:
    ...
    def retornar_estabelecimentos(
        ...
        tipo_documento: EnumTipoDocumento = None,
        ...
        estabelecimentos: List[Estabelecimento] = EstabelecimentoDAO(
            self.conexao
        ).retornar_estabelecimentos(estabelecimentos)
        cfops: List[CFOP] = CfopDAO(self.conexao).retornar_cfops()
        unidades: List[Unidade] = UnidadeDAO(self.conexao).retornar_unidades()
        ...
        for estabelecimento in estabelecimentos:
            ...
            if tipo_documento == EnumTipoDocumento.NFCE:
