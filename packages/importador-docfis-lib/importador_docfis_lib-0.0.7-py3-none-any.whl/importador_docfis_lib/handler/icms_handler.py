...
class ICMSHandler(xml.sax.ContentHandler):
    ...
    def __init__(self, parser, handler_anterior, tipo_documento: EnumTipoDocumento):
    ...
    def endElement(self, name):
        ...
        """
        if name == "ICMS":
            if self.__tipoDocumento == EnumTipoDocumento.NFCE:
                if hasattr(self.__handler_anterior,'nfce'):
