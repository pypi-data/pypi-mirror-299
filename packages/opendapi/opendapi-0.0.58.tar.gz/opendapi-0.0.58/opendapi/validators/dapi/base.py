...
from opendapi.utils import find_files_with_suffix, prune_additional_properties
...
class DapiValidator(BaseValidator):
    ...
    @classmethod
    def skip_autoupdate(cls, new_content: Dict, original_content: Dict) -> bool:
        """
        ...
        return prune_additional_properties(
            new_content, _ORM_EXTRACTED_FIELDS_SCHEMA
        ) == prune_additional_properties(original_content, _ORM_EXTRACTED_FIELDS_SCHEMA)
