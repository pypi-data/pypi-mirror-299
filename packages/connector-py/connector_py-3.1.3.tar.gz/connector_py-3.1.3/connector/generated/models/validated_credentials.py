...
class ValidatedCredentials(BaseModel):
    ...
    """ # noqa: E501
    valid: StrictBool
    unique_tenant_id: Optional[StrictStr] = Field(default=None, description="This is the unique ID, in the Application's side, of the user's organization. Some examples are: * AWS account ID * Pagerduty unique domain * Github organization name")
    __properties: ClassVar[List[str]] = ["valid", "unique_tenant_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidatedCredentials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidatedCredentials from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "valid": obj.get("valid"),
            "unique_tenant_id": obj.get("unique_tenant_id")
        })
        return _obj
