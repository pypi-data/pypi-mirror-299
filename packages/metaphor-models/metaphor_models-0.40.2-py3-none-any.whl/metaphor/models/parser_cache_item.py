...
class Species18040___ToStringTag8484(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18040: Optional['SharedArrayBuffer'] = None
    to_string_tag_8484: Optional[Species18040___ToStringTag8484] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18040 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18040"))
        to_string_tag_8484 = from_union([Species18040___ToStringTag8484, from_none], obj.get("__@toStringTag@8484"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18040, to_string_tag_8484, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18040 is not None:
            result["__@species@18040"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18040)
        if self.to_string_tag_8484 is not None:
            result["__@toStringTag@8484"] = from_union([lambda x: to_enum(Species18040___ToStringTag8484, x), from_none], self.to_string_tag_8484)
...
class ArrayBufferLike:
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        ...
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18040 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18040"))
        return ArrayBufferLike(to_string_tag_8484, byte_length, species_18040)
