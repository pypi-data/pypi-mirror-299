...
class QueryInfo:
    ...
    def from_dict(obj: Any) -> 'QueryInfo':
        ...
        return QueryInfo(bytes_read, bytes_written, cost, elapsed_time, entity_ids, id, issued_at, issued_by, issued_by_email, platform, query, rows_read, rows_written, run_count)
