...
class Species18043___ToStringTag8484(Enum):
    SHARED_ARRAY_BUFFER = "SharedArrayBuffer"


@dataclass
class SharedArrayBuffer:
    species_18043: Optional['SharedArrayBuffer'] = None
    to_string_tag_8484: Optional[Species18043___ToStringTag8484] = None
    byte_length: Optional[float] = None

    @staticmethod
    def from_dict(obj: Any) -> 'SharedArrayBuffer':
        assert isinstance(obj, dict)
        species_18043 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18043"))
        to_string_tag_8484 = from_union([Species18043___ToStringTag8484, from_none], obj.get("__@toStringTag@8484"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        return SharedArrayBuffer(species_18043, to_string_tag_8484, byte_length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.species_18043 is not None:
            result["__@species@18043"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18043)
        if self.to_string_tag_8484 is not None:
            result["__@toStringTag@8484"] = from_union([lambda x: to_enum(Species18043___ToStringTag8484, x), from_none], self.to_string_tag_8484)
...
class ArrayBufferLike:
    to_string_tag_8484: Optional[str] = None
    byte_length: Optional[float] = None
    species_18043: Optional[SharedArrayBuffer] = None
    ...
    def from_dict(obj: Any) -> 'ArrayBufferLike':
        assert isinstance(obj, dict)
        to_string_tag_8484 = from_union([from_str, from_none], obj.get("__@toStringTag@8484"))
        byte_length = from_union([from_float, from_none], obj.get("byteLength"))
        species_18043 = from_union([SharedArrayBuffer.from_dict, from_none], obj.get("__@species@18043"))
        return ArrayBufferLike(to_string_tag_8484, byte_length, species_18043)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_8484 is not None:
            result["__@toStringTag@8484"] = from_union([from_str, from_none], self.to_string_tag_8484)
        if self.byte_length is not None:
            result["byteLength"] = from_union([to_float, from_none], self.byte_length)
        if self.species_18043 is not None:
            result["__@species@18043"] = from_union([lambda x: to_class(SharedArrayBuffer, x), from_none], self.species_18043)
...
class ID:
    ...
    to_string_tag_8484: Optional[IDToStringTag8484] = None
    ...
    def from_dict(obj: Any) -> 'ID':
        assert isinstance(obj, dict)
        to_string_tag_8484 = from_union([IDToStringTag8484, from_none], obj.get("__@toStringTag@8484"))
        ...
        return ID(to_string_tag_8484, buffer, byte_length, byte_offset, bytes_per_element, length)

    def to_dict(self) -> dict:
        result: dict = {}
        if self.to_string_tag_8484 is not None:
            result["__@toStringTag@8484"] = from_union([lambda x: to_enum(IDToStringTag8484, x), from_none], self.to_string_tag_8484)
...
class LogicalID:
    ...
    def from_dict(obj: Any) -> 'LogicalID':
        ...
        return LogicalID(dashboard_id, platform, name, type, account, id, email)
...
class FieldElement:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'FieldElement':
        assert isinstance(obj, dict)
        description = from_union([from_str, from_none], obj.get("description"))
        field_name = from_union([from_str, from_none], obj.get("fieldName"))
        field_path = from_union([from_str, from_none], obj.get("fieldPath"))
        ...
        subfields = from_union([SchemaField.from_dict, lambda x: from_list(SchemaField.from_dict, x), from_none], obj.get("subfields"))
        tags = from_union([lambda x: from_list(from_str, x), from_none], obj.get("tags"))
        return FieldElement(description, field_name, field_path, formula, optional_type, type, is_unique, max_length, native_type, nullable, precision, subfields, tags)
...
class Schema:
    ...
    entity_id: Optional[str] = None
    fields: Optional[List[FieldElement]] = None
    id: Optional[str] = None
    """The id field is deprecated and will be removed at a later time post migration"""
    ...
    def from_dict(obj: Any) -> 'Schema':
        ...
        entity_id = from_union([from_str, from_none], obj.get("entityId"))
        fields = from_union([lambda x: from_list(FieldElement.from_dict, x), from_none], obj.get("fields"))
        id = from_union([from_str, from_none], obj.get("id"))
        query = from_union([VirtualViewQuery.from_dict, from_none], obj.get("query"))
        description = from_union([from_str, from_none], obj.get("description"))
        last_modified = from_union([AuditStamp.from_dict, from_none], obj.get("lastModified"))
        ...
        return Schema(created_at, aspect_type, schema_created_at, entity_id, fields, id, query, description, last_modified, raw_schema, schema_type, sql_schema)
    ...
    def to_dict(self) -> dict:
        ...
        if self.entity_id is not None:
            result["entityId"] = from_union([from_str, from_none], self.entity_id)
        if self.fields is not None:
            result["fields"] = from_union([lambda x: from_list(lambda x: to_class(FieldElement, x), x), from_none], self.fields)
        if self.id is not None:
            result["id"] = from_union([from_str, from_none], self.id)
        if self.query is not None:
            result["query"] = from_union([lambda x: to_class(VirtualViewQuery, x), from_none], self.query)
...
class Entity:
    ...
    logical_id: Optional[LogicalID] = None
    """Identify an entity "logically".
    Each entity must have a logicalId to be ingested.
    A compelling use-case is that this allows a producer to create an
    instance of the Entity without requiring an entity ID to be
    ...
    def from_dict(obj: Any) -> 'Entity':
        ...
        logical_id = from_union([LogicalID.from_dict, from_none], obj.get("logicalId"))
        ...
        return Entity(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, entity_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, entity_id, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, parsed_upstream, related_assets, source_info, structure, system_contacts, system_description, system_tags, system_tag_values, entity_versioned_id, dbt_metric, metric_info, azure_data_factory_pipeline, fivetran, informatica_mapping, power_bi_dataflow, spark, dbt_model, full_name, looker_explore, looker_view, ownership_assignment, pipeline_info, power_bi_dataset, quick_sight, schema, tableau_datasource, tag_assignment, thought_spot, custom_metadata, data_quality, description_assignment, documentation, field_associations, field_statistics, last_query, snowflake_iceberg_info, snowflake_stream_info, soda_data_quality, statistics, unity_catalog, usage, asset_likes, organization)
    ...
    def to_dict(self) -> dict:
        ...
        if self.logical_id is not None:
            result["logicalId"] = from_union([lambda x: to_class(LogicalID, x), from_none], self.logical_id)
...
class MapStringString:
    ...
    def from_dict(obj: Any) -> 'MapStringString':
        ...
        to_string_tag_8484 = from_union([from_str, from_none], obj.get("__@toStringTag@8484"))
        size = from_union([from_float, from_none], obj.get("size"))
        return MapStringString(to_string_tag_8484, size)
