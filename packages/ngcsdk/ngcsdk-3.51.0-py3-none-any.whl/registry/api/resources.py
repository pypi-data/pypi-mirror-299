...
from ngcbpc.transfer import async_download, async_workers, http_uploader
...
class ResourceAPI:  # noqa: D101
    ...
    def upload_version(
        ...
        completed_upload = self._perform_upload(mrt, transfer_path, progress_callback_func=progress_callback_func)
        if completed_upload:
