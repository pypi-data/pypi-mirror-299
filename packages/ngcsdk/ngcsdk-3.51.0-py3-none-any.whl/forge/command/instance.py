...
class InstanceCommand(ForgeCommand):  # noqa: D101
    ...
    @CLICommand.arguments(
        ...
        metavar="<target>",
        help=(
            "Filter by matches across all instances. Input will be matched against name, description and status fields."
        ),
        type=str,
        nargs="?",
        default=None,
    ...
    @CLICommand.arguments(
        "--label",
        metavar="<key:value>",
        help="Specify labels. (Can be specified multiple times.)",
    ...
    @CLICommand.arguments("--reboot", help="Trigger instance reboot.", action="store_true")
    @CLICommand.arguments(
        "--reboot-custom-ipxe",
    ...
    @CLICommand.arguments(
        "--label",
        metavar="<key:value>",
        help="Add or update a label. (Can be specified multiple times.)",
        type=check_instance_label,
        action="extend",
    )
