...
class ScreenshotService:
    ...
    def screenshot_dashboard_get_image_link(self) -> str:
        ...
        image_url = upload_file_to_gdrive("GGChatBotImage", self.__parent_directory_id, self.__creds_ggdrive, self.__path_file,file_name)

        return image_url['thumbnailLink']
