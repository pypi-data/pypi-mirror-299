...
def runCvvCommands():
  ...
  parser.add_argument("commandCall", help="Curvv function you want to run.")
#  parser.add_argument("arg2", help="Additional Dependencies")
  ...
  if command == commandList[0]:
    ...
    parser.add_argument("repoName", required=False, help="Name for the repository you want to create")
    parser.add_argument("repoType", required=False, help="Type of repository you want to create")
