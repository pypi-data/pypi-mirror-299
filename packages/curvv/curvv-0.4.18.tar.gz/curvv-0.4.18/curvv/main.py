...
#  parser.add_argument("arg2", help="Additional Dependencies")
  ...
  if command == commandList[0]:
    ...
    parser.add_argument("repoName", default=None, help="Name for the repository you want to create")
    parser.add_argument("repoType", default=None, help="Type of repository you want to create")
