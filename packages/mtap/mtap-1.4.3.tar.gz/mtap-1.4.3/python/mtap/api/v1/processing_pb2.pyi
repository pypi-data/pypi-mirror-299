...
class ProcessRequest(_message.Message):
    __slots__ = ("processor_id", "event_id", "event_service_instance_id", "params")
...
class ProcessResponse(_message.Message):
    __slots__ = ("timing_info", "result", "created_indices")
...
class TimerStats(_message.Message):
    __slots__ = ("mean", "std", "max", "min", "sum")
...
class GetStatsResponse(_message.Message):
    __slots__ = ("processed", "failures", "timing_stats")
