...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in mtap/api/v1/processing_pb2_grpc.py depends on'
...
def add_ProcessorServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('mtap.api.v1.Processor', rpc_method_handlers)
