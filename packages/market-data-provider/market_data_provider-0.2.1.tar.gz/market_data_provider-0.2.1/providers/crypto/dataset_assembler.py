...
class CryptoSeriesDatasetAssembler:
    ...
    def generate_dataset(self):
        ...
        self._clean_selected_series(selected_series)
        self._save_selected_series(selected_series)

    def _save_selected_series(self, selected_series: List[dict]):
    ...
    def _clean_selected_series(self, selected_series):
