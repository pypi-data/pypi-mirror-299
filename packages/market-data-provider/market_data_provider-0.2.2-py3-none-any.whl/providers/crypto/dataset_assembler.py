...
class CryptoSeriesDatasetAssembler:
    def __init__(self,
        ...
        self.dataset_out_folder = os.path.join(dataset_out_root_folder, self.dataset_unique_name)
    ...
    def _generate_dataset_config(self):
        config = {
            ...
            "selector_name": self.dataset_labeler.get_name(),
            "selector_training_window_size_length": self.dataset_labeler.training_window_length,
            "selector_prediction_window_size_length": self.dataset_labeler.prediction_window_length,
            "indicators": [
                {
            ...
            for candle in labeled['series']:
                for key in list(candle.keys()):
                    if key in self.dataset_cleanup_keys:
                        del candle[key]
        print(f'{instrument} clean up dataset')
