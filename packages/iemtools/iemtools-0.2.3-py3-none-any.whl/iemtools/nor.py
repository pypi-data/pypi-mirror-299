...
def NOR( subfolder , time_limit , fps , rescale_low , rescale_hi , sigma ):
    ...
    results.append( [ subfolder[ len(root)-1 : ] , duration_L , N_ls , duration_R , N_rs , index ] )
    return results
...
def unblind( to_sort , template ):
    ...
    return recognition_indices, mistakes