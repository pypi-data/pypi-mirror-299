"""
A subagent tool for tok2me

Lets tok2me break down a task into smaller parts, and delegate them to subagents.
"""
...
class Subagent:
    ...
    def get_log(self) -> "LogManager":
        # noreorder
        from tok2me.cli import get_logdir  # fmt: skip
...
def subagent(prompt: str, agent_id: str):
    ...
    # noreorder
    from tok2me import chat  # fmt: skip
    from tok2me.cli import get_logdir  # fmt: skip
