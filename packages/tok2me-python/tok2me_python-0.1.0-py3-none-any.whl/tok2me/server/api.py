...
tok2me_path_ctx = resources.as_file(resources.files("tok2me"))
static_path = tok2me_path_ctx.__enter__().parent / "static"
atexit.register(tok2me_path_ctx.__exit__, None, None, None)
