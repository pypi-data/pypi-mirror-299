...
if TYPE_CHECKING:
    from tok2me.eval.main import EvalSpec
...
tests: list["EvalSpec"] = [
    ...
    },
    {
        ...
        # TODO: work around the "don't try to execute it" part by improving tok2me such that it just gives EOF to stdin in non-interactive mode
