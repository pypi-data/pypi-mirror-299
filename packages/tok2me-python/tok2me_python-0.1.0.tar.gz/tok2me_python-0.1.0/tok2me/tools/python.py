...
# TODO: launch the IPython session in the current venv, if any, instead of the pipx-managed tok2me-python venv (for example) in which tok2me itself runs
#       would let us use libraries installed with `pip install` in the current venv
#       https://github.com/ErikBjare/tok2me/issues/29
