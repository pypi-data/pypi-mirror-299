...
docstring = f"""
tok2me is a chat-CLI for LLMs, empowering them with tools to run shell commands, execute code, read and manipulate files, and more.
...
def main(
    ...
    if version:
        # print version
        print(f"tok2me {importlib.metadata.version('tok2me-python')}")
...
# TODO: move to seperate file and make this simply callable with `tok2me.chat("prompt")`
def chat(
