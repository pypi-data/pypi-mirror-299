...
def prompt_full(interactive: bool) -> Generator[Message, None, None]:
    ...
    yield from prompt_tok2me(interactive)
...
def prompt_tok2me(interactive: bool) -> Generator[Message, None, None]:
    """
    Base system prompt for tok2me.

    It should:
     - Introduce tok2me and its general capabilities and purpose
    ...
    base_prompt = f"""
You are tok2me v{__version__}, a general-purpose AI assistant powered by LLMs.
...
document_prompt_function(interactive=True)(prompt_tok2me)
