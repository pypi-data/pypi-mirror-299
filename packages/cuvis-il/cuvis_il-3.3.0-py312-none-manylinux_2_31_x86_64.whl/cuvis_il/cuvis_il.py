...
class cuvis_sensor_info_t(object):
    ...
    width = property(_cuvis_pyil.cuvis_sensor_info_t_width_get, _cuvis_pyil.cuvis_sensor_info_t_width_set)
    height = property(_cuvis_pyil.cuvis_sensor_info_t_height_get, _cuvis_pyil.cuvis_sensor_info_t_height_set)
    raw_frame_id = property(_cuvis_pyil.cuvis_sensor_info_t_raw_frame_id_get, _cuvis_pyil.cuvis_sensor_info_t_raw_frame_id_set)
    pixel_format = property(_cuvis_pyil.cuvis_sensor_info_t_pixel_format_get, _cuvis_pyil.cuvis_sensor_info_t_pixel_format_set)
    binning = property(_cuvis_pyil.cuvis_sensor_info_t_binning_get, _cuvis_pyil.cuvis_sensor_info_t_binning_set)
...
class cuvis_calibration_info_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    model_name = property(_cuvis_pyil.cuvis_calibration_info_t_model_name_get, _cuvis_pyil.cuvis_calibration_info_t_model_name_set)
    serial_no = property(_cuvis_pyil.cuvis_calibration_info_t_serial_no_get, _cuvis_pyil.cuvis_calibration_info_t_serial_no_set)
    calibration_date = property(_cuvis_pyil.cuvis_calibration_info_t_calibration_date_get, _cuvis_pyil.cuvis_calibration_info_t_calibration_date_set)
    annotation_name = property(_cuvis_pyil.cuvis_calibration_info_t_annotation_name_get, _cuvis_pyil.cuvis_calibration_info_t_annotation_name_set)
    unique_id = property(_cuvis_pyil.cuvis_calibration_info_t_unique_id_get, _cuvis_pyil.cuvis_calibration_info_t_unique_id_set)
    file_path = property(_cuvis_pyil.cuvis_calibration_info_t_file_path_get, _cuvis_pyil.cuvis_calibration_info_t_file_path_set)
...
class cuvis_mesu_metadata_t(object):
    ...
    processing_mode_at_capture = property(_cuvis_pyil.cuvis_mesu_metadata_t_processing_mode_at_capture_get, _cuvis_pyil.cuvis_mesu_metadata_t_processing_mode_at_capture_set)
    ...
    measurement_frame_id = property(_cuvis_pyil.cuvis_mesu_metadata_t_measurement_frame_id_get, _cuvis_pyil.cuvis_mesu_metadata_t_measurement_frame_id_set)
...
class cuvis_save_args_t(object):
    ...
    full_export = property(_cuvis_pyil.cuvis_save_args_t_full_export_get, _cuvis_pyil.cuvis_save_args_t_full_export_set)
...
class cuvis_export_general_settings_t(object):
    ...
    pre_pan_sharpen_cube = property(_cuvis_pyil.cuvis_export_general_settings_t_pre_pan_sharpen_cube_get, _cuvis_pyil.cuvis_export_general_settings_t_pre_pan_sharpen_cube_set)
...
class cuvis_viewer_settings_t(object):
    ...
    pre_pan_sharpen_cube = property(_cuvis_pyil.cuvis_viewer_settings_t_pre_pan_sharpen_cube_get, _cuvis_pyil.cuvis_viewer_settings_t_pre_pan_sharpen_cube_set)
...
class cuvis_worker_settings_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    input_queue_size = property(_cuvis_pyil.cuvis_worker_settings_t_input_queue_size_get, _cuvis_pyil.cuvis_worker_settings_t_input_queue_size_set)
    mandatory_queue_size = property(_cuvis_pyil.cuvis_worker_settings_t_mandatory_queue_size_get, _cuvis_pyil.cuvis_worker_settings_t_mandatory_queue_size_set)
    supplementary_queue_size = property(_cuvis_pyil.cuvis_worker_settings_t_supplementary_queue_size_get, _cuvis_pyil.cuvis_worker_settings_t_supplementary_queue_size_set)
    output_queue_size = property(_cuvis_pyil.cuvis_worker_settings_t_output_queue_size_get, _cuvis_pyil.cuvis_worker_settings_t_output_queue_size_set)
    can_skip_measurements = property(_cuvis_pyil.cuvis_worker_settings_t_can_skip_measurements_get, _cuvis_pyil.cuvis_worker_settings_t_can_skip_measurements_set)
    can_skip_supplementary_steps = property(_cuvis_pyil.cuvis_worker_settings_t_can_skip_supplementary_steps_get, _cuvis_pyil.cuvis_worker_settings_t_can_skip_supplementary_steps_set)
    can_drop_results = property(_cuvis_pyil.cuvis_worker_settings_t_can_drop_results_get, _cuvis_pyil.cuvis_worker_settings_t_can_drop_results_set)
...
class cuvis_worker_state_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    measurementsInQueue = property(_cuvis_pyil.cuvis_worker_state_t_measurementsInQueue_get, _cuvis_pyil.cuvis_worker_state_t_measurementsInQueue_set)
    sessionFilesInQueue = property(_cuvis_pyil.cuvis_worker_state_t_sessionFilesInQueue_get, _cuvis_pyil.cuvis_worker_state_t_sessionFilesInQueue_set)
    framesInQueue = property(_cuvis_pyil.cuvis_worker_state_t_framesInQueue_get, _cuvis_pyil.cuvis_worker_state_t_framesInQueue_set)
    measurementsBeingProcessed = property(_cuvis_pyil.cuvis_worker_state_t_measurementsBeingProcessed_get, _cuvis_pyil.cuvis_worker_state_t_measurementsBeingProcessed_set)
    resultsInQueue = property(_cuvis_pyil.cuvis_worker_state_t_resultsInQueue_get, _cuvis_pyil.cuvis_worker_state_t_resultsInQueue_set)
    hasAcquisitionContext = property(_cuvis_pyil.cuvis_worker_state_t_hasAcquisitionContext_get, _cuvis_pyil.cuvis_worker_state_t_hasAcquisitionContext_set)
    isProcessing = property(_cuvis_pyil.cuvis_worker_state_t_isProcessing_get, _cuvis_pyil.cuvis_worker_state_t_isProcessing_set)
