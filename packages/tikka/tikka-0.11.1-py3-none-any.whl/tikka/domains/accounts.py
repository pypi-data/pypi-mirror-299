...
class Accounts:
    ...
    def network_get_balance(self, account: Account) -> Account:
        """
        ...
        :return:
        """
        self.network.get_balance(account)
        self.repository.update(account)

        return account

    def network_get_balances(self, accounts: List[Account]) -> None:
        """
        ...
        :return:
        """
        for account in self.network.get_balances(accounts):
            self.repository.update(account)
