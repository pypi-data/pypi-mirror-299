...
class LLMs__Platforms(Type_Safe):
    ...
    def model_options(self):
        return { 'SambaNova (Free)'  : {'Meta'          : { 'Llama 3.2 1B'                 : 'Meta-Llama-3.2-1B-Instruct'                  ,
                                                            'Llama 3.2 3B'                 : 'Meta-Llama-3.2-3B-Instruct'                  ,
                                                            'Llama 3.1 8B (8k)'            : 'Meta-Llama-3.1-8B-Instruct-8k'               ,
                                                            'Llama 3.1 70B (8k)'           : 'Meta-Llama-3.1-70B-Instruct-8k'              ,
                                                            'Llama 3.1 405B (8k)'          : 'Meta-Llama-3.1-405B-Instruct-8k'             }},
