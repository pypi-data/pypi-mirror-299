...
class H2OGLMParams(HasRandomCols, HasIgnoredCols, HasPlugValues, HasBetaConstraints, HasInteractionPairs, HasLinearConstraints, Params):
    ...
    startval = Param(
        Params._dummy(),
        "startval",
        """double array to initialize fixed and random coefficients for HGLM, coefficients for GLM.  If standardize is true, the standardized coefficients should be used.  Otherwise, use the regular coefficients.""",
        H2OTypeConverters.toNullableListFloat())
