...
param_details = {
    ...
    "LogToConsole": {
        "description": "Enables or disables console logging. Use OutputFlag to shut off all\nlogging.\n\nNote that this refers to all the output of Gurobi to the console\nincluding the various display and print functions provided by the API\nin interactive environments. It also disables logging on the remote\nside of Instant Cloud or Compute Server environments.",
        "name": "LogToConsole",
        "values": {
            "default": 1,
            "maximum": 1,
