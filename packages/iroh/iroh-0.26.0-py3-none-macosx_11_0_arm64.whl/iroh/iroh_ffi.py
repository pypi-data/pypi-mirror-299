...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_iroh_ffi_checksum_func_set_log_level() != 52619:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_func_start_metrics_collection() != 23413:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_connecting_connect() != 64341:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connecting_local_ip() != 3368:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connecting_remote_address() != 25819:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_connection_datagram_send_buffer_space() != 52904:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connection_get_remote_node_id() != 64024:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connection_local_ip() != 11203:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_connection_read_datagram() != 23201:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connection_remote_address() != 60000:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_connection_send_datagram() != 105:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_connection_send_datagram_wait() != 3162:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_endpoint_connect() != 29734:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_endpoint_connect_by_node_id() != 56155:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_entry_author() != 39787:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_entry_content_bytes() != 18583:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_hash_to_hex() != 52108:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_iroh_authors() != 25106:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_node_endpoint() != 6829:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_my_rpc_addr() != 34751:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_node_shutdown() != 21075:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_method_nodestatus_version() != 3183:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_protocolcreator_create() != 44945:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_method_protocolhandler_accept() != 54515:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_iroh_ffi_checksum_constructor_hash_new() != 30613:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_iroh_ffi_checksum_constructor_iroh_client() != 40014:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UNIFFI_CALLBACK_INTERFACE_PROTOCOL_CREATOR_METHOD0 = ctypes.CFUNCTYPE(None,ctypes.c_uint64,ctypes.c_void_p,ctypes.c_void_p,ctypes.POINTER(ctypes.c_void_p),
...
_UniffiLib.uniffi_iroh_ffi_fn_method_connecting_local_ip.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connecting_local_ip.restype = ctypes.c_uint64
_UniffiLib.uniffi_iroh_ffi_fn_method_connecting_remote_address.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connecting_remote_address.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_get_remote_node_id.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_get_remote_node_id.restype = ctypes.c_void_p
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_local_ip.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_local_ip.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_remote_address.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_remote_address.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_send_datagram_wait.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_connection_send_datagram_wait.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_method_endpoint_connect_by_node_id.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_endpoint_connect_by_node_id.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_method_entry_content_bytes.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
)
_UniffiLib.uniffi_iroh_ffi_fn_method_entry_content_bytes.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_constructor_iroh_client.argtypes = (
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_iroh_ffi_fn_constructor_iroh_client.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_iroh_ffi_fn_method_node_my_rpc_addr.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_method_node_my_rpc_addr.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_iroh_ffi_fn_func_start_metrics_collection.argtypes = (
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_iroh_ffi_fn_func_start_metrics_collection.restype = None
...
_UniffiLib.uniffi_iroh_ffi_checksum_func_start_metrics_collection.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_func_start_metrics_collection.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_connecting_local_ip.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connecting_local_ip.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_connecting_remote_address.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connecting_remote_address.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_get_remote_node_id.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_get_remote_node_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_local_ip.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_local_ip.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_remote_address.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_remote_address.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_send_datagram_wait.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_connection_send_datagram_wait.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_endpoint_connect_by_node_id.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_endpoint_connect_by_node_id.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_entry_content_bytes.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_entry_content_bytes.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_my_rpc_addr.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_method_node_my_rpc_addr.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_iroh_client.argtypes = (
)
_UniffiLib.uniffi_iroh_ffi_checksum_constructor_iroh_client.restype = ctypes.c_uint16
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def local_ip(self, ) -> "typing.Optional[str]":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_connecting_local_ip(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def remote_address(self, ) -> "str":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_connecting_remote_address(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_rust_buffer,
...
class ConnectionProtocol(typing.Protocol):
    ...
    def send_datagram(self, data: "bytes"):
        raise NotImplementedError
    def send_datagram_wait(self, data: "bytes"):
        raise NotImplementedError
...
_UniffiConverterTypeIrohError__as_error,
    ...
    def get_remote_node_id(self, ) -> "PublicKey":
        return _UniffiConverterTypePublicKey.lift(
            _uniffi_rust_call_with_error(_UniffiConverterTypeIrohError__as_error,_UniffiLib.uniffi_iroh_ffi_fn_method_connection_get_remote_node_id,self._uniffi_clone_pointer(),)
        )
    ...
    def local_ip(self, ) -> "typing.Optional[str]":
        return _UniffiConverterOptionalString.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_method_connection_local_ip,self._uniffi_clone_pointer(),)
        )
...
_UniffiConverterTypeIrohError__as_error,
    ...
    def remote_address(self, ) -> "str":
        return _UniffiConverterString.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_method_connection_remote_address,self._uniffi_clone_pointer(),)
        )
    ...
    async def send_datagram_wait(self, data: "bytes") -> None:

        _UniffiConverterBytes.check_lower(data)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_connection_send_datagram_wait(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(data)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_void,
...
class EndpointProtocol(typing.Protocol):
    def connect(self, node_addr: "NodeAddr",alpn: "bytes"):
        raise NotImplementedError
    def connect_by_node_id(self, node_id: "str",alpn: "bytes"):
        raise NotImplementedError
...
_UniffiConverterTypeIrohError__as_error,
    ...
    async def connect_by_node_id(self, node_id: "str",alpn: "bytes") -> "Connection":
        _UniffiConverterString.check_lower(node_id)
        
        _UniffiConverterBytes.check_lower(alpn)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_endpoint_connect_by_node_id(
                self._uniffi_clone_pointer(), 
...
class EntryProtocol(typing.Protocol):
    ...
    def author(self, ):
        ...
        raise NotImplementedError
    def content_bytes(self, doc: "Doc"):
        """
...
class Entry:
    ...
    async def content_bytes(self, doc: "Doc") -> "bytes":
        """
        Read all content of an [`Entry`] into a buffer.
        This allocates a buffer for the full entry. Use only if you know that the entry you're
        reading is small. If not sure, use [`Self::content_len`] and check the size with
        ...
        _UniffiConverterTypeDoc.check_lower(doc)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_entry_content_bytes(
                self._uniffi_clone_pointer(), 
...
class Iroh:
    ...
    def _make_instance_(cls, pointer):
        ...
        return inst
    @classmethod
    async def client(cls, addr: "typing.Optional[str]"):
        """
        Create a new iroh client, connecting to an existing node.
        """

        _UniffiConverterOptionalString.check_lower(addr)
        

        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_constructor_iroh_client(
...
class Node:
    ...
    def my_rpc_addr(self, ) -> "typing.Optional[str]":
        """
        Returns `Some(addr)` if an RPC endpoint is running, `None` otherwise.
        """

        return _UniffiConverterOptionalString.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_iroh_ffi_fn_method_node_my_rpc_addr,self._uniffi_clone_pointer(),)
        )




    async def shutdown(self, force: "bool") -> None:

        """
        Shutdown this iroh node.
        """

        _UniffiConverterBool.check_lower(force)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_node_shutdown(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBool.lower(force)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_void,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_void,
            _UniffiLib.ffi_iroh_ffi_rust_future_free_void,
...
class ProtocolCreator(typing.Protocol):
    def create(self, endpoint: "Endpoint",client: "Iroh"):
        raise NotImplementedError
...
class ProtocolCreatorImpl:
    ...
    def create(self, endpoint: "Endpoint",client: "Iroh") -> "ProtocolHandler":
        _UniffiConverterTypeEndpoint.check_lower(endpoint)
        
        _UniffiConverterTypeIroh.check_lower(client)
        ...
        _UniffiConverterTypeIroh.lower(client))
        )
...
class _UniffiTraitImplProtocolCreator:
    ...
    def create(
        ...
        def make_call():
            args = (_UniffiConverterTypeEndpoint.lift(endpoint), _UniffiConverterTypeIroh.lift(client), )
...
class ProtocolHandler(typing.Protocol):
    def accept(self, conn: "Connecting"):
        raise NotImplementedError
    def shutdown(self, ):
        raise NotImplementedError
...
class ProtocolHandlerImpl:
    ...
    async def accept(self, conn: "Connecting") -> None:

        _UniffiConverterTypeConnecting.check_lower(conn)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_iroh_ffi_fn_method_protocolhandler_accept(
                self._uniffi_clone_pointer(), 
        _UniffiConverterTypeConnecting.lower(conn)
            ),
            _UniffiLib.ffi_iroh_ffi_rust_future_poll_void,
            _UniffiLib.ffi_iroh_ffi_rust_future_complete_void,
            _UniffiLib.ffi_iroh_ffi_rust_future_free_void,
...
class _UniffiTraitImplProtocolHandler:
    ...
    def accept(
        ...
        def make_call():
            args = (_UniffiConverterTypeConnecting.lift(conn), )
...
class NodeOptions:
    ...
    def __init__(self, *, gc_interval_millis: "typing.Optional[int]" = _DEFAULT, blob_events: "typing.Optional[BlobProvideEventCallback]" = _DEFAULT, enable_docs: "bool" = _DEFAULT, ipv4_addr: "typing.Optional[str]" = _DEFAULT, ipv6_addr: "typing.Optional[str]" = _DEFAULT, enable_rpc: "bool" = _DEFAULT, rpc_addr: "typing.Optional[str]" = _DEFAULT, node_discovery: "typing.Optional[NodeDiscoveryConfig]" = _DEFAULT, secret_key: "typing.Optional[bytes]" = _DEFAULT, protocols: "typing.Optional[dict[bytes, ProtocolCreator]]" = _DEFAULT):
        ...
        if enable_rpc is _DEFAULT:
            self.enable_rpc = False
        else:
            self.enable_rpc = enable_rpc
        if rpc_addr is _DEFAULT:
            self.rpc_addr = None
        else:
    ...
    def __str__(self):
        return "NodeOptions(gc_interval_millis={}, blob_events={}, enable_docs={}, ipv4_addr={}, ipv6_addr={}, enable_rpc={}, rpc_addr={}, node_discovery={}, secret_key={}, protocols={})".format(self.gc_interval_millis, self.blob_events, self.enable_docs, self.ipv4_addr, self.ipv6_addr, self.enable_rpc, self.rpc_addr, self.node_discovery, self.secret_key, self.protocols)
    ...
    def __eq__(self, other):
        ...
        if self.ipv6_addr != other.ipv6_addr:
            return False
        if self.enable_rpc != other.enable_rpc:
            return False
        if self.rpc_addr != other.rpc_addr:
            return False
...
class _UniffiConverterTypeNodeOptions(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return NodeOptions(
            ...
            enable_rpc=_UniffiConverterBool.read(buf),
            rpc_addr=_UniffiConverterOptionalString.read(buf),
    ...
    def check_lower(value):
        ...
        _UniffiConverterBool.check_lower(value.enable_rpc)
        _UniffiConverterOptionalString.check_lower(value.rpc_addr)
    ...
    def write(value, buf):
        ...
        _UniffiConverterBool.write(value.enable_rpc, buf)
        _UniffiConverterOptionalString.write(value.rpc_addr, buf)
...
def start_metrics_collection() -> None:
    ...
    _uniffi_rust_call_with_error(_UniffiConverterTypeIrohError__as_error,_UniffiLib.uniffi_iroh_ffi_fn_func_start_metrics_collection,)
