...
Go to [https://www.mapbox.com/mapbox\-gl\-js/api/](https://www.mapbox.com/mapbox-gl-js/api/) for more details on `mapbox-gl-js sdk`.
    ...
    style = Union([Unicode(default_value=None, allow_none=True),Any(default_value=None, allow_none=True),], default_value=None, allow_none=True, help="""Sets the style of the Mapbox map. Same as [https://www.mapbox.com/mapbox\-gl\-js/style\-spec/](https://www.mapbox.com/mapbox-gl-js/style-spec/).""").tag(sync=True)
...
```""").tag(sync=True)
    ...
    zoom = Float(None, allow_none=True, help="""Sets the zoom level of the map. See [https://www.mapbox.com/mapbox\-gl\-js/style\-spec/\#root\-zoom](https://www.mapbox.com/mapbox-gl-js/style-spec/#root-zoom)""").tag(sync=True)
    
    bearing = Float(None, allow_none=True, help="""Sets the bearing angle of the map. See [https://www.mapbox.com/mapbox\-gl\-js/style\-spec/\#root\-bearing](https://www.mapbox.com/mapbox-gl-js/style-spec/#root-bearing)""").tag(sync=True)
    
    pitch = Float(None, allow_none=True, help="""Sets the pitch angle of the map. The default is `0` means perpendicular to the surface of the map. The greater value is `60`. See [https://www.mapbox.com/mapbox\-gl\-js/style\-spec/\#root\-pitch](https://www.mapbox.com/mapbox-gl-js/style-spec/#root-pitch)""").tag(sync=True)
