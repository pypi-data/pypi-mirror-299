...
* `'cartesian2d'`
 ...
 Use a two\-dimensional rectangular coordinate (also known as Cartesian coordinate), with [xAxisIndex](#series-boxplot.xAxisIndex) and [yAxisIndex](#series-boxplot.yAxisIndex) to assign the corresponding axis component.""").tag(sync=True)
