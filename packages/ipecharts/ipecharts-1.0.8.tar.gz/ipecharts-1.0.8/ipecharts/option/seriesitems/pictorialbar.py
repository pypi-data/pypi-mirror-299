...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbol), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbol) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolSize), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolSize) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolPosition), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolPosition) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolOffset), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolOffset) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolRotate), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolRotate) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolRepeat), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolRepeat) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolMargin), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolMargin) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolClip), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolClip) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
...
This attribute can be set at the [root level of a series](#series-pictorialBar.symbolPatternSize), where all data items in the series will be affected by this attribute. And this attribute can also be set at [each data item](#series-pictorialBar.data.symbolPatternSize) in [series\-pictorialBar.data](series-pictorialBar.data), where only the data item is affected by this attribute.
