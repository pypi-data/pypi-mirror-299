...
class ManageApiLedgerCorpEndpointsTest(TestCase):
    ...
    def test_get_corporation_billbboard_api_single(self):
        self.client.force_login(self.user)
        url = "/ledger/api/corporation/2002/billboard/year/2024/month/3/"
    ...
    def test_get_corporation_billbboard_api(self):
        self.client.force_login(self.user)
    ...
    def test_get_corporation_billbboard_api_year(self):
        self.client.force_login(self.user)
    ...
    def test_get_corporation_billbboard_api_no_permission(self):
