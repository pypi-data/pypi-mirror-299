...
class Configuration:
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "http://api.exoops.exotrail.space/data-management" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("spacetower_data_management_python_client")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "http://api.exoops.exotrail.space/data-management",
                'description': "Data Management production API",
            }
        ]
