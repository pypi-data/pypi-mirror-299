    ...
    try:
        ...
        with requests.Session() as session:
            ...
            inputs = utils.validate_inputs(
                {
                    ...
                    'api_url': API_URL,
                    'client_time_out_in_seconds': TIMEOUT_CONECTION_SECONDS,
                    'separator': "*"
                }
            )
            ...
            authentication_obj = authentication.Authentication(
                req,
                inputs['client_time_out_in_seconds'],
                inputs['client_time_out_in_seconds'],
                inputs['api_url'],
                inputs['client_id'],
            ...
            managed_account_obj = managed_account.ManagedAccount(authentication=authentication_obj, logger=logger, separator=inputs['separator'])
