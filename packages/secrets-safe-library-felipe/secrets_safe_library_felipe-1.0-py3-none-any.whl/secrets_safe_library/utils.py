...
def validate_inputs(inputs):
    ...
    schema = {
        'client_id': {'type': 'string', 'minlength': 36, 'maxlength': 36, 'required': True},
        ...
        'client_time_out_in_seconds': {'type': 'integer', 'min': 0, 'max': 300, 'required': True},
        'separator': {'type': 'string', 'minlength': 0, 'maxlength': 1},
    }
    ...
    if v.validate(inputs):
        ...
        if inputs['client_time_out_in_seconds'] == 0:
            inputs['client_time_out_in_seconds'] = 30

        if  inputs['separator'].strip() == "":
            inputs['separator'] = "/"
