...
class CleanCommand(Command):
    ...
    def run(self):
        if platform_system == "Windows":
            cmd = [
                "del" "/Q",
                "tests\\data\\temp_*.*" "&&" "rd" "/s/q",
                "_cmake_test_compile",
                "_skbuild",
                "dist",
                ".pytest_cache",
                "src\\swmm\\toolkit\\swmm_toolkit.egg-info",
                "tests\\__pycache__",
            ]
            ...
            cmd = [
                "rm -vrf _skbuild/ dist/ **/build .pytest_cache/ **/__pycache__  \
            **/*.egg-info **/data/temp_*.* **/data/en* **/.DS_Store MANIFEST"
            ...
            cmd = [
                "setopt extended_glob nullglob; rm -vrf _skbuild dist **/build .pytest_cache \
