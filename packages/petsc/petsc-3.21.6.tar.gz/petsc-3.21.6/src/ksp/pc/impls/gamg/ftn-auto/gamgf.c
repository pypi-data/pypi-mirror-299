...
PETSC_EXTERN void  pcgamgasmsethem_(PC pc,PetscInt *n, int *__ierr)
{
*__ierr = PCGAMGASMSetHEM(
	(PC)PetscToPointer((pc) ),*n);
}
...
PETSC_EXTERN void  pcgamgsetinjectionindex_(PC pc,PetscInt *n,PetscInt idx[], int *__ierr)
{
*__ierr = PCGAMGSetInjectionIndex(
