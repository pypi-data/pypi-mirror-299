...
PETSC_EXTERN void  dmplexreordersetdefault_(DM dm,DMReorderDefaultFlag *reorder, int *__ierr)
{
*__ierr = DMPlexReorderSetDefault(
	(DM)PetscToPointer((dm) ),*reorder);
}
PETSC_EXTERN void  dmplexreordergetdefault_(DM dm,DMReorderDefaultFlag *reorder, int *__ierr)
{
