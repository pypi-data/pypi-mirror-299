...
PETSC_EXTERN void  dmplexfilter_(DM dm,DMLabel cellLabel,PetscInt *value,PetscBool *ignoreLabelHalo,PetscBool *sanitizeSubmesh,PetscSF *ownershipTransferSF,DM *subdm, int *__ierr)
{
*__ierr = DMPlexFilter(
	(DM)PetscToPointer((dm) ),
