...
extern "C" {
#endif
PETSC_EXTERN void  snesngssettolerances_(SNES snes,PetscReal *abstol,PetscReal *rtol,PetscReal *stol,PetscInt *maxit, int *__ierr)
{
...
PETSC_EXTERN void  snesngsgetsweeps_(SNES snes,PetscInt *sweeps, int *__ierr)
{
