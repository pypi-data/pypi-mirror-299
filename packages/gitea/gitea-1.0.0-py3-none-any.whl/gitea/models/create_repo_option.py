...
class CreateRepoOption(object):
    ...
    def __init__(self, auto_init=None, default_branch=None, description=None, gitignores=None, issue_labels=None, license=None, name=None, object_format_name=None, private=None, readme=None, template=None, trust_model=None):  # noqa: E501
    ...
    def object_format_name(self, object_format_name):
        ...
        if object_format_name not in allowed_values:
            raise ValueError(
