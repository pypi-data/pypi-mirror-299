...
class CreateOrgOption(object):
    ...
    def __init__(self, description=None, email=None, full_name=None, location=None, repo_admin_change_team_access=None, username=None, visibility=None, website=None):  # noqa: E501
