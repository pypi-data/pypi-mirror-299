...
class IssueApi(object):
    ...
    def issue_create_issue_attachment(self, attachment, owner, repo, index, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_create_issue_attachment(attachment, owner, repo, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issue_create_issue_attachment_with_http_info(attachment, owner, repo, index, **kwargs)  # noqa: E501
        else:
            (data) = self.issue_create_issue_attachment_with_http_info(attachment, owner, repo, index, **kwargs)  # noqa: E501
            return data
    ...
    def issue_create_issue_attachment_with_http_info(self, attachment, owner, repo, index, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_create_issue_attachment_with_http_info(attachment, owner, repo, index, async_req=True)
        >>> result = thread.get()
    ...
    def issue_create_issue_comment_attachment(self, attachment, owner, repo, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_create_issue_comment_attachment(attachment, owner, repo, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.issue_create_issue_comment_attachment_with_http_info(attachment, owner, repo, id, **kwargs)  # noqa: E501
        else:
            (data) = self.issue_create_issue_comment_attachment_with_http_info(attachment, owner, repo, id, **kwargs)  # noqa: E501
            return data
    ...
    def issue_create_issue_comment_attachment_with_http_info(self, attachment, owner, repo, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.issue_create_issue_comment_attachment_with_http_info(attachment, owner, repo, id, async_req=True)
        >>> result = thread.get()
