...
class ChangedFile(object):
    ...
    def __init__(self, additions=None, changes=None, contents_url=None, deletions=None, filename=None, html_url=None, previous_filename=None, raw_url=None, status=None):  # noqa: E501
