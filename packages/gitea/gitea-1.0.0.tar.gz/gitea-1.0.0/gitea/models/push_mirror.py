...
class PushMirror(object):
    ...
    def __init__(self, created=None, interval=None, last_error=None, last_update=None, remote_address=None, remote_name=None, repo_name=None, sync_on_commit=None):  # noqa: E501
