...
class MARAClient:
    ...
    def _request(self, path, method='POST', headers={}, json={}, **kwargs):
        if self.api_key:
...
class DataTableManager:
    ...
    def create(self, filepath: str = None, file_id: str = None):
...
class FileManager:
    ...
    def download(self, filename: str, out_filename: Optional[str] = None):
...
class Chat:
    ...
    def prompt(self, content: str, files: List[str] = None):
