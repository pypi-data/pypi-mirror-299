...
{Fore.light_green}colors{Fore.light_steel_blue} - print system examples for colors from the colored module{Style.reset}
...
{Fore.light_steel_blue}if 'b' returns to previous menu, try '#b' to return to barcode input, in ListMode@$LOCATION_FIELD, 'e' does the same{Style.reset}''')
                ...
                continue
            elif cmd.lower() in ["bldls","build","buildls","build list","bld ls",]:
                with db.Session(db.ENGINE) as session:
