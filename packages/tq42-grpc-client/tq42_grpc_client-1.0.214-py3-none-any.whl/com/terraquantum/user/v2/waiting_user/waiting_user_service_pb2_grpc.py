...
class WaitingUserService(object):
    ...
    def JoinWaitingList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.user.v2.waiting_user.WaitingUserService/JoinWaitingList',
    ...
    def AddWaitingUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.user.v2.waiting_user.WaitingUserService/AddWaitingUser',
    ...
    def GetWaitingUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.user.v2.waiting_user.WaitingUserService/GetWaitingUser',
