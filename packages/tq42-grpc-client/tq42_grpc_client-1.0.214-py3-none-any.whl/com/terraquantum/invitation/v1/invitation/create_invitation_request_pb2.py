...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CREATEINVITATIONREQUEST'].fields_by_name['email']._options = None
  _globals['_CREATEINVITATIONREQUEST'].fields_by_name['email']._serialized_options = b'\210\265\030\001\242\265\030\024^[^@]{3}(.*)(\\.\\w+)$'
  _globals['_CREATEINVITATIONREQUEST'].fields_by_name['first_name']._options = None
  ...
  _globals['_CREATEINVITATIONREQUEST'].fields_by_name['last_name']._options = None
