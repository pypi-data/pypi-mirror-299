...
from com.terraquantum.organization.v1.organization import list_organization_members_by_organization_id_without_permissions_request_pb2 as com_dot_terraquantum_dot_organization_dot_v1_dot_organization_dot_list__organization__members__by__organization__id__without__permissions__request__pb2
...
class OrganizationMemberServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListOrganizationMembersByOrganizationIdWithoutPermissions = channel.unary_unary(
                '/com.terraquantum.organization.v1.organization.OrganizationMemberService/ListOrganizationMembersByOrganizationIdWithoutPermissions',
                request_serializer=com_dot_terraquantum_dot_organization_dot_v1_dot_organization_dot_list__organization__members__by__organization__id__without__permissions__request__pb2.ListOrganizationMembersByOrganizationIdWithoutPermissionsRequest.SerializeToString,
...
class OrganizationMemberServiceServicer(object):
    ...
    def ListOrganizationMembersByOrganizationIdWithoutPermissions(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_OrganizationMemberServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListOrganizationMembersByOrganizationIdWithoutPermissions': grpc.unary_unary_rpc_method_handler(
                    servicer.ListOrganizationMembersByOrganizationIdWithoutPermissions,
                    request_deserializer=com_dot_terraquantum_dot_organization_dot_v1_dot_organization_dot_list__organization__members__by__organization__id__without__permissions__request__pb2.ListOrganizationMembersByOrganizationIdWithoutPermissionsRequest.FromString,
...
class OrganizationMemberService(object):
    ...
    def CreateOrganizationMember(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/CreateOrganizationMember',
    ...
    def ReactivateOrganizationMember(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/ReactivateOrganizationMember',
    ...
    def InactivateOrganizationMember(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/InactivateOrganizationMember',
    ...
    def UpdateOrganizationMember(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/UpdateOrganizationMember',
    ...
    def GetOrganizationMemberById(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/GetOrganizationMemberById',
    ...
    @staticmethod
    def ListOrganizationMembersByOrganizationIdWithoutPermissions(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/ListOrganizationMembersByOrganizationIdWithoutPermissions',
            com_dot_terraquantum_dot_organization_dot_v1_dot_organization_dot_list__organization__members__by__organization__id__without__permissions__request__pb2.ListOrganizationMembersByOrganizationIdWithoutPermissionsRequest.SerializeToString,
    ...
    def GetOrganizationMemberByOrganizationIdAndUserIdWithoutPermissions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.terraquantum.organization.v1.organization.OrganizationMemberService/GetOrganizationMemberByOrganizationIdAndUserIdWithoutPermissions',
