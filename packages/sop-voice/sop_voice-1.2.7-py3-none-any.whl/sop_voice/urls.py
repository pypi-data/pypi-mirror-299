...
urlpatterns = [
    ...
    path('voice-delivery/add_site/<int:pk>', vd.VoiceDeliverySiteView.as_view(), name='voicedelivery_site_add'),
    ...
    path('sda-list/add_site/<int:pk>', sda.VoiceSdaAddSiteView.as_view(), name='voicesda_site_add'),
