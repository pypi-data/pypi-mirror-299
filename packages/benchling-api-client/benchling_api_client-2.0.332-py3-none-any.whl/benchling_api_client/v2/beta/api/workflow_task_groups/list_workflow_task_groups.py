...
def _get_kwargs(
    *,
    ...
    root_task_group_ids: Union[Unset, str] = UNSET,
    ...
    if not isinstance(root_task_group_ids, Unset) and root_task_group_ids is not None:
        params["rootTaskGroupIds"] = root_task_group_ids
...
def sync_detailed(
    *,
    ...
    kwargs = _get_kwargs(
        ...
        root_task_group_ids=root_task_group_ids,
