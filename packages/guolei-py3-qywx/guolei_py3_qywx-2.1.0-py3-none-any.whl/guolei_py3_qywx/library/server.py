...
class Api(Request):
    ...
    def get(self, on_response_callback: Callable = ResponseCallback.json_errcode_0, path: str = None, **kwargs):
        """
    ...
    def post(self, on_response_callback: Callable = ResponseCallback.json_errcode_0, path: str = None, **kwargs):
        """
    ...
    def put(self, on_response_callback: Callable = ResponseCallback.json_errcode_0, path: str = None, **kwargs):
        """
    ...
    def request(self, on_response_callback: Callable = ResponseCallback.json_errcode_0, path: str = None,
                **kwargs):
        """
