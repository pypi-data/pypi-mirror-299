...
class Ui_PresetMSRGoal(object):
    def setupUi(self, PresetMSRGoal):
        ...
        self.final_boss_group = QGroupBox(self.centralWidget)
        ...
        sizePolicy1.setHeightForWidth(self.final_boss_label.sizePolicy().hasHeightForWidth())
        self.final_boss_label.setSizePolicy(sizePolicy1)
        ...
        self.goal_layout.addWidget(self.final_boss_group)
