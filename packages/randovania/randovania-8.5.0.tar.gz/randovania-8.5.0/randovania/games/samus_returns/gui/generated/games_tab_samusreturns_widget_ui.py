...
class Ui_SamusReturnsGameTabWidget(object):
    def setupUi(self, SamusReturnsGameTabWidget):
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 166, 4692))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 99, 2161))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 100, 726))
