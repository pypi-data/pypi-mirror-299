...
class Ui_MSRGameExportDialog(object):
    def setupUi(self, MSRGameExportDialog):
        ...
        MSRGameExportDialog.resize(501, 618)
        ...
        self.input_exheader_edit = QLineEdit(MSRGameExportDialog)
        self.input_exheader_edit.setObjectName(u"input_exheader_edit")

        self.root_layout.addWidget(self.input_exheader_edit, 4, 0, 1, 1)

        self.input_exheader_label = QLabel(MSRGameExportDialog)
        self.input_exheader_label.setObjectName(u"input_exheader_label")
        self.input_exheader_label.setWordWrap(True)

        self.root_layout.addWidget(self.input_exheader_label, 3, 0, 1, 3)
        ...
        self.root_layout.addWidget(self.auto_save_spoiler_check, 17, 0, 1, 1)
        ...
        self.root_layout.addWidget(self.output_tab_widget, 14, 0, 2, 3)
        ...
        self.root_layout.addLayout(self.version_layout, 11, 0, 1, 3)

        self.accept_button = QPushButton(MSRGameExportDialog)
        self.accept_button.setObjectName(u"accept_button")

        self.root_layout.addWidget(self.accept_button, 18, 0, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 10, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.root_layout.addItem(self.verticalSpacer, 10, 0, 1, 1)
        ...
        self.root_layout.addWidget(self.console_reminder_label, 12, 0, 1, 3)
        ...
        self.root_layout.addLayout(self.target_platform_layout, 9, 0, 1, 3)
        ...
        self.root_layout.addWidget(self.cancel_button, 18, 2, 1, 1)
        ...
        self.input_exheader_button = QPushButton(MSRGameExportDialog)
        self.input_exheader_button.setObjectName(u"input_exheader_button")

        self.root_layout.addWidget(self.input_exheader_button, 4, 2, 1, 1)
        ...
        self.root_layout.addWidget(self.line, 6, 0, 1, 3)

        self.input_exheader_warning_label = QLabel(MSRGameExportDialog)
        self.input_exheader_warning_label.setObjectName(u"input_exheader_warning_label")
        self.input_exheader_warning_label.setWordWrap(True)

        self.root_layout.addWidget(self.input_exheader_warning_label, 5, 0, 1, 3)
    ...
    def retranslateUi(self, MSRGameExportDialog):
        ...
        self.input_exheader_edit.setPlaceholderText(QCoreApplication.translate("MSRGameExportDialog", u"Path to vanilla exheader.bin", None))
        self.input_exheader_label.setText(QCoreApplication.translate("MSRGameExportDialog", u"<html><head/><body><p>Input exheader.bin (Required for automatic item tracker and multiworld)<br/>If you're unsure how to extract your ExHeader, you can <a href=\"https://randovania.org/guides/export-exheader\"><span style=\" text-decoration: underline; color:#1d99f3;\">consult this guide</span></a>.</p></body></html>", None))
        ...
        self.input_exheader_button.setText(QCoreApplication.translate("MSRGameExportDialog", u"Select File", None))
        self.input_file_label.setText(QCoreApplication.translate("MSRGameExportDialog", u"<html><head/><body><p>In order to create the randomized game, an extracted RomFS of Metroid: Samus Returns for the Nintendo 3DS is necessary.<br/>If you're unsure how to extract your RomFS, you can <a href=\"https://randovania.org/guides/export-romfs-3ds\"><span style=\" text-decoration: underline; color:#1d99f3;\">consult this guide</span></a>.</p><p>Input Path (An extracted unmodified Samus Returns RomFS)</p></body></html>", None))
        self.input_exheader_warning_label.setText(QCoreApplication.translate("MSRGameExportDialog", u"Exporting to Luma3DS is disabled since the automatic item tracker is incompatible.", None))
    # retranslateUi
