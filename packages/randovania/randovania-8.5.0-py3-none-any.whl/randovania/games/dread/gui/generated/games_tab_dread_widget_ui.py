...
class Ui_DreadGameTabWidget(object):
    def setupUi(self, DreadGameTabWidget):
        ...
        self.intro_layout.setSizeConstraint(QLayout.SizeConstraint.SetMinimumSize)
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 629, 466))
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 629, 466))
        ...
        self.known_crashes_contents.setGeometry(QRect(0, 0, 612, 684))
        ...
        self.known_crashes_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 629, 466))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 629, 466))
        ...
        self.hint_item_names_label.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 629, 466))
