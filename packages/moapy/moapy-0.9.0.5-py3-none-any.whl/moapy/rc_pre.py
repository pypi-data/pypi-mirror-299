...
from moapy.data_pre import Point, Stress_Strain_Component, Length
# ==== Concrete Material ====
...
class ConcreteGeometry(MBaseModel):
    ...
    outerPolygon: list[Point] = dataclass_field(default=[Point(x=Length(value=0.0, unit="mm"), y=Length(value=0.0, unit="mm")), Point(x=Length(value=400.0, unit="mm"), y=Length(value=0.0, unit="mm")), 
                                                         Point(x=Length(value=400.0, unit="mm"), y=Length(value=600.0, unit="mm")), Point(x=Length(value=0.0, unit="mm"), y=Length(value=600.0, unit="mm"))], description="Outer polygon of the concrete")
    innerPolygon: list[Point] = dataclass_field(default=[Point(x=Length(value=80.0, unit="mm"), y=Length(value=80.0, unit="mm")), Point(x=Length(value=320.0, unit="mm"), y=Length(value=80.0, unit="mm")),
                                                         Point(x=Length(value=320.0, unit="mm"), y=Length(value=520.0, unit="mm")), Point(x=Length(value=80.0, unit="mm"), y=Length(value=520.0, unit="mm"))], description="Inner polygon of the concrete")
...
class RebarGeometry(MBaseModel):
    ...
    points: list[Point] = dataclass_field(default=[Point(x=Length(value=40.0, unit="mm"), y=Length(value=40.0, unit="mm")), Point(x=Length(value=360.0, unit="mm"), y=Length(value=40.0, unit="mm")),
                                                   Point(x=Length(value=360.0, unit="mm"), y=Length(value=560.0, unit="mm")), Point(x=Length(value=40.0, unit="mm"), y=Length(value=560.0, unit="mm"))], description="Rebar Points")
