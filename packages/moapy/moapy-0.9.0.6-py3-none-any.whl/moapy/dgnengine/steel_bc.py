...
# res = report_ec3_beam_column(SteelMaterial(code='KS18(S)', name='SS275'), SteelSection(shape='H', name='H 400x200x8/13'),
#                              MemberForce(Nz=Force(value=1000.0, unit=enUnitForce.kN), Mx=Moment(value=500.0, unit=enUnitMoment.kNm), My=Moment(value=200.0, unit=enUnitMoment.kNm),
