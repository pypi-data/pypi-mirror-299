...
def main(
    ...
    if use_calib_adc:
        logger.warning(
            "The --use-calib-adc was supplied but Data Transmission cannot be performed with this option. Will ignore."
        )
    ...
    for chip in yr._enabled_chip_positions:
        ...
        logger.info(r"data\[chip]: %s", data[chip], extra={"markup": False})
