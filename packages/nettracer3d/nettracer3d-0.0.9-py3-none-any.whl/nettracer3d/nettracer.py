...
def extract_pairwise_connections(connections):
    """Internal method used by the primary algorithm to break lists of edge interactions from the above method(s) to break down into trios"""
...
def label_vertices(array, branch_removal = 0, directory = None):
    """
    ...
    for x, y, z in nonzero_coords:
        ...
        if nearby_sum > threshold:
            ...
            if test_num > 2:
                image_copy[x-1:x+2, y-1:y+2, z-1:z+2] = threshold
