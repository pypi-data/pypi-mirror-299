...
def break_and_label_skeleton(skeleton, peaks = 1, branch_removal = 0, directory = None):
    ...
    verts = label_vertices(skeleton, peaks = peaks, branch_removal = branch_removal)
...
def label_branches(array, peaks = 1, branch_removal = None, down_factor = None, directory = None):
    """
    ...
    other_array = break_and_label_skeleton(other_array, peaks = peaks, branch_removal = branch_removal)
