...
from chalk._gen.chalk.server.v1 import chart_pb2 as _chart_pb2_1
from chalk._gen.chalk.server.v1 import timeserieschart_pb2 as _timeserieschart_pb2
...
class GetFeatureValuesTimeSeriesChartResponse(_message.Message):
    __slots__ = ("chart",)
    CHART_FIELD_NUMBER: _ClassVar[int]
    chart: _chart_pb2_1.TimeSeriesChart
    def __init__(self, chart: _Optional[_Union[_chart_pb2_1.TimeSeriesChart, _Mapping]] = ...) -> None: ...
...
class GetFeatureValuesTimeSeriesChartV2Response(_message.Message):
    __slots__ = ("chart",)
    CHART_FIELD_NUMBER: _ClassVar[int]
    chart: _timeserieschart_pb2.TimeSeriesChartV2
    def __init__(self, chart: _Optional[_Union[_timeserieschart_pb2.TimeSeriesChartV2, _Mapping]] = ...) -> None: ...
