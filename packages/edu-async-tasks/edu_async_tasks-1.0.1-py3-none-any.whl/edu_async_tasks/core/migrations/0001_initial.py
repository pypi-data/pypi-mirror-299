    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(default='PENDING', on_delete=django.db.models.deletion.PROTECT, to='edu_async_tasks_core.AsyncTaskStatus', verbose_name='Состояние задачи')),
                ('task_type', models.ForeignKey(default='UNKNOWN', on_delete=django.db.models.deletion.PROTECT, to='edu_async_tasks_core.AsyncTaskType', verbose_name='Тип задачи')),
            ],
            options={
