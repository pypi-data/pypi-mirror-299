...
class ResponseDataInterview(NamedTuple):
    ...
    def make(
        ...
        return cls(resp_cmd, ses_id, payload_id, ref_payload_id, text)
...
class RequestDataMessage(NamedTuple):
    ...
    message: Union[RequestDataSlack, RequestDataEmail, RequestDataSms]
    """The message payload (Slack, Email, or SMS)."""
...
class ResponseDataMessage(NamedTuple):
    ...
    message: Union[ResponseDataSlack, ResponseDataEmail, ResponseDataSms]
    """The response message payload (Slack, Email, or SMS)."""
