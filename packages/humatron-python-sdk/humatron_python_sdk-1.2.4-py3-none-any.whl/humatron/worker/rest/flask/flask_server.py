...
from humatron.worker.client import Request, HumatronWorker
...
def make_flask_server(
    ...
    def _process() -> flask.Response:
        ...
        try:
            ...
            resp_spec = worker.process_request(Request.from_dict(request.json))
