...
class Object:
    _type_prefix: typing.ClassVar[typing.Optional[str]]
    _prefix_to_type: typing.ClassVar[typing.Dict[str, type]]
    _load: typing.Optional[typing.Callable[[_BLOCKING_O, modal._resolver.Resolver, typing.Optional[str]], None]]
    _preload: typing.Optional[typing.Callable[[_BLOCKING_O, modal._resolver.Resolver, typing.Optional[str]], None]]
    _rep: str
    _is_another_app: bool
    _hydrate_lazily: bool
    _deps: typing.Optional[typing.Callable[..., typing.List[Object]]]
    _deduplication_key: typing.Optional[typing.Callable[[], typing.Hashable]]
    _object_id: str
