...
class ModalClientModal:
    ...
    def __init__(self, grpclib_stub: modal_proto.api_grpc.ModalClientStub, client: "modal.client._Client") -> None:
        ...
        self.ClientCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.ClientCreate, client)
        self.ClientHeartbeat = modal.client.UnaryUnaryWrapper(grpclib_stub.ClientHeartbeat, client)
        ...
        self.DictCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.DictCreate, client)
        ...
        self.EnvironmentConfigGet = modal.client.UnaryUnaryWrapper(grpclib_stub.EnvironmentConfigGet, client)
        ...
        self.MountBuild = modal.client.UnaryUnaryWrapper(grpclib_stub.MountBuild, client)
        ...
        self.QueueCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.QueueCreate, client)
        ...
        self.SecretCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.SecretCreate, client)
        ...
        self.SharedVolumeCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.SharedVolumeCreate, client)
        ...
        self.VolumeCreate = modal.client.UnaryUnaryWrapper(grpclib_stub.VolumeCreate, client)
