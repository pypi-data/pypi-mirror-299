...
class ModalClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.EnvironmentConfigGet = channel.unary_unary(
                '/modal.client.ModalClient/EnvironmentConfigGet',
                request_serializer=modal__proto_dot_api__pb2.EnvironmentConfigGetRequest.SerializeToString,
                response_deserializer=modal__proto_dot_api__pb2.EnvironmentConfigGetResponse.FromString,
                )
...
class ModalClientServicer(object):
    ...
    def EnvironmentConfigGet(self, request, context):
        """Environments
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
...
def add_ModalClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'EnvironmentConfigGet': grpc.unary_unary_rpc_method_handler(
                    servicer.EnvironmentConfigGet,
                    request_deserializer=modal__proto_dot_api__pb2.EnvironmentConfigGetRequest.FromString,
                    response_serializer=modal__proto_dot_api__pb2.EnvironmentConfigGetResponse.SerializeToString,
            ),
...
class ModalClient(object):
    ...
    @staticmethod
    def EnvironmentConfigGet(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/modal.client.ModalClient/EnvironmentConfigGet',
            modal__proto_dot_api__pb2.EnvironmentConfigGetRequest.SerializeToString,
            modal__proto_dot_api__pb2.EnvironmentConfigGetResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
