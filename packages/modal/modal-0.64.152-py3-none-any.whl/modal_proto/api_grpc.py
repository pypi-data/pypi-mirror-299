...
class ModalClientBase(abc.ABC):
    ...
    @abc.abstractmethod
    async def EnvironmentConfigGet(self, stream: 'grpclib.server.Stream[modal_proto.api_pb2.EnvironmentConfigGetRequest, modal_proto.api_pb2.EnvironmentConfigGetResponse]') -> None:
        pass
    ...
    def __mapping__(self) -> typing.Dict[str, grpclib.const.Handler]:
        return {
            ...
            '/modal.client.ModalClient/EnvironmentConfigGet': grpclib.const.Handler(
                self.EnvironmentConfigGet,
                grpclib.const.Cardinality.UNARY_UNARY,
                modal_proto.api_pb2.EnvironmentConfigGetRequest,
                modal_proto.api_pb2.EnvironmentConfigGetResponse,
            ),
...
class ModalClientStub:
    ...
    def __init__(self, channel: grpclib.client.Channel) -> None:
        ...
        self.EnvironmentConfigGet = grpclib.client.UnaryUnaryMethod(
            channel,
