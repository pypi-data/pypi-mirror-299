...
# ./pypiUploadVer exists -- pypiNextVer=0.12 -- installedVersion=0.1
def pkgVersion():
        return '0.12'   # Version Nu To Be Uploaded
...
'./bin/qmailMua-admin.cs',
'./bin/qmailMua-assemble.cs',
'./bin/qmailMua-binsPrep.cs',
