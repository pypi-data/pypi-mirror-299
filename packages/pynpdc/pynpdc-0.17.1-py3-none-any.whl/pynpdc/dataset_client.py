...
class DatasetClient:
    ...
    def get_dataset(self, dataset_id: str) -> Union[Dataset, None]:
        """
    ...
    def add_attachment(
        self, dataset_id: str, upload: AttachmentCreateDTO
    ) -> AttachmentCreationInfo:
        """
    ...
    def add_attachments(
        self, dataset_id: str, uploads: List[AttachmentCreateDTO]
    ...
    def add_records(
        self, dataset_id: str, records: List[RecordCreateDTO]
    ) -> List[RecordCreationInfo]:
        """
        ...
        return [RecordCreationInfo(item) for item in response_items]
    ...
    def get_record(self, dataset_id: str, record_id: str) -> Union[Record, None]:
        """
    ...
    def get_permission(self, dataset_id: str, user_id: str) -> Union[Permission, None]:
        """
