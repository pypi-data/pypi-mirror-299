...
class Assessment(BaseModule):
    ...
    def read_report(self, assessment_id: str, report_id: str):
        return self._make_request(method="GET", path=f"{self.root_path}/{assessment_id}/report/results/{report_id}")

    def read_topic_report(self, assessment_id: str, report_id: str, topic_id: str):
        return self._make_request(method="GET", path=f"{self.root_path}/{assessment_id}/report/results/{report_id}/topic/{topic_id}")

    def list_report(self, report_type: ReportType = ReportType.LLM):
