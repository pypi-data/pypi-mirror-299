...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_labels=None, content_guard=None, base_url=None, pulp_href=None, name=None, base_path=None, local_vars_configuration=None):  # noqa: E501
