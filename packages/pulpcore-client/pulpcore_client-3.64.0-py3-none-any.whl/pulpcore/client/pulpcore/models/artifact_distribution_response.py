...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_last_updated=None, hidden=False, content_guard=None, prn=None, pulp_labels=None, base_url=None, name=None, no_content_change_since=None, pulp_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
