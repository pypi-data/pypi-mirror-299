...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, name=None, base_url=None, hidden=False, prn=None, no_content_change_since=None, pulp_last_updated=None, pulp_href=None, content_guard=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
