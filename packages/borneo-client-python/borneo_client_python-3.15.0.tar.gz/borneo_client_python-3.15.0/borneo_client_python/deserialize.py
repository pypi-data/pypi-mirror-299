...
def _deserialize_scan_iteration_stats(
    ...
    if (_successful := output.get("successful")) is not None:
        kwargs["successful"] = expect_type(int, _successful)
    ...
    if (_unknown := output.get("unknown")) is not None:
        kwargs["unknown"] = expect_type(int, _unknown)
