...
import { q as colors } from './2-DpTvHskm.js';
import { g as get_next_color } from './color-BMq_dF2x.js';
import './vega-embed.module-BMwx_TJ-.js';
...
const AltairPlot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  fit_width_to_parent = spec.encoding?.column?.field || spec.encoding?.row?.field || value.chart === void 0 ? false : true;
  return `<div${add_attribute("data-testid", "altair", 0)} class="altair layout svelte-1ghah4v"${add_attribute("this", parent_element, 0)}><div${add_attribute("this", element, 0)}></div> ${caption ? `<div class="caption layout svelte-1ghah4v">${escape(caption)}</div>` : ``} </div>`;
});

export { AltairPlot as default };
//# sourceMappingURL=AltairPlot-dOjb5vLC.js.map
