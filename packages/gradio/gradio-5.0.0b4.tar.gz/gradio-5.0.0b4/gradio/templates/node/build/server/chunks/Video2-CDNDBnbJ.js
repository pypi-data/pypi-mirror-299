...
const Video = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="${["overlay svelte-1pwzuub", !processingVideo ? "hidden" : ""].join(" ").trim()}" data-svelte-h="svelte-mez4j5"><span class="load-wrap svelte-1pwzuub"><span class="loader svelte-1pwzuub"></span></span></div> <video${add_attribute("src", resolved_src, 0)} ${muted ? "muted" : ""} ${playsinline ? "playsinline" : ""}${add_attribute("preload", preload, 0)} ${autoplay ? "autoplay" : ""} ${controls ? "controls" : ""} ${loop ? "loop" : ""}${add_attribute("data-testid", $$props["data-testid"], 0)} crossorigin="anonymous"${add_attribute("currentTime", currentTime, 0)}${add_attribute("paused", paused, 0)}${add_attribute("this", node, 0)}>${slots.default ? slots.default({}) : ``}</video>`;
});

export { Video as V };
//# sourceMappingURL=Video2-CDNDBnbJ.js.map
