...
const DownloadButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Button, "BaseButton").$$render(
    ...
    {
      default: () => {
        return `${icon ? `<img class="button-icon svelte-qrkusm"${add_attribute("src", icon.url, 0)}${add_attribute("alt", `${value} icon`, 0)}>` : ``} ${slots.default ? slots.default({}) : ``}`;
      }
    }
  )}`;
});
...
//# sourceMappingURL=Index41-CutxbTiD.js.map
