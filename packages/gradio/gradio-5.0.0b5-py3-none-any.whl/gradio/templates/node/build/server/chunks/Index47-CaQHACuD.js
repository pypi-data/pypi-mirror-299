    ...
    $$rendered = `${validate_component(Block, "Block").$$render(
      ...
      {},
      {
        default: () => {
          ...
          })} <div class="wrap svelte-1wdncym">${each(choices, ([display_value, internal_value], i) => {
...
//# sourceMappingURL=Index47-CaQHACuD.js.map
