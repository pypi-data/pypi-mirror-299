...
const Colorpicker = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })} <input type="color" ${disabled ? "disabled" : ""} class="svelte-16l8u73"${add_attribute("value", value, 0)}> </label>`;
});
...
//# sourceMappingURL=Index39-CNkgRoXa.js.map
