...
import { B as Block, S as Static, c as IconButton, C as Copy } from './2-Ax4bcEC3.js';
...
import { I as IconButtonWrapper } from './IconButtonWrapper-BjpnJZXp.js';
import { M as MarkdownCode$1 } from './Example.svelte_svelte_type_style_lang4-DiZJe0YE.js';
import { D as DownloadLink } from './DownloadLink-4kzPen0P.js';
import { U as Undo } from './Undo-CbHQvbEr.js';
import { B as BlockLabel } from './BlockLabel-CcEvnTTV.js';
import './index4-D_FyJKAV.js';
import './file-url-D-K40zdU.js';
import './prism-python-CUVUMwlN.js';
...
const css$4 = {
  code: ".pending.svelte-1pwlswb{background:var(--color-accent-soft);display:flex;flex-direction:row;justify-content:center;align-items:center;align-self:center;gap:2px;width:100%;height:var(--size-16)}.dot-flashing.svelte-1pwlswb{animation:svelte-1pwlswb-flash 1s infinite ease-in-out;border-radius:5px;background-color:var(--body-text-color);width:7px;height:7px;color:var(--body-text-color)}@keyframes svelte-1pwlswb-flash{0%,100%{opacity:0}50%{opacity:1}}.dot-flashing.svelte-1pwlswb:nth-child(1){animation-delay:0s}.dot-flashing.svelte-1pwlswb:nth-child(2){animation-delay:0.33s}.dot-flashing.svelte-1pwlswb:nth-child(3){animation-delay:0.66s}",
...
const Pending = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="message pending svelte-1pwlswb" role="status" aria-label="Loading response" aria-live="polite"${add_styles({
    "border-radius": layout === "bubble" ? "var(--radius-xxl)" : "none"
  })} data-svelte-h="svelte-exuub1"><span class="sr-only">Loading content</span> <div class="dot-flashing svelte-1pwlswb"></div>
	 
	<div class="dot-flashing svelte-1pwlswb"></div>
	 
	<div class="dot-flashing svelte-1pwlswb"></div> </div>`;
});
const css$3 = {
  code: ".box.svelte-1j60sah{border-radius:4px;cursor:pointer;max-width:max-content;background:var(--color-accent-soft);border:1px solid var(--border-color-accent-subdued);font-size:0.8em}.title.svelte-1j60sah{display:flex;align-items:center;padding:3px 6px;color:var(--body-text-color);opacity:0.8}.content.svelte-1j60sah{padding:4px 8px}.content.svelte-1j60sah *{font-size:0.8em}.title-text.svelte-1j60sah{padding-right:var(--spacing-lg)}.arrow.svelte-1j60sah{margin-left:auto;opacity:0.8}",
...
const MessageBox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="box svelte-1j60sah"><div class="title svelte-1j60sah"><span class="title-text svelte-1j60sah">${escape(title)}</span> <span class="arrow svelte-1j60sah"${add_styles({
    "transform": expanded ? "rotate(0)" : "rotate(90deg)"
  })} data-svelte-h="svelte-15ydlzc">▼</span></div> ${expanded ? `<div class="content svelte-1j60sah">${slots.default ? slots.default({}) : ``}</div>` : ``} </button>`;
});
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  show_copy = show_copy_button && message && is_all_text(message);
  show_download = !Array.isArray(message) && is_component_message(message) && message.content.value?.url;
  return `${show ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-1xfayjo"}">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
...
const css$1 = {
  code: '.hidden.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:none}.placeholder-content.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:flex;flex-direction:column;height:100%}.placeholder.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-items:center;display:flex;justify-content:center;height:100%;flex-grow:1}.suggestions.svelte-1brq25p img{pointer-events:none}.suggestions.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin:auto;padding:var(--spacing-xxl);display:grid;grid-template-columns:repeat(auto-fit, minmax(200px, 1fr));gap:var(--spacing-xxl);max-width:calc(min(4 * 200px + 5 * var(--spacing-xxl), 100%))}.suggestion.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:flex;flex-direction:column;align-items:center;padding:var(--spacing-xl);border:0.05px solid var(--border-color-primary);border-radius:var(--radius-xl);background-color:var(--background-fill-secondary);cursor:pointer;transition:var(--button-transition);max-width:var(--size-56);width:100%}.suggestion.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p:hover{background-color:var(--color-accent-soft);border-color:var(--border-color-accent)}.suggestion-icon-container.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:flex;align-self:flex-start;margin-left:var(--spacing-md);width:var(--size-6);height:var(--size-6)}.suggestion-display-text.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p,.suggestion-text.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p,.suggestion-file.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{font-size:var(--text-md);width:100%;text-align:center;overflow:hidden;text-overflow:ellipsis}.suggestion-display-text.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p,.suggestion-file.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin-top:var(--spacing-md)}.suggestion-image-container.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{flex-grow:1;display:flex;justify-content:center;align-items:center;margin-top:var(--spacing-xl)}.suggestion-image-container.svelte-1brq25p img{max-height:100%;max-width:100%;height:var(--size-32);width:100%;object-fit:cover;border-radius:var(--radius-xl)}.panel-wrap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%;overflow-y:auto}.flex-wrap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%;height:100%}.bubble-wrap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%;overflow-y:auto;height:100%;padding-top:var(--spacing-xxl)}.dark .bubble-wrap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{background:var(--background-fill-secondary)}.message-wrap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:flex;flex-direction:column;justify-content:space-between;margin-bottom:var(--spacing-xxl)}.bubble-gap.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{gap:calc(var(--spacing-xxl) + var(--spacing-lg))}.message-wrap.svelte-1brq25p>div.svelte-1brq25p p:not(:first-child){margin-top:var(--spacing-xxl)}.message.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{position:relative;display:flex;flex-direction:column;width:calc(100% - var(--spacing-xxl));max-width:100%;color:var(--body-text-color);font-size:var(--chatbot-text-size);overflow-wrap:break-word}.thought.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin-top:var(--spacing-xxl)}.message.svelte-1brq25p .prose{font-size:var(--chatbot-text-size)}.message-bubble-border.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{border-width:1px;border-radius:var(--radius-md)}.user.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-end}.message-fit.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:fit-content !important}.panel-full-width.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%}.message-markdown-disabled.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{white-space:pre-line}.flex-wrap.user.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{border-width:1px;border-radius:var(--radius-md);align-self:flex-start;border-bottom-right-radius:0;box-shadow:var(--shadow-drop);align-self:flex-start;text-align:right;padding:var(--spacing-sm) var(--spacing-xl);border-color:var(--border-color-accent-subdued);background-color:var(--color-accent-soft)}:not(.component-wrap).flex-wrap.bot.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{border-width:1px;border-radius:var(--radius-lg);align-self:flex-start;border-bottom-left-radius:0;box-shadow:var(--shadow-drop);align-self:flex-start;text-align:right;padding:var(--spacing-sm) var(--spacing-xl);border-color:var(--border-color-primary);background-color:var(--background-fill-secondary)}.panel.svelte-1brq25p .user.svelte-1brq25p *{text-align:right}.bubble.svelte-1brq25p .bot.svelte-1brq25p.svelte-1brq25p{border-color:var(--border-color-primary)}.message-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:flex;position:relative}.message-row.user-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-end}.message-row.bubble.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin:calc(var(--spacing-xl) * 2);margin-bottom:var(--spacing-xl)}.with_avatar.message-row.panel.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{padding-left:calc(var(--spacing-xl) * 2) !important;padding-right:calc(var(--spacing-xl) * 2) !important}.with_avatar.message-row.bubble.user-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin-right:calc(var(--spacing-xl) * 2) !important}.with_avatar.message-row.bubble.bot-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin-left:calc(var(--spacing-xl) * 2) !important}.with_opposite_avatar.message-row.bubble.user-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin-left:calc(var(--spacing-xxl) + 35px + var(--spacing-xxl))}.message-row.panel.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{margin:0;padding:calc(var(--spacing-xl) * 3) calc(var(--spacing-xxl) * 2)}.message-row.panel.bot-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{background:var(--background-fill-secondary)}.message-row.bubble.user-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-end;max-width:calc(100% - var(--spacing-xl) * 6)}.message-row.bubble.bot-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-start;max-width:calc(100% - var(--spacing-xl) * 6)}.message-row.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p:last-of-type{margin-bottom:calc(var(--spacing-xxl) * 2)}.user-row.bubble.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{flex-direction:row;justify-content:flex-end}@media(max-width: 480px){.user-row.bubble.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-end}.bot-row.bubble.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-start}.message.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%}}.avatar-container.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{align-self:flex-start;position:relative;display:flex;justify-content:flex-start;align-items:flex-start;width:35px;height:35px;flex-shrink:0;bottom:0;border-radius:50%;border:1px solid var(--border-color-primary)}.user-row.svelte-1brq25p>.avatar-container.svelte-1brq25p.svelte-1brq25p{order:2;margin-left:var(--spacing-xxl)}.bot-row.svelte-1brq25p>.avatar-container.svelte-1brq25p.svelte-1brq25p{margin-right:var(--spacing-xxl);margin-left:0;margin-top:-5px}.avatar-container.svelte-1brq25p:not(.thumbnail-item) img{width:100%;height:100%;object-fit:cover;border-radius:50%;padding:6px}.selectable.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{cursor:pointer}@keyframes svelte-1brq25p-dot-flashing{0%{opacity:0.8}50%{opacity:0.5}100%{opacity:0.8}}.message-wrap.svelte-1brq25p>.message .svelte-1brq25p:not(.image-button) img{margin:var(--size-2);max-height:200px}.message-wrap.svelte-1brq25p>div.svelte-1brq25p :not(.avatar-container) div .svelte-1brq25p:not(.image-button) img{border-radius:var(--radius-xl);margin:var(--size-2);width:400px;max-width:30vw;max-height:30vw}.message-wrap.svelte-1brq25p .message.svelte-1brq25p a{color:var(--color-text-link);text-decoration:underline}.message-wrap.svelte-1brq25p .bot.svelte-1brq25p table,.message-wrap.svelte-1brq25p .bot.svelte-1brq25p tr,.message-wrap.svelte-1brq25p .bot.svelte-1brq25p td,.message-wrap.svelte-1brq25p .bot.svelte-1brq25p th{border:1px solid var(--border-color-primary)}.message-wrap.svelte-1brq25p .user.svelte-1brq25p table,.message-wrap.svelte-1brq25p .user.svelte-1brq25p tr,.message-wrap.svelte-1brq25p .user.svelte-1brq25p td,.message-wrap.svelte-1brq25p .user.svelte-1brq25p th{border:1px solid var(--border-color-accent)}.message-wrap.svelte-1brq25p span.katex{font-size:var(--text-lg);direction:ltr}.message-wrap.svelte-1brq25p div[class*="code_wrap"] > button{position:absolute;top:var(--spacing-md);right:var(--spacing-md);z-index:1;cursor:pointer;border-bottom-left-radius:var(--radius-sm);padding:var(--spacing-md);width:25px;height:25px}.message-wrap.svelte-1brq25p code > button > span{position:absolute;top:var(--spacing-md);right:var(--spacing-md);width:12px;height:12px}.message-wrap.svelte-1brq25p .check{position:absolute;top:0;right:0;opacity:0;z-index:var(--layer-top);transition:opacity 0.2s;background:var(--background-fill-primary);padding:var(--size-1);width:100%;height:100%;color:var(--body-text-color)}.message-wrap.svelte-1brq25p pre{position:relative}.message-wrap.svelte-1brq25p .grid-wrap{max-height:80% !important;max-width:600px;object-fit:contain}.message.svelte-1brq25p .preview{object-fit:contain;width:95%;max-height:93%}.image-preview.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{position:absolute;z-index:999;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0, 0, 0, 0.9);display:flex;justify-content:center;align-items:center}.image-preview.svelte-1brq25p svg{stroke:white}.image-preview-close-button.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{position:absolute;top:10px;right:10px;background:none;border:none;font-size:1.5em;cursor:pointer;height:30px;width:30px;padding:3px;background:var(--bg-color);box-shadow:var(--shadow-drop);border:1px solid var(--button-secondary-border-color);border-radius:var(--radius-lg)}.component.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{padding:0;border-radius:var(--radius-md);width:fit-content;overflow:hidden}.component.gallery.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{border:none}.file-pil.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{display:block;width:fit-content;padding:var(--spacing-sm) var(--spacing-lg);border-radius:var(--radius-md);background:var(--background-fill-secondary);color:var(--body-text-color);text-decoration:none;margin:0;font-family:var(--font-mono);font-size:var(--text-sm)}.file.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:auto !important;max-width:fit-content !important}@media(max-width: 600px) or (max-width: 480px){.component.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{width:100%}}.message-wrap.svelte-1brq25p .prose.chatbot.md{opacity:0.8;overflow-wrap:break-word}.message.svelte-1brq25p>button.svelte-1brq25p.svelte-1brq25p{width:100%}.html.svelte-1brq25p.svelte-1brq25p.svelte-1brq25p{padding:0;border:none;background:none}',
  map: '{"version":3,"file":"ChatBot.svelte","sources":["ChatBot.svelte"],"sourcesContent":["<script lang=\\"ts\\">import {\\n  format_chat_for_sharing,\\n  is_component_message\\n} from \\"./utils\\";\\nimport { Gradio, copy } from \\"@gradio/utils\\";\\nimport { dequal } from \\"dequal/lite\\";\\nimport {\\n  beforeUpdate,\\n  afterUpdate,\\n  createEventDispatcher,\\n  tick,\\n  onMount\\n} from \\"svelte\\";\\nimport { Image } from \\"@gradio/image/shared\\";\\nimport { Clear, Trash, Community } from \\"@gradio/icons\\";\\nimport { IconButtonWrapper, IconButton } from \\"@gradio/atoms\\";\\nimport { MarkdownCode as Markdown } from \\"@gradio/markdown\\";\\nimport Pending from \\"./Pending.svelte\\";\\nimport MessageBox from \\"./MessageBox.svelte\\";\\nimport { ShareError } from \\"@gradio/utils\\";\\nexport let value = [];\\nlet old_value = null;\\nimport Component from \\"./Component.svelte\\";\\nimport LikeButtons from \\"./ButtonPanel.svelte\\";\\nimport CopyAll from \\"./CopyAll.svelte\\";\\nexport let _fetch;\\nexport let load_component;\\nlet _components = {};\\nasync function load_components(component_names) {\\n  let names = [];\\n  let components = [];\\n  component_names.forEach((component_name) => {\\n    if (_components[component_name] || component_name === \\"file\\") {\\n      return;\\n    }\\n    const { name, component } = load_component(component_name, \\"base\\");\\n    names.push(name);\\n    components.push(component);\\n    component_name;\\n  });\\n  const loaded_components = await Promise.all(components);\\n  loaded_components.forEach((component, i) => {\\n    _components[names[i]] = component.default;\\n  });\\n}\\n$:\\n  load_components(get_components_from_messages(value));\\nfunction get_components_from_messages(messages) {\\n  if (!messages)\\n    return [];\\n  let components = /* @__PURE__ */ new Set();\\n  messages.forEach((message) => {\\n    if (message.type === \\"component\\") {\\n      components.add(message.content.component);\\n    }\\n  });\\n  return Array.from(components);\\n}\\nexport let latex_delimiters;\\nexport let pending_message = false;\\nexport let generating = false;\\nexport let selectable = false;\\nexport let likeable = false;\\nexport let show_share_button = false;\\nexport let show_copy_all_button = false;\\nexport let rtl = false;\\nexport let show_copy_button = false;\\nexport let avatar_images = [null, null];\\nexport let sanitize_html = true;\\nexport let bubble_full_width = true;\\nexport let render_markdown = true;\\nexport let line_breaks = true;\\nexport let theme_mode;\\nexport let i18n;\\nexport let layout = \\"bubble\\";\\nexport let placeholder = null;\\nexport let upload;\\nexport let msg_format = \\"tuples\\";\\nexport let suggestions = null;\\nexport let _retryable = false;\\nexport let _undoable = false;\\nexport let like_user_message = false;\\nexport let root;\\nlet target = null;\\nonMount(() => {\\n  target = document.querySelector(\\"div.gradio-container\\");\\n});\\nlet div;\\nlet autoscroll;\\nconst dispatch = createEventDispatcher();\\nbeforeUpdate(() => {\\n  autoscroll = div && div.offsetHeight + div.scrollTop > div.scrollHeight - 100;\\n});\\nasync function scroll() {\\n  if (!div)\\n    return;\\n  await tick();\\n  requestAnimationFrame(() => {\\n    if (autoscroll) {\\n      div?.scrollTo(0, div.scrollHeight);\\n    }\\n  });\\n}\\nlet image_preview_source;\\nlet image_preview_source_alt;\\nlet is_image_preview_open = false;\\n$:\\n  if (value || autoscroll || _components) {\\n    scroll();\\n  }\\nafterUpdate(() => {\\n  if (!div)\\n    return;\\n  div.querySelectorAll(\\"img\\").forEach((n) => {\\n    n.addEventListener(\\"click\\", (e) => {\\n      const target2 = e.target;\\n      if (target2) {\\n        image_preview_source = target2.src;\\n        image_preview_source_alt = target2.alt;\\n        is_image_preview_open = true;\\n      }\\n    });\\n  });\\n});\\n$: {\\n  if (!dequal(value, old_value)) {\\n    old_value = value;\\n    dispatch(\\"change\\");\\n  }\\n}\\n$:\\n  groupedMessages = value && group_messages(value);\\nfunction handle_suggestion_select(i, suggestion) {\\n  dispatch(\\"suggestion_select\\", {\\n    index: i,\\n    value: { text: suggestion.text, files: suggestion.files }\\n  });\\n}\\nfunction is_last_bot_message(messages, all_messages) {\\n  const is_bot = messages[messages.length - 1].role === \\"assistant\\";\\n  const last_index = messages[messages.length - 1].index;\\n  const is_last = JSON.stringify(last_index) === JSON.stringify(all_messages[all_messages.length - 1].index);\\n  return is_last && is_bot;\\n}\\nfunction handle_select(i, message) {\\n  dispatch(\\"select\\", {\\n    index: message.index,\\n    value: message.content\\n  });\\n}\\nfunction handle_like(i, message, selected) {\\n  if (selected === \\"undo\\" || selected === \\"retry\\") {\\n    const val_ = value;\\n    let last_index = val_.length - 1;\\n    while (val_[last_index].role === \\"assistant\\") {\\n      last_index--;\\n    }\\n    dispatch(selected, {\\n      index: val_[last_index].index,\\n      value: val_[last_index].content\\n    });\\n    return;\\n  }\\n  if (msg_format === \\"tuples\\") {\\n    dispatch(\\"like\\", {\\n      index: message.index,\\n      value: message.content,\\n      liked: selected === \\"like\\"\\n    });\\n  } else {\\n    if (!groupedMessages)\\n      return;\\n    const message_group = groupedMessages[i];\\n    const [first, last] = [\\n      message_group[0],\\n      message_group[message_group.length - 1]\\n    ];\\n    dispatch(\\"like\\", {\\n      index: [first.index, last.index],\\n      value: message_group.map((m) => m.content),\\n      liked: selected === \\"like\\"\\n    });\\n  }\\n}\\nfunction get_message_label_data(message) {\\n  if (message.type === \\"text\\") {\\n    return message.content;\\n  } else if (message.type === \\"component\\" && message.content.component === \\"file\\") {\\n    if (Array.isArray(message.content.value)) {\\n      return `file of extension type: ${message.content.value[0].orig_name?.split(\\".\\").pop()}`;\\n    }\\n    return `file of extension type: ${message.content.value?.orig_name?.split(\\".\\").pop()}` + (message.content.value?.orig_name ?? \\"\\");\\n  }\\n  return `a component of type ${message.content.component ?? \\"unknown\\"}`;\\n}\\nfunction group_messages(messages) {\\n  const groupedMessages2 = [];\\n  let currentGroup = [];\\n  let currentRole = null;\\n  for (const message of messages) {\\n    if (msg_format === \\"tuples\\") {\\n      currentRole = null;\\n    }\\n    if (!(message.role === \\"assistant\\" || message.role === \\"user\\")) {\\n      continue;\\n    }\\n    if (message.role === currentRole) {\\n      currentGroup.push(message);\\n    } else {\\n      if (currentGroup.length > 0) {\\n        groupedMessages2.push(currentGroup);\\n      }\\n      currentGroup = [message];\\n      currentRole = message.role;\\n    }\\n  }\\n  if (currentGroup.length > 0) {\\n    groupedMessages2.push(currentGroup);\\n  }\\n  return groupedMessages2;\\n}\\n<\/script>\\n\\n{#if value !== null && value.length > 0}\\n\\t<IconButtonWrapper>\\n\\t\\t{#if show_share_button}\\n\\t\\t\\t<IconButton\\n\\t\\t\\t\\tIcon={Community}\\n\\t\\t\\t\\ton:click={async () => {\\n\\t\\t\\t\\t\\ttry {\\n\\t\\t\\t\\t\\t\\t// @ts-ignore\\n\\t\\t\\t\\t\\t\\tconst formatted = await format_chat_for_sharing(value);\\n\\t\\t\\t\\t\\t\\tdispatch(\\"share\\", {\\n\\t\\t\\t\\t\\t\\t\\tdescription: formatted\\n\\t\\t\\t\\t\\t\\t});\\n\\t\\t\\t\\t\\t} catch (e) {\\n\\t\\t\\t\\t\\t\\tconsole.error(e);\\n\\t\\t\\t\\t\\t\\tlet message = e instanceof ShareError ? e.message : \\"Share failed.\\";\\n\\t\\t\\t\\t\\t\\tdispatch(\\"error\\", message);\\n\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t}}\\n\\t\\t\\t>\\n\\t\\t\\t\\t<Community />\\n\\t\\t\\t</IconButton>\\n\\t\\t{/if}\\n\\t\\t<IconButton Icon={Trash} on:click={() => dispatch(\\"clear\\")}></IconButton>\\n\\t\\t{#if show_copy_all_button}\\n\\t\\t\\t<CopyAll {value} />\\n\\t\\t{/if}\\n\\t</IconButtonWrapper>\\n{/if}\\n\\n<div\\n\\tclass={layout === \\"bubble\\" ? \\"bubble-wrap\\" : \\"panel-wrap\\"}\\n\\tbind:this={div}\\n\\trole=\\"log\\"\\n\\taria-label=\\"chatbot conversation\\"\\n\\taria-live=\\"polite\\"\\n>\\n\\t{#if value !== null && value.length > 0 && groupedMessages !== null}\\n\\t\\t<div class=\\"message-wrap\\" use:copy>\\n\\t\\t\\t{#each groupedMessages as messages, i}\\n\\t\\t\\t\\t{@const role = messages[0].role === \\"user\\" ? \\"user\\" : \\"bot\\"}\\n\\t\\t\\t\\t{@const avatar_img = avatar_images[role === \\"user\\" ? 0 : 1]}\\n\\t\\t\\t\\t{@const opposite_avatar_img = avatar_images[role === \\"user\\" ? 0 : 1]}\\n\\t\\t\\t\\t{#if is_image_preview_open}\\n\\t\\t\\t\\t\\t<div class=\\"image-preview\\">\\n\\t\\t\\t\\t\\t\\t<img src={image_preview_source} alt={image_preview_source_alt} />\\n\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\tclass=\\"image-preview-close-button\\"\\n\\t\\t\\t\\t\\t\\t\\ton:click={() => {\\n\\t\\t\\t\\t\\t\\t\\t\\tis_image_preview_open = false;\\n\\t\\t\\t\\t\\t\\t\\t}}><Clear /></button\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\tclass=\\"message-row {layout} {role}-row\\"\\n\\t\\t\\t\\t\\tclass:with_avatar={avatar_img !== null}\\n\\t\\t\\t\\t\\tclass:with_opposite_avatar={opposite_avatar_img !== null}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t{#if avatar_img !== null}\\n\\t\\t\\t\\t\\t\\t<div class=\\"avatar-container\\">\\n\\t\\t\\t\\t\\t\\t\\t<Image\\n\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"avatar-image\\"\\n\\t\\t\\t\\t\\t\\t\\t\\tsrc={avatar_img?.url}\\n\\t\\t\\t\\t\\t\\t\\t\\talt=\\"{role} avatar\\"\\n\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\tclass=\\"flex-wrap {role} \\"\\n\\t\\t\\t\\t\\t\\tclass:component-wrap={messages[0].type === \\"component\\"}\\n\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t{#each messages as message, thought_index}\\n\\t\\t\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"message {role} {is_component_message(message)\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t? message?.content.component\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t: \'\'}\\"\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:message-fit={!bubble_full_width}\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:panel-full-width={true}\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:message-markdown-disabled={!render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\tstyle:text-align={rtl && role === \\"user\\" ? \\"left\\" : \\"right\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:component={message.type === \\"component\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:html={is_component_message(message) &&\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tmessage.content.component === \\"html\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\tclass:thought={thought_index > 0}\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tdata-testid={role}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tclass:latest={i === value.length - 1}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tclass:message-markdown-disabled={!render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tstyle:user-select=\\"text\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tclass:selectable\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tstyle:cursor={selectable ? \\"pointer\\" : \\"default\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tstyle:text-align={rtl ? \\"right\\" : \\"left\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\ton:click={() => handle_select(i, message)}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\ton:keydown={(e) => {\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tif (e.key === \\"Enter\\") {\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\thandle_select(i, message);\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t}}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tdir={rtl ? \\"rtl\\" : \\"ltr\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\taria-label={role +\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\"\'s message: \\" +\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tget_message_label_data(message)}\\n\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{#if message.type === \\"text\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{#if message.metadata.title}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<MessageBox\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ttitle={message.metadata.title}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\texpanded={is_last_bot_message(messages, value)}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<Markdown\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tmessage={message.content}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{sanitize_html}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{line_breaks}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ton:load={scroll}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{root}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</MessageBox>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<Markdown\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tmessage={message.content}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{sanitize_html}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{line_breaks}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ton:load={scroll}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{root}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{:else if message.type === \\"component\\" && message.content.component in _components}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<Component\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{target}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{theme_mode}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tprops={message.content.props}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ttype={message.content.component}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tcomponents={_components}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tvalue={message.content.value}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{i18n}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{upload}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{_fetch}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ton:load={scroll}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{:else if message.type === \\"component\\" && message.content.component === \\"file\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<a\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tdata-testid=\\"chatbot-file\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"file-pil\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\thref={message.content.value.url}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ttarget=\\"_blank\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tdownload={window.__is_colab__\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t? null\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t: message.content.value?.orig_name ||\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tmessage.content.value?.path.split(\\"/\\").pop() ||\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\"file\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{message.content.value?.orig_name ||\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tmessage.content.value?.path.split(\\"/\\").pop() ||\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\"file\\"}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</a>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t{@const show_like =\\n\\t\\t\\t\\t\\trole === \\"user\\" ? likeable && like_user_message : likeable}\\n\\t\\t\\t\\t{@const show_retry = _retryable && is_last_bot_message(messages, value)}\\n\\t\\t\\t\\t{@const show_undo = _undoable && is_last_bot_message(messages, value)}\\n\\t\\t\\t\\t<LikeButtons\\n\\t\\t\\t\\t\\tshow={show_like || show_retry || show_undo || show_copy_button}\\n\\t\\t\\t\\t\\thandle_action={(selected) => handle_like(i, messages[0], selected)}\\n\\t\\t\\t\\t\\tlikeable={show_like}\\n\\t\\t\\t\\t\\t_retryable={show_retry}\\n\\t\\t\\t\\t\\t_undoable={show_undo}\\n\\t\\t\\t\\t\\tdisable={generating}\\n\\t\\t\\t\\t\\t{show_copy_button}\\n\\t\\t\\t\\t\\tmessage={msg_format === \\"tuples\\" ? messages[0] : messages}\\n\\t\\t\\t\\t\\tposition={role === \\"user\\" ? \\"right\\" : \\"left\\"}\\n\\t\\t\\t\\t\\tavatar={avatar_img}\\n\\t\\t\\t\\t\\t{layout}\\n\\t\\t\\t\\t/>\\n\\t\\t\\t{/each}\\n\\t\\t\\t{#if pending_message}\\n\\t\\t\\t\\t<Pending {layout} />\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\t{:else}\\n\\t\\t<div class=\\"placeholder-content\\">\\n\\t\\t\\t{#if placeholder !== null}\\n\\t\\t\\t\\t<div class=\\"placeholder\\">\\n\\t\\t\\t\\t\\t<Markdown message={placeholder} {latex_delimiters} {root} />\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t{/if}\\n\\t\\t\\t{#if suggestions !== null}\\n\\t\\t\\t\\t<div class=\\"suggestions\\">\\n\\t\\t\\t\\t\\t{#each suggestions as suggestion, i}\\n\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\tclass=\\"suggestion\\"\\n\\t\\t\\t\\t\\t\\t\\ton:click={() => handle_suggestion_select(i, suggestion)}\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{#if suggestion.icon !== undefined}\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"suggestion-icon-container\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<Image\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"suggestion-icon\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tsrc={suggestion.icon.url}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\talt=\\"suggestion-icon\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t{#if suggestion.display_text !== undefined}\\n\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"suggestion-display-text\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t>{suggestion.display_text}</span\\n\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"suggestion-text\\">{suggestion.text}</span>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t{#if suggestion.files !== undefined && suggestion.files.length > 1}\\n\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"suggestion-file\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t><em>{suggestion.files.length} Files</em></span\\n\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{:else if suggestion.files !== undefined && suggestion.files[0] !== undefined && suggestion.files[0].mime_type?.includes(\\"image\\")}\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"suggestion-image-container\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<Image\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"suggestion-image\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tsrc={suggestion.files[0].url}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\talt=\\"suggestion-image\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t{:else if suggestion.files !== undefined && suggestion.files[0] !== undefined}\\n\\t\\t\\t\\t\\t\\t\\t\\t<span class=\\"suggestion-file\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t><em>{suggestion.files[0].orig_name}</em></span\\n\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\t{/if}\\n</div>\\n\\n<style>\\n\\t.hidden {\\n\\t\\tdisplay: none;\\n\\t}\\n\\n\\t.placeholder-content {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\theight: 100%;\\n\\t}\\n\\n\\t.placeholder {\\n\\t\\talign-items: center;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\theight: 100%;\\n\\t\\tflex-grow: 1;\\n\\t}\\n\\n\\t.suggestions :global(img) {\\n\\t\\tpointer-events: none;\\n\\t}\\n\\n\\t.suggestions {\\n\\t\\tmargin: auto;\\n\\t\\tpadding: var(--spacing-xxl);\\n\\t\\tdisplay: grid;\\n\\t\\tgrid-template-columns: repeat(auto-fit, minmax(200px, 1fr));\\n\\t\\tgap: var(--spacing-xxl);\\n\\t\\tmax-width: calc(min(4 * 200px + 5 * var(--spacing-xxl), 100%));\\n\\t}\\n\\n\\t.suggestion {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\talign-items: center;\\n\\t\\tpadding: var(--spacing-xl);\\n\\t\\tborder: 0.05px solid var(--border-color-primary);\\n\\t\\tborder-radius: var(--radius-xl);\\n\\t\\tbackground-color: var(--background-fill-secondary);\\n\\t\\tcursor: pointer;\\n\\t\\ttransition: var(--button-transition);\\n\\t\\tmax-width: var(--size-56);\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.suggestion:hover {\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t\\tborder-color: var(--border-color-accent);\\n\\t}\\n\\n\\t.suggestion-icon-container {\\n\\t\\tdisplay: flex;\\n\\t\\talign-self: flex-start;\\n\\t\\tmargin-left: var(--spacing-md);\\n\\t\\twidth: var(--size-6);\\n\\t\\theight: var(--size-6);\\n\\t}\\n\\n\\t.suggestion-display-text,\\n\\t.suggestion-text,\\n\\t.suggestion-file {\\n\\t\\tfont-size: var(--text-md);\\n\\t\\twidth: 100%;\\n\\t\\ttext-align: center;\\n\\t\\toverflow: hidden;\\n\\t\\ttext-overflow: ellipsis;\\n\\t}\\n\\n\\t.suggestion-display-text,\\n\\t.suggestion-file {\\n\\t\\tmargin-top: var(--spacing-md);\\n\\t}\\n\\n\\t.suggestion-image-container {\\n\\t\\tflex-grow: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t\\tmargin-top: var(--spacing-xl);\\n\\t}\\n\\n\\t.suggestion-image-container :global(img) {\\n\\t\\tmax-height: 100%;\\n\\t\\tmax-width: 100%;\\n\\t\\theight: var(--size-32);\\n\\t\\twidth: 100%;\\n\\t\\tobject-fit: cover;\\n\\t\\tborder-radius: var(--radius-xl);\\n\\t}\\n\\n\\t.panel-wrap {\\n\\t\\twidth: 100%;\\n\\t\\toverflow-y: auto;\\n\\t}\\n\\n\\t.flex-wrap {\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t}\\n\\n\\t.bubble-wrap {\\n\\t\\twidth: 100%;\\n\\t\\toverflow-y: auto;\\n\\t\\theight: 100%;\\n\\t\\tpadding-top: var(--spacing-xxl);\\n\\t}\\n\\n\\t:global(.dark) .bubble-wrap {\\n\\t\\tbackground: var(--background-fill-secondary);\\n\\t}\\n\\n\\t.message-wrap {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: space-between;\\n\\t\\tmargin-bottom: var(--spacing-xxl);\\n\\t}\\n\\n\\t.bubble-gap {\\n\\t\\tgap: calc(var(--spacing-xxl) + var(--spacing-lg));\\n\\t}\\n\\n\\t.message-wrap > div :global(p:not(:first-child)) {\\n\\t\\tmargin-top: var(--spacing-xxl);\\n\\t}\\n\\n\\t.message {\\n\\t\\tposition: relative;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\twidth: calc(100% - var(--spacing-xxl));\\n\\t\\tmax-width: 100%;\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\tfont-size: var(--chatbot-text-size);\\n\\t\\toverflow-wrap: break-word;\\n\\t}\\n\\n\\t.thought {\\n\\t\\tmargin-top: var(--spacing-xxl);\\n\\t}\\n\\n\\t.message :global(.prose) {\\n\\t\\tfont-size: var(--chatbot-text-size);\\n\\t}\\n\\n\\t.message-bubble-border {\\n\\t\\tborder-width: 1px;\\n\\t\\tborder-radius: var(--radius-md);\\n\\t}\\n\\n\\t.user {\\n\\t\\talign-self: flex-end;\\n\\t}\\n\\n\\t.message-fit {\\n\\t\\twidth: fit-content !important;\\n\\t}\\n\\n\\t.panel-full-width {\\n\\t\\twidth: 100%;\\n\\t}\\n\\t.message-markdown-disabled {\\n\\t\\twhite-space: pre-line;\\n\\t}\\n\\n\\t.flex-wrap.user {\\n\\t\\tborder-width: 1px;\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\talign-self: flex-start;\\n\\t\\tborder-bottom-right-radius: 0;\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\talign-self: flex-start;\\n\\t\\ttext-align: right;\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-xl);\\n\\t\\tborder-color: var(--border-color-accent-subdued);\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t}\\n\\n\\t:not(.component-wrap).flex-wrap.bot {\\n\\t\\tborder-width: 1px;\\n\\t\\tborder-radius: var(--radius-lg);\\n\\t\\talign-self: flex-start;\\n\\t\\tborder-bottom-left-radius: 0;\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\talign-self: flex-start;\\n\\t\\ttext-align: right;\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-xl);\\n\\t\\tborder-color: var(--border-color-primary);\\n\\t\\tbackground-color: var(--background-fill-secondary);\\n\\t}\\n\\n\\t.panel .user :global(*) {\\n\\t\\ttext-align: right;\\n\\t}\\n\\n\\t/* Colors */\\n\\t.bubble .bot {\\n\\t\\tborder-color: var(--border-color-primary);\\n\\t}\\n\\n\\t.message-row {\\n\\t\\tdisplay: flex;\\n\\t\\t/* flex-direction: column; */\\n\\t\\tposition: relative;\\n\\t}\\n\\n\\t.message-row.user-row {\\n\\t\\talign-self: flex-end;\\n\\t}\\n\\t.message-row.bubble {\\n\\t\\tmargin: calc(var(--spacing-xl) * 2);\\n\\t\\tmargin-bottom: var(--spacing-xl);\\n\\t}\\n\\n\\t.with_avatar.message-row.panel {\\n\\t\\tpadding-left: calc(var(--spacing-xl) * 2) !important;\\n\\t\\tpadding-right: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.with_avatar.message-row.bubble.user-row {\\n\\t\\tmargin-right: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.with_avatar.message-row.bubble.bot-row {\\n\\t\\tmargin-left: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.with_opposite_avatar.message-row.bubble.user-row {\\n\\t\\tmargin-left: calc(var(--spacing-xxl) + 35px + var(--spacing-xxl));\\n\\t}\\n\\n\\t.message-row.panel {\\n\\t\\tmargin: 0;\\n\\t\\tpadding: calc(var(--spacing-xl) * 3) calc(var(--spacing-xxl) * 2);\\n\\t}\\n\\n\\t.message-row.panel.bot-row {\\n\\t\\tbackground: var(--background-fill-secondary);\\n\\t}\\n\\n\\t.message-row.bubble.user-row {\\n\\t\\talign-self: flex-end;\\n\\t\\tmax-width: calc(100% - var(--spacing-xl) * 6);\\n\\t}\\n\\n\\t.message-row.bubble.bot-row {\\n\\t\\talign-self: flex-start;\\n\\t\\tmax-width: calc(100% - var(--spacing-xl) * 6);\\n\\t}\\n\\n\\t.message-row:last-of-type {\\n\\t\\tmargin-bottom: calc(var(--spacing-xxl) * 2);\\n\\t}\\n\\n\\t.user-row.bubble {\\n\\t\\tflex-direction: row;\\n\\t\\tjustify-content: flex-end;\\n\\t}\\n\\t@media (max-width: 480px) {\\n\\t\\t.user-row.bubble {\\n\\t\\t\\talign-self: flex-end;\\n\\t\\t}\\n\\n\\t\\t.bot-row.bubble {\\n\\t\\t\\talign-self: flex-start;\\n\\t\\t}\\n\\t\\t.message {\\n\\t\\t\\twidth: 100%;\\n\\t\\t}\\n\\t}\\n\\n\\t.avatar-container {\\n\\t\\talign-self: flex-start;\\n\\t\\tposition: relative;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: flex-start;\\n\\t\\talign-items: flex-start;\\n\\t\\twidth: 35px;\\n\\t\\theight: 35px;\\n\\t\\tflex-shrink: 0;\\n\\t\\tbottom: 0;\\n\\t\\tborder-radius: 50%;\\n\\t\\tborder: 1px solid var(--border-color-primary);\\n\\t}\\n\\t.user-row > .avatar-container {\\n\\t\\torder: 2;\\n\\t\\tmargin-left: var(--spacing-xxl);\\n\\t}\\n\\t.bot-row > .avatar-container {\\n\\t\\tmargin-right: var(--spacing-xxl);\\n\\t\\tmargin-left: 0;\\n\\t\\tmargin-top: -5px;\\n\\t}\\n\\n\\t.avatar-container:not(.thumbnail-item) :global(img) {\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tobject-fit: cover;\\n\\t\\tborder-radius: 50%;\\n\\t\\tpadding: 6px;\\n\\t}\\n\\n\\t.selectable {\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t@keyframes dot-flashing {\\n\\t\\t0% {\\n\\t\\t\\topacity: 0.8;\\n\\t\\t}\\n\\t\\t50% {\\n\\t\\t\\topacity: 0.5;\\n\\t\\t}\\n\\t\\t100% {\\n\\t\\t\\topacity: 0.8;\\n\\t\\t}\\n\\t}\\n\\t.message-wrap > .message :not(.image-button) :global(img) {\\n\\t\\tmargin: var(--size-2);\\n\\t\\tmax-height: 200px;\\n\\t}\\n\\n\\t.message-wrap\\n\\t\\t> div\\n\\t\\t:not(.avatar-container)\\n\\t\\tdiv\\n\\t\\t:not(.image-button)\\n\\t\\t:global(img) {\\n\\t\\tborder-radius: var(--radius-xl);\\n\\t\\tmargin: var(--size-2);\\n\\t\\twidth: 400px;\\n\\t\\tmax-width: 30vw;\\n\\t\\tmax-height: 30vw;\\n\\t}\\n\\n\\t.message-wrap .message :global(a) {\\n\\t\\tcolor: var(--color-text-link);\\n\\t\\ttext-decoration: underline;\\n\\t}\\n\\n\\t.message-wrap .bot :global(table),\\n\\t.message-wrap .bot :global(tr),\\n\\t.message-wrap .bot :global(td),\\n\\t.message-wrap .bot :global(th) {\\n\\t\\tborder: 1px solid var(--border-color-primary);\\n\\t}\\n\\n\\t.message-wrap .user :global(table),\\n\\t.message-wrap .user :global(tr),\\n\\t.message-wrap .user :global(td),\\n\\t.message-wrap .user :global(th) {\\n\\t\\tborder: 1px solid var(--border-color-accent);\\n\\t}\\n\\n\\t/* KaTeX */\\n\\t.message-wrap :global(span.katex) {\\n\\t\\tfont-size: var(--text-lg);\\n\\t\\tdirection: ltr;\\n\\t}\\n\\n\\t/* Copy button */\\n\\t.message-wrap :global(div[class*=\\"code_wrap\\"] > button) {\\n\\t\\tposition: absolute;\\n\\t\\ttop: var(--spacing-md);\\n\\t\\tright: var(--spacing-md);\\n\\t\\tz-index: 1;\\n\\t\\tcursor: pointer;\\n\\t\\tborder-bottom-left-radius: var(--radius-sm);\\n\\t\\tpadding: var(--spacing-md);\\n\\t\\twidth: 25px;\\n\\t\\theight: 25px;\\n\\t}\\n\\n\\t.message-wrap :global(code > button > span) {\\n\\t\\tposition: absolute;\\n\\t\\ttop: var(--spacing-md);\\n\\t\\tright: var(--spacing-md);\\n\\t\\twidth: 12px;\\n\\t\\theight: 12px;\\n\\t}\\n\\t.message-wrap :global(.check) {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 0;\\n\\t\\tright: 0;\\n\\t\\topacity: 0;\\n\\t\\tz-index: var(--layer-top);\\n\\t\\ttransition: opacity 0.2s;\\n\\t\\tbackground: var(--background-fill-primary);\\n\\t\\tpadding: var(--size-1);\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tcolor: var(--body-text-color);\\n\\t}\\n\\n\\t.message-wrap :global(pre) {\\n\\t\\tposition: relative;\\n\\t}\\n\\n\\t.message-wrap :global(.grid-wrap) {\\n\\t\\tmax-height: 80% !important;\\n\\t\\tmax-width: 600px;\\n\\t\\tobject-fit: contain;\\n\\t}\\n\\n\\t/* Image preview */\\n\\t.message :global(.preview) {\\n\\t\\tobject-fit: contain;\\n\\t\\twidth: 95%;\\n\\t\\tmax-height: 93%;\\n\\t}\\n\\t.image-preview {\\n\\t\\tposition: absolute;\\n\\t\\tz-index: 999;\\n\\t\\tleft: 0;\\n\\t\\ttop: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\toverflow: auto;\\n\\t\\tbackground-color: rgba(0, 0, 0, 0.9);\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t}\\n\\t.image-preview :global(svg) {\\n\\t\\tstroke: white;\\n\\t}\\n\\t.image-preview-close-button {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 10px;\\n\\t\\tright: 10px;\\n\\t\\tbackground: none;\\n\\t\\tborder: none;\\n\\t\\tfont-size: 1.5em;\\n\\t\\tcursor: pointer;\\n\\t\\theight: 30px;\\n\\t\\twidth: 30px;\\n\\t\\tpadding: 3px;\\n\\t\\tbackground: var(--bg-color);\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\tborder: 1px solid var(--button-secondary-border-color);\\n\\t\\tborder-radius: var(--radius-lg);\\n\\t}\\n\\n\\t.component {\\n\\t\\tpadding: 0;\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\twidth: fit-content;\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.component.gallery {\\n\\t\\tborder: none;\\n\\t}\\n\\n\\t.file-pil {\\n\\t\\tdisplay: block;\\n\\t\\twidth: fit-content;\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-lg);\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\tbackground: var(--background-fill-secondary);\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\ttext-decoration: none;\\n\\t\\tmargin: 0;\\n\\t\\tfont-family: var(--font-mono);\\n\\t\\tfont-size: var(--text-sm);\\n\\t}\\n\\n\\t.file {\\n\\t\\twidth: auto !important;\\n\\t\\tmax-width: fit-content !important;\\n\\t}\\n\\n\\t@media (max-width: 600px) or (max-width: 480px) {\\n\\t\\t.component {\\n\\t\\t\\twidth: 100%;\\n\\t\\t}\\n\\t}\\n\\n\\t.message-wrap :global(.prose.chatbot.md) {\\n\\t\\topacity: 0.8;\\n\\t\\toverflow-wrap: break-word;\\n\\t}\\n\\n\\t.message > button {\\n\\t\\twidth: 100%;\\n\\t}\\n\\t.html {\\n\\t\\tpadding: 0;\\n\\t\\tborder: none;\\n\\t\\tbackground: none;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAmdC,oDAAQ,CACP,OAAO,CAAE,IACV,CAEA,iEAAqB,CACpB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,MAAM,CAAE,IACT,CAEA,yDAAa,CACZ,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,CACZ,CAEA,2BAAY,CAAS,GAAK,CACzB,cAAc,CAAE,IACjB,CAEA,yDAAa,CACZ,MAAM,CAAE,IAAI,CACZ,OAAO,CAAE,IAAI,aAAa,CAAC,CAC3B,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,QAAQ,CAAC,CAAC,OAAO,KAAK,CAAC,CAAC,GAAG,CAAC,CAAC,CAC3D,GAAG,CAAE,IAAI,aAAa,CAAC,CACvB,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,IAAI,aAAa,CAAC,CAAC,CAAC,IAAI,CAAC,CAC9D,CAEA,wDAAY,CACX,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,YAAY,CAAC,CAC1B,MAAM,CAAE,MAAM,CAAC,KAAK,CAAC,IAAI,sBAAsB,CAAC,CAChD,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,gBAAgB,CAAE,IAAI,2BAA2B,CAAC,CAClD,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,IAAI,mBAAmB,CAAC,CACpC,SAAS,CAAE,IAAI,SAAS,CAAC,CACzB,KAAK,CAAE,IACR,CAEA,wDAAW,MAAO,CACjB,gBAAgB,CAAE,IAAI,mBAAmB,CAAC,CAC1C,YAAY,CAAE,IAAI,qBAAqB,CACxC,CAEA,uEAA2B,CAC1B,OAAO,CAAE,IAAI,CACb,UAAU,CAAE,UAAU,CACtB,WAAW,CAAE,IAAI,YAAY,CAAC,CAC9B,KAAK,CAAE,IAAI,QAAQ,CAAC,CACpB,MAAM,CAAE,IAAI,QAAQ,CACrB,CAEA,qEAAwB,CACxB,6DAAgB,CAChB,6DAAiB,CAChB,SAAS,CAAE,IAAI,SAAS,CAAC,CACzB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,MAAM,CAClB,QAAQ,CAAE,MAAM,CAChB,aAAa,CAAE,QAChB,CAEA,qEAAwB,CACxB,6DAAiB,CAChB,UAAU,CAAE,IAAI,YAAY,CAC7B,CAEA,wEAA4B,CAC3B,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,UAAU,CAAE,IAAI,YAAY,CAC7B,CAEA,0CAA2B,CAAS,GAAK,CACxC,UAAU,CAAE,IAAI,CAChB,SAAS,CAAE,IAAI,CACf,MAAM,CAAE,IAAI,SAAS,CAAC,CACtB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,KAAK,CACjB,aAAa,CAAE,IAAI,WAAW,CAC/B,CAEA,wDAAY,CACX,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IACb,CAEA,uDAAW,CACV,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CAEA,yDAAa,CACZ,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,IAAI,aAAa,CAC/B,CAEQ,KAAM,CAAC,yDAAa,CAC3B,UAAU,CAAE,IAAI,2BAA2B,CAC5C,CAEA,0DAAc,CACb,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,aAAa,CAC9B,aAAa,CAAE,IAAI,aAAa,CACjC,CAEA,wDAAY,CACX,GAAG,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,IAAI,YAAY,CAAC,CACjD,CAEA,4BAAa,CAAG,kBAAG,CAAS,mBAAqB,CAChD,UAAU,CAAE,IAAI,aAAa,CAC9B,CAEA,qDAAS,CACR,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,aAAa,CAAC,CAAC,CACtC,SAAS,CAAE,IAAI,CACf,KAAK,CAAE,IAAI,iBAAiB,CAAC,CAC7B,SAAS,CAAE,IAAI,mBAAmB,CAAC,CACnC,aAAa,CAAE,UAChB,CAEA,qDAAS,CACR,UAAU,CAAE,IAAI,aAAa,CAC9B,CAEA,uBAAQ,CAAS,MAAQ,CACxB,SAAS,CAAE,IAAI,mBAAmB,CACnC,CAEA,mEAAuB,CACtB,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,IAAI,WAAW,CAC/B,CAEA,kDAAM,CACL,UAAU,CAAE,QACb,CAEA,yDAAa,CACZ,KAAK,CAAE,WAAW,CAAC,UACpB,CAEA,8DAAkB,CACjB,KAAK,CAAE,IACR,CACA,uEAA2B,CAC1B,WAAW,CAAE,QACd,CAEA,UAAU,kDAAM,CACf,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,UAAU,CAAE,UAAU,CACtB,0BAA0B,CAAE,CAAC,CAC7B,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,UAAU,CAAE,UAAU,CACtB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,YAAY,CAAC,CAAC,IAAI,YAAY,CAAC,CAC5C,YAAY,CAAE,IAAI,6BAA6B,CAAC,CAChD,gBAAgB,CAAE,IAAI,mBAAmB,CAC1C,CAEA,KAAK,eAAe,CAAC,UAAU,iDAAK,CACnC,YAAY,CAAE,GAAG,CACjB,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,UAAU,CAAE,UAAU,CACtB,yBAAyB,CAAE,CAAC,CAC5B,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,UAAU,CAAE,UAAU,CACtB,UAAU,CAAE,KAAK,CACjB,OAAO,CAAE,IAAI,YAAY,CAAC,CAAC,IAAI,YAAY,CAAC,CAC5C,YAAY,CAAE,IAAI,sBAAsB,CAAC,CACzC,gBAAgB,CAAE,IAAI,2BAA2B,CAClD,CAEA,qBAAM,CAAC,oBAAK,CAAS,CAAG,CACvB,UAAU,CAAE,KACb,CAGA,sBAAO,CAAC,kCAAK,CACZ,YAAY,CAAE,IAAI,sBAAsB,CACzC,CAEA,yDAAa,CACZ,OAAO,CAAE,IAAI,CAEb,QAAQ,CAAE,QACX,CAEA,YAAY,sDAAU,CACrB,UAAU,CAAE,QACb,CACA,YAAY,oDAAQ,CACnB,MAAM,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACnC,aAAa,CAAE,IAAI,YAAY,CAChC,CAEA,YAAY,YAAY,mDAAO,CAC9B,YAAY,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,UAAU,CACpD,aAAa,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,UAC5C,CAEA,YAAY,YAAY,OAAO,sDAAU,CACxC,YAAY,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,UAC3C,CAEA,YAAY,YAAY,OAAO,qDAAS,CACvC,WAAW,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,UAC1C,CAEA,qBAAqB,YAAY,OAAO,sDAAU,CACjD,WAAW,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,CAAC,IAAI,aAAa,CAAC,CACjE,CAEA,YAAY,mDAAO,CAClB,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,KAAK,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,CAAC,CACjE,CAEA,YAAY,MAAM,qDAAS,CAC1B,UAAU,CAAE,IAAI,2BAA2B,CAC5C,CAEA,YAAY,OAAO,sDAAU,CAC5B,UAAU,CAAE,QAAQ,CACpB,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAC7C,CAEA,YAAY,OAAO,qDAAS,CAC3B,UAAU,CAAE,UAAU,CACtB,SAAS,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,YAAY,CAAC,CAAC,CAAC,CAAC,CAAC,CAC7C,CAEA,yDAAY,aAAc,CACzB,aAAa,CAAE,KAAK,IAAI,aAAa,CAAC,CAAC,CAAC,CAAC,CAAC,CAC3C,CAEA,SAAS,oDAAQ,CAChB,cAAc,CAAE,GAAG,CACnB,eAAe,CAAE,QAClB,CACA,MAAO,YAAY,KAAK,CAAE,CACzB,SAAS,oDAAQ,CAChB,UAAU,CAAE,QACb,CAEA,QAAQ,oDAAQ,CACf,UAAU,CAAE,UACb,CACA,qDAAS,CACR,KAAK,CAAE,IACR,CACD,CAEA,8DAAkB,CACjB,UAAU,CAAE,UAAU,CACtB,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,UAAU,CAC3B,WAAW,CAAE,UAAU,CACvB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,WAAW,CAAE,CAAC,CACd,MAAM,CAAE,CAAC,CACT,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,sBAAsB,CAC7C,CACA,wBAAS,CAAG,+CAAkB,CAC7B,KAAK,CAAE,CAAC,CACR,WAAW,CAAE,IAAI,aAAa,CAC/B,CACA,uBAAQ,CAAG,+CAAkB,CAC5B,YAAY,CAAE,IAAI,aAAa,CAAC,CAChC,WAAW,CAAE,CAAC,CACd,UAAU,CAAE,IACb,CAEA,gCAAiB,KAAK,eAAe,CAAC,CAAS,GAAK,CACnD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,CACjB,aAAa,CAAE,GAAG,CAClB,OAAO,CAAE,GACV,CAEA,wDAAY,CACX,MAAM,CAAE,OACT,CAEA,WAAW,2BAAa,CACvB,EAAG,CACF,OAAO,CAAE,GACV,CACA,GAAI,CACH,OAAO,CAAE,GACV,CACA,IAAK,CACJ,OAAO,CAAE,GACV,CACD,CACA,4BAAa,CAAG,QAAQ,gBAAC,KAAK,aAAa,CAAC,CAAS,GAAK,CACzD,MAAM,CAAE,IAAI,QAAQ,CAAC,CACrB,UAAU,CAAE,KACb,CAEA,4BAAa,CACV,kBAAG,CACL,KAAK,iBAAiB,CAAC,CACvB,GAAG,gBACH,KAAK,aAAa,CAAC,CACX,GAAK,CACb,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,MAAM,CAAE,IAAI,QAAQ,CAAC,CACrB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,IACb,CAEA,4BAAa,CAAC,uBAAQ,CAAS,CAAG,CACjC,KAAK,CAAE,IAAI,iBAAiB,CAAC,CAC7B,eAAe,CAAE,SAClB,CAEA,4BAAa,CAAC,mBAAI,CAAS,KAAM,CACjC,4BAAa,CAAC,mBAAI,CAAS,EAAG,CAC9B,4BAAa,CAAC,mBAAI,CAAS,EAAG,CAC9B,4BAAa,CAAC,mBAAI,CAAS,EAAI,CAC9B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,sBAAsB,CAC7C,CAEA,4BAAa,CAAC,oBAAK,CAAS,KAAM,CAClC,4BAAa,CAAC,oBAAK,CAAS,EAAG,CAC/B,4BAAa,CAAC,oBAAK,CAAS,EAAG,CAC/B,4BAAa,CAAC,oBAAK,CAAS,EAAI,CAC/B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,qBAAqB,CAC5C,CAGA,4BAAa,CAAS,UAAY,CACjC,SAAS,CAAE,IAAI,SAAS,CAAC,CACzB,SAAS,CAAE,GACZ,CAGA,4BAAa,CAAS,gCAAkC,CACvD,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,YAAY,CAAC,CACtB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,OAAO,CACf,yBAAyB,CAAE,IAAI,WAAW,CAAC,CAC3C,OAAO,CAAE,IAAI,YAAY,CAAC,CAC1B,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CAEA,4BAAa,CAAS,oBAAsB,CAC3C,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,YAAY,CAAC,CACtB,KAAK,CAAE,IAAI,YAAY,CAAC,CACxB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IACT,CACA,4BAAa,CAAS,MAAQ,CAC7B,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,OAAO,CAAE,CAAC,CACV,OAAO,CAAE,IAAI,WAAW,CAAC,CACzB,UAAU,CAAE,OAAO,CAAC,IAAI,CACxB,UAAU,CAAE,IAAI,yBAAyB,CAAC,CAC1C,OAAO,CAAE,IAAI,QAAQ,CAAC,CACtB,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,iBAAiB,CAC7B,CAEA,4BAAa,CAAS,GAAK,CAC1B,QAAQ,CAAE,QACX,CAEA,4BAAa,CAAS,UAAY,CACjC,UAAU,CAAE,GAAG,CAAC,UAAU,CAC1B,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,OACb,CAGA,uBAAQ,CAAS,QAAU,CAC1B,UAAU,CAAE,OAAO,CACnB,KAAK,CAAE,GAAG,CACV,UAAU,CAAE,GACb,CACA,2DAAe,CACd,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,GAAG,CACZ,IAAI,CAAE,CAAC,CACP,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,QAAQ,CAAE,IAAI,CACd,gBAAgB,CAAE,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CACpC,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MACd,CACA,6BAAc,CAAS,GAAK,CAC3B,MAAM,CAAE,KACT,CACA,wEAA4B,CAC3B,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,MAAM,CAAE,IAAI,CACZ,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,OAAO,CACf,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,GAAG,CACZ,UAAU,CAAE,IAAI,UAAU,CAAC,CAC3B,UAAU,CAAE,IAAI,aAAa,CAAC,CAC9B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,+BAA+B,CAAC,CACtD,aAAa,CAAE,IAAI,WAAW,CAC/B,CAEA,uDAAW,CACV,OAAO,CAAE,CAAC,CACV,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,KAAK,CAAE,WAAW,CAClB,QAAQ,CAAE,MACX,CAEA,UAAU,qDAAS,CAClB,MAAM,CAAE,IACT,CAEA,sDAAU,CACT,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,WAAW,CAClB,OAAO,CAAE,IAAI,YAAY,CAAC,CAAC,IAAI,YAAY,CAAC,CAC5C,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,UAAU,CAAE,IAAI,2BAA2B,CAAC,CAC5C,KAAK,CAAE,IAAI,iBAAiB,CAAC,CAC7B,eAAe,CAAE,IAAI,CACrB,MAAM,CAAE,CAAC,CACT,WAAW,CAAE,IAAI,WAAW,CAAC,CAC7B,SAAS,CAAE,IAAI,SAAS,CACzB,CAEA,kDAAM,CACL,KAAK,CAAE,IAAI,CAAC,UAAU,CACtB,SAAS,CAAE,WAAW,CAAC,UACxB,CAEA,MAAO,YAAY,KAAK,CAAC,CAAC,EAAE,CAAC,YAAY,KAAK,CAAE,CAC/C,uDAAW,CACV,KAAK,CAAE,IACR,CACD,CAEA,4BAAa,CAAS,iBAAmB,CACxC,OAAO,CAAE,GAAG,CACZ,aAAa,CAAE,UAChB,CAEA,uBAAQ,CAAG,oCAAO,CACjB,KAAK,CAAE,IACR,CACA,kDAAM,CACL,OAAO,CAAE,CAAC,CACV,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,IACb"}'
};
function get_components_from_messages(messages) {
  if (!messages)
    return [];
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
  ...
  })}` : ``} <div class="${escape(null_to_empty(layout === "bubble" ? "bubble-wrap" : "panel-wrap"), true) + " svelte-1brq25p"}" role="log" aria-label="chatbot conversation" aria-live="polite"${add_attribute("this", div, 0)}>${value !== null && value.length > 0 && groupedMessages !== null ? `<div class="message-wrap svelte-1brq25p">${each(groupedMessages, (messages, i) => {
    ...
    return `   ${``} <div class="${[
      "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-1brq25p",
      (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
    ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-1brq25p">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "avatar-image",
        src: avatar_img?.url,
      ...
      "flex-wrap " + escape(role, true) + " svelte-1brq25p",
      ...
      return `<div class="${[
        ...
        {},
        {}
      )}` : `${message.type === "component" && message.content.component === "file" ? `<a data-testid="chatbot-file" class="file-pil svelte-1brq25p"${add_attribute("href", message.content.value.url, 0)} target="_blank"${add_attribute(
        "download",
  ...
  })} ${pending_message ? `${validate_component(Pending, "Pending").$$render($$result, { layout }, {}, {})}` : ``}</div>` : `<div class="placeholder-content svelte-1brq25p">${placeholder !== null ? `<div class="placeholder svelte-1brq25p">${validate_component(MarkdownCode$1, "Markdown").$$render(
    $$result,
    {
      message: placeholder,
      latex_delimiters,
    ...
    {},
    {}
  )}</div>` : ``} ${suggestions !== null ? `<div class="suggestions svelte-1brq25p">${each(suggestions, (suggestion, i) => {
    return `<button class="suggestion svelte-1brq25p">${suggestion.icon !== void 0 ? `<div class="suggestion-icon-container svelte-1brq25p">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "suggestion-icon",
        src: suggestion.icon.url,
      ...
      {},
      {}
    )} </div>` : ``} ${suggestion.display_text !== void 0 ? `<span class="suggestion-display-text svelte-1brq25p">${escape(suggestion.display_text)}</span>` : `<span class="suggestion-text svelte-1brq25p">${escape(suggestion.text)}</span>`} ${suggestion.files !== void 0 && suggestion.files.length > 1 ? `<span class="suggestion-file svelte-1brq25p"><em class="svelte-1brq25p">${escape(suggestion.files.length)} Files</em></span>` : `${suggestion.files !== void 0 && suggestion.files[0] !== void 0 && suggestion.files[0].mime_type?.includes("image") ? `<div class="suggestion-image-container svelte-1brq25p">${validate_component(Image$1, "Image").$$render(
      $$result,
      {
        class: "suggestion-image",
        src: suggestion.files[0].url,
    ...
    {},
    {
      default: () => {
        return `${loading_status ? `${validate_component(Static, "StatusTracker").$$render(
          ...
          {},
          {}
        )}` : ``} <div class="wrapper svelte-motrg9">${show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            show_label,
            Icon: Chat,
...
//# sourceMappingURL=Index57-CpnW6raB.js.map
