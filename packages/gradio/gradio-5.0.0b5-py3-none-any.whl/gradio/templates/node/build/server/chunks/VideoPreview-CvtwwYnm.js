...
import { c as IconButton, u as uploadToHuggingFace, f as format_time, p as prepare_files } from './2-Ax4bcEC3.js';
import { B as BlockLabel } from './BlockLabel-CcEvnTTV.js';
import { E as Empty } from './Empty-CJWSov-X.js';
import { S as ShareButton } from './ShareButton-DfV49rK_.js';
...
import { V as Video$1 } from './Video2-CDNDBnbJ.js';
import { M as ModifyUpload } from './ModifyUpload-DJvIDMBL.js';
...
const VideoTimeline = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  loadingTimeline = thumbnails.length !== numberOfThumbnails;
  return `<div class="container svelte-kn3uji">${loadingTimeline ? `<div class="load-wrap svelte-kn3uji" data-svelte-h="svelte-13yzice"><span aria-label="loading timeline" class="loader svelte-kn3uji"></span></div>` : `<div id="timeline" class="thumbnail-wrapper svelte-kn3uji"><button aria-label="start drag handle for trimming video" class="handle left svelte-kn3uji" style="${"left: " + escape(leftHandlePosition, true) + "%;"}"></button> <div class="opaque-layer svelte-kn3uji" style="${"left: " + escape(leftHandlePosition, true) + "%; right: " + escape(100 - rightHandlePosition, true) + "%"}"></div> ${each(thumbnails, (thumbnail, i) => {
    return `<img${add_attribute("src", thumbnail, 0)}${add_attribute("alt", `frame-${i}`, 0)} draggable="false" class="svelte-kn3uji">`;
  })} <button aria-label="end drag handle for trimming video" class="handle right svelte-kn3uji" style="${"left: " + escape(rightHandlePosition, true) + "%;"}"></button></div>`} </div>`;
});
const css$1 = {
  code: ".container.svelte-uu53fr.svelte-uu53fr{width:100%}time.svelte-uu53fr.svelte-uu53fr{color:var(--color-accent);font-weight:bold;padding-left:var(--spacing-xs)}.timeline-wrapper.svelte-uu53fr.svelte-uu53fr{display:flex;align-items:center;justify-content:center;width:100%}.text-button.svelte-uu53fr.svelte-uu53fr{border:1px solid var(--neutral-400);border-radius:var(--radius-sm);font-weight:300;font-size:var(--size-3);text-align:center;color:var(--neutral-400);height:var(--size-5);font-weight:bold;padding:0 5px;margin-left:5px}.text-button.svelte-uu53fr.svelte-uu53fr:hover,.text-button.svelte-uu53fr.svelte-uu53fr:focus{color:var(--color-accent);border-color:var(--color-accent)}.controls.svelte-uu53fr.svelte-uu53fr{display:flex;justify-content:space-between;align-items:center;margin:var(--spacing-lg);overflow:hidden}.edit-buttons.svelte-uu53fr.svelte-uu53fr{display:flex;gap:var(--spacing-sm)}@media(max-width: 320px){.controls.svelte-uu53fr.svelte-uu53fr{flex-direction:column;align-items:flex-start}.edit-buttons.svelte-uu53fr.svelte-uu53fr{margin-top:var(--spacing-sm)}.controls.svelte-uu53fr .svelte-uu53fr{margin:var(--spacing-sm)}.controls.svelte-uu53fr .text-button.svelte-uu53fr{margin-left:0}}.container.svelte-uu53fr.svelte-uu53fr{display:flex;flex-direction:column}.hidden.svelte-uu53fr.svelte-uu53fr{display:none}",
...
const VideoControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${["container svelte-uu53fr", mode !== "edit" ? "hidden" : ""].join(" ").trim()}">${mode === "edit" ? `<div class="timeline-wrapper svelte-uu53fr">${validate_component(VideoTimeline, "VideoTimeline").$$render(
      $$result,
      {
        videoElement,
        dragStart,
      ...
      {}
    )}</div>` : ``} <div class="controls svelte-uu53fr" data-testid="waveform-controls">${mode === "edit" && trimmedDuration !== null ? `<time aria-label="duration of selected region in seconds" class="${["svelte-uu53fr", loadingTimeline ? "hidden" : ""].join(" ").trim()}">${escape(format_time(trimmedDuration))}</time> <div class="edit-buttons svelte-uu53fr"><button class="${["text-button svelte-uu53fr", loadingTimeline ? "hidden" : ""].join(" ").trim()}" data-svelte-h="svelte-18nzick">Trim</button> <button class="${["text-button svelte-uu53fr", loadingTimeline ? "hidden" : ""].join(" ").trim()}" data-svelte-h="svelte-1mj98i4">Cancel</button></div>` : `<div class="svelte-uu53fr"></div>`}</div></div> ${validate_component(ModifyUpload, "ModifyUpload").$$render(
      $$result,
      {
        i18n,
        download: show_download_button ? value?.url : null
...
const css = {
  code: "span.svelte-1laj904.svelte-1laj904{text-shadow:0 0 8px rgba(0, 0, 0, 0.5)}progress.svelte-1laj904.svelte-1laj904{margin-right:var(--size-3);border-radius:var(--radius-sm);width:var(--size-full);height:var(--size-2)}progress.svelte-1laj904.svelte-1laj904::-webkit-progress-bar{border-radius:2px;background-color:rgba(255, 255, 255, 0.2);overflow:hidden}progress.svelte-1laj904.svelte-1laj904::-webkit-progress-value{background-color:rgba(255, 255, 255, 0.9)}.mirror.svelte-1laj904.svelte-1laj904{transform:scaleX(-1)}.mirror-wrap.svelte-1laj904.svelte-1laj904{position:relative;height:100%;width:100%}.controls.svelte-1laj904.svelte-1laj904{position:absolute;bottom:0;opacity:0;transition:500ms;margin:var(--size-2);border-radius:var(--radius-md);background:var(--color-grey-800);padding:var(--size-2) var(--size-1);width:calc(100% - 0.375rem * 2);width:calc(100% - var(--size-2) * 2)}.wrap.svelte-1laj904:hover .controls.svelte-1laj904{opacity:1}.inner.svelte-1laj904.svelte-1laj904{display:flex;justify-content:space-between;align-items:center;padding-right:var(--size-2);padding-left:var(--size-2);width:var(--size-full);height:var(--size-full)}.icon.svelte-1laj904.svelte-1laj904{display:flex;justify-content:center;cursor:pointer;width:var(--size-6);color:white}.time.svelte-1laj904.svelte-1laj904{flex-shrink:0;margin-right:var(--size-3);margin-left:var(--size-3);color:white;font-size:var(--text-sm);font-family:var(--font-mono)}.wrap.svelte-1laj904.svelte-1laj904{position:relative;background-color:var(--background-fill-secondary);height:var(--size-full);width:var(--size-full);border-radius:var(--radius-xl)}.wrap.svelte-1laj904 video{height:var(--size-full);width:var(--size-full)}",
  map: '{"version":3,"file":"Player.svelte","sources":["Player.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { createEventDispatcher } from \\"svelte\\";\\nimport { Play, Pause, Maximise, Undo } from \\"@gradio/icons\\";\\nimport Video from \\"./Video.svelte\\";\\nimport VideoControls from \\"./VideoControls.svelte\\";\\nimport { prepare_files } from \\"@gradio/client\\";\\nimport { format_time } from \\"@gradio/utils\\";\\nexport let root = \\"\\";\\nexport let src;\\nexport let subtitle = null;\\nexport let mirror;\\nexport let autoplay;\\nexport let loop;\\nexport let label = \\"test\\";\\nexport let interactive = false;\\nexport let handle_change = () => {\\n};\\nexport let handle_reset_value = () => {\\n};\\nexport let upload;\\nexport let is_stream;\\nexport let i18n;\\nexport let show_download_button = false;\\nexport let value = null;\\nexport let handle_clear = () => {\\n};\\nexport let has_change_history = false;\\nconst dispatch = createEventDispatcher();\\nlet time = 0;\\nlet duration;\\nlet paused = true;\\nlet video;\\nlet processingVideo = false;\\nfunction handleMove(e) {\\n  if (!duration)\\n    return;\\n  if (e.type === \\"click\\") {\\n    handle_click(e);\\n    return;\\n  }\\n  if (e.type !== \\"touchmove\\" && !(e.buttons & 1))\\n    return;\\n  const clientX = e.type === \\"touchmove\\" ? e.touches[0].clientX : e.clientX;\\n  const { left, right } = e.currentTarget.getBoundingClientRect();\\n  time = duration * (clientX - left) / (right - left);\\n}\\nasync function play_pause() {\\n  if (document.fullscreenElement != video) {\\n    const isPlaying = video.currentTime > 0 && !video.paused && !video.ended && video.readyState > video.HAVE_CURRENT_DATA;\\n    if (!isPlaying) {\\n      await video.play();\\n    } else\\n      video.pause();\\n  }\\n}\\nfunction handle_click(e) {\\n  const { left, right } = e.currentTarget.getBoundingClientRect();\\n  time = duration * (e.clientX - left) / (right - left);\\n}\\nfunction handle_end() {\\n  dispatch(\\"stop\\");\\n  dispatch(\\"end\\");\\n}\\nconst handle_trim_video = async (videoBlob) => {\\n  let _video_blob = new File([videoBlob], \\"video.mp4\\");\\n  const val = await prepare_files([_video_blob]);\\n  let value2 = ((await upload(val, root))?.filter(Boolean))[0];\\n  handle_change(value2);\\n};\\nfunction open_full_screen() {\\n  video.requestFullscreen();\\n}\\n<\/script>\\n\\n<div class=\\"wrap\\">\\n\\t<div class=\\"mirror-wrap\\" class:mirror>\\n\\t\\t<Video\\n\\t\\t\\t{src}\\n\\t\\t\\tpreload=\\"auto\\"\\n\\t\\t\\t{autoplay}\\n\\t\\t\\t{loop}\\n\\t\\t\\t{is_stream}\\n\\t\\t\\ton:click={play_pause}\\n\\t\\t\\ton:play\\n\\t\\t\\ton:pause\\n\\t\\t\\ton:ended={handle_end}\\n\\t\\t\\tbind:currentTime={time}\\n\\t\\t\\tbind:duration\\n\\t\\t\\tbind:paused\\n\\t\\t\\tbind:node={video}\\n\\t\\t\\tdata-testid={`${label}-player`}\\n\\t\\t\\t{processingVideo}\\n\\t\\t\\ton:load\\n\\t\\t>\\n\\t\\t\\t<track kind=\\"captions\\" src={subtitle} default />\\n\\t\\t</Video>\\n\\t</div>\\n\\n\\t<div class=\\"controls\\">\\n\\t\\t<div class=\\"inner\\">\\n\\t\\t\\t<span\\n\\t\\t\\t\\trole=\\"button\\"\\n\\t\\t\\t\\ttabindex=\\"0\\"\\n\\t\\t\\t\\tclass=\\"icon\\"\\n\\t\\t\\t\\taria-label=\\"play-pause-replay-button\\"\\n\\t\\t\\t\\ton:click={play_pause}\\n\\t\\t\\t\\ton:keydown={play_pause}\\n\\t\\t\\t>\\n\\t\\t\\t\\t{#if time === duration}\\n\\t\\t\\t\\t\\t<Undo />\\n\\t\\t\\t\\t{:else if paused}\\n\\t\\t\\t\\t\\t<Play />\\n\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t<Pause />\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t</span>\\n\\n\\t\\t\\t<span class=\\"time\\">{format_time(time)} / {format_time(duration)}</span>\\n\\n\\t\\t\\t<!-- TODO: implement accessible video timeline for 4.0 -->\\n\\t\\t\\t<!-- svelte-ignore a11y-click-events-have-key-events -->\\n\\t\\t\\t<!-- svelte-ignore a11y-no-noninteractive-element-interactions -->\\n\\t\\t\\t<progress\\n\\t\\t\\t\\tvalue={time / duration || 0}\\n\\t\\t\\t\\ton:mousemove={handleMove}\\n\\t\\t\\t\\ton:touchmove|preventDefault={handleMove}\\n\\t\\t\\t\\ton:click|stopPropagation|preventDefault={handle_click}\\n\\t\\t\\t/>\\n\\n\\t\\t\\t<div\\n\\t\\t\\t\\trole=\\"button\\"\\n\\t\\t\\t\\ttabindex=\\"0\\"\\n\\t\\t\\t\\tclass=\\"icon\\"\\n\\t\\t\\t\\taria-label=\\"full-screen\\"\\n\\t\\t\\t\\ton:click={open_full_screen}\\n\\t\\t\\t\\ton:keypress={open_full_screen}\\n\\t\\t\\t>\\n\\t\\t\\t\\t<Maximise />\\n\\t\\t\\t</div>\\n\\t\\t</div>\\n\\t</div>\\n</div>\\n{#if interactive}\\n\\t<VideoControls\\n\\t\\tvideoElement={video}\\n\\t\\tshowRedo\\n\\t\\t{handle_trim_video}\\n\\t\\t{handle_reset_value}\\n\\t\\tbind:processingVideo\\n\\t\\t{value}\\n\\t\\t{i18n}\\n\\t\\t{show_download_button}\\n\\t\\t{handle_clear}\\n\\t\\t{has_change_history}\\n\\t/>\\n{/if}\\n\\n<style lang=\\"postcss\\">\\n\\tspan {\\n\\t\\ttext-shadow: 0 0 8px rgba(0, 0, 0, 0.5);\\n\\t}\\n\\n\\tprogress {\\n\\t\\tmargin-right: var(--size-3);\\n\\t\\tborder-radius: var(--radius-sm);\\n\\t\\twidth: var(--size-full);\\n\\t\\theight: var(--size-2);\\n\\t}\\n\\n\\tprogress::-webkit-progress-bar {\\n\\t\\tborder-radius: 2px;\\n\\t\\tbackground-color: rgba(255, 255, 255, 0.2);\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\tprogress::-webkit-progress-value {\\n\\t\\tbackground-color: rgba(255, 255, 255, 0.9);\\n\\t}\\n\\n\\t.mirror {\\n\\t\\ttransform: scaleX(-1);\\n\\t}\\n\\n\\t.mirror-wrap {\\n\\t\\tposition: relative;\\n\\t\\theight: 100%;\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.controls {\\n\\t\\tposition: absolute;\\n\\t\\tbottom: 0;\\n\\t\\topacity: 0;\\n\\t\\ttransition: 500ms;\\n\\t\\tmargin: var(--size-2);\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\tbackground: var(--color-grey-800);\\n\\t\\tpadding: var(--size-2) var(--size-1);\\n\\t\\twidth: calc(100% - 0.375rem * 2);\\n\\t\\twidth: calc(100% - var(--size-2) * 2);\\n\\t}\\n\\t.wrap:hover .controls {\\n\\t\\topacity: 1;\\n\\t}\\n\\n\\t.inner {\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: space-between;\\n\\t\\talign-items: center;\\n\\t\\tpadding-right: var(--size-2);\\n\\t\\tpadding-left: var(--size-2);\\n\\t\\twidth: var(--size-full);\\n\\t\\theight: var(--size-full);\\n\\t}\\n\\n\\t.icon {\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\tcursor: pointer;\\n\\t\\twidth: var(--size-6);\\n\\t\\tcolor: white;\\n\\t}\\n\\n\\t.time {\\n\\t\\tflex-shrink: 0;\\n\\t\\tmargin-right: var(--size-3);\\n\\t\\tmargin-left: var(--size-3);\\n\\t\\tcolor: white;\\n\\t\\tfont-size: var(--text-sm);\\n\\t\\tfont-family: var(--font-mono);\\n\\t}\\n\\t.wrap {\\n\\t\\tposition: relative;\\n\\t\\tbackground-color: var(--background-fill-secondary);\\n\\t\\theight: var(--size-full);\\n\\t\\twidth: var(--size-full);\\n\\t\\tborder-radius: var(--radius-xl);\\n\\t}\\n\\t.wrap :global(video) {\\n\\t\\theight: var(--size-full);\\n\\t\\twidth: var(--size-full);\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA6JC,kCAAK,CACJ,WAAW,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,GAAG,CACvC,CAEA,sCAAS,CACR,YAAY,CAAE,IAAI,QAAQ,CAAC,CAC3B,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,KAAK,CAAE,IAAI,WAAW,CAAC,CACvB,MAAM,CAAE,IAAI,QAAQ,CACrB,CAEA,sCAAQ,sBAAuB,CAC9B,aAAa,CAAE,GAAG,CAClB,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAC1C,QAAQ,CAAE,MACX,CAEA,sCAAQ,wBAAyB,CAChC,gBAAgB,CAAE,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAC1C,CAEA,qCAAQ,CACP,SAAS,CAAE,OAAO,EAAE,CACrB,CAEA,0CAAa,CACZ,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,IAAI,CACZ,KAAK,CAAE,IACR,CAEA,uCAAU,CACT,QAAQ,CAAE,QAAQ,CAClB,MAAM,CAAE,CAAC,CACT,OAAO,CAAE,CAAC,CACV,UAAU,CAAE,KAAK,CACjB,MAAM,CAAE,IAAI,QAAQ,CAAC,CACrB,aAAa,CAAE,IAAI,WAAW,CAAC,CAC/B,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACjC,OAAO,CAAE,IAAI,QAAQ,CAAC,CAAC,IAAI,QAAQ,CAAC,CACpC,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,QAAQ,CAAC,CAAC,CAAC,CAAC,CAAC,CAChC,KAAK,CAAE,KAAK,IAAI,CAAC,CAAC,CAAC,IAAI,QAAQ,CAAC,CAAC,CAAC,CAAC,CAAC,CACrC,CACA,oBAAK,MAAM,CAAC,wBAAU,CACrB,OAAO,CAAE,CACV,CAEA,oCAAO,CACN,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,aAAa,CAAE,IAAI,QAAQ,CAAC,CAC5B,YAAY,CAAE,IAAI,QAAQ,CAAC,CAC3B,KAAK,CAAE,IAAI,WAAW,CAAC,CACvB,MAAM,CAAE,IAAI,WAAW,CACxB,CAEA,mCAAM,CACL,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,MAAM,CAAE,OAAO,CACf,KAAK,CAAE,IAAI,QAAQ,CAAC,CACpB,KAAK,CAAE,KACR,CAEA,mCAAM,CACL,WAAW,CAAE,CAAC,CACd,YAAY,CAAE,IAAI,QAAQ,CAAC,CAC3B,WAAW,CAAE,IAAI,QAAQ,CAAC,CAC1B,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,IAAI,SAAS,CAAC,CACzB,WAAW,CAAE,IAAI,WAAW,CAC7B,CACA,mCAAM,CACL,QAAQ,CAAE,QAAQ,CAClB,gBAAgB,CAAE,IAAI,2BAA2B,CAAC,CAClD,MAAM,CAAE,IAAI,WAAW,CAAC,CACxB,KAAK,CAAE,IAAI,WAAW,CAAC,CACvB,aAAa,CAAE,IAAI,WAAW,CAC/B,CACA,oBAAK,CAAS,KAAO,CACpB,MAAM,CAAE,IAAI,WAAW,CAAC,CACxB,KAAK,CAAE,IAAI,WAAW,CACvB"}'
};
const Player = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `<div class="wrap svelte-1laj904"><div class="${["mirror-wrap svelte-1laj904", mirror ? "mirror" : ""].join(" ").trim()}">${validate_component(Video$1, "Video").$$render(
      $$result,
      {
        src,
        preload: "auto",
    ...
    )}</div> <div class="controls svelte-1laj904"><div class="inner svelte-1laj904"><span role="button" tabindex="0" class="icon svelte-1laj904" aria-label="play-pause-replay-button">${time === duration ? `${validate_component(Undo, "Undo").$$render($$result, {}, {}, {})}` : `${paused ? `${validate_component(Play, "Play").$$render($$result, {}, {}, {})}` : `${validate_component(Pause, "Pause").$$render($$result, {}, {}, {})}`}`}</span> <span class="time svelte-1laj904">${escape(format_time(time))} / ${escape(format_time(duration))}</span>    <progress${add_attribute("value", time / duration || 0, 0)} class="svelte-1laj904"></progress> <div role="button" tabindex="0" class="icon svelte-1laj904" aria-label="full-screen">${validate_component(Maximise, "Maximise").$$render($$result, {}, {}, {})}</div></div></div></div> ${interactive ? `${validate_component(VideoControls, "VideoControls").$$render(
      $$result,
      {
        videoElement: video,
        showRedo: true,
...
//# sourceMappingURL=VideoPreview-CvtwwYnm.js.map
