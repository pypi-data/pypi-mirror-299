import { c as IconButton, l as Clear, u as uploadToHuggingFace, t as tick } from './2-Ax4bcEC3.js';
...
const Gallery = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${show_label ? `${validate_component(BlockLabel, "BlockLabel").$$render(
  ...
  })}` : `<div class="gallery-container"${add_attribute("this", gallery_container, 0)}>${selected_media && allow_preview ? `<button class="${["preview svelte-btxdw", mode === "minimal" ? "minimal" : ""].join(" ").trim()}">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
  ...
  })} <button class="media-button svelte-btxdw" style="${"height: calc(100% - " + escape(selected_media.caption ? "80px" : "60px", true) + ")"}" aria-label="detailed view of selected image">${"image" in selected_media ? `${validate_component(Image$1, "Image").$$render(
    $$result,
    {
      "data-testid": "detailed-image",
      src: selected_media.image.url,
    ...
    {},
    {}
  )}`}</button> ${selected_media?.caption ? `<caption class="caption svelte-btxdw">${escape(selected_media.caption)}</caption>` : ``} <div class="thumbnails scroll-hide svelte-btxdw" data-testid="container_el"${add_attribute("this", container_element, 0)}>${each(resolved_value, (media, i) => {
    return `<button class="${[
      "thumbnail-item thumbnail-small svelte-btxdw",
    ...
    "grid-wrap svelte-btxdw",
    (mode === "minimal" ? "minimal" : "") + " " + (mode !== "minimal" && (!height || height == "auto") ? "fixed-height" : "") + " "
  ].join(" ").trim()}"><div class="${["grid-container svelte-btxdw", show_label ? "pt-6" : ""].join(" ").trim()}" style="${"--grid-cols:" + escape(columns, true) + "; --grid-rows:" + escape(rows, true) + "; --object-fit: " + escape(object_fit, true) + "; height: " + escape(height, true) + ";"}">${interactive ? `<div class="icon-button svelte-btxdw">${validate_component(ModifyUpload, "ModifyUpload").$$render($$result, { i18n }, {}, {})}</div>` : ``} ${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      return `${show_share_button ? `<div class="icon-button svelte-btxdw">${validate_component(ShareButton, "ShareButton").$$render(
        $$result,
        {
          i18n,
          value: resolved_value,
    ...
    return `<button class="${[
      "thumbnail-item thumbnail-lg svelte-btxdw",
      ...
      {},
      {}
    )}`} ${entry.caption ? `<div class="caption-label svelte-btxdw">${escape(entry.caption)} </div>` : ``} </button>`;
  })}</div></div></div>`}`;
});

export { Gallery as default };
//# sourceMappingURL=Gallery-CJ4QLmeV.js.map
