...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {
      default: () => {
        return `${show_label ? `<span class="label-container svelte-15uhf08">${validate_component(BlockLabel, "BlockLabel").$$render(
          $$result,
          {
            Icon: Code,
            show_label,
          ...
          {},
          {}
        )}</span>` : ``} ${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status, { variant: "center" }), {}, {})} <div class="${["svelte-15uhf08", loading_status?.status === "pending" ? "pending" : ""].join(" ").trim()}"${add_styles({
...
//# sourceMappingURL=Index45-Dg-el8VN.js.map
