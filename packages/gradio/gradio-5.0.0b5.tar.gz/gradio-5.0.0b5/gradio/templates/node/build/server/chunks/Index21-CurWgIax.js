...
import { B as Block, S as Static, c as IconButton } from './2-Ax4bcEC3.js';
    ...
    {},
    {
      default: () => {
        return `${validate_component(Static, "StatusTracker").$$render($$result, Object.assign({}, { autoscroll: gradio.autoscroll }, { i18n: gradio.i18n }, loading_status), {}, {})} ${validate_component(BlockLabel, "BlockLabel").$$render(
          ...
          {},
          {}
        )} <div class="container svelte-6n387">${_value == null ? `${validate_component(Empty, "Empty").$$render($$result, { size: "large", unpadded_box: true }, {}, {
          default: () => {
            return `${validate_component(Image, "Image").$$render($$result, {}, {}, {})}`;
          }
        })}` : `<div class="image-container svelte-6n387"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
          default: () => {
        ...
        })}</div> ${show_legend && _value ? `<div class="legend svelte-6n387">${each(_value.annotations, (ann, i) => {
          return `<button class="legend-item svelte-6n387" style="${"background-color: " + escape(
...
//# sourceMappingURL=Index21-CurWgIax.js.map
