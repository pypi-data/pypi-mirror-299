...
const css = {
  code: ".container.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{padding:var(--block-padding)}.output-class.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{display:flex;justify-content:center;align-items:center;padding:var(--size-6) var(--size-4);color:var(--body-text-color);font-weight:var(--weight-bold);font-size:var(--text-xxl)}.confidence-set.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:var(--size-2);color:var(--body-text-color);line-height:var(--line-none);font-family:var(--font-mono);width:100%}.confidence-set.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w:last-child{margin-bottom:0}.inner-wrap.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{flex:1 1 0%;display:flex;flex-direction:column}.bar.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{appearance:none;align-self:flex-start;margin-bottom:var(--size-1);border-radius:var(--radius-md);background:var(--stat-background-fill);height:var(--size-1)}.label.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{display:flex;align-items:baseline}.label.svelte-1iqed6w>.svelte-1iqed6w+.svelte-1iqed6w{margin-left:var(--size-2)}.confidence-set.svelte-1iqed6w:hover .label.svelte-1iqed6w.svelte-1iqed6w{color:var(--color-accent)}.confidence-set.svelte-1iqed6w:focus .label.svelte-1iqed6w.svelte-1iqed6w{color:var(--color-accent)}.text.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{line-height:var(--line-md);text-align:left}.line.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{flex:1 1 0%;border:1px dashed var(--border-color-primary);padding-right:var(--size-4);padding-left:var(--size-4)}.confidence.svelte-1iqed6w.svelte-1iqed6w.svelte-1iqed6w{margin-left:auto;text-align:right}",
...
const Label = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="container svelte-1iqed6w"><h2 class="${[
    "output-class svelte-1iqed6w",
    ...
    return `<button class="${["confidence-set group svelte-1iqed6w", selectable ? "selectable" : ""].join(" ").trim()}"${add_attribute("data-testid", `${confidence_set.label}-confidence-set`, 0)}><div class="inner-wrap svelte-1iqed6w"><meter${add_attribute("aria-labelledby", get_aria_referenceable_id(`meter-text-${confidence_set.label}`), 0)}${add_attribute("aria-label", confidence_set.label, 0)}${add_attribute("aria-valuenow", Math.round(confidence_set.confidence * 100), 0)} aria-valuemin="0" aria-valuemax="100" class="bar svelte-1iqed6w" min="0" max="1"${add_attribute("value", confidence_set.confidence, 0)} style="${"width: " + escape(confidence_set.confidence * 100, true) + "%; background: var(--stat-background-fill);"}"></meter> <dl class="label svelte-1iqed6w"><dt${add_attribute("id", get_aria_referenceable_id(`meter-text-${confidence_set.label}`), 0)} class="text svelte-1iqed6w">${escape(confidence_set.label)} </dt><div class="line svelte-1iqed6w"></div><dd class="confidence svelte-1iqed6w">${escape(Math.round(confidence_set.confidence * 100))}%
						</dd></dl></div> </button>`;
  })}` : ``} </div>`;
});
const Label$1 = Label;
...
//# sourceMappingURL=Index42-DA6_tfI9.js.map
