...
import { B as Block, S as Static } from './2-Ax4bcEC3.js';
...
const Checkbox = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<input type="checkbox" ${disabled ? "disabled" : ""} class="${["svelte-34z85b", disabled && !value ? "disabled" : ""].join(" ").trim()}"${add_attribute("checked", value, 1)}>`;
});
...
const FileTree = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<ul class="svelte-zlvxd5">${each(content, ({ type, name, valid }, i) => {
    return `<li class="svelte-zlvxd5"><span class="wrap svelte-zlvxd5">${validate_component(Checkbox, "Checkbox").$$render(
      $$result,
      {
      ...
      {},
      {}
    )} ${type === "folder" ? `<span class="${["icon svelte-zlvxd5", !opened_folders.includes(i) ? "hidden" : ""].join(" ").trim()}" role="button" aria-label="expand directory" tabindex="0">${validate_component(ArrowIcon, "Arrow").$$render($$result, {}, {}, {})}</span>` : `<span class="file-icon svelte-zlvxd5"><img${add_attribute("src", name === "." ? FolderIcon : FileIcon, 0)} alt="file icon" class="svelte-zlvxd5"> </span>`} ${escape(name)}</span> ${type === "folder" && opened_folders.includes(i) ? `${validate_component(FileTree, "svelte:self").$$render(
      $$result,
      {
        path: [...path, name],
...
const css = {
  code: ".file-wrap.svelte-h8i5yo{height:calc(100% - 25px);overflow-y:scroll}",
...
const DirectoryExplorer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.ls_fn === void 0 && $$bindings.ls_fn && ls_fn !== void 0)
    $$bindings.ls_fn(ls_fn);
  $$result.css.add(css);
  return `<div class="file-wrap svelte-h8i5yo">${validate_component(FileTree, "FileTree").$$render(
    $$result,
    {
      path: [],
      selected_files: value,
...
//# sourceMappingURL=Index55-ahDFJ-m3.js.map
