...
import { c as IconButton, u as uploadToHuggingFace } from './2-Ax4bcEC3.js';
...
const ImagePreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  })}` : `<div class="image-container svelte-1bbirhu"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
  ...
  })} <button class="svelte-1bbirhu"><div class="${["image-frame svelte-1bbirhu", selectable ? "selectable" : ""].join(" ").trim()}">${validate_component(Image$1, "Image").$$render($$result, { src: value.url, alt: "", loading: "lazy" }, {}, {})}</div></button></div>`}`;
});

export { ImagePreview as default };
//# sourceMappingURL=ImagePreview-DzyPANIb.js.map
