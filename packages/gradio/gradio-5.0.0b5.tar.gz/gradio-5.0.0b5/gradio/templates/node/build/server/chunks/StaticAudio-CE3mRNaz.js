...
import { c as IconButton, u as uploadToHuggingFace, f as format_time } from './2-Ax4bcEC3.js';
...
const WaveformControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="controls svelte-1gy6045" data-testid="waveform-controls"><div class="control-wrapper svelte-1gy6045"><button class="action icon volume svelte-1gy6045" aria-label="Adjust volume"${add_styles({
...
const AudioPlayer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<audio class="${[
      "standard-player svelte-19le9nd",
    ...
    })}` : `${!value.is_stream ? `<div class="component-wrapper svelte-19le9nd"${add_attribute("data-testid", label ? "waveform-" + label : "unlabelled-audio", 0)}><div class="waveform-container svelte-19le9nd"><div id="waveform" class="svelte-19le9nd"${add_styles({ "height": "58px" })}${add_attribute("this", container, 0)}></div></div> <div class="timestamps svelte-19le9nd"><time id="time" class="svelte-19le9nd"${add_attribute("this", timeRef, 0)} data-svelte-h="svelte-lp3mlp">0:00</time> <div>${mode === "edit" && trimDuration > 0 ? `<time id="trim-duration" class="svelte-19le9nd">${escape(format_time(trimDuration))}</time>` : ``} <time id="duration" class="svelte-19le9nd"${add_attribute("this", durationRef, 0)} data-svelte-h="svelte-1jd0owv">0:00</time></div></div>  ${validate_component(WaveformControls, "WaveformControls").$$render(
      $$result,
      {
        container,
        waveform,
...
//# sourceMappingURL=StaticAudio-CE3mRNaz.js.map
