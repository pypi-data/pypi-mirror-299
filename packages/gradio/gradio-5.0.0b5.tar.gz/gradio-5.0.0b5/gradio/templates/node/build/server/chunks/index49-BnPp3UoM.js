...
import { W as Webcam$1 } from './ImageUploader-DNNmd3Yh.js';
import { P as Player$1, V as VideoPreview } from './VideoPreview-CvtwwYnm.js';
export { default as BaseExample } from './Example23-Boynvm5q.js';
...
import './ModifyUpload-DJvIDMBL.js';
...
const css = {
  code: ".file-name.svelte-1kyjvp4{padding:var(--size-6);font-size:var(--text-xxl);word-break:break-all}.file-size.svelte-1kyjvp4{padding:var(--size-2);font-size:var(--text-xl)}.upload-container.svelte-1kyjvp4{height:100%;width:100%}.video-container.svelte-1kyjvp4{display:flex;height:100%;flex-direction:column;justify-content:center;align-items:center}",
...
const InteractiveVideo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      {},
      {}
    )} <div data-testid="video" class="video-container svelte-1kyjvp4">${value === null || value.url === void 0 ? `<div class="upload-container svelte-1kyjvp4">${active_source === "upload" ? `${validate_component(Upload, "Upload").$$render(
      $$result,
      {
        filetype: "video/x-m4v,video/*",
        max_file_size,
...
//# sourceMappingURL=index49-BnPp3UoM.js.map
