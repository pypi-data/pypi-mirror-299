...
const JSONNode = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "json-node svelte-1340jar",
    (is_root ? "root" : "") + " " + (theme_mode === "dark" ? "dark-mode" : "")
  ].join(" ").trim()}" style="${"--depth: " + escape(depth, true) + ";"}"${add_attribute("this", root_element, 0)}><div class="${["line svelte-1340jar", collapsed ? "collapsed" : ""].join(" ").trim()}"><span class="line-number svelte-1340jar"></span> <span class="content svelte-1340jar">${is_collapsible(value) ? `<button${add_attribute("data-pseudo-content", collapsed ? "▶" : "▼", 0)}${add_attribute("aria-label", collapsed ? "Expand" : "Collapse", 0)} class="toggle svelte-1340jar"></button>` : ``} ${key !== null ? `<span class="key svelte-1340jar">&quot;${escape(key)}&quot;</span><span class="punctuation colon svelte-1340jar" data-svelte-h="svelte-1cahzs5">:</span>` : ``} ${is_collapsible(value) ? `<span class="${[
    "punctuation bracket svelte-1340jar",
    Array.isArray(value) ? "square-bracket" : ""
  ].join(" ").trim()}">${escape(Array.isArray(value) ? "[" : "{")}</span> ${collapsed ? `<button class="preview svelte-1340jar">${escape(get_collapsed_preview(value))}</button> <span class="${[
    "punctuation bracket svelte-1340jar",
    Array.isArray(value) ? "square-bracket" : ""
  ].join(" ").trim()}">${escape(Array.isArray(value) ? "]" : "}")}</span>` : ``}` : `${typeof value === "string" ? `<span class="value string svelte-1340jar">&quot;${escape(value)}&quot;</span>` : `${typeof value === "number" ? `<span class="value number svelte-1340jar">${escape(value)}</span>` : `${typeof value === "boolean" ? `<span class="value bool svelte-1340jar">${escape(value.toString())}</span>` : `${value === null ? `<span class="value null svelte-1340jar" data-svelte-h="svelte-xcjkvs">null</span>` : `<span>${escape(value)}</span>`}`}`}`}`} ${!is_last_item && (!is_collapsible(value) || collapsed) ? `<span class="punctuation svelte-1340jar" data-svelte-h="svelte-19nlgjl">,</span>` : ``}</span></div> ${is_collapsible(value) ? `<div class="${["children svelte-1340jar", collapsed ? "hidden" : ""].join(" ").trim()}">${each(child_nodes, ([subKey, subVal], i) => {
...
const JSON_1 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${value && value !== '""' && !is_empty(value) ? `${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
  ...
  })} <div class="json-holder svelte-j704tc"${add_styles({ "max-height": json_max_height })}>${validate_component(JSONNode, "JSONNode").$$render(
    $$result,
    {
      value,
      depth: 0,
    ...
    {},
    {}
  )}</div>` : `<div class="empty-wrapper svelte-j704tc">${validate_component(Empty, "Empty").$$render($$result, {}, {}, {
    default: () => {
...
//# sourceMappingURL=Index50-DZfLf_Ho.js.map
