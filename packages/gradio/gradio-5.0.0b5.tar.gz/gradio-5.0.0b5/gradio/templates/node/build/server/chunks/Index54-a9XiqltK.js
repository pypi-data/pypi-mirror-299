...
import { B as Block, S as Static, h as BlockTitle } from './2-Ax4bcEC3.js';
export { default as BaseExample } from './Example13-Rtx6F1bu.js';
import './index4-D_FyJKAV.js';

const css$3 = {
  code: ".dropdown-arrow.svelte-145leq6{fill:currentColor}",
  map: '{"version":3,"file":"DropdownArrow.svelte","sources":["DropdownArrow.svelte"],"sourcesContent":["<svg\\n\\tclass=\\"dropdown-arrow\\"\\n\\txmlns=\\"http://www.w3.org/2000/svg\\"\\n\\twidth=\\"100%\\"\\n\\theight=\\"100%\\"\\n\\tviewBox=\\"0 0 18 18\\"\\n>\\n\\t<path d=\\"M5 8l4 4 4-4z\\" />\\n</svg>\\n\\n<style>\\n\\t.dropdown-arrow {\\n\\t\\tfill: currentColor;\\n\\t\\t/* margin-right: var(--size-2); */\\n\\t\\t/* width: var(--size-5); */\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAWC,8BAAgB,CACf,IAAI,CAAE,YAGP"}'
};
const DropdownArrow = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<svg class="dropdown-arrow svelte-145leq6" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 18 18"><path d="M5 8l4 4 4-4z"></path></svg>`;
});
...
const DropdownOptions = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` <div class="reference"${add_attribute("this", refElement, 0)}></div> ${show_options && !disabled ? `<ul class="options svelte-wmd465" role="listbox"${add_styles({
    top,
    bottom,
...
const Multiselect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<label class="${["svelte-1meb8if", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
    default: () => {
      return `${escape(label)}`;
    }
  })} <div class="wrap svelte-1meb8if"><div class="${["wrap-inner svelte-1meb8if", ""].join(" ").trim()}">${each(selected_indices, (s) => {
    return `<div class="token svelte-1meb8if"><span class="svelte-1meb8if">${typeof s === "number" ? `${escape(choices_names[s])}` : `${escape(s)}`}</span> ${!disabled ? `<div class="token-remove svelte-1meb8if" role="button" tabindex="0"${add_attribute("title", i18n("common.remove") + " " + s, 0)}>${validate_component(Remove, "Remove").$$render($$result, {}, {}, {})} </div>` : ``} </div>`;
  })} <div class="secondary-wrap svelte-1meb8if"><input class="${[
    "border-none svelte-1meb8if",
    !choices_names.includes(input_text) && !allow_custom_value || selected_indices.length === max_choices ? "subdued" : ""
  ].join(" ").trim()}" ${disabled ? "disabled" : ""} autocomplete="off" ${!filterable ? "readonly" : ""}${add_attribute("value", input_text, 0)}${add_attribute("this", filter_input, 0)}> ${!disabled ? `${selected_indices.length > 0 ? `<div role="button" tabindex="0" class="token-remove remove-all svelte-1meb8if"${add_attribute("title", i18n("common.clear"), 0)}>${validate_component(Remove, "Remove").$$render($$result, {}, {}, {})}</div>` : ``} <span class="icon-wrap svelte-1meb8if">${validate_component(DropdownArrow, "DropdownArrow").$$render($$result, {}, {}, {})}</span>` : ``}</div></div> ${validate_component(DropdownOptions, "DropdownOptions").$$render(
    $$result,
    {
      show_options,
      choices,
...
const Dropdown = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["svelte-1f451w2", container ? "container" : ""].join(" ").trim()}">${validate_component(BlockTitle, "BlockTitle").$$render($$result, { show_label, info }, {}, {
    default: () => {
      return `${escape(label)}`;
    }
  })} <div class="wrap svelte-1f451w2"><div class="${["wrap-inner svelte-1f451w2", show_options ? "show_options" : ""].join(" ").trim()}"><div class="secondary-wrap svelte-1f451w2"><input role="listbox" aria-controls="dropdown-options"${add_attribute("aria-expanded", show_options, 0)}${add_attribute("aria-label", label, 0)} class="${[
    "border-none svelte-1f451w2",
    !choices_names.includes(input_text) && !allow_custom_value ? "subdued" : ""
  ].join(" ").trim()}" ${disabled ? "disabled" : ""} autocomplete="off" ${!filterable ? "readonly" : ""}${add_attribute("value", input_text, 0)}${add_attribute("this", filter_input, 0)}> ${!disabled ? `<div class="icon-wrap svelte-1f451w2">${validate_component(DropdownArrow, "DropdownArrow").$$render($$result, {}, {}, {})}</div>` : ``}</div></div> ${validate_component(DropdownOptions, "DropdownOptions").$$render(
    $$result,
    {
      show_options,
      choices,
...
//# sourceMappingURL=Index54-a9XiqltK.js.map
