...
const css = {
  code: "table.svelte-1bq8l1x.svelte-1bq8l1x{position:relative}td.svelte-1bq8l1x.svelte-1bq8l1x{border:1px solid var(--table-border-color);padding:var(--size-2);font-size:var(--text-sm);font-family:var(--font-mono)}.selected.svelte-1bq8l1x td.svelte-1bq8l1x{border-color:var(--border-color-accent)}.table.svelte-1bq8l1x.svelte-1bq8l1x{display:inline-block;margin:0 auto}.gallery.svelte-1bq8l1x td.svelte-1bq8l1x:first-child{border-left:none}.gallery.svelte-1bq8l1x tr:first-child td.svelte-1bq8l1x{border-top:none}.gallery.svelte-1bq8l1x td.svelte-1bq8l1x:last-child{border-right:none}.gallery.svelte-1bq8l1x tr:last-child td.svelte-1bq8l1x{border-bottom:none}.overlay.svelte-1bq8l1x.svelte-1bq8l1x{--gradient-to:transparent;position:absolute;bottom:0;background:linear-gradient(to bottom, transparent, var(--gradient-to));width:var(--size-full);height:50%}.odd.svelte-1bq8l1x.svelte-1bq8l1x{--gradient-to:var(--table-even-background-fill)}.even.svelte-1bq8l1x.svelte-1bq8l1x{--gradient-to:var(--table-odd-background-fill)}.button.svelte-1bq8l1x.svelte-1bq8l1x{--gradient-to:var(--background-fill-primary)}",
...
const Example = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ].join(" ").trim()}">${typeof value === "string" ? `${escape(value)}` : `<table class=" svelte-1bq8l1x">${each(value.slice(0, 3), (row, i) => {
    return `<tr>${each(row.slice(0, 3), (cell, j) => {
      return `<td class="svelte-1bq8l1x">${escape(cell)}</td>`;
    })} ${row.length > 3 ? `<td class="svelte-1bq8l1x" data-svelte-h="svelte-1o35md4">…</td>` : ``} </tr>`;
  })} ${value.length > 3 ? `<div class="${[
    "overlay svelte-1bq8l1x",
    (index % 2 != 0 ? "odd" : "") + " " + (index % 2 == 0 ? "even" : "") + " " + (type === "gallery" ? "button" : "")
  ].join(" ").trim()}"></div>` : ``}</table>`}</div>` : ``}`;
});

export { Example as default };
//# sourceMappingURL=Example12-BPX4bLvL.js.map
