import { B as Block, S as Static, h as BlockTitle, o as globals } from './2-DpTvHskm.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-BMwx_TJ-.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
  ...
  return `${validate_component(Block, "Block").$$render(
    ...
    {},
    {
      default: () => {
        ...
        })} ${value && is_browser ? `<div class="svelte-1mkj2j"${add_attribute("this", chart_element, 0)}></div> ${caption ? `<p class="caption svelte-1mkj2j">${escape(caption)}</p>` : ``}` : `${validate_component(Empty, "Empty").$$render($$result, { unpadded_box: true }, {}, {
          default: () => {
...
//# sourceMappingURL=Index27-CFu8TKUg.js.map
