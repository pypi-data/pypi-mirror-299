...
class BusinessObject:
    ...
    def getProcessData(self, id:str):
        valReturn = ''
        try:
            if existsJsonPath(self.businessObject,['processData',id]):# 'data' in self.businessObject['data'] and bind in self.businessObject['data'] and id in self.businessObject['data'][bind] and 'value' in self.businessObject['data'][bind][id] and 'value' in self.businessObject['data'][bind][id]['value']:
                valReturn = self.businessObject['data'][id]
        except Exception as ex:
