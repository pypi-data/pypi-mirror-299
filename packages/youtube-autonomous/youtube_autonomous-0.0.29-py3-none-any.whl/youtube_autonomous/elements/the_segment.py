...
from youtube_autonomous.elements.the_enhancement import Enhancement
...
class Segment:
    ...
    def build_step_6_build_and_apply_enhancements(self):
        ...
        enhancement_clips = []
        for enhancement in self.enhancements.sort(key = lambda enhancement: enhancement.start):
            enhancement_clip = enhancement.build()
            # TODO: Combine with our segment according to type

        if enhancement.mode == EnhancementMode.INLINE.value:
            # TODO: Build it inline
            print('build inline enhancement')
            pass
        elif enhancement.mode == EnhancementMode.OVERLAY.value:
            # TODO: Build it overlay
            print('build overlay enhancement')
            pass
        elif enhancement.mode == EnhancementMode.REPLACE.value:
            # TODO: Build it by replacing the clip
            print('build replace enhancement')
            pass
