...
class ElementBuilder:
    ...
    def get_subclass_by_type(type: Union[SegmentType, EnhancementType, str]):
        ...
        elif type == [SegmentType.AI_IMAGE, EnhancementType]:
            return AIImageElementBuilder
        elif type == [SegmentType.AI_VIDEO, EnhancementType.AI_VIDEO]:
            return AIVideoElementBuilder
        elif type == [SegmentType.IMAGE, EnhancementType.IMAGE]:
            return ImageElementBuilder
        elif type == [SegmentType.VIDEO, EnhancementType.VIDEO]:
            return VideoElementBuilder
        elif type == [SegmentType.STOCK, EnhancementType.STOCK]:
            return StockElementBuilder
        elif type == [SegmentType.CUSTOM_STOCK, EnhancementType.CUSTOM_STOCK]:
            return CustomStockElementBuilder
        elif type == [SegmentType.SOUND, EnhancementType.SOUND]:
            return SoundElementBuilder
        elif type == [SegmentType.YOUTUBE_VIDEO, EnhancementType.YOUTUBE_VIDEO]:
            return YoutubeVideoElementBuilder
        elif type == [SegmentType.TEXT, EnhancementType.TEXT]:
            return TextElementBuilder
        elif type == [SegmentType.PREMADE, EnhancementType.PREMADE]:
            return PremadeElementBuilder
        elif type == EnhancementType.EFFECT:
            return EffectElementBuilder
        elif type == EnhancementType.GREENSCREEN:
