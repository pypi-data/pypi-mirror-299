...
class ImageElementRules(ElementRules):
    def __init__(self):
        # super().__init__(True, False, True, True, False, False, True, True, True, False, False, False, True, True, [EnhancementElementMode.INLINE, EnhancementElementMode.OVERLAY], EnhancementElementMode.OVERLAY)
        # super().__init__(
        ...
        self.valid_enhancement_modes = [EnhancementElementMode.INLINE, EnhancementElementMode.OVERLAY]
        self.default_enhancement_mode = EnhancementElementMode.OVERLAY