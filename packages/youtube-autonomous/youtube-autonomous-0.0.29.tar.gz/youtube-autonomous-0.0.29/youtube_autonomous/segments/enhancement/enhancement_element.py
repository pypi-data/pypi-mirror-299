from youtube_autonomous.segments.enums import EnhancementElementType, EnhancementMode
...
class EnhancementElement:
    ...
    def __init__(self, type: EnhancementElementType, start: float, duration: float, keywords: str, url: str, filename: str, mode: EnhancementMode):
        self.type = type
        self.start = start
