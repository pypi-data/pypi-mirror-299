...
class PremadeElementRules(ElementRules):
    def __init__(self):
        ...
        self.can_have_text = False # dynamic parameters will be applied
        ...
        self.default_enhancement_mode = EnhancementElementMode.INLINE