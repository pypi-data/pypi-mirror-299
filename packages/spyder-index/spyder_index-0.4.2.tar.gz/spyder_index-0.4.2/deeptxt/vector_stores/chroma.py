...
from deeptxt.core.document import Document, DocumentWithScore
from deeptxt.core.embeddings import BaseEmbedding
...
class ChromaVectorStore:
    ...
    **Example**
    ...
    .. code-block:: python
        ...
        from deeptxt.vector_stores import ChromaVectorStore
