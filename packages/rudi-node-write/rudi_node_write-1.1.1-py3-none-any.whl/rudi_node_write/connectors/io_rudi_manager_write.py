...
class RudiNodeManagerConnector(Connector):
    ...
    @property
    def hash(self):
        return self._get_api(url="open/hash", headers=self._def_headers)
    ...
    @property
    def init_data(self):
        return self._get_cache("front/init-data")
    ...
    def _get_cache(self, url_bit: str):
        """
        ...
        obj_cache = self._data_cache.get(url_bit)
...
if __name__ == "__main__":  # pragma: no cover
    ...
    rudi_media_url = pm_connector.media_url
