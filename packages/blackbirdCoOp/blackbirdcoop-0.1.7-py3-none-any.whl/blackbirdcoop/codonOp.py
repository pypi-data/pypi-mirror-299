...
class RunAll:
    ...
    def replaced(seq, replaced):
        ...
        for stuff in replaced:
            ...
            seq = seq[: stuff[0]] + stuff[1] + seq[stuff[0] + length :] #replaces choice sequence at position
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        usage=f"""blackbird --insert (-n) <insert infile> --stealth (-s) <stealth infile> --hostT (-ht) <host genome infile> --target (-t) <target genome infile> --outfile -o [outfile | default: stdout]""",
    )
