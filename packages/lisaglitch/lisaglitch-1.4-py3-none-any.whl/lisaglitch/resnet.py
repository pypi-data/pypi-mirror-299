'''
Code borrowed from https://github.com/bayesiains/nflows
'''
...
class ConvResidualBlock(nn.Module):
    ...
    def forward(self, inputs, context=None):
        '''
          Forward pass of Convolutional Residual Block.
        '''
        temps = inputs
        if self.use_batch_norm:
            temps = self.batch_norm_layers[0](temps)
...
class ConvResidualNet(nn.Module):
    '''
      Network constructed of convolutional residual blocks.
    '''
    def __init__(
        self,
        in_channels,
    ...
    def forward(self, inputs, context=None):
        '''
          Forward pass of residual network.
        '''
        if context is None:
            temps = self.initial_layer(inputs)
        else:
