...
class useragent:
    ...
    def android(self, developer=__author__, app_version=None, version_code=None, android_name=None, language=None):
...
# z=useragent().android(developer='Khamdihi Dev', app_version='1', version_code='2', android_name='all', language='id_id')
# print(z)
