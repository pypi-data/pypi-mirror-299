...
from duple.publish_actions import delete_logs
...
def scan(
    ...
    # create output
    create_output(options, path, files.create_duplicate_output(), files.create_all_files_output(), summary_statistics)
