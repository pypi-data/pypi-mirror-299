       ...
       if (n_structures != 0):
          ...
          for i in range(n_structures):
              ...
              if (mismatch_type == 0):
                 ...
                 #------------------------------------------------------------
                 if (n_Lattice == 2):
                    poscar_new.write(f' | mismatch_area = {var_area_A}_{var_area_B} | mismatch_angle_12 = {mismatch_ang12}')
                    poscar_new.write(f' | rotation_12 = {angle1}')
                 if (n_Lattice == 3):
                    poscar_new.write(f' | mismatch_area = {var_area_A}_{var_area_B}_{var_area_C} | mismatch_angle_12_13 = {mismatch_ang12}_{mismatch_ang13}')
              ...
              if (mismatch_type == 1):
                 ...
                 #----------------------------------------------
                 if (n_Lattice == 2):
                    poscar_new.write(f' | mismatch_area = 0.0_0.0 | mismatch_angle_12 = {mismatch_ang12}')
                    poscar_new.write(f' | rotation_12 = {angle1}')
                 if (n_Lattice == 3):
                    poscar_new.write(f' | mismatch_area = 0.0_0.0_0.0 | mismatch_angle_12_13 = {mismatch_ang12}_{mismatch_ang13}')
                    poscar_new.write(f' | rotation_12_13 = {angle1}_{angle3}')
                       #----------------------------------------------
                 poscar_new.write(f' | MSCell_1 = {int(MT1_00[i])}_{int(MT1_01[i])}_{int(MT1_10[i])}_{int(MT1_10[i])}')
                 poscar_new.write(f' | MSCell_2 = {int(MT2_00[i])}_{int(MT2_01[i])}_{int(MT2_10[i])}_{int(MT2_10[i])}')
