       ...
       if (n_structures != 0):
          ...
          for i in range(n_structures):
              ...
              if (mismatch_type == 0):
                 ...
                 #---------------------------------------
                 var_A = ((Area1 -Area4)/Area1)*100
                 var_B = ((Area2 -Area4)/Area2)*100
                 if (n_Lattice == 3):
                    var_C = ((Area3 -Area4)/Area3)*100
                 #------------------------------------
                 ...
                 #------------------------------------------------------------
                 if (n_Lattice == 2):
                    poscar_new.write(f' | mismatch_area = {var_area_A}_{var_area_B}_{var_A}_{var_B} | mismatch_angle_12 = {mismatch_ang12[i]}')
                    poscar_new.write(f' | rotation_12 = {angle1}')
                 if (n_Lattice == 3):
                    poscar_new.write(f' | mismatch_area = {var_area_A}_{var_area_B}_{var_area_C}_{var_A}_{var_B}_{var_C} | mismatch_angle_12_13 = {mismatch_ang12[i]}_{mismatch_ang13[i]}')
