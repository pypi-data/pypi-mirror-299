                         ...
                         if (angle >= angle_min and angle <= angle_max):
                            if (angle != 0.0 and angle != 180.0):
                               ...
                               for t in range(len(vector_areas)):
                                   temp_area_min = vector_areas[t]*fator_n;  temp_area_min = round(temp_area_min, 3)
                                   temp_area_max = vector_areas[t]*fator_p;  temp_area_max = round(temp_area_max, 3)
                                   #--------------------------------------------------------------------------------
                                   if (Area >= temp_area_min and Area <= temp_area_max):
