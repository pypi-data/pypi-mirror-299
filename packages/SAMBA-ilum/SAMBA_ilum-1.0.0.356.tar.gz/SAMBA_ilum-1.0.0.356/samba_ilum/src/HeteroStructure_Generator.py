       ...
       if (n_structures != 0):
          ...
          for i in range(n_structures):
              ...
              if (mismatch_type == 0):
                 ...
                 #------------------------------------
                 var_A1 = ((modA4 -modA1)/modA1)*100
                 var_B1 = ((modB4 -modB1)/modB1)*100
                 var_A2 = ((modA4 -modA2)/modA2)*100
                 var_B2 = ((modB4 -modB2)/modB2)*100
                 if (n_Lattice == 3):
                    var_A3 = ((modA4 -modA3)/modA3)*100
                    var_B3 = ((modB4 -modB3)/modB3)*100
                 #--------------------------------------
