...
--------
    ...
    3. A function for fitting the parameters of pre- or user-defined gas exchange models to gas tracer data.
...
from .modelling import fitmodel
