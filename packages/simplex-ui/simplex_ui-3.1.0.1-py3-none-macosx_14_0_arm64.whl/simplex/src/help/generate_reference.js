...
function ExportHelpFile()
{
    ...
    let tabpanel = GetTabPanelTable();
    
    let ebmtbl = GetEBeamPrmList();
    let eproftbl = GetEBTypesTable();
    let seedtypetbl = GetSeedTypesTable();
    let simtypetbl = GetSimTypeTable();
    let simoptiontbl = GetSimOptionTable();

    let seedtbl = GetSeedPrmList();
    let spxtbl = GetSPXPrmList();
    let undtbl = GetUndPrmList();
    let latticetbl = GetLatticePrmList();
    let waketbl = GetWakePrmList();
    let aligntbl = GetAlignPrmList();
    let chicanetbl = GetChicanePrmList();
    let disptbl = GetDispersionPrmList();
    let simctrltbl = GetSimCtrlPrmList();
    let dumptbl = GetDataDumpPrmList();
    let outftbl = GetOutFilePrmList();
    let feltbl = GetFELPrmList();
    let mbunchtbl = GetMbunchPrmList();
    let bopttbl = GetOptBetaPrmList();
    let plottbl = GetPlotOptPrmList();
    let pprawtbl = GetPPrawOptPrmList();

    let ebmjson  =  GetEBPrmTable();
    let seedjson  =  GetSeedPrmTable();
    let spxjson = GetSPXPrmTable();
    let undjson = GetUndPrmTable();
    let latticejson = GetLatticePrmTable();
    let wakejson = GetWakePrmTable();
    let alignjson = GetAlignPrmTable();
    let chicanejson = GetChicanePrmTable();
    let dispjson = GetDispersionPrmTable();
    let simctrljson = GetSimCtrlPrmTable();
    let dumpjson = GetDataDumpPrmTable();
    let pptble = GetPreprocDetailTable();
    let imptbl = GetImportDetailTable();
    let ppaviltbl = GetPPAvailTable();
    let outfmttbl = GetOutputFormat();
    let undtypetbl = GetUndulatorType();
    let tapertypetbl = GetTaperType();
    let umtypetbl = GetUMType();
    let topttbl = GetTaperOptType();
    let alignttbl = GetAlignmentType();
    let rawexptbl = GetRawExportType();

    let contrep = cont 
        .replace("<p>@filemenu</p>", filemenu)
        .replace("<p>@runmenu</p>", runmenu)
        .replace("<p>@tabpanel</p>", tabpanel)
        .replace("<p>@ebprm</p>", ebmtbl)
        .replace("<p>@ebtype</p>", eproftbl)
        .replace("<p>@seedtype</p>", seedtypetbl)
        .replace("<p>@seedprm</p>", seedtbl)
        .replace("<p>@spxprm</p>", spxtbl)
        .replace("<p>@undprm</p>", undtbl)
        .replace("<p>@undtype</p>", undtypetbl)
        .replace("<p>@utapertype</p>", tapertypetbl)
        .replace("<p>@umodeltype</p>", umtypetbl)
        .replace("<p>@taperopttype</p>", topttbl)
        .replace("<p>@aligntype</p>", alignttbl) 
        .replace("<p>@rawexptype</p>", rawexptbl) 
        .replace("<p>@latticeprm</p>", latticetbl)
        .replace("<p>@wakeprm</p>", waketbl)
        .replace("<p>@alignprm</p>", aligntbl)
        .replace("<p>@chicaneprm</p>", chicanetbl)
        .replace("<p>@dispprm</p>", disptbl)
        .replace("<p>@simctrlprm</p>", simctrltbl)
        .replace("<p>@datadumpprm</p>", dumptbl)
        .replace("<p>@outfpprm</p>", outftbl)
        .replace("<p>@felprm</p>", feltbl)
        .replace("<p>@mbunchprm</p>", mbunchtbl)
        .replace("<p>@boptprm</p>", bopttbl)
        .replace("<p>@pprawprm</p>", pprawtbl)
        .replace("<p>@ploptprm</p>", plottbl)
        .replace("<p>@ebjson</p>", ebmjson)
        .replace("<p>@seedjson</p>", seedjson)
        .replace("<p>@spxjson</p>", spxjson)
        .replace("<p>@undjson</p>", undjson)
        .replace("<p>@latticejson</p>", latticejson)
        .replace("<p>@wakejson</p>", wakejson)
        .replace("<p>@alignjson</p>", alignjson)
        .replace("<p>@chicanejson</p>", chicanejson)
        .replace("<p>@dispjson</p>", dispjson)
        .replace("<p>@simctrljson</p>", simctrljson)
        .replace("<p>@simtype</p>", simtypetbl)
        .replace("<p>@simoption</p>", simoptiontbl)
        .replace("<p>@dumpjson</p>", dumpjson)
        .replace("<p>@preproc</p>", pptble)
        .replace("<p>@importpp</p>", imptbl)
        .replace("<p>@ppavailtype</p>", ppaviltbl)
        .replace("<p>@outfmt</p>", outfmttbl)
