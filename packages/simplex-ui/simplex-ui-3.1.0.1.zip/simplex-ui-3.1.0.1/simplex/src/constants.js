...
//PrePLabel, PartConfLabel, MBunchEvalLabel, PostPLabel
...
const SettingKeys = [
  ...
  DataUnitLabel, OutFileLabel, 
  PrePLabel, PlotWindowsRowLabel, SubPlotsRowLabel, 
  PartConfLabel, PartPlotConfLabel, MBunchEvalLabel
];
...
const BySpecifiedLabel = "Apply Selected";
...
const EBeamPrmsLabel = {
  ...
  avgsize:["&lt;&sigma;<sub>x,y</sub>&gt; (mm)",[null,null]],
...
const PulseProfiles = [NotAvaliable, GaussianPulse, ChirpedPulse, SimplexOutput];
...
const FELPrmsLabel = {
  ...
  avgbetavalue: ["&lt;&beta;&gt (m)", -1],
  inputbeta: ["&beta; (m)", 15],
  optbeta: ["Optimum &lt;&beta;&gt (m)", 15],
...
const PreRespObjs = {
  [PreProcessPrmLabel.cbetaxy0[0]]: [LatticePrmsLabel.betaxy0[0]],
  [PreProcessPrmLabel.calphaxy0[0]]: [LatticePrmsLabel.alphaxy0[0]],
  [PreProcessPrmLabel.cqdg[0]]: [LatticePrmsLabel.qdg[0]],
  [PreProcessPrmLabel.cqfg[0]]: [LatticePrmsLabel.qfg[0]]  
};
