...
from mpesaflow import Mpesaflow, AsyncMpesaflow, APIResponseValidationError
...
def _get_open_connections(client: Mpesaflow | AsyncMpesaflow) -> int:
...
class TestMpesaflow:
    client = Mpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mpesaflow/_legacy_response.py",
                        "mpesaflow/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mpesaflow/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MpesaflowError):
            with update_env(**{"MPESAFLOW_API_KEY": Omit()}):
                client2 = Mpesaflow(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Mpesaflow) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Mpesaflow(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            client = Mpesaflow(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                Mpesaflow(api_key=api_key, _strict_response_validation=True, environment="production")

            client = Mpesaflow(
                base_url=None, api_key=api_key, _strict_response_validation=True, environment="production"
            )
            assert str(client.base_url).startswith("https://dev.mpesaflow.com/v1")

    @pytest.mark.parametrize(
        "client",
        [
            Mpesaflow(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Mpesaflow(
    ...
    def test_base_url_trailing_slash(self, client: Mpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Mpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Mpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Mpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Mpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Mpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/paybill").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/paybill").mock(return_value=httpx.Response(500))
    ...
    @mock.patch("mpesaflow._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retries_taken(self, client: Mpesaflow, failures_before_success: int, respx_mock: MockRouter) -> None:
        ...
        respx_mock.post("/paybill").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Mpesaflow, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMpesaflow:
    client = AsyncMpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MpesaflowError):
            with update_env(**{"MPESAFLOW_API_KEY": Omit()}):
                client2 = AsyncMpesaflow(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMpesaflow) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMpesaflow(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(MPESAFLOW_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncMpesaflow(api_key=api_key, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncMpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMpesaflow) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMpesaflow(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self, async_client: AsyncMpesaflow, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
