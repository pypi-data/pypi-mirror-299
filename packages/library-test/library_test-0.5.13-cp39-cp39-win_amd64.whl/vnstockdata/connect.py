...
def Connect(phone_number:str,password:str):
    """
    ...
    Nếu xác thực thành công, hàm sẽ lưu trữ token để sử dụng cho các yêu cầu API tiếp theo.
