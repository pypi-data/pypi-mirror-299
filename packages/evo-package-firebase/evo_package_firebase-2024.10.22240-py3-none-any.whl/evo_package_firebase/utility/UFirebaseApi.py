...
#<        
            await self.doSet(collection=eApiQuery.collection,
...
#<        
            ...
            data = await self.doGet(collection=eApiQuery.collection, id=eApiQuery.eObjectID)
...
#<        
            ...
            eFirebaseMap = await self.doQuery(collection=eApiQuery.collection, query=eApiQuery.query)
        ...
        try:
            ...
            for doc in arrayDoc: 
                ...
                if "id" in mapInfo:
                    ...
                    eApiQuery.collection = collection 
