...
def send_email(email_type="info", email_message="Message", originator="Rikpy", attachment=None, email_recipient=None):
    ...
    try:
        ...
        # Use the provided email_recipient if given, otherwise use the default
        recipient = email_recipient if email_recipient else default_recipient
        ...
        with smtplib.SMTP(smtp_server, smtp_port) as server:
            ...
            response=server.sendmail(smtp_user, recipient, message.as_string())
            # xlogger(response)
    except Exception as e:
        rfplogger(e)
