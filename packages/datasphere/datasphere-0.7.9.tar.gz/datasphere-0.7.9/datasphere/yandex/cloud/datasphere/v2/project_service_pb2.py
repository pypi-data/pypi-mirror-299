...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PROJECTEXECUTIONRESPONSE'].fields_by_name['output_variables']._loaded_options = None
  _globals['_PROJECTEXECUTIONRESPONSE'].fields_by_name['output_variables']._serialized_options = b'\030\001'
