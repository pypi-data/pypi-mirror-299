...
class SediflowModel(HydroflowModel):
    ...
    def __init__(self,mesh: Mesh):
        ...
        # tests (only for sediments)
        self.__is_sediments_conservation = False
        # conditions
    ...
    @property
    def is_sediments_conservation(self):
        """
        True if we check mass conservation and False if not
        :getter: returns a boolean that indicates if mass conservation has to be checked
        :setter: impose boolean value
        :type: boolean
        """
        return self.__is_sediments_conservation
    
    @is_sediments_conservation.setter
    def is_sediments_conservation(self,is_sediments_conservation):
        self.__is_sediments_conservation = is_sediments_conservation
...
class SediflowExport(HydroflowExport):
    ...
    def __export_data(self,write=True):
        ...
        if self.model.is_sediments_conservation : input_data['model']['mass conservation check'] = self.model.is_sediments_conservation
