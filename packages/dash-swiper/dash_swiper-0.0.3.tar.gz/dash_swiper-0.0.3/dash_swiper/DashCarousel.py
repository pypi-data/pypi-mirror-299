...
- swiperOptions (dict; optional):
    ...
    _type = 'DashCarousel'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, slides=Component.REQUIRED, className=Component.UNDEFINED, carouselEffect=Component.UNDEFINED, navigation=Component.UNDEFINED, pagination=Component.UNDEFINED, autoplayEnabled=Component.UNDEFINED, autoplay=Component.UNDEFINED, loop=Component.UNDEFINED, grabCursor=Component.UNDEFINED, slidesPerView=Component.UNDEFINED, swiperOptions=Component.UNDEFINED, activeIndex=Component.UNDEFINED, activeSlideAlt=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'activeIndex', 'activeSlideAlt', 'autoplay', 'autoplayEnabled', 'carouselEffect', 'className', 'grabCursor', 'loop', 'navigation', 'pagination', 'slides', 'slidesPerView', 'style', 'swiperOptions']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'activeIndex', 'activeSlideAlt', 'autoplay', 'autoplayEnabled', 'carouselEffect', 'className', 'grabCursor', 'loop', 'navigation', 'pagination', 'slides', 'slidesPerView', 'style', 'swiperOptions']
