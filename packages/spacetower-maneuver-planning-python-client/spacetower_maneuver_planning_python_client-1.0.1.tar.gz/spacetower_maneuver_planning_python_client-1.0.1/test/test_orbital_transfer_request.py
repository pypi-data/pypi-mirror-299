...
class TestOrbitalTransferRequest(unittest.TestCase):
    """OrbitalTransferRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitalTransferRequest:
        """Test OrbitalTransferRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitalTransferRequest`
        """
        model = OrbitalTransferRequest()
        if include_optional:
            return OrbitalTransferRequest(
    ...
    def testOrbitalTransferRequest(self):
        """Test OrbitalTransferRequest"""
