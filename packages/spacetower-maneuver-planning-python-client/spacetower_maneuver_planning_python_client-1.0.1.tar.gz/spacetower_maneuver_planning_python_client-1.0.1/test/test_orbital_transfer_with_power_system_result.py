...
class TestOrbitalTransferWithPowerSystemResult(unittest.TestCase):
    """OrbitalTransferWithPowerSystemResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrbitalTransferWithPowerSystemResult:
        """Test OrbitalTransferWithPowerSystemResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrbitalTransferWithPowerSystemResult`
        """
        model = OrbitalTransferWithPowerSystemResult()
        if include_optional:
            return OrbitalTransferWithPowerSystemResult(
                output_ephemeris = None,
    ...
    def testOrbitalTransferWithPowerSystemResult(self):
        """Test OrbitalTransferWithPowerSystemResult"""
