...
class OrbitalTransferWithPowerSystemResult(BaseModel):
    """
    Maneuver planning results including maneuver schedule and detailed report 
    """ # noqa: E501
    output_ephemeris: Optional[OutputEphemerisWithPowerSystem] = Field(default=None, alias="outputEphemeris")
    ...
    __properties: ClassVar[List[str]] = ["finalOsculatingOrbit", "finalMeanOrbit", "finalOrbitTle", "maneuverSchedule", "attitudeSequence", "maneuverExecutionReport", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithPowerSystemResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithPowerSystemResult from a dict"""
        if obj is None:
            return None
