...
class OrbitalTransferWithPowerSystemRequest(BaseModel):
    """
    ...
    space_object: BoxObjectWithPowerSystem = Field(alias="spaceObject")
    ephemeris_generation_requests: Optional[SimulationWithPowerEphemerisRequest] = Field(default=None, alias="ephemerisGenerationRequests")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithPowerSystemRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalTransferWithPowerSystemRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": obj.get("data"),
            "spaceObject": BoxObjectWithPowerSystem.from_dict(obj["spaceObject"]) if obj.get("spaceObject") is not None else None,
            "ephemerisGenerationRequests": SimulationWithPowerEphemerisRequest.from_dict(obj["ephemerisGenerationRequests"]) if obj.get("ephemerisGenerationRequests") is not None else None
        })
        return _obj
