...
class AttitudeEphemeris(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CardanAngleEphemeris, QuaternionEphemeris]]:
        ...
        if object_type ==  'CardanAngleEphemeris':
            return import_module("spacetower_maneuver_planning_python_client.models.cardan_angle_ephemeris").CardanAngleEphemeris.from_dict(obj)
        if object_type ==  'QuaternionEphemeris':
            return import_module("spacetower_maneuver_planning_python_client.models.quaternion_ephemeris").QuaternionEphemeris.from_dict(obj)
