...
class OrbitalTransferRequest(BaseModel):
    """
    Input parameters for computing a maneuver to change mean orbital elements sma, eccentricity, inclination 
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["initialOrbit", "maneuverTarget", "maneuverStrategy", "simulationConfiguration", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrbitalTransferRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrbitalTransferRequest from a dict"""
        if obj is None:
            return None
