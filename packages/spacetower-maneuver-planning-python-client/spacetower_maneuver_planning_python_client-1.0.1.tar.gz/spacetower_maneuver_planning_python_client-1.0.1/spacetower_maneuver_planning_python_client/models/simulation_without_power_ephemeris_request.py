...
class SimulationWithoutPowerEphemerisRequest(BaseModel):
    """
    SimulationWithoutPowerEphemerisRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["attitudeEphemerisRequest", "osculatingOrbitEphemerisRequest", "meanOrbitEphemerisRequest", "thrustVectorEphemerisRequest", "massEphemerisRequest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimulationWithoutPowerEphemerisRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimulationWithoutPowerEphemerisRequest from a dict"""
        if obj is None:
            return None
