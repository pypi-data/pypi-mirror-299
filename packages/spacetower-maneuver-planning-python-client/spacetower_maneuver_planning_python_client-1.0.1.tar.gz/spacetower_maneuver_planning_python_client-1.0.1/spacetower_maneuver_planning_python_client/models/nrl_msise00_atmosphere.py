...
class NrlMsise00Atmosphere(AtmosphereModel):
    ...
    """ # noqa: E501
    solar_activity_type: StrictStr = Field(description="From CSSI", alias="solarActivityType")
    ...
    def solar_activity_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CSSI']):
            raise ValueError("must be one of enum values ('CSSI')")
        return value
