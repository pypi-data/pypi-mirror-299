...
class LofAttitudeLaw(AttitudeLaw):
    """
    ...
    """ # noqa: E501
    lof_type: InertialLofType = Field(alias="lofType")
    ...
    __properties: ClassVar[List[str]] = ["attitudeLawType", "lofType", "alpha", "beta", "gamma"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LofAttitudeLaw from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LofAttitudeLaw from a dict"""
        if obj is None:
            return None
