...
class BoxObjectWithoutPowerSystem(BaseModel):
    """
    Common fields for box objects having or not a power system defined 
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["mass", "dragCoefficient", "xDimension", "yDimension", "zDimension", "solarArrayGeometry", "radiationCoefficients", "thruster"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BoxObjectWithoutPowerSystem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BoxObjectWithoutPowerSystem from a dict"""
        if obj is None:
            return None
