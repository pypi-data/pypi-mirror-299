...
class SolarArrayGeometry(BaseModel):
    ...
    drag_coefficient: Optional[Union[StrictFloat, StrictInt]] = Field(default=2.2, description="Drag coefficient of the solar array panel. Units [-]", alias="dragCoefficient")
    surface_area: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Units [m^2]", alias="surfaceArea")
