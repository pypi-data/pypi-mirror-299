...
class Control(BaseSectionObject):
    ...
    class _Condition(BaseSectionObject):
        ...
        def __init__(self, logic: Literal['IF', 'OR', 'AND'], object_kind=nan, *args, label=nan, attribute=None, relation: Literal['=', '<>', '<', '<=', '>', '>='] = None, value=None):
...
class ControlVariable(Control):
    ...
    def __init__(self, name, object_kind, label, attribute=nan):
        self.name = name
        self.object_kind = object_kind.upper()   # Control.OBJECTS
        self.label = label
        self.attribute = attribute
