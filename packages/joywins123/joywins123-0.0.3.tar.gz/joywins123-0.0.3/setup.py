...
setuptools.setup(
    # 필수 항목
    name="joywins123",  # PyPI에서 유일한 패키지 이름
    version="0.0.3",           # 버전 번호 (e.g., "1.0.0", "0.1.2")
    author="joywins",        # 작성자 이름
    author_email="joywins123@gmail.com",  # 연락 가능한 이메일
    description="A short description of your package",  # 한 줄 설명
    long_description=long_description,  # README 파일의 내용
    long_description_content_type="text/markdown",  # README 파일 형식
    url="https://github.com/JoyWins123/password_make_sample",  # 소스코드 저장소 URL
