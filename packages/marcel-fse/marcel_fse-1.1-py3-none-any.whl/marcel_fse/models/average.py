...
from marcel_fse.models.base_s2v import BaseSentence2VecModel
...
try:
    from marcel_fse.models.average_inner import train_average_cy
    from marcel_fse.models.average_inner import (
        FAST_VERSION,
        MAX_WORDS_IN_BATCH,
        MAX_NGRAMS_IN_BATCH,
    )
