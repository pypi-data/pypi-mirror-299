...
class Template(fpdf.FPDF):
    ...
    def __init__(
        ...
        self.updated = (
            datetime.datetime.fromisoformat(str(updated)).strftime("%Y-%m-%d")
            if updated
            else ""
        )
        self.subtitle = None
    ...
    # *************************************************
    def cell(
        self, text_trim: bool = False, **kwargs
    ...
    def header(self):
        ...
        with self.local_context():
            ...
            self.line(
                x1=self.l_margin, y1=line_y, x2=self.epw + self.l_margin, y2=line_y
            )
