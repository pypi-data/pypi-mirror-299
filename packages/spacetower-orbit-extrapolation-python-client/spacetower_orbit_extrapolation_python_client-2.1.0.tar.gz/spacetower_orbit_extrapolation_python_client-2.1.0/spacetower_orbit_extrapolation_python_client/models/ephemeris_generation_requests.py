...
class EphemerisGenerationRequests(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["osculatingOrbitEphemerisRequest", "meanOrbitEphemerisRequest", "cartesianEphemerisRequest", "geodeticEphemerisRequest", "tleEphemerisRequest"]
