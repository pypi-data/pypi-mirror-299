...
class EphemerisGenerationRequestsWithAttitude(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["osculatingOrbitEphemerisRequest", "meanOrbitEphemerisRequest", "cartesianEphemerisRequest", "geodeticEphemerisRequest", "tleEphemerisRequest", "massEphemerisRequest", "cartesianCovarianceEphemerisRequest", "orbitalCovarianceEphemerisRequest", "batteryPowerEphemerisRequest", "thrustVectorEphemerisRequest", "attitudeEphemerisRequest"]
