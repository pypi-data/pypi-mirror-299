...
class NumericalExtrapolationWithoutAttitudeSimulationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cartesianEphemeris", "geodeticEphemeris", "meanOrbitEphemeris", "osculatingOrbitEphemeris", "cartesianCovarianceEphemeris", "massEphemeris", "orbitalCovarianceEphemeris", "orbitalEventLogs", "stationEventLogs", "closestApproachEventLogs", "data"]
