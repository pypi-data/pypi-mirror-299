...
class EphemerisGenerationRequestsWithAttitude(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["osculatingOrbitEphemerisRequest", "meanOrbitEphemerisRequest", "cartesianEphemerisRequest", "geodeticEphemerisRequest", "massEphemerisRequest", "cartesianCovarianceEphemerisRequest", "orbitalCovarianceEphemerisRequest", "attitudeEphemerisRequest", "batteryPowerEphemerisRequest", "thrustVectorEphemerisRequest"]
