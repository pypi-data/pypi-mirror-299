...
class OutputConfiguration(BaseModel):
    """
    Frame types (Earth-fixed, inertial, orbit relative) and ellipsoid model used for ephemeris and events computation 
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["includeTidalEffectsInEopInterpolation", "inertialFrameId", "earthFixedFrameId", "localFrameId", "ellipsoidId", "shadowModelType"]
