...
class OrbitalEventRequest(BaseModel):
    ...
    event_family_types: List[OrbitalEventFamilyType] = Field(description="The type of family of orbital events that can be detected and logged. For eclipse events, the shadow model type can be specified in the output configuration", alias="eventFamilyTypes")
