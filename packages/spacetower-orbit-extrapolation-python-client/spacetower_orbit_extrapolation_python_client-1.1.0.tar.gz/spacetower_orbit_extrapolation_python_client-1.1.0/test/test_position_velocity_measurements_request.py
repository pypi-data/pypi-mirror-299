    ...
    def make_instance(self, include_optional) -> PositionVelocityMeasurementsRequest:
        ...
        if include_optional:
            return PositionVelocityMeasurementsRequest(
                frame_id = 'GCRF',
                position_standard_deviation = spacetower_orbit_extrapolation_python_client.models.position_standard_deviation.PositionStandardDeviation(
                    position_x_standard_deviation = 1.337, 
                    position_y_standard_deviation = 1.337, 
                    position_z_standard_deviation = 1.337, ),
                position_correlation_coefficients = spacetower_orbit_extrapolation_python_client.models.position_correlation_coefficients.PositionCorrelationCoefficients(
                    position_xy_correlation = 1.337, 
                    position_xz_correlation = 1.337, 
                    position_yz_correlation = 1.337, ),
                velocity_standard_deviation = spacetower_orbit_extrapolation_python_client.models.velocity_standard_deviation.VelocityStandardDeviation(
                    velocity_x_standard_deviation = 1.337, 
                    velocity_y_standard_deviation = 1.337, 
                    velocity_z_standard_deviation = 1.337, ),
                velocity_correlation_coefficients = spacetower_orbit_extrapolation_python_client.models.velocity_correlation_coefficients.VelocityCorrelationCoefficients(
                    velocity_xy_correlation = 1.337, 
                    velocity_xz_correlation = 1.337, 
                    velocity_yz_correlation = 1.337, ),
                position_velocity_correlation_coefficients = spacetower_orbit_extrapolation_python_client.models.position_velocity_correlation_coefficients.PositionVelocityCorrelationCoefficients(
